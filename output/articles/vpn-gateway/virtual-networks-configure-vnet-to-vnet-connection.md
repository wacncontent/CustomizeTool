...
1. Log in to the [Azure Classic Management Portal](https://manage.windowsazure.cn). In this article, we use the Classic Management Portal because some of the required configuration settings are not yet available in the Azure portal.
