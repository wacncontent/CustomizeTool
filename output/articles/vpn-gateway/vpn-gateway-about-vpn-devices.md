<properties 
   pageTitle="About VPN Devices for Site-to-Site VPN Gateway connections for Azure Virtual Networks | Windows Azure"
...
We have validated a set of standard VPN devices in partnership with device vendors. All of the devices in the device families contained in the list below should work with Azure VPN gateways. See the [VPN gateways](/documentation/articles/vpn-gateway-about-vpngateways) article to verify the type of gateway that you'll need to create for the solution you want to configure. 
...
| Cisco                           | ASA                                                      | 8.3                                                | [Cisco samples](http://go.microsoft.com/fwlink/p/?LinkID=717348)                                                                                                                                                                        | Not compatible                                                                                                                                                                                               |
| Cisco                           | ASR                                                      | IOS 15.1 (policy-based),  IOS 15.2 (route-based)                | [Cisco samples](http://go.microsoft.com/fwlink/p/?LinkID=717348)                                                                                                                                                                        | [Cisco samples](http://go.microsoft.com/fwlink/p/?LinkID=717348)                                                                                                                                 |
| Cisco                           | ISR                                                      | IOS 15.0 (policy-based),  IOS 15.1 (route-based)               | [Cisco samples](http://go.microsoft.com/fwlink/p/?LinkID=717348)                                                                                                                                                                        | [Cisco samples](http://go.microsoft.com/fwlink/p/?LinkID=717348)                                                                                                                                |
...
| Juniper                         | SRX                                                      | JunOS 10.2 (policy-based),  JunOS 11.4 (route-based)            | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                                                                      | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                              |
| Juniper                         | J-Series                                                 | JunOS 10.4r9 (policy-based),  JunOS 11.4 (route-based)          | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                                                                 | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                         |
| Juniper                         | ISG                                                      | ScreenOS 6.3 (policy-based and route-based)                  | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                                                                      | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                              |
| Juniper                         | SSG                                                      | ScreenOS 6.2 (policy-based and route-based)                  | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                                                                      | [Juniper samples](http://go.microsoft.com/fwlink/p/?LinkId=717760)                                                                                                                              |
...
If you donât see your device listed in the Validated VPN devices table (above), it still may work with a Site-to-Site connection. Verify that your VPN device meets the minimum requirements outlined in the Gateway Requirements section of the [About VPN Gateways](/documentation/articles/vpn-gateway-about-vpngateways#gateway-requirements) article. Devices meeting the minimum requirements should also work well with VPN gateways. Please contact your device manufacturer for additional support and configuration instructions.
