...
If you don't already have an Azure subscription, you can sign up for a trial at [Try Azure](http://azure.microsoft.com/pricing/1rmb-trial/). If you have an MSDN Subscription, see [Azure benefit for MSDN subscribers](http://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/).
