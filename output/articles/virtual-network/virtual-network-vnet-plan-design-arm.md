...
### Limits
Review the networking limits in the [Azure limits](/documentation/articles/azure-subscription-service-limits/#networking-limits) article to ensure that your design doesn't conflict with any of the limits. Some limits can be increased by opening a support ticket.
