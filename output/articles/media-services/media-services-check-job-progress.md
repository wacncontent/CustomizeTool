...
Windows Azure Media Services has the ability to deliver notification messages to the [Azure Queue storage](storage-dotnet-how-to-use-queues#what-is) when processing media jobs. This topic shows how to get these notification messages from Queue storage.
