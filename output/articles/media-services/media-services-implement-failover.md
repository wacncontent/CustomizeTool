...
- If you want to take advantage of dynamic packaging, you must first get at least one On-demand Streaming reserved units. For more information, see [Dynamically Packaging Assets](media-services-dynamic-packaging-overview).
...
- Two Media Services accounts in a new or existing Azure subscription. See [How to Create a Media Services Account](media-services-create-account).
