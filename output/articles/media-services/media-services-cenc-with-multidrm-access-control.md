...
- [Introduction](/documentation/articles/media-services-cenc-with-multidrm-access-control#introduction)
	- [Overview of this article](/documentation/articles/media-services-cenc-with-multidrm-access-control#overview-of-this-article)
- [A reference design](/documentation/articles/media-services-cenc-with-multidrm-access-control#a-reference-design)
- [Mapping design to technology for implementation](/documentation/articles/media-services-cenc-with-multidrm-access-control#mapping-design-to-technology-for-implementation)
- [Implementation](/documentation/articles/media-services-cenc-with-multidrm-access-control#implementation)
	- [Implementation procedures](/documentation/articles/media-services-cenc-with-multidrm-access-control#implementation-procedures)
	- [Some gotchas in implementation](/documentation/articles/media-services-cenc-with-multidrm-access-control#some-gotchas-in-implementation)
- [Additional Topics for Implementation](/documentation/articles/media-services-cenc-with-multidrm-access-control#additional-topics-for-implementation)
	- [HTTP or HTTPS](/documentation/articles/media-services-cenc-with-multidrm-access-control#http-or-https)
	- [Azure Active Directory signing key rollover](/documentation/articles/media-services-cenc-with-multidrm-access-control#azure-active-directory-signing-key-rollover)
	- [Where is the Access Token?](/documentation/articles/media-services-cenc-with-multidrm-access-control#where-is-the-access-token)
	- [What about Live Streaming?](/documentation/articles/media-services-cenc-with-multidrm-access-control#what-about-live-streaming)
	- [What about license servers outside of Azure Media Services?](/documentation/articles/media-services-cenc-with-multidrm-access-control#what-about-license-servers-outside-of-azure-media-services)
	- [What if I want to use a custom STS?](/documentation/articles/media-services-cenc-with-multidrm-access-control#what-if-i-want-to-use-a-custom-sts)
- [The completed system and test](/documentation/articles/media-services-cenc-with-multidrm-access-control#the-completed-system-and-test)
	- [User login](/documentation/articles/media-services-cenc-with-multidrm-access-control#user-login)
	- [Using Encrypted Media Extensions for PlayReady](/documentation/articles/media-services-cenc-with-multidrm-access-control#using-encrypted-media-extensipons-for-playready)
	- [Using EME for Widevine](/documentation/articles/media-services-cenc-with-multidrm-access-control#using-eme-for-widevine)
	- [Not entitled users](/documentation/articles/media-services-cenc-with-multidrm-access-control#not-entitled-users)
	- [Running custom Secure Token Service](/documentation/articles/media-services-cenc-with-multidrm-access-control#running-custom-secure-token-service)
- [Summary](/documentation/articles/media-services-cenc-with-multidrm-access-control#summary)
...
1. Provides a reference implementation on Windows Azure/Azure Media Services platform;
...
Next, we map our generic design to technologies on Windows Azure/Azure Media Services platform, by specifying which technology to use for each building block.

The following table shows the mapping:

**Building Block**|**Technology**
------|-------
**Player**|[Azure Media Player](/home/features/media-services/media-player/)
...
In other words, both Identity Provider (IDP) and Secure Token Service (STS) will be Azure AD. For player, we will use [Azure Media Player API](http://amp.chinacloudapi.cn/libs/amp/latest/docs/). Both Azure Media Services and Azure Media Player support DASH and CENC with multi-DRM.
...
1. Create a player using [Azure Media Player API](http://amp.chinacloudapi.cn/libs/amp/latest/docs/). [Azure Media Player's ProtectionInfo API](http://amp.chinacloudapi.cn/libs/amp/latest/docs/) allows you to specify which DRM technology to use on different DRM platform.
1. Test matrix:
...
3. Use the right issuer in setting up dynamic CENC protection:
	...
	The GUID is the AAD tenant ID. The GUID can be found in Endpoints popup in Azure Management Portal.
...
Detailed info on Azure AD key rollover can be found in the document: [Important Information about Signing Key Rollover in Azure AD](http://msdn.microsoft.com/zh-cn/library/azure/dn641920.aspx/).
