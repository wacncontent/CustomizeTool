...
This topic gives an overview of main [concepts](#concepts) and links to topics that show how to perform content delivery related [tasks](#tasks).
...
For an overview about streaming endpoints and information on how to manage them, see [How to Manage Streaming Endpoints in a Media Services Account](/documentation/articles/media-services-manage-origins).
