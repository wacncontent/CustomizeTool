<properties
	pageTitle="Replicate Hyper-V VMs (in a VMM cloud) to a secondary site with Azure Site Recovery using SAN | Windows Azure"
...
1. [Read about](/documentation/articles/site-recovery-network-mapping) network mapping.
