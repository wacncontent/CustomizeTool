...
* [Google account](https://accounts.google.com/SignUp) with a verified email address.
* [Visual Studio Community 2013](https://www.visualstudio.com/downloads/download-visual-studio-vs)&mdash;not needed for a Node.js backend project.
* Complete the [quickstart tutorial](/documentation/articles/app-service-mobile-android-get-started/).
...
* Tags allow you to target segmented customers with pushes. [Work with the .NET backend server SDK for Azure Mobile Apps](/documentation/articles/app-service-mobile-dotnet-backend-how-to-use-server-sdk/) shows you how to add tags to a device installation.
