...
The following diagram shows the lifecycle of a runbook job for [Graphical runbooks](automation-runbook-types#graphical-runbooks) and [PowerShell Workflow runbooks](automation-runbook-types#powershell-workflow-runbooks).
...
|Failed| For [Graphical and PowerShell Workflow runbooks](automation-runbook-types), the runbook failed to compile.  For [PowerShell Script runbooks](automation-runbook-types), the runbook failed to start or the job encountered an exception. |
