...
|Failed| For [<!-- deleted by customization Graphical and --> PowerShell Workflow runbooks](/documentation/articles/automation-runbook-types), the runbook failed to compile.  For [PowerShell Script runbooks](/documentation/articles/automation-runbook-types), the runbook failed to start or the job encountered an exception. |
