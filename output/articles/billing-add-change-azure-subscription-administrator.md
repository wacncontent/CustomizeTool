<properties
	pageTitle="How to add or change Azure Administrator Roles | Windows Azure"
...
| Service Administrator (SA) | 1 per Azure subscription  |This person is authorized to manage services on the [Azure Management Portal](https://manage.windowsazure.cn/). By default, for a new subscription, the Account Administrator is also the Service Administrator.|
...
**Note** Azure Active Directory Role-based Access Control (RBAC) allows users to be added to multiple roles. For more information, see [Azure Active Directory Role-based Access Control](/documentation/articles/role-based-access-control-configure).
 ...
 * Each subscription is associated with an Azure Active Directory (aks the Default Directory). To find the Default Directory the subscription is associated with, go to the [Azure Management Portal](https://manage.windowsazure.cn/), select **Settings** > **Subscriptions**. Check the subscription ID to find the Default Directory.
