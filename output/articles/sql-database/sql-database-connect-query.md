...
- Visual Studio 2013 update 4 (or later). Microsoft now provides Visual Studio Community for *free*.
 ...
 - Or, let the [step](#InstallVSForFree) later in this topic describe how the [Azure Management Portal](http://manage.windowsazure.cn/) guides you to the install of Visual Studio.
...
- Let the [Azure Management Portal](http://manage.windowsazure.cn/) guide you to the download webpage, which described next.
...
You can use the [Azure Management Portal](http://manage.windowsazure.cn/) to add the IP address.
