...
- **Upgrade all Web and Business databases**: See [Upgrade all Web and Business databases](/documentation/articles/sql-database-v12-upgrade#upgrade-all-web-and-business-databases) section below or use [PowerShell to upgrade databases and server](/documentation/articles/sql-database-upgrade-server-powershell).
