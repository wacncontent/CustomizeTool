...
1. In Management Studio, in Connect to Server, make sure that Database Engine is selected, then enter the logical server name in this format: *servername*.database.chinacloudapi.cn
...
[Managing SQL Database using Management Studio]: /documentation/articles/sql-database-manage-azure-ssms/
