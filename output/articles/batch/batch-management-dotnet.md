...
When you create Batch accounts with the Batch Management .NET library, you will typically be creating them within a [resource group][resman_overview]. You can create the resource group programmatically by using the [ResourceManagementClient][resman_client] class in the [Resource Manager .NET][resman_api] library. Or you can add an account to an existing resource group that you created previously by using the [Azure Management Portal][azure_portal].
...
![Azure Management Portal displaying the resource group and Batch account][1]
<br />
...
[azure_portal]: http://manage.windowsazure.cn
