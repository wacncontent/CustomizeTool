<properties
	pageTitle="Run MPI applications in Azure Batch with multi-instance tasks | Azure"
...
> [AZURE.TIP] When you use size [A8 or A9 compute nodes](/documentation/articles/virtual-machines-windows-a8-a9-a10-a11-specs/) in your Batch pool, your MPI application can take advantage of Azure's high-performance, low-latency remote direct memory access (RDMA) network. You can see the full list of compute node sizes available for Batch pools in [Sizes for Cloud Services](./../cloud-services/cloud-services-sizes-specs.md).
