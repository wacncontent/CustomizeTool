<properties
    pageTitle="Create an application gateway using URL routing rules | Azure"
...
> [AZURE.SELECTOR]
- [Azure portal](/documentation/articles/application-gateway-create-url-route-portal/)
...
If you want to learn Secure Sockets Layer (SSL) offload, see [Configure an application gateway for SSL offload](/documentation/articles/application-gateway-ssl-arm/).
