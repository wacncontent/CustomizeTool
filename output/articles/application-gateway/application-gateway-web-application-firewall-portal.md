<properties
   pageTitle="Create an application gateway with web application firewall using the portal | Azure"
...
> [AZURE.SELECTOR]
- [Azure portal](/documentation/articles/application-gateway-web-application-firewall-portal/)
