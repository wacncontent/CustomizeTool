...
1. Open PuTTY, and enter your connection information. If you are not familiar with PuTTY, see [Use SSH with Linux-based Hadoop on HDInsight from Windows](hdinsight-hadoop-linux-use-ssh-windows) for information on how to use it with HDInsight.
...
* [Manage HDInsight clusters by using Ambari](hdinsight-hadoop-manage-ambari)
