...
> [AZURE.NOTE]
> The steps in this document assume that you are using a Windows-based HDInsight cluster. For information on using a Linux-based HDInsight cluster, see [Use Maven to build Java applications that use HBase with Linux-based HDInsight](/documentation/articles/hdinsight-hbase-build-java-maven-linux/)
> 
> 
...
* [A Windows-based HDInsight cluster with HBase](/documentation/articles/hdinsight-hbase-tutorial-get-started-v1/#create-hbase-cluster)
