...
> [AZURE.IMPORTANT]
> The HDInsight Query Console is only available on Windows-based HDInsight clusters. If you are using a Linux-based HDInsight cluster, see [Run Hive queries using the Hive View](/documentation/articles/hdinsight-hadoop-use-hive-ambari-view/).
> 
> 
