...
* An Azure HDInsight (Hadoop on HDInsight) cluster (either Windows <!-- deleted by customization or Linux-based) --><!-- keep by customization: begin --> ) <!-- keep by customization: end -->
