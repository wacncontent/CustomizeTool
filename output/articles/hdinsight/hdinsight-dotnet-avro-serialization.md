...
 **Azure  3. Click the **Install** button next to **Azure HDInsight Avro Library**.
...
 ###Sample  ###Sample 3: Serialization using object container files and serialization with reflection
...
 ###Sample  ###Sample 4: Serialization using object container files and serialization with generic record
...
 ###Sample  ###Sample 5: Serialization using object container files with a custom compression codec
...
 ###Sample  ###Sample 6: Using Avro to upload data for the Azure HDInsight service
