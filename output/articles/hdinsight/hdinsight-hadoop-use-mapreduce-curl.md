...
You can list and download these files by using the [Azure CLI for Mac, Linux and Windows](xplat-cli-install). For example, to list files in the **example/curl**, use the following command:
