...
- The __Azure CLI__. For more information, see [Install and configure the Azure CLI](xplat-cli-install)
...
- [Get started with HDInsight](hdinsight-hadoop-linux-tutorial-get-started)
- [Analyze flight delay data using HDInsight](hdinsight-analyze-flight-delay-data-linux)
