...
> [AZURE.NOTE]
> The information in this document is specific to Linux-based HDInsight clusters. For information on Windows-based clusters, see [Access YARN application logs on Windows-based HDInsight](/documentation/articles/hdinsight-hadoop-access-yarn-app-logs/)
> 
> 
