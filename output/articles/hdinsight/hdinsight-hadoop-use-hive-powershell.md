...
 or Linux-based)**  - **An Azure HDInsight (Hadoop on HDInsight) cluster (Windows-based or Linux-based)**
...
 **Add-AzureRmAccount**  * **Add-AzureRmAccount**: Authenticates Azure PowerShell to your Azure subscription
