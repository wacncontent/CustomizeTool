...
* [Provision Hadoop clusters in HDInsight](hdinsight-hadoop-provision-linux-clusters) - Provides information on provisioning Hadoop clusters, including information on using Azure Virtual Network.

* [Use Sqoop with Hadoop in HDInsight](hdinsight-use-sqoop-mac-linux) - Provides information on using Sqoop to transfer data with SQL Server over a virtual network.
