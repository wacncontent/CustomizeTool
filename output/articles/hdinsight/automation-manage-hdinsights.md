...
With the Azure HDInsight cmdlets you can automate tasks such as provisioning HDInsight clusters on <!-- deleted by customization Linux or -->Windows, scaling clusters, managing clusters, and submitting MapReduce jobs. These are just a few of the many tasks that you can automate using PowerShell in Azure Automation.  
