...
* **SSH** - &lt;clustername>-ssh.azurehdinsight.cn on <!-- keep by customization: begin --> port 22on <!-- keep by customization: end -->  port 22 or 23. Port 22 is used to connect to head node 0, while 23 is used to connect to head node 1. For more information on the head nodes, see [Availability and reliability of Hadoop clusters in HDInsight](/documentation/articles/hdinsight-high-availability).
