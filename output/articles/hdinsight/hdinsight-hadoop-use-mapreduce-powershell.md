...
* **New-AzureRmHDInsightMapRe **New-AzureRmHDInsightMapReduceJobDefinition**  : Creates a new *job definition* by using the specified MapReduce information
...
 **Wait-AzureRmHDInsightJob**   **Wait-AzureRmHDInsightJob**: Uses the job object to check the status of the job. It waits until the job completes or the wait time is exceeded.
