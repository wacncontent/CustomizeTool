...
> [AZURE.NOTE]
> HDInsight clusters use Ubuntu long term support (LTS) as the operating system for the nodes in the cluster. For information on the version of Ubuntu available with HDInsight, along with other component versioning information, see [HDInsight component versions](/documentation/articles/hdinsight-component-versioning-v1/).
>
>
...
* Execute .NET activities on Azure Batch pool. See the Use Azure Batch linked service section of [Use custom activities in an Azure Data Factory pipeline](/documentation/articles/data-factory-use-custom-activities/)
