...
* **Updated Tomcat and Jetty distributions**. The Jetty and Tomcat distributions which are available on Windows Azure for use with the Azure Toolkit for Eclipse have been updated.
