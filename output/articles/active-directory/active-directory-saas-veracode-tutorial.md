<properties pageTitle="Tutorial: Azure Active Directory integration with Veracode | Windows Azure" description="Learn how to use Veracode with Azure Active Directory to enable single sign-on, automated provisioning, and more!." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
...
After completing this tutorial, the Azure AD users you have assigned to Veracode will be able to single sign into the application using the [Introduction to the Access Panel](https://msdn.microsoft.com/zh-cn/library/dn308586)
...
2.  On the **How would you like users to sign on to Veracode** page, select **Windows Azure AD Single Sign-On**, and then click **Next**.
...
8.  In the **Organization SAML Settings** section, perform the following steps:
    ...
    1.  In the Azure Management Portal, on the **Configure single sign-on at Veracode** dialog page, copy the **Issuer URL** value, and then paste it into the **Issuer** textbox
