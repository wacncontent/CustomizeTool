<properties
	pageTitle="Tutorial: Azure Active Directory integration with Evidence.com | Windows Azure"
...
1.	After adding Evidence.com in the Azure Management Portal, click **Configure Single Sign-On**. 
...
8.	Copy the **Issuer URL**, **Single Sign On** and **Single Sign Out** values shown in the Azure Management Portal and to the corresponding fields in Evidence.com.
...
11.	In the Azure Management Portal, check **Confirm that you have configured single sign-on as described above**. Checking this will enable the current certificate to start working for this application checkbox.
...
1.	On the quick start page for Evidence.com in the Azure Management Portal, click **Assign users to Evidence.com**.
