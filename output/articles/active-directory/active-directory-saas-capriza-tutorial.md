<properties
	pageTitle="Tutorial: Azure Active Directory integration with Capriza | Windows Azure"
...
The objective of this section is to enable Azure AD single sign-on in the Azure Management Portal and to configure single sign-on in your Capriza application.



**To configure Azure AD single sign-on with Capriza, perform the following steps:**

1. In the Azure Management Portal, on the **Capriza** application integration page, click **Configure single sign-on** to open the **Configure Single Sign-On**  dialog.
...
<br><br>![Configure Single Sign-On](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_04.png) <br>
    ...
    a. In the Sign On URL textbox, type the URL used by your users to sign-on to your Capriza application using the following pattern: **âhttps://companyname.capriza.com/tenantidâ**.
