...
Sometimes a user may try to sign in to the Azure Management Portal using a work or school account prior to signing up for an Azure subscription. In this case, the user will receive a message that there is no subscription for that account. The message will include a link to start a trial subscription.

After signing up for the trial, the user will see the directory for the organization in the Azure Management Portal but be unable to manage it (that is, be unable to add users, or edit any existing user properties) because the user is not a directory global administrator. The subscription allows the user to use the Azure Management Portal and see the Azure Active Directory extension, but the additional permissions of a global administrator are needed to manage the directory.
...
Let's say you signed up for Office 365 before you sign up for Azure. Now you want to manage the directory for the Office 365 subscription in the Azure Management Portal. There are two ways to do this, depending on whether you have signed up for Azure or you have not.
...
To manage both of the directories in the Azure Management Portal, complete these steps.
...
7. Sign back in to the Azure Management Portal using your Microsoft account. Both directories will appear in the Active Directory extension.
