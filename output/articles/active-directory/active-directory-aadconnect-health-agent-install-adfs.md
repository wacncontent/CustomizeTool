...
> [AZURE.WARNING] If you have a group policy that is disabling AD FS auditing then the Azure AD Connect Health Agent will not be able to collect information. Ensure that you donĄŻt have a group policy that may be disabling auditing.
...
>[AZURE.NOTE]
- Using Ą°Netsh WinHttp set ProxyServerAddressĄą will not work as the agent uses System.Net to make web requests instead of Microsoft Windows HTTP Services.
