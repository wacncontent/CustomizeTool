...
identityMetadata: <!-- deleted by customization 'https://login.chinacloudapi.cn/common/.well-known/openid-configuration' --><!-- keep by customization: begin --> 'https://login.microsoftonline.com/common/.well-known/openid-configuration' <!-- keep by customization: end --> // For using Microsoft you should never need to change this.
};
