...
<properties 
	pageTitle="Using Azure AD Connect Health with sync | Windows Azure" 
...
* [Azure AD Connect Health Agent Installation](/documentation/articles/active-directory-aadconnect-health-install)
