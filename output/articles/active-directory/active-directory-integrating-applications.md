...
To learn more about the two Azure AD objects that represent a registered application and the relationship between them, see [Application Objects and Service Principal Objects](/documentation/articles/active-directory-application-objects); to learn more about the branding guidelines you should use when developing applications with Azure Active Directory, see [Branding Guidelines for Integrated Apps](/documentation/articles/active-directory-branding-guidelines).
...
### To register a new application in the Azure Management Portal
...
For more detailed information about the consent framework, see [OAuth 2.0 in Azure AD](https://msdn.microsoft.com/zh-cn/library/azure/dn645545.aspx), [Authentication Scenarios for Azure AD](/documentation/articles/active-directory-authentication-scenarios), and Office 365 topic [Understanding authentication with Office 365 APIs](https://msdn.microsoft.com/office/office365/howto/common-app-authentication-tasks).
...
1. On your Web client application's configuration page in the Azure Management Portal, set the permissions your application requires by using the drop-down menus in the Permissions to other applications control.
...
For more information on application manifest concepts in general, please refer to [Understanding the Azure Active Directory application manifest](/documentation/articles/active-directory-application-manifest).
...
The grant access page is created by Azure AD, and you can find a link to it in your app's Configuration page in the Azure Management Portal. To get to the Configuration page, click on the Applications link in the top menu of your Azure AD tenant, click the app you want to configure, then click on Configure from the top menu of the Quick Start page.
...
In order to remove a multi-tenant application's access to your directory (after having granted consent), the company administrator must have an Azure subscription to remove access through the Azure Management Portal. You simply navigate to the application's configuration page, and click the "Manage Access" button at the bottom. Alternatively, the company administrator can use the [Azure AD PowerShell Cmdlets](https://msdn.microsoft.com/zh-cn/library/azure/jj151815.aspx) to remove access.
