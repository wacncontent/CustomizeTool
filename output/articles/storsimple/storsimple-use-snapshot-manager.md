...
- For a description of the MMC accessibility features, go to [Accessibility for MMC 3.0](https://technet.microsoft.com/zh-cn/library/cc766075.aspx)
...
| Add/Remove Snap-in | Click **Add/Remove Snap-in** to add or remove snap-ins and to organize nodes in the **Scope** pane. For more information, go to [Add, Remove, and Organize Snap-ins and Extensions in MMC 3.0](https://technet.microsoft.com/zh-cn/library/cc722035.aspx). |
...
- Learn how to [use StorSimple Snapshot Manager to connect and manage devices](/documentation/articles/storsimple-snapshot-manager-manage-devices).