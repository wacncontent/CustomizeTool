...
For more information about using Windows PowerShell remoting to manage your device, go to [Use Windows PowerShell for StorSimple to administer your StorSimple device](/documentation/articles/storsimple-windows-powershell-administration).
...
You can use either the Azure Management Portal or the serial console to configure remote management. Select from the following procedures:

- [Use the Azure Management Portal to enable remote management over HTTP](#use-the-azure-classic-portal-to-enable-remote-management-over-http)
...
### Use the Azure Management Portal to enable remote management over HTTP 

Perform the following steps in the Azure Management Portal to enable remote management over HTTP.

#### To enable remote management through the Azure Management Portal
...
- [Use the Azure Management Portal to enable remote management over HTTPS](#use-the-azure-classic-portal-to-enable-remote-management-over-https)
...
### Use the Azure Management Portal to enable remote management over HTTPS

Perform the following steps in the Azure Management Portal to enable remote management over HTTPS.

#### To enable remote management over HTTPS from the Azure Management Portal
...
Use Windows PowerShell and SSL to enter an SSAdmin session on your device from a remote host or client. The SSAdmin session maps to option 1 in the [serial console](/documentation/articles/storsimple-windows-powershell-administration#connect-to-windows-powershell-for-storsimple-via-device-serial-console) menu of your device.
...
- Learn more about [using Windows PowerShell to administer your StorSimple device](/documentation/articles/storsimple-windows-powershell-administration).
