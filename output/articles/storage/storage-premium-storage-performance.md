...
Learn more about [iostat](http://linuxcommand.org/man_pages/iostat1.html) and [PerfMon](https://msdn.microsoft.com/zh-cn/library/aa645516(v=vs.71).aspx).
...
Learn more about [Degrees of Parallelism](https://technet.microsoft.com/zh-cn/library/ms188611(v=sql.105).aspx) in SQL Server. Find out such settings that influence multi-threading in your application and their configurations to optimize performance.
