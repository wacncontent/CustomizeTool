...
For an example of setting the environment variables in the [Azure Management Portal](portal.azure.com) for an Azure Website, see [Node.js Web Application with Storage]
