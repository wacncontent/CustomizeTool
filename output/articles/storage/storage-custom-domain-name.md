<properties
	pageTitle="Configure a domain name for your Blob storage endpoint | Windows Azure"
...
You can configure a custom domain for accessing blob data in your Azure storage account. The default endpoint for Blob storage is https://<*mystorageaccount*>.blob.core.chinacloudapi.cn. If you map a custom domain and subdomain such as **www.contoso.com** to the blob endpoint for your storage account, then your users can also access blob data in your storage account using that domain.


> [AZURE.NOTE]	The procedures in this task apply to Azure storage accounts. For cloud services, see <a href = "/develop/net/common-tasks/custom-dns/">Configuring a Custom Domain Name for an Azure Cloud Service</a>; for Websites, see <a href="/documentation/articles/web-sites-custom-domain-name/">Configuring a Custom Domain Name for an Azure Website</a>.
...
1.  In the [Azure Management Portal](manage.windowsazure.cn), navigate to the **Storage** tab.
