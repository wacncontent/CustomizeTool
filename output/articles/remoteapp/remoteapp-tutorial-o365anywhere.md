<properties
   pageTitle="Get the same Office 365 experience on any device with Azure RemoteApp | Windows Azure"
...
![Showing Azure RemoteApp on the Azure Management Portal](./media/remoteapp-tutorial-o365anywhere/1-menu.png)
