...
<properties 
    pageTitle="How to use Azure RemoteApp with Office 365 user accounts | Windows Azure"
...
For info on how to deploy Office 365 client applications, see [How to use your Office 365 subscription with Azure RemoteApp](/documentation/articles/remoteapp-officesubscription).
 
## Phase 1: Register your free Office 365 Azure Active Directory subscription
Follow [Change the Azure Active Directory tenant in Azure RemoteApp](/documentation/articles/remoteapp-changetenant) in order to get administrative access to your Azure AD via the Azure Management Portal. As the result of this process you should be able to log into the Azure Management Portal and see your directory there - at this point you won't see much more since the full Azure subscription you are using with Azure RemoteApp is in a different directory.
...
Follow the instructions described in [Change the Azure Active Directory tenant in Azure RemoteApp](/documentation/articles/remoteapp-changetenant). Pay particular attention to the following steps:
