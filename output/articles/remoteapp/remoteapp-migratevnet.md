<properties
    pageTitle="How to migrate from a RemoteApp VNET to an Azure VNET | Windows Azure"
...
1.	On the **Networks** tab in the [management portal](http://manage.windowsazure.cn/), create a VNET called *AzureVNET*, using the same location, DNS configuration, and address space (for at least one of the *AzureVNET* subnets) as you used for *RemoteAppVNET*.
