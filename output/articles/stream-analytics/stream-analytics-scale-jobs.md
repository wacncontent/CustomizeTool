...
- The input source must be partitioned. For more information, see [Azure Stream Analytics developer guide](/documentation/articles/stream-analytics-developer-guide) and [Event Hubs Programming Guide](/documentation/articles/event-hubs-programming-guide).
