...
2. Upload your certificate's .cer file to Azure. In the [Azure Classic Management Portal](https://manage.windowsazure.cn), click **Settings** in the bottom left of the service area (shown below)
