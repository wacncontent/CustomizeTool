...
 name="checkdisk"<</a>Check  ### <a name="checkdisk"<</a>Check the consistency of added disks
...
 name="checkdisk"<</a>Repair  ### <a name="checkdisk"<</a>Repair added disks on your Linux VM
