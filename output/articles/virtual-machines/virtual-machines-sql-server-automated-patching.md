<!-- rename to virtual-machines-windows-classic-sql-automated-patching -->
...
You can use the [Azure portal](https://portal.azure.cn/) to configure Automated Patching when you create a new SQL Server Virtual Machine.
