<!-- rename to virtual-machines-linux-classic-faq -->
...
If you're having problems with Remote Desktop or SSH, install and use the [VMAccess](/documentation/articles/virtual-machines-linux-extensions-features/) extension to help fix the problem. 
...
- Use Windows PowerShell Remoting to connect to the VM, or create additional endpoints for other resources to connect to the VM. For details, see [How to Set Up Endpoints to a Virtual Machine](/documentation/articles/virtual-machines-linux-classic-setup-endpoints/).
...
If you've forgotten the user name or password and you've installed the VM Agent, you can install and use the [VMAccess](/documentation/articles/virtual-machines-linux-extensions-features/) extension to fix the problem.
...
- [Deploying Antimalware Solutions on Azure Virtual Machines](https://azure.microsoft.com/zh-cn/blog/2014/05/13/deploying-antimalware-solutions-on-azure-virtual-machines/)
