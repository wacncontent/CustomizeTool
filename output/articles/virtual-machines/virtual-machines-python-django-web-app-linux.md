...
 Resource Manager model. [AZURE.INCLUDE [learn-about-deployment-models](../includes/learn-about-deployment-models-rm-include.md)] Resource Manager model.
...
1. Follow the instructions given [here](/documentation/articles/virtual-machines-linux-tutorial-portal-rm) to create an Azure virtual machine of the *Ubuntu Server 14.04 LTS* distribution.  If you prefer, you can cho  If you prefer, you can choose password authentication instead of SSH public key. 
