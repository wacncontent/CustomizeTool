...
1. After the HPC Pack cluster is deployed, go to the [Azure portal](https://portal.azure.cn). Click **Resource groups**, and find the resource group in which the cluster was deployed. You can find the head node virtual machines.
