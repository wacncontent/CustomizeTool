...
This topic steps you through creating a hybrid cloud environment for testing a web-based line-of-business (LOB) application hosted in Azure. Here is the resulting configuration.
...
- Deploy the [production environment](/documentation/articles/virtual-machines-windows-lob-overview/).
