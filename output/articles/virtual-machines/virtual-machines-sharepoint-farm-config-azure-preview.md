...
<properties
	...
	description="Learn about the default configuration of SharePoint farms when you use the SharePoint Server Farm feature of the Azure Portal Preview."
...
SharePoint Server Farm is a feature of the Azure Portal Preview that automatically creates a preconfigured SharePoint Server 2013 farm for you. There are two farm configurations:
