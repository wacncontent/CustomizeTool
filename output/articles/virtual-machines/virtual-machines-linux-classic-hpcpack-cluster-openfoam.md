...
8. Click **Submit** to run this job.
   ...
   hpccred delcreds
   ```
9. The job takes from tens of minutes to several hours according to the parameters you have set for the sample. In the heat map, you see the job running on the Linux nodes. 
