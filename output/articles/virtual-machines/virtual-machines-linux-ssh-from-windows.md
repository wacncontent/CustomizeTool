...
1. **ssh-rsa** keys are required for any deployment using the [Azure portal](https://portal.azure.cn), and Resource Manager deployments using the [Azure CLI](/documentation/articles/xplat-cli-install/).
