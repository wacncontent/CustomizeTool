...
* In the Azure Management Portal: click the deployment of your cloud service, click **All settings**, and then click **Properties**.
* In the Azure Management Portal: click the deployment of your cloud service, click **DASHBOARD**, locate to the lower-right corner of the page (under **quick glance**). Be aware that there's no "Properties" text for this pane.
