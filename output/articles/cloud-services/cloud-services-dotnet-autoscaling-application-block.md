<properties 
	pageTitle="Use the autoscaling application block (.NET) | Windows Azure" 
...
-   **[subscriptionid]:** The unique ID of the
    ...
    3.  In the Azure Management Portal, click
        **Cloud Services**.

    4.  In the list of Cloud Services, locate the service that hosts the
    ...
    5.  In the Azure Management Portal, click
        **Cloud Services**.

    6.  In the list of Cloud Services, click on the service that hosts the
    ...
    7.  In the Azure Management Portal, click
        **Storage**.

    8.  In the list of Storage Accounts, select  the storage account you are using. The
        **Name** column will display the **Name**.

    9.  Click the **Manage Keys** button at the bottom of the screen
    ...
    10.  In the Azure Management Portal, click
        **Settings**.

    11.  The **Thumbprint** column will display the **Thumbprint**.
...
-   [Reducing TechNet and MSDN hosting costs and environmental impact with autoscaling on Azure][]
  ...
  [Using performance counters in Azure]: http://www.windowsazure.cn/develop/net/common-tasks/performance-profiling/
  [NuGet]: http://nuget.org/
  [Azure Management Portal]: http://manage.windowsazure.cn
  [Storing Your Service Information Data]: http://msdn.microsoft.com/zh-cn/library/hh680878(PandP.50).aspx		
  [Hosting the Autoscaling Application Block in a Worker Role]: http://msdn.microsoft.com/zh-cn/library/hh680914(PandP.50).aspx
  [Implementing Throttling Behavior]: http://msdn.microsoft.com/zh-cn/library/hh680896(PandP.50).aspx
  [Understanding Rule Ranks and Reconciliation]: http://msdn.microsoft.com/zh-cn/library/hh680923(PandP.50).aspx
  [Extending and Modifying the Autoscaling Application Block]: http://msdn.microsoft.com/zh-cn/library/hh680889(PandP.50).aspx
  [Using the Optimizing Stabilizer to prevent high frequency oscillation and to optimize costs]: http://msdn.microsoft.com/zh-cn/library/hh680951(PandP.50).aspx
  [Using Notifications and Manual Scaling]: http://msdn.microsoft.com/zh-cn/library/hh680885(PandP.50).aspx
  [Defining Scale Groups]: http://msdn.microsoft.com/zh-cn/library/hh680902(PandP.50).aspx
  [Using the WASABiCmdlets for manipulating the block via Windows PowerShell]: http://msdn.microsoft.com/zh-cn/library/hh680938(PandP.50).aspx
  [Developer's Guide to the Enterprise Library 5.0 Integration Pack for Azure]: http://msdn.microsoft.com/zh-cn/library/hh680949(PandP.50).aspx
  [How Sage Reduces Azure Hosting Costs Using Autoscaling]: http://msdn.microsoft.com/zh-cn/library/jj838716(PandP.50).aspx
  [Reducing TechNet and MSDN hosting costs and environmental impact with autoscaling on Azure]: http://msdn.microsoft.com/zh-cn/library/jj838718(PandP.50).aspx
