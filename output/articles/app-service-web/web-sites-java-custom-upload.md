...
Note that Azure provides a means for creating Java web apps using the Azure preview portal's configuration UI, and the Azure Marketplace, as documented at [Create a Java web app in Azure Websites](web-sites-java-get-started). This tutorial is for scenarios in which you do not want to use the portal configuration UI or the Azure Marketplace.  
