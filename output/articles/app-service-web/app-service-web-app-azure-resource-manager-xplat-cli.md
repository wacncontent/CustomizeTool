...
Using the same **azure appserviceplan create** command, with the extra parameter **--islinux true**. Note the restrictions and regions outlined in [Introduction to App Service on Linux](/documentation/articles/app-service-linux-intro/)
...
* To learn about Azure App Service on Linux, see [Introduction to App Service on Linux](/documentation/articles/app-service-linux-intro/)
