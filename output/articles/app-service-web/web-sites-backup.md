...
4. Use the <!-- deleted by customization **Begin** --><!-- keep by customization: begin --> **Start Date** <!-- keep by customization: end --> option to specify a date and time when you want the automated backups to begin.
<!-- keep by customization: begin -->
...
5. In the **Included Databases** section, select the databases that are connected to your <!-- deleted by customization web app --><!-- keep by customization: begin --> website <!-- keep by customization: end --> (SQL Server or MySQL) that you want to back up. For a database to appear in the list, its connection string must exist in the **Connection <!-- deleted by customization strings** --><!-- keep by customization: begin --> Strings** <!-- keep by customization: end --> section of the <!-- deleted by customization **Web app settings** blade --><!-- keep by customization: begin --> Configure tab <!-- keep by customization: end --> in the portal.
<!-- keep by customization: begin -->
