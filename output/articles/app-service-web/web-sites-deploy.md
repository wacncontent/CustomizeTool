...
,  such as Visual Studio, WebMatrix, and Visual Studio Team Ser, and Visual Studio Team Services . . This tool supports diff-only deployment, database creation, transforms of
 differs from Kudu  iconnection strings, etc. Web Deploy differs from Kudu in that application binaries are built before they are deployed to Azure.
...
[Trello](https://trello.com), [Azure Service Bus](/home/features/service Bus](/home/features/service-bus/)  , and much more.
