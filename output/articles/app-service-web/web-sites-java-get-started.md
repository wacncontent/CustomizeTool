...
This tutorial shows how to create a Java [web app in Azure](/documentation/services/web-sites/) by using the [Azure Management Portal](https://manage.windowsazure.cn/). The Azure Management Portal  The Azure Management Portal is a web interface that you can use to manage Azure resources. 

> [AZURE.NOTE] To complete this tutorial, you need a Azure account. If you don't have an account, you can [activate your Visual Studi [activate your Visual Studio subscriber benefits][] or  [ [sign up for a trial][].
>

...
1. Create an app and then use the Azure configuration UI.
	...
	Azure Websites  provides several Tomcat and Jetty versions, with default configuration. If the application that you will be hosting will work with one of the built-in versions, this method of setting up a web container is the easiest  site](#appsettings) section later in this tutorial.

