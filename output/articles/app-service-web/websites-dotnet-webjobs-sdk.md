...
[WebJobs](websites-webjobs-resources) is a feature of Azure Websites that enables you to run a program or script in the same context as a web app. The purpose of the WebJobs SDK is to simplify the task of writing code that runs as a WebJob and works with Azure Storage queues, blobs, and tables, and Service Bus queues.
