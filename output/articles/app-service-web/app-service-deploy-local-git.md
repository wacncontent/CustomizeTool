...
This tutorial shows you how to deploy your app to [Azure Web App] from a Git repository on your local computer. Azure supports this approach with the **Local Git** deployment option in the [Azure Portal].  
