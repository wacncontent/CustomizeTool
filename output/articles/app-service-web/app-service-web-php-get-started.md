...
> [AZURE.NOTE]
> See a web app in action. [Try App Service](https://tryappservice.azure.com/) immediately and create a short-lived starter app--no credit 
...
> [AZURE.NOTE]
> "Wait! What if I want to deploy with FTP?" There's an [FTP tutorial](/documentation/articles/web-sites-php-mysql-deploy-use-ftp/) for your needs. 
> 
> 
...
7. Select **Composer** in the **Choose extension** [blade](/documentation/articles/azure-portal-overview/) (*blade*: a portal page that opens horizontally).
