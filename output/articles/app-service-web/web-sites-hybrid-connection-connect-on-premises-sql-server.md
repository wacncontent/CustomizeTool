...
>
>The Web Apps portion of the Hybrid Connections feature is available only in the [Azure preview portal](https://manage.windowsazure.cn). To create a connection in BizTalk Services, see [Hybrid Connections](http://go.microsoft.com/fwlink/p/?LinkID=397274).  
