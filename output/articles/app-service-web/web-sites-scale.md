...
, or **Premium**  mFor increased performance and throughput for your web apps on Azure, you can use the [Azure Management Portal](https://manage.windowsazure.cn/) to scale your [Azure Web App](/documentation/services/web-sites/) plan from **Free** mode to **Shared**, **Basic**, **Standard**, or **Premium** mode.
...
For information about App S For information about App Service plans, see [What is an App Service Plan?](/documentation/articles/web-sites-web-hosting-plan-overview) and [Azure App Service Plans In-Depth Overview](/documentation/articles/azure-web-sites-web-hosting-plans-in-depth-overview).  F For information the pricing and features of individual App Service plans, see [Azure Pricing Details](/home/features/web-site/#price).
...
<!-- ================================= -->
 or Premium  m## Scaling to Standard or Premium mode
<!-- ================================= -->

 or **Premium**  m> [AZURE.NOTE] Before switching an App Service plan to **Standard** or **Premium** mode, you should remove spending caps in place for your Azure subscription. Otherwise, you risk your web app becoming unavailable if you reach your caps before the billing period ends. To view or change options for your Azure subscription, see [Azure Subscriptions][azuresubscriptions].

...
, and **Premium**  m- The **Basic**, **Standard**, and **Premium** modes support 64-bit and 32-bit applications.
...
 and **Premium**  m- Debugger support is available for the **Standard** and **Premium** modes at 5 concurrent connections per App Service plan.
...
, and **Premium**  m- Web endpoint monitoring is available in the **Basic**, **Standard**, and **Premium** modes. For more information about web endpoint monitoring, see [How to Monitor Web Apps](/documentation/articles/web-sites-monitor).
