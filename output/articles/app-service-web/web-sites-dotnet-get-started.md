...
5. In the **Azure** section of the **New ASP.NET Project** dialog box, make sure that **Host in the cloud** is selected and that **App Services** is selected in the drop-down list.
...
* Monitor and manage your web app in the [Azure portal](https://portal.azure.cn/). 
