<properties
	pageTitle="Deploy a Sails.js web app to Azure"
	description="Learn how to deploy a Node.js application Azure Web App. This tutorial shows you how to deploy a Sails.js web app."
...
This tutorial shows you how to deploy a Sails.js app to Azure Web App. In the process, you can glean some general knowledge
on how to configure your Node.js app to run in Azure Web App. 
...
>[AZURE.NOTE] To see Azure in action before signing up for an Azure account, go to [Try Azure Web App](https://tryappservice.azure.com/). There,
you can immediately create a short-lived starter app in Azure Web App--no credit card required, no commitments.
...
## Step 2: Create the Azure Web App resource in Azure
...
2. Make sure you're still in the root directory of your Sails.js project. Create the Azure Web App resource in Azure with a unique
app name with the next command. Your web app's URL is http://&lt;appname>.chinacloudsites.cn.
    ...
    - Your local Git-initialized repository is connected to the new Azure Web App as a Git remote, aptly named "azure", and
...
## Step 3: Configure and deploy your Sails.js app
 ...
 Working with a Sails.js app in Azure consists of three main steps:

 - Configure your app for it to run in Azure
 - Deploy it to Azure
...
If your Sails.js application fails for some reason in Azure Web App, find the stderr logs to help troubleshoot it.
For more information, see [Get stdout and stderr logs from iisnode](/documentation/articles/app-service-web-nodejs-sails/#iisnodelog).
...
SQL Server. The default firewall settings allow Azure services (e.g. Azure Web App) to connect to it.
...
4. For each environment variable (`process.env.*`), you need to set it in Azure Web App. To do this, run the following commands 
from your terminal:
