...
-	You must have an Azure account. If you don't have one, you can create a [trial account](http://azure.microsoft.com/pricing/1rmb-trial/) in just a few moments.
-	[Install the Azure CLI](xplat-cli-install).
...
-	Before running any of the following commands, switch the Azure CLI into Resource Manager mode by running the `azure config mode arm` command. For more information, see [Setting the Azure Resource Manager mode](xplat-cli-azure-resource-manager#setting-the-azure-resource-manager-mode).
