...
For more information about the classic deployment model, see [Azure Resource Manager vs. classic deployment: Understand deployment models and the state of your resources](/documentation/articles/resource-manager-deployment-model/#classic-deployment-characteristics).
...
> [AZURE.IMPORTANT]
> Import/Export is only available for [premium tier](/documentation/articles/cache-premium-tier-intro/) caches. For more information about Import/Export, see [Import and Export data in Azure Redis Cache](/documentation/articles/cache-how-to-import-export-data/).
> 
> 
...
> [AZURE.IMPORTANT]
> Reboot is only available for [premium tier](/documentation/articles/cache-premium-tier-intro/) caches. For more information about rebooting your cache, see [Cache administration - reboot](/documentation/articles/cache-administration/#reboot).
> 
> 
