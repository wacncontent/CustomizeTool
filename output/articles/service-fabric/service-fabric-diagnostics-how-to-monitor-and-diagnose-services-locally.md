<properties
   pageTitle="Locally monitor and diagnose services written with Azure Service Fabric | Windows Azure"
   description="Learn how to monitor and diagnose your services written using Windows Azure Service Fabric on a local development machine."
...
* [Collecting logs from a Service Fabric cluster in Azure Diagnostics and Operational Insights](/documentation/articles/service-fabric-diagnostics-how-to-setup-wad-operational-insights)
* [Using ElasticSearch as a Service Fabric application trace store](/documentation/articles/service-fabric-diagnostic-how-to-use-elasticsearch)
