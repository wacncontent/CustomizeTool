<properties
   pageTitle="Service Fabric App upgrade using PowerShell| Windows Azure"
...
You can use the Visual Studio *Edit Manifest Files* option after you right-click on the solution to make the manifest file changes - see [Service Fabric Application Upgrade Tutorial](/documentation/articles/service-fabric-application-tutorial).
...
[Uprading your Application Using Visual Studio](/documentation/articles/service-fabric-application-upgrade-tutorial) walks you through an application upgrade using Visual Studio.
