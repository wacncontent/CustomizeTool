<properties
   pageTitle="Deploy a Node.js application using MongoDB | Windows Azure"
...
For building a Service Fabric package manually, review how to [deploy an existing application in Service Fabric](/documentation/articles/service-fabric-deploy-existing-app).
...
- Learn how to [package a single application manually](/documentation/articles/service-fabric-deploy-existing-app).
