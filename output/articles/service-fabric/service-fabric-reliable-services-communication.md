...
Finally, describe the endpoints that are required for the service in the [Service manifest](/documentation/articles/service-fabric-application-model) under the Endpoints section.
...
For a complete walkthrough of writing an `ICommunicationListener`, see [Getting Started with Windows Azure Service Fabric Web API services with OWIN self-host](/documentation/articles/service-fabric-reliable-services-communication-webapi)
