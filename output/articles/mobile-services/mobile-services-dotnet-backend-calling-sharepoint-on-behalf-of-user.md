...
4. Set SP_Authority to be the authority endpoint for your AAD tenant. This should be the same as the authority value used for your client app. It will be of the form https://login.chinacloudapi.cn/contoso.partner.onmschina.cn
