<properties 
	pageTitle="Send push notifications to authenticated Windows Phone Silverlight app users | Windows Azure" 
...
>[AZURE.NOTE]This tutorial supports Windows Phone 8.0 and Windows Phone 8.1 Silverlight apps. For Windows Phone 8.1 Store apps, see the [Windows Store version of this topic](/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users).
