<properties 
	pageTitle="Accessing Azure Active Directory Graph Information (Windows Store) | Windows Azure" 
...
3. In Visual Studio, right click the **Controllers** folder for the mobile service project and click **Add** to add a new **Windows Azure Mobile Services Custom Controller** named `GetUserInfoController`. The client will call this API to get user information from the Active Directory.
