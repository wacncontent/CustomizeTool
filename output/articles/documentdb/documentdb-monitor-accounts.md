...
You can monitor your DocumentDB accounts in the [Windows Azure Management Portal](https://manage.windowsazure.cn/). For each DocumentDB account, both performance metrics, such as requests and server errors, and usage metrics, such as storage consumption, are available.
