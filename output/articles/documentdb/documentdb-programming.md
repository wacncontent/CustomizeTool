...
Once you have one or more stored procedures, triggers, and user-defined functions created, you can load them and view them in the Azure Management Portal using Script Explorer. For more information, see [View stored procedures, triggers, and user-defined functions using the DocumentDB Script Explorer](/documentation/articles/documentdb-view-scripts).
