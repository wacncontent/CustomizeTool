<properties
	pageTitle="NoSQL tutorial: DocumentDB .NET SDK | Windows Azure"
...
Next, save the DocumentDB account endpoint and either the primary or secondary access key, which can be found in the [Azure Management Portal](https://manage.windowsazure.cn).
...
-   Want a more complex ASP.NET MVC NoSQL tutorial? See [Build a web site with ASP.NET MVC using DocumentDB](/documentation/articles/documentdb-dotnet-application).
