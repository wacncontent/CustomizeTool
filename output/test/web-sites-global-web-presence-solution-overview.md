...
<object type="image/svg+xml" data="https://sidneyhcontent.blob.core.chinacloudapi.cn/documentation/corp-website-visio.svg" width="100%" height="100%"></object>
...
The Azure Marketplace provides templates from the popular website content management systems (CMS), such as [Orchard], [Umbraco], Drupal, and [WordPress]. You can create a web app using your favorite CMS flavor. You can choose from various database backends to meet your needs, including [Azure SQL 数据库] and [MySQL].
...
[Azure Websites]: /home/features/app-service/web/
...
[Azure Websites Pricing Details]: /pricing/details/app-service/#ssl-connections

[Azure Traffic Manager]:http://www.hanselman.com/blog/CloudPowerHowToScaleAzureWebsitesGloballyWithTrafficManager.aspx
[integrating your web app with Azure CDN]:cdn-websites-with-cdn 
[CDN node]:http://msdn.microsoft.com/zh-cn/library/azure/gg680302.aspx
...
[ASP.NET session state]:http://msdn.microsoft.com/zh-cn/library/azure/dn690522.aspx
[output cache]:http://msdn.microsoft.com/zh-cn/library/azure/dn798898.aspx
