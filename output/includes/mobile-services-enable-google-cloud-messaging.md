...
1. Navigate to the [Google Cloud Console](https://console.developers.google.com/project) and sign-in with your Google account credentials, and then click <!-- deleted by customization **Create Project** --><!-- keep by customization: begin --> **CREATE PROJECT** <!-- keep by customization: end -->.
