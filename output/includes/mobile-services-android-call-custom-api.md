...
<!-- deleted by customization ###<a --><!-- keep by customization: begin --> ##<a <!-- keep by customization: end --> name="update-app"></a>Update the app to call the custom API
...
<!-- deleted by customization ### --><!-- keep by customization: begin --> ## <!-- keep by customization: end --> Test the app
