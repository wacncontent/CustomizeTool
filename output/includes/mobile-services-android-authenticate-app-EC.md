...
2. Add the following method to the **ToDoActivity** class: 
    ...
    > [AZURE.NOTE] If you are using an identity provider other than Google, change the value passed to the **login** method above to one of the following: _MicrosoftAccount_, or _windowsazureactivedirectory_.
