...
Visit the [Virtual Network Overview](virtual-networks-overview) to see a decision table that will help you decide the best network design option for you.
...
Use the decision table on the [Name Resolution for VMs and Role Instances](virtual-networks-name-resolution-for-vms-and-role-instances) page to guide you through all the DNS options available.
