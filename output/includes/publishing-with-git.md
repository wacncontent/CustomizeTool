[Azure Web App](/documentation/services/web-sites/) supports continuous deployment to Web Apps from source code control and repository tools like BitBucket, CodePle BitBucket, CodePlex, Dropbox,  G  application  Dropbox, Git, GitHub, Mercurial, and TFS. You can use these tools to maintain the content and code for your application, and then quickly and easily push changes to your Azure web app when you want.

In this article, you will learn how to use Git to publish directly from your local computer to Web Apps (in Azure, this method of publishing is called **Local Git**). You will also learn how to enable continuous deployment from repository sites like BitBucket, CodePle BitBucket, CodePlex, Dropbox,  G Dropbox, GitHub, or Mercurial. For information about using  For information about using TFS for continuous deployment, see [Continuous delivery to Azure using Visual Studio Team Services]. 

> [AZURE.NOTE] Many of the Git commands described in this article are performed automatically when creating a web app using the [Azure Command-Line Tools for Mac and Linux](/develop/nodejs/how- Linux](/develop/nodejs/how-to-guides/command-line-tools/)  .

...
* [Deploy your project](#Step5)
	...
	* [Deploy files from a repository web site like GitHub, or  Mercurial](#Step7)
...
* [Pushing local files to Azure (Local Git)](#Step6)
* [Deploy files from a repository web site like BitBucket, CodePle BitBucket, CodePlex, Dropbox,  G Dropbox, GitHub, or  Mercurial](#Step7)
* [Deploy a Visual Studio solution from BitBucket, CodePle BitBucket, CodePlex, Dropbox,  G Dropbox, GitHub, or  Mercurial](#Step75)
...


<a id="Step6"></a>Use the following steps to publish your web app to Azure using Local Git.
...
 either  G, CodePlex, or BitBucket  rDeploying files from either GitHub, CodePlex, or BitBucket requires that you have published your local project to one of these services. For more information on publishing your project to these services, see [Create a Repo (GitHub)], [Using Git with CodePlex], , [Using Git with CodePlex], [Create a Repo (BitBucket)], [Using Dropbox to Share Git Repositories],  o or [Quick Start - Mercurial].
...
### Deploy a Visual Studio solution from GitHub, or Mercurial


Pushing a Visual Studio solution to Web Apps in Azure is just as easy as pushing a simple index.html file. The Web Apps deployment process streamlines all the details, including restore NuGet dependencies and building the application binaries. You can follow the source control best practices of maintaining code only in your Git repository, and let Web Apps deployment take care of the rest.
...
After answering **Yes** to the confirmation message, you can return to **Set up deployment from source control** if you would like to set up publishing from another source.

...
[Continuous delivery to Azure using Visual Studio Team Services]: /documentation/articles/clo /documentation/articles/cloud-services-continuous-delivery-use-vso  
