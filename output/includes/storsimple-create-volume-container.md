...
2. In the **Create Volume container** dialog box:
  ...
  If you have your bandwidth usage information available, you may be able to allocate bandwidth based on a schedule by specifying **Select a bandwidth template**. For a step-by-step procedure, go to [Add a bandwidth template](/documentation/articles/storsimple-manage-bandwidth-templates#add-a-bandwidth-template).
