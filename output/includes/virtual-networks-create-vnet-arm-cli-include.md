...
1. If you have never used the Azure CLI, see [Install and Configure the Azure CLI](xplat-cli-install) and follow the instructions up to the point where you select your Azure account and subscription.
