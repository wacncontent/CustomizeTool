...
For more information, see [About Traffic Manager Load Balancing Methods](traffic-manager-load-balancing-methods).
...
For more information, see [Azure Load Balancer](load-balancer-overview). For the steps to create a load-balanced set, see [Configure a load-balanced set](load-balancer-overview).
...
For more information, see [Internal load balancing](load-balancer-internal-overview). For the steps to create a load-balanced set, see [Configure an internal load-balanced set](load-balancer-internal-getstarted).
