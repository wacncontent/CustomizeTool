...
- You can run Windows Server Active Directory (commonly called just AD) in the cloud using virtual <!-- deleted by customization machines --><!-- keep by customization: begin --> Machines <!-- keep by customization: end --> created with Azure Virtual machines. This approach makes sense when you're using Azure to extend your on-premises datacenter into the cloud.
