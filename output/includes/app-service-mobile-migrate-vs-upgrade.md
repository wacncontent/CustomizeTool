There are two options for moving from Mobile Services to Azure Web App: migration or upgrade. Either option will give you access to all of the hosting capabilities of Azure Web App:
