...
-->
- PowerShell Workflow runbooks <!-- deleted by customization and Graphical runbooks --> can only be included as child runbooks by using the Start-AzureAutomationRunbook cmdlet which creates a new job.
