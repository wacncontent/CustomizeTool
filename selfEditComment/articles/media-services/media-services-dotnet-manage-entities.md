...
See [Set up your environment](/documentation/articles/media-services-set-up-computer)
...
For more information on options for delivering assets, see [Deliver Assets with the Media Services SDK for .NET](/documentation/articles/media-services-deliver-streaming-content).
...
Note that a locator path to an asset is only a base URL to the asset. To create a direct path to individual files that a user or application could browse to, your code must add the specific file path to the locator path. For more information on how to do this, see the topic [Deliver Assets with the Media Services SDK for .NET](/documentation/articles/media-services-deliver-streaming-content).
