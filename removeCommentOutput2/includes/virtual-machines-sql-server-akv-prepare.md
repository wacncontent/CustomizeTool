...
First, you need to have an [Azure Active Directory](https://azure.mi(AAD) in your subscription. Among many benefits, this allows you to grant permission to your key vault for certain users and applications.
