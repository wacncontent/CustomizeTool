...
- You can use the Management Portal. See [How to manage Virtual Network (VNet) Properties](/documentation/articles/virtual-networks-settings).

- You can use a network configuration file (netcfg). See [Configure a virtual network using a network configuration file](/documentation/articles/virtual-networks-using-network-configuration-file).
...
Yes. You can create VNet to VNet communication by using REST APIs or Windows PowerShell. See [Configure a VNet to VNet Connection](/documentation/articles/virtual-networks-configure-vnet-to-vnet-connection).
