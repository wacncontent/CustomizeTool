...
5. In the **Policy: RootManageSharedAccessKey** blade, click the copy button next to **Connection string¨Cprimary key**, to copy the connection string to your clipboard for later use.
