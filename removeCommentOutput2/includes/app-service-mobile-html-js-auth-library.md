...
example, to login with Microsoft Account use the following code.
...
If you are using an identity provider other than Microsoft Account, change the value passed to the login method above to `aad`.
