...
1. Follow the [HDInsight Storm - Get Started](/documentation/articles/hdinsight-storm-overview) procedure to create a new HDInsight cluster, and connect to it via Remote Desktop.
