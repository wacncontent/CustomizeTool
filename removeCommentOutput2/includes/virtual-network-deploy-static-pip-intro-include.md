...
Before you can implement static Public IPs in VMs, it is necessary to understand when you can use static Public IPs, and how they are used. Read the [IP addressing overview](/documentation/articles/virtual-network-ip-addresses-overview-arm) to learn more about IP addressing in Azure.
