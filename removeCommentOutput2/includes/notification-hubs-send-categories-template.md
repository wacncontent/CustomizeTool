...
If you are using Mobile Apps please refer to the [Add push notifications for Mobile Apps](/documentation/articles/app-service-mobile-windows-store-dotnet-get-started-push/) tutorial and select your platform at the top. 

If you want to use Java or PHP refer to [How to use Notification Hubs from Java/PHP](/documentation/articles/notification-hubs-java-push-notification-tutorial/). You can send notifications from any backend using the [Notification Hub REST interface](http://msdn.microsoft.com/zh-cn/library/windowsazure/dn223264.aspx).
