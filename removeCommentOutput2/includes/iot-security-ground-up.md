...
The [Azure IoT Hub](/documentation/articles/iot-hub-what-is-iot-hub/) within the [IoT Suite](/documentation/articles/iot-suite-what-is-azure-iot/) offers a fully-managed service that enables reliable and secure bi-directional communication between IoT devices and Azure services such as [Azure Machine Learning](/documentation/articles/machine-learning-what-is-machine-learning/) and [Azure Stream Analytics](/documentation/articles/stream-analytics-introduction/) by using per-device security credentials and access control.  
...
All keys used by the IoT infrastructure are stored in the cloud in secure storage, with the ability to roll over in case keys need to be re-provisioned. Data can be stored in [DocumentDB](/documentation/articles/documentdb-introduction/) or in [SQL databases](/documentation/articles/sql-database-faq/), enabling definition of the level of security desired. Additionally, Azure provides a way to monitor and audit all access to your data to alert you of any intrusion or unauthorized access.
...
- [**Azure IoT Hub**](/home/features/iot-hub): Your gateway that connects the cloud to “things”. You can scale to millions of connections per hub and process massive volumes of data with per-device authentication support helping you secure your solution.
- [**Azure DocumentDB**](/home/features/documentdb): A scalable, fully-indexed database service for semi-structured data that manages metadata for the devices you provision, such as attributes, configuration, and security properties. DocumentDB offers high-performance and high-throughput processing, schema-agnostic indexing of data, and a rich SQL query interface.
- [**Azure Stream Analytics**](/home/features/stream-analytics): Real-time stream processing in the cloud that enables you to rapidly develop and deploy a low-cost analytics solution to uncover real-time insights from devices, sensors, infrastructure, and applications. The data from this fully-managed service can scale to any volume while still achieving high throughput, low latency, and resiliency.
- [**Azure App Services**](/home/features/app-service): A cloud platform to build powerful web and mobile apps that connect to data anywhere; in the cloud or on-premises. Build engaging mobile apps for iOS, Android, and Windows. Integrate with your Software as 
