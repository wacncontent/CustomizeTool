<properties
  pageTitle="Store and View Diagnostic Data in Azure Storage | Windows Azure"
...
Diagnostic data is not permanently stored unless you transfer it to the Windows Azure storage emulator or to Azure storage. Once in storage, it can be viewed with one of several available tools.
