...
><p>Any values that are configurable, such as **max-memory-policy**, are configurable through the Azure Portal Preview or command line management tools such as Azure CLI or PowerShell.
