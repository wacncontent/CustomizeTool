<properties
   pageTitle="Prepare to publish or deploy an Azure application from Visual Studio | Windows Azure"
...
A storage account provides access to the Blob, Queue, and Table services. You can create a storage account by using Visual Studio or the [Azure Platform Management Portal](https://manage.windowsazure.cn/).
...
1. Sign in to the [Azure Platform Management Portal](https://manage.windowsazure.cn/) on the Microsoft website.
