...
-   API reference for [SqlFilter](http://msdnmicrosoft.com/zh-cn/library/azure/microsoft.servicebus.messaging.sqlfilter.aspx).
-	Visit the [Azure SDK for Ruby](https://githubcom/WindowsAzure/azure-sdk-for-ruby) repository on GitHub.
