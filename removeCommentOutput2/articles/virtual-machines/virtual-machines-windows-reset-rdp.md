...
Make sure you have Azure PowerShell 1.0 or later installed, and you have signed in to your account using the `Login-AzureRmAccount -EnvironmentName AzureChinaCloud` cmdlet.
...
[Connect to an Azure virtual machine with RDP or SSH](/documentation/articles/virtual-machines-linux-about/)
