<properties
   pageTitle="Encrypt disks on a Linux VM | Azure"
...
To complete the remainder of this guide, you need the [latest Azure CLI](/documentation/articles/xplat-cli-install/) installed and logged in using the Resource Manager mode as follows:
...
- For more information about managing Azure Key Vault, including deleting cryptographic keys and vaults, see [Manage Key Vault using CLI](/documentation/articles/key-vault-manage-with-cli/).
- For more information about disk encryption, such as preparing an encrypted custom VM to upload to Azure, see [Azure Disk Encryption](/documentation/articles/azure-security-disk-encryption/).