...
Review the Azure PowerShell command set you built in your text editor or the PowerShell ISE. Make sureconsisting of multiple blocks of commands from Step 4 you have specified all the variables and that they have the correct values. Also make sure that you have removed all the < and > characters.

If you have your commands in a text editor, copy the setcommand to the clipboard and then right-click your Azureopen PowerShell prompt. This will issue the command set as a series of PowerShell commands and create your Azure virtual machine. Alternately, run the command set from the Azure PowerShell ISE.
