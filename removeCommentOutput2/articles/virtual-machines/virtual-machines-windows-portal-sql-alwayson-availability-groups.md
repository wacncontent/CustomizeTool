...
In this tutorial you will use the Azure portal preview to:
...
1. Log in to the Azure portal preview using your account.
2. On the Azure portal preview click **+New.** The portal will open the New blade.
...
> [AZURE.NOTE]
> Azure will install Enterprise Edition of SQL Server. The cost depends on the edition and the virtual machine size. For detailed information about current costs, see [virtual machines Pricing](/pricing/details/virtual-machines/#Sql).
> 
> 
...
The Azure portal preview will create the resource group and all of the resources.
