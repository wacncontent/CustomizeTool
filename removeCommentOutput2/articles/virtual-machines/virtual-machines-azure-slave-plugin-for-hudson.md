...
4. Click **Add new cloud > Azure**.
    ...
    >[AZURE.NOTE] In order to use Azure China, you need to click **Advanced...**, and replace "https://management.core.windows.net" by "https://management.core.chinacloudapi.cn".
