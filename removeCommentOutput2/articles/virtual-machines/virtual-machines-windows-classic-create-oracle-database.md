<properties
	pageTitle="Create an Oracle Database VM with the Azure classic portal | Azure"
...
> [AZURE.NOTE] You can determine the value for *\<\<unique\_domain\_name\>\>* within the [Azure classic portal](https://portal.azure.cn/) by clicking **Virtual Machines** and then selecting the virtual machine that you are using to run Oracle Database).
