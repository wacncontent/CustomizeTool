<properties
    pageTitle="Automated Backup for SQL Server Virtual Machines (Resource Manager) | Azure"
...
You can use the Azure Portal Preview to configure Automated Backup during provisioning or for existing VMs.
