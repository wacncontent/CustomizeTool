...
Generally, you can start, stop, or restart your VM whenever you need to. Azure. (For details, see [About starting, stopping, and restarting an Azure VM](https://msdn.microsoft.com/zh-cn/library/azure/dn763934.aspx)) sometimes restarts your VM as part of regular, planned maintenance updates in the Azure datacenters. Unplanned maintenance events can occur when Azure detects a serious hardware problem that affects your VM. For unplanned events, Azure automatically migrates the VM to a healthy host and restarts the VM.
