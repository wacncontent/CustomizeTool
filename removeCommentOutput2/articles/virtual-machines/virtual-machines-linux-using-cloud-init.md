...
Prerequisites are: [an Azure account](/pricing/1rmb-trial/), [SSH public and private keys](/documentation/articles/virtual-machines-linux-mac-create-ssh-keys/), and [the Azure CLI](/documentation/articles/xplat-cli-install/) switched to Azure Resource Manager mode using `azure config mode arm`.
