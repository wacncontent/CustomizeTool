...
* [Azure portal preview](#using-the-azure-portal) - great if you need to quickly reset the SSH configuration or SSH key and you don't have the Azure tools installed.
...
## <a name="using-the-azure-portal"></a> Using the Azure portal preview
