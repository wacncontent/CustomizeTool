...
To view the Resource Manager version of this article, see [Automated Backup for SQL Server in Azure Virtual Machines Resource Manager](/documentation/articles/virtual-machines-windows-sql-automated-backup/).
