...
If you'll r version is not 0.9.0 or later, you need to either [install the Azure CLI](/documentation/articles/xplat-cli-install) or update using oneeither of the native installers or through **npm** by typing `npm update -g azure-cli`.
