<properties
    pageTitle="Custom scripts on Linux VMs | Azure"
...
## Next Steps
For information on other VM Script Extensions, see [Azure Script Extension overview for Linux](/documentation/articles/virtual-machines-linux-extensions-features/).
