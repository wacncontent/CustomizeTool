<properties
	pageTitle="Troubleshoot connection to an Azure VM over SSH | Windows Azure"
...
This article only applies to Azure virtual machines running Linux. For troubleshooting connections to Azure virtual machines running Windows, see [this article](/documentation/articles/virtual-machines-troubleshoot-remote-desktop-connections).
