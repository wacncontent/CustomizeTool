...
- The Azure PowerShell module, version 0.8.2 or newer, Install ed on your local computer. You can check the version of Azure PowerShell that you have installed by using the **Get-Module azure | format-table version** command. For instructions and a link to the latest version, see [How to install and Configure Azure PowerShell](/documentation/articles/install-configure-powershell).
