<!-- rename to virtual-machines-linux-classic-cli-use-docker -->
...
and select one of the image names, such as `b549f4301d0b4295b8e76ceb65df47d4__Ubuntu-14_04-LTS-amd64-server-20140724-en-us-30GB`, and use the following command to create a new VM using that image.
