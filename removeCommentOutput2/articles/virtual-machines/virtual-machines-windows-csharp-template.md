...
- Create a resource group using [Azure PowerShell](/documentation/articles/resource-group-template-deploy/), [Azure CLI](/documentation/articles/resource-group-template-deploy-cli/), or [Azure portal](/documentation/articles/resource-group-template-deploy-portal/).
