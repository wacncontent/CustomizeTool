...
DS-series VMs support [Premium Storage](/documentation/articles/storage-premium-storage/). Premium Storage is recommended for all production workloads.
