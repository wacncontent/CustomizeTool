...
For instructions on publishing an ASP.NET Web application to Azure, see [How to: Migrate and Publis[ [Get started with Web Apps and ASP.NET](/documentation/articles/web-sites-dotnet-get-started).
