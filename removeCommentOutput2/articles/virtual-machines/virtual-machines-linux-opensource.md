...
1. Docker
	...
	- [Using the Docker VM Extension from the Azure Command-lineCross-Platform Interface (Azure CLI)](/documentation/articles/virtual-machines-docker-with-xplat-cli) 
