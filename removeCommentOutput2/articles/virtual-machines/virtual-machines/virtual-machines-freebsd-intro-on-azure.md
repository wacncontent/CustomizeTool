<properties
    pageTitle="Introduction to FreeBSD on Azure | Azure"
...
* If you want to bring your own FreeBSD to Azure, refer to [Create and upload a FreeBSD VHD to Azure](/documentation/articles/virtual-machines-linux-classic-freebsd-create-upload-vhd/).
