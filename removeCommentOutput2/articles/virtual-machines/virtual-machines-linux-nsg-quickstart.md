<properties
    pageTitle="Open ports and endpoints to a Linux VM | Azure"
...
## Quick commands
To create a Network Security Group and rules you need [the Azure CLI](/documentation/articles/xplat-cli-install/) installed and using Resource Manager mode:
