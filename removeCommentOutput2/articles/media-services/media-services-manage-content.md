<properties 
	pageTitle="How to manage media content with Azure Media Services using the Azure Management Portal" 
...
# Manage Content with Azure Media Services using the Azure Management Portal


This topic shows how to use the Azure Management Portal to manage media content in your Media Services account.
...
1. In the [Azreu Management Portal](http://manage.windowsazure.cn), click **Media Services** and then click on the Media Services account name.
...
<a href="/documentation/articles/media-services-manage-content#index">Portal</a>
</div>
Azure Media Indexer enables you to make content of your media files searchable and to generate a full-text transcript for closed captioning and keywords. You can index your content using the Azure Management Portal following the steps demonstrated below. However, if you would like more control over what files and how the indexing job is done, you can use the Media Services SDK for .NET or REST APIs. For more information, see [Indexing Media Files with Azure Media Indexer](/documentation/articles/media-services-index-content).

To following steps demonstrate how to use the Azure Management Portal to index your content.
...
This section describes the steps you can take to encode your content with Media Encoder Standard using the Azure Management Portal.
...
The [Task Preset Strings for Media Encoder Standard](https://msdn.microsoft.com/zh-cn/library/mt269960) topic explains what each preset means.
...
- Get at least one On-Demand streaming unit for the streaming endpoint from which you plan to delivery your content. For more information, see [How to Scale On-Demand Streaming Reserved Units](/documentation/articles/media-services-manage-origins#scale_streaming_endpoints).
- Configure "default aes clear key service policy" or "default playready license service policy". For more information, see [Configure Content Key Authorization Policy](/documentation/articles/media-services-portal-configure-content-key-auth-policy).  
...
- [Protect with PlayReady DRM](/documentation/articles/media-services-rest-deliver-streaming-content)
- [Protect with AES-128 key](/documentation/articles/media-services-protect-with-aes128)
