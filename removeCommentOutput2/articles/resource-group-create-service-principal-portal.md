...
1. Login to your Azure Account through the [Azure Management Portal](https://manage.windowsazure.cn/).
...
- To learn about specifying security policies, see [Azure Role-based Access Control](/documentation/articles/active-directory/role-based-access-control-configure).
