<properties 
	pageTitle="Search Traffic Analytics for Azure Search | Windows Azure" 
	description="Enable Search traffic analytics for Azure Search, a cloud hosted search service on Windows Azure, to unlock insights about your users and your data." 
	services="search" 
	documentationCenter="" 
	authors="bernitorres" 
	manager="pablocas" 
...
### 1. Using the portal
Open your Azure Search service in the [Azure Management Portal](http://manage.windowsazure.cn). Under Settings, you will find the Search traffic analytics option. 
...
As a starting point, we recommend using [Power BI Desktop](https://powerbi.microsoft.com/desktop) to explore and visualize your data. You can easily connect to your Azure Storage Account and quickly start analyzing your data.
...
3. Select Windows Azure Blob Storage and Connect
...
11. Your data for the last 30 days is now ready to be consumed. Go ahead and create some [visualizations](https://powerbi.microsoft.com/documentation/powerbi-desktop-report-view/).

## Next Steps

Learn more about search syntax and query parameters. See [Search Documents (Azure Search REST API)](https://msdn.microsoft.com/zh-cn/library/azure/dn798927.aspx) for details.
