...
|:---|:---|:---|:---|:---|
|**Free**|5 jobs per job collection|Once per hour. Cannot execute jobs more often than once an hour|A subscription is allowed up to 1 free job collection|Cannot use [HTTP outbound authorization object](https://msdn.microsoft.com/zh-CN/library/azure/dn864828.aspx)| 
...
- A job in the job collection has an HTTP or HTTPS action that uses an [HTTP outbound authorization object](https://msdn.microsoft.com/zh-CN/library/azure/dn864828.aspx) 
