...
> [AZURE.WARNING] It's not possible to restnor e a deleted storage account or retrieve any of the content that it contained before deletion. Be sure to back up anything you want to save before you delete the account. This also holds true for any resources in the account - once you delete a blob, table, queue, or file, it is permanently deleted.
>
