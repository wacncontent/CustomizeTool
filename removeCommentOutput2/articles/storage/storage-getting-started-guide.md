...
The [Azure Storage Emulator](/documentation/articles/storage-use-emulator) provides a local environment that emulates the Azure Blob, Queue, a Windows d Table services for development purposes. You can use the storage emulator to test your storage application locally, without creating an Azure subscription or storage account, and without incurring any cost.
