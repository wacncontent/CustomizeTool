...
## Types<a id="types"></a> that you can bind to blobs
...
## Getting<a id="string"></a> text blob content by binding to string
...
## Getting<a id="icbsb"></a> serialized blob content by using ICloudBlobStreamBinder
...
## How<a id="poison"></a> to handle poison blobs
