...
> [AZURE.NOTE]	The procedures in this task apply to Azure storage accounts. For cloud services, see <a href = "/documentation/articles/cloud-services-custom-domain-name">Configuring a Custom Domain Name for an Azure Cloud Service</a>; for Websites, see <a href="/documentation/articles/web-sites-custom-domain-name">Configuring a Custom Domain Name for an Azure Website</a>.
