...
1. Follow the tutorial [here](/documentation/articles/mysql-database-get-started/) to create a MySQL database in Azure.
...
from your terminal. All connection information you need is in the Azure Classic Management portal (see 
[Connect to your MySQL database](/documentation/articles/mysql-database-get-started/#step5)).
