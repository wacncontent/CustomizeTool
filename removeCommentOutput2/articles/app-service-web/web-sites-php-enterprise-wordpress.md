...
4. Create a web app in the Azure portal Preview and publish the WordPress backup.
   ...
   1. Create a web app in the [Azure portal Preview][mgmtportal] with a database using **New** -> **Web + Mobile** -> **Web Apps** -> **Create**. Configure all the required settings to create an empty web app.
