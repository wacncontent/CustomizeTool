...
- Select the base interpreter. Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the **Application Settings** bla app in the Azure Management Portal).
...
Visual Studio doesn't show the progress of the deployment. If you'd like to review the
...
Make sure to use the same version of Python that is selected a app (in runtime.txt or the Application Settings blade for your web app in the Azure Management Portal)
...
Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the Application Settings blade a app in the Azure Management Portal).
