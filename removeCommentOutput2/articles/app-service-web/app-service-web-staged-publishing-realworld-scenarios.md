...
Assuming you already have a WordPress web app running on Azure Web, login to [Azure Portal Preview](https://portal.azure.cn/) and go to your WordPress web app.
