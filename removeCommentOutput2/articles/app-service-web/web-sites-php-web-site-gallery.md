...
This tutorial shows how to find an application in the Azure Marketplace and install it in an Azure web app. The tutorial uses a WordPress blog site as an example, but the process is similar for many other Marketplace applications.
