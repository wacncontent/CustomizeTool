...
1. Back to [Azure portal Preview](https://portal.azure.cn). Click **Settings > Properties**. The URL of the remote Git repository that you'll deploy to is shown under **GIT URL**.
