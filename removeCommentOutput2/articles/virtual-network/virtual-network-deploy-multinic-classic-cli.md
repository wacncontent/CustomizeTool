...
[AZURE.INCLUDE [azure-arm-classic-important-include](../includes/learn-about-deployment-models-classic-include.md)] [Resource Manager model](/d
...
1. Change the values of the variables below based on your existing resource groudeployed above in [Prerequisites](#Prerequisites).
