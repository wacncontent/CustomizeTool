...
domainName	| String	| Domain name of the publicly accessible jumpbox VM in the format: **{domainName}.{location}.chinacloudapp.cn** For example: **mydomainname.westus.chinacloudapp.azure.cn**
