...
Now that we've set up all the pieces, we can start to set-up the pipeline by navigating to your Azure Data Factory instance in the Azure Management Portal.  This can be done by going to the [Azure Management Portal](https://manage.windowsazure.cn) and selecting your data factory from the left-hand menu.
