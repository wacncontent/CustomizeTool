<properties 
	pageTitle="Get started with Transparent Data Encryption (TDE) in SQL Data Warehouse| Windows Azure" 
...
# Get started with Transparent Data Encryption (TDE) in SQL Data Warehouse in SQL Data Warehouse
> [AZURE.SELECTOR]
...
1. Open the database in the [Azure Management Portal](https://manage.windowsazure.cn/) 
