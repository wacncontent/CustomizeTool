...
The [Register-AzureRmAutomationDscNode](https://msdn.microsoft.com/zh-cn/library/mt244097.aspx?f=255&MSPPError=-2147217396) cmdlet can be used to onboard virtual machines in the Azure preview portal via PowerShell.
