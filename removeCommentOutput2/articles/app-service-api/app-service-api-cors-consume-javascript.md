...
You can configure CORS in the Azure Portal Preview or by using [Azure Resource Manager](../azure-resource-manager/documentation/articles/resource-group-overview) tools.
