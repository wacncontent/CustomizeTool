...
You can also configure the API definition URL for an API app by using [Azure Resource Manager templates](/documentation/articles/resource-group-authoring-templates/) in command line tools such as [Azure PowerShell](/documentation/articles/powershell-install-configure/) and the [Azure CLI](/documentation/articles/xplat-cli-install/). 
