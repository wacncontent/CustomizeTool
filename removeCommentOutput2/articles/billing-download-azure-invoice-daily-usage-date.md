<properties
	pageTitle="How to download your Azure billing invoice and daily usage data | Windows Azure"
...
1. Sign into the [Usage and Billing Portal](https://account.windowsazure.cn/subscriptions) using your Microsoft Account ID, Work Account ID or School Account ID.
