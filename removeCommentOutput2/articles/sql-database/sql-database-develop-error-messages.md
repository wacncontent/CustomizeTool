...
- [Actions to fix connection errors and transient faults in SQL Database](/documentation/articles/sql-database-connectivity-issues)
...
|40501|20|The service is currently busy. Retry the request after 10 seconds. Incident ID: %ls. Code: %d.<br/><br/>*Note:* For more information, see:<br/>• [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits).
...
The following table covers the various errors you can encounter while copying a database in Azure SQL Database. For more information, see [Copy an Azure SQL Database](/documentation/articles/sql-database-copy).
...
- [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits)


|Error number|Severity|Description|
|---:|---:|:---|
|10928|20|Resource ID: %d. The %s limit for the database is %d and has been reached. For more information, see [https://msdn.microsoft.com/zh-cn/library/dn338081.aspx](https://msdn.microsoft.com/zh-cn/library/dn338081.aspx).<br/><br/>The Resource ID indicates the resource that has reached the limit. For worker threads, the Resource ID = 1. For sessions, the Resource ID = 2.<br/><br/>*Note:* For more information about this error and how to resolve it, see:<br/>• [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits). |
|10929|20|Resource ID: %d. The %s minimum guarantee is %d, maximum limit is %d and the current usage for the database is %d. However, the server is currently too busy to support requests greater than %d for this database. For more information, see [https://msdn.microsoft.com/zh-cn/library/dn338081.aspx](https://msdn.microsoft.com/zh-cn/library/dn338081.aspx). Otherwise, please try again later.<br/><br/>The Resource ID indicates the resource that has reached the limit. For worker threads, the Resource ID = 1. For sessions, the Resource ID = 2.<br/><br/>*Note:* For more information about this error and how to resolve it, see:<br/>• [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits).|
...
> 
> For more information about Elastic Scale, see [Azure SQL Database Elastic Scale Topics](/documentation/articles/sql-database-elastic-scale-documentation-map). Consider deploying custom sharding solutions to maximize scalability, flexibility, and performance. For more information about custom sharding, see [Elastic Database features overview](/documentation/articles/sql-database-elastic-scale-introduction).
...
- [Azure SQL Database General Limitations and Guidelines](/documentation/articles/sql-database-general-limitations)
- [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits)
