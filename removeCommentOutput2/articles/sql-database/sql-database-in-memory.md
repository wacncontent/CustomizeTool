...
You can create the AdventureWorksLT [V12] sample database by a few clicks in the [Azure Management Portal](http://manage.windowsazure.cn). Then the steps in this section explain how you can enrich your AdventureWorksLT database with:
...
1. In the [Azure Management Portal](http://manage.windowsazure.cn), create a Premium database on a V12 server. Set the **Source** to the AdventureWorksLT [V12] sample database.
...
- [Description of the Replay Markup Language (RML) Utilities for SQL Server](http://support.microsoft.com/zh-cn/kb/944837) 
