<properties
	pageTitle="Create an Azure SQL Database elastic database pool with the Azure preview portal | Windows Azure"
...
# Create an elastic database pool with the Azure preview portal
...
This article shows you how to create an [elastic database pool](/documentation/articles/sql-database-elastic-pool) using the Azure preview portal.
