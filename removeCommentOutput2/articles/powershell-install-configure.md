...
Use of Azure requires a subscription. If you don't have a subscription, see [Get Started with Azure](/pricing/overview).
...
about your subscriptions, you can get it from the [Azure Management Portal](http://manage.windowsazure.cn/).
...
services for a subscription, see [Add and Remove Co-Administrators for Your Azure Subscriptions](http://msdn.microsoft.com/zh-cn/library/azure/gg456328.aspx).
...
- Reference information about the cmdlets in the Azure PowerShell modules is also available in the Azure library. For information, see [Azure Cmdlet Reference](http://msdn.microsoft.com/zh-cn/library/azure/jj554330.aspx).
...
- To learn about how to access Azure Storage components, see [Using Azure PowerShell with Azure Storage](/documentation/articles/storage-powershell-guide-full).
...
- To learn about the Windows PowerShell command line and scripting environment, see the [TechNet Script Center](https://technet.microsoft.com/zh-cn/scriptcenter/powershell.aspx).
