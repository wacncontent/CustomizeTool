...
To list an application that supports single sign-on with Azure Active Directory in the [Azure AD gallery](/home/features/identity/all/), the application first needs to implement one of the following integration modes:
