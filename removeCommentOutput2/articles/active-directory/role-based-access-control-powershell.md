...
- [Azure Resource Manager Cmdlets](https://msdn.microsoft.com/zh-cn/library/azure/mt125356.aspx&clcid=0x409): Learn to use the cmdlets in the AzureResourceManager module.
...
- [Configure role based access control using Azure CLI](/documentation/articles/role-based-access-control-xplat-cli-install)
