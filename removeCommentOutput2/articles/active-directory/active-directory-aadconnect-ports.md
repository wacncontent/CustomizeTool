...
This table describes the ports and protocols that are required for communication between the Azure AD Connect Health agents and Azure AD.
...
For a list of endpoints see [the Requirements section for the Azure AD Connect Health agent](/documentation/articles/active-directory-aadconnect-health#requirements)
