...
>[AZURE.NOTE]
If you are not familiar with MFA and what it does, it is strongly recommended that you read the article [What is Azure Multi-Factor Authentication?](/documentation/articles/multi-factor-authentication) prior to continue reading this section.
...
## Next steps
[Define a hybrid identity adoption strategy](/documentation/articles/active-directory-hybrid-identity-design-considerations-identity-adoption-strategy)
