<properties
	pageTitle="Tutorial: Azure Active Directory integration with SilkRoad Life Suite | Windows Azure"
...
5. Sign-on to your SilkRoad company site as administrator. 
    ...
    > [AZURE.NOTE] To obtain access to the SilkRoad Life Suite Authentication application for configuring federation with Windows Azure AD, please contact SilkRoad Support or your SilkRoad Services representative.
