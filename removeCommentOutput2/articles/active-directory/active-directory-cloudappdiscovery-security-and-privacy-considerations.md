...
The information outlined in the list below is collected by the agent when connections are made to a Web application. The information is only collected for those applications that the administrator has configured for discovery. <br>
