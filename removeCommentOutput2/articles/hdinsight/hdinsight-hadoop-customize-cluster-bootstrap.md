...
A complete working PowerShell script can be found in [Appendix-A](#hdinsight-hadoop-customize-cluster-v1-bootstrap.md/appx-a:-powershell-sample).
...
![hdinsight hadoop customize cluster bootstrap arm template](./media/hdinsight-hadoop-customize-cluster-v1-bootstrap/hdinsight-customize-cluster-bootstrap-arm.png)
