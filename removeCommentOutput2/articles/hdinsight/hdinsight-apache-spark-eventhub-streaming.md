...
> [AZURE.NOTE]
> To follow the instructions in this article, you will have to use both versions of the Azure portal. To create an Event Hub you will use the [Azure Classic Management Portal](https://manage.windowsazure.cn). To work with the HDInsight Spark cluster, you will use the [Azure Portal](https://portal.azure.cn/).  
> 
> 
...
><p> 
><p> * You will not have to update the POM to include the Spark version. That's because there is no dependency on Spark for creating this application
><p> * You will not have to add some dependency jars to the project library. That's because those jars are not required for this project.
> 
> 
