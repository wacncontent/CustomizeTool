...
For more information on using these methods to apply script actions, see [Customize HDInsight clusters using script actions](/documentation/articles/hdinsight-hadoop-customize-cluster-v1/).
...
You can use script actions to customize HDInsight clusters by using the Azure portal, Azure PowerShell, Azure Resource Manager (ARM) templates or the HDInsight .NET SDK. For instructions, see [How to use script action](/documentation/articles/hdinsight-hadoop-customize-cluster-v1/).
