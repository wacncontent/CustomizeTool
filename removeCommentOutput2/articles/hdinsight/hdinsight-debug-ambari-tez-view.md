...
> [AZURE.NOTE]
> The information in this document is specific to Linux-based HDInsight clusters. For information on debugging Tez jobs using Windows-based HDInsight, see [Use the Tez UI to debug Tez jobs on Windows-based HDInsight](/documentation/articles/hdinsight-debug-tez-ui/).
> 
> 
