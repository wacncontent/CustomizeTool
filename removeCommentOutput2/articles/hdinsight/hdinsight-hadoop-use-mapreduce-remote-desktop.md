...
2. To use the **Hadoop** command to run an example MapReduce job, use the following command:
   ...
   > [AZURE.NOTE]
   > for more information about this MapReduce job and the example data, see <a href="/documentation/articles/hdinsight-use-mapreduce">Use MapReduce in HDInsight Hadoop</a>.
   >
   >
