...
The following release notes identify the critical open issues for the October 2014 release of Windows Azure StorSimple. They also contain a list of the StorSimple software and firmware updates included in this release. This is the first release after the General Availability (GA) release of Windows Azure StorSimple and corresponds to software version 6.3.9600.17312.

We recommend that you scan for and apply any available updates immediately after you install the device. You can also turn on automatic updates to download and install high-priority updates from Microsoft as soon as they are released. For more information, see how to install [Updates](https://msdn.microsoft.com/zh-cn/library/azure/1a2cd7de-706b-4d3c-8efb-02e322d3ae73#BKMK_Updates).
...
- Ensure that ports 80 and 443 are available on StorSimple device for outbound communication. For more information, see the [Networking requirements for your StorSimple device](https://msdn.microsoft.com/zh-cn/library/azure/dn772371.aspx).
...
- You can now use the Manager service UI to manage your device controllers. The management actions include restart, shutdown, or turn on a controller. For more information, go to [Manage StorSimple device controllers](https://msdn.microsoft.com/zh-cn/library/azure/3216e992-f6ae-41c9-9ca4-f671342e1ab3#ManageControllers).
- You can schedule WAN bandwidth allocation according to day-of-the-week and time-of-day combinations. This allows you to make better use of WAN bandwidth during off-peak hours. Different bandwidth templates are permitted for different volume containers. For more information, go to [Bandwidth templates](https://msdn.microsoft.com/zh-cn/library/azure/1747f56e-858a-4cfe-a020-949d7db23b8b#bt).
- You can configure email notifications to proactively notify the administrator(s) and others of existing or possibly upcoming issues. For more information, go to [Configure alert settings](https://msdn.microsoft.com/zh-cn/library/azure/02f1412f-e196-4a88-8eda-2113247ea47c#sec_11).
