...
1. A support request can be created through the [Azure Management Portal](http://manage.windowsazure.com/). In the [portal](http://manage.windowsazure.cn/), click your **Account Name** and then click **Contact Microsoft Support**.
