<properties 
   pageTitle="Deploy your StorSimple device (Update 2) | Windows Azure"
...
> [AZURE.SELECTOR]
- [Update 2](/documentation/articles/storsimple-deployment-walkthrough-u2)
...
Welcome to Windows Azure StorSimple device deployment. These deployment tutorials apply to StorSimple 8000 Series Update 2. This series of tutorials includes a configuration checklist, configuration prerequisites, and detailed configuration steps for your StorSimple device.
