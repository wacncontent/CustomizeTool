...
Welcome to Windows Azure StorSimple device deployment. 
...
The following sections explain the configuration prerequisites for your StorSimple Manager serviceand your StorSimple device.
