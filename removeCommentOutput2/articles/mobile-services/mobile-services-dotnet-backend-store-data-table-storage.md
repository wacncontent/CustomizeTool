...
The tutorial requires completion of the [Get started with Mobile Services] tutorial.or [Add Mobile Services to an existing app] You will also need an Azure storage account.
