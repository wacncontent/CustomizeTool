<properties 
   pageTitle="Create an internal load balancer for cloud services in the classic deployment model | Windows Azure"
...
[AZURE.INCLUDE [azure-arm-classic-important-include](../includes/learn-about-deployment-models-classic-include.md)] [Resource Manager model](/documentation/articles/load-balancer-get-started-ilb-arm-ps).
