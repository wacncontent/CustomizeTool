...
This tutorial is based on the Mobile Apps quickstart. You must first complete the tutorial [Get started with Mobile Apps](/documentation/articles/app-service-mobile-windows-store-dotnet-get-started/).
