<properties
	pageTitle="Get started with Azure App Service Mobile Apps for Xamarin.iOS apps | Azure"
...
* [Add authentication to your app ](/documentation/articles/app-service-mobile-xamarin-ios-get-started-users/)
  <br/>Learn how to authenticate users of your app by using an identity provider.

* [Add push notifications to your app](/documentation/articles/app-service-mobile-xamarin-ios-get-started-push/)
