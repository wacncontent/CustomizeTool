...
To migrate your site:
  ...
  1.  Log onto the [Azure Classic Management Portal].
...
You can monitor the status of the migration in the activity monitor and your site will be listed as *migrating* in the Azure Classic Management Portal.
...
you used to perform in the [Azure Classic Management Portal], together with their App Service equivalent.
...
> [AZURE.TIP] Notification Hubs management features in the [Azure Portal] is still in preview.  The [Azure Classic Management Portal] remains available for
...
### <a name="upgrading-your-site"></a>Upgrading your Mobile Services site to Azure Mobile Apps SDK
  ...
  * For .NET-based server projects, the new [Mobile Apps SDK NuGet packages](https://www.nuget.org/packages/Microsoft.Azure.Mobile.Server/) has more flexibility on NuGet dependencies, supports the new App Service authentication features, and composes with any ASP.NET project, including MVC. To learn more about upgrading, see [Upgrade your existing .NET Mobile Service to App Service](/documentation/articles/app-service-mobile-net-upgrading-from-mobile-services/).
