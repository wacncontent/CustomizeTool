...
1. Add the following code to the **TodoActivity** class:
    ...
    > [AZURE.NOTE] If you are using an identity provider other than Microsoft, change the value passed to **LoginAsync** above to one of the following: _MicrosoftAccount_ or _WindowsAzureActiveDirectory_.
