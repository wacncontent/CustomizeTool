...
2. Add new method named **Authenticate** to **QSTodoService** with the following definition:
	...
	>[AZURE.NOTE] If you are using an identity provider other than a Microsoft, change the value passed to **LoginAsync** above to one of the following: _MicrosoftAccount_ or _WindowsAzureActiveDirectory_.
