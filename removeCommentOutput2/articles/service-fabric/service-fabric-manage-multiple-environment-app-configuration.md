<properties
   pageTitle="Manage multiple environments in Service Fabric | Windows Azure"
...
To learn more about some of the core concepts discussed in this topic, see the [Service Fabric Technial Overview](/documentation/articles/service-fabric-technical-overview). For information about other app management capabilities available in Visual Studio, see [Managing your Service Fabric applications in Visual Studio](/documentation/articles/service-fabric-manage-application-in-visual-studio).
