...
2. Application design simplification, as stateful microservices remove the need for additional queues and caches. These have traditionally been required to address the availability and latency requirements of a purely stateless application. Since stateful services are naturally high-availability and low-latency, this means less moving parts to manage in your application as a whole.
...
- Scale up or scales down your Service Fabric cluster easily, knowing that the applications scale according to available resources.
