...
The page Azure Websites, Cloud Services and Virtual Machines comparison (/zh-cn/documentation/articles/choose-web-site-cloud-service-vm/ ) provides more detailed information on how to choose a Compute model.
