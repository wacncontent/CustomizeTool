...
Cloud Services is an example of Platform-as-a-Service (PaaS). Like [App Services](/documentation/articles/app-service-web-overview), this technology is designed to support applications that are scalable, reliable, and cheap to operate. Just like an [App Services](/documentation/articles/app-service-web-overview) are hosted on VMs, so too are Cloud Services, however, you have more control over the VMs. You can install your own software on Cloud Service VMs and you can remote into them.
