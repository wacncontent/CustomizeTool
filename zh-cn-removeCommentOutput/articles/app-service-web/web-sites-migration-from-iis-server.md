...
你可以轻松将运行于 Internet 信息服务 (IIS) 6 或更高版本的现有网站迁移至 [Azure 网站](/documentation/services/web-sites/)。[Web 应用迁移助手](https://www.movemetothecloud.net/)可以分析你的 IIS 服务器安装，确定哪些站点可以迁移至 Azure 网站、突出显示所有不能迁移或不受平台支持的元素，然后将你的网站迁移到与 Azure 相关联的数据库。
...
-	ISAPI 筛选器 – Web Apps 支持使用 ISAPI 筛选器。您需要执行以下操作：
	...
	-	将 applicationHost.xdt 文件放置在带有下列内容的站点根目录中：
		...
		有关如何使用 XML 文档转换网站的更多示例，请参阅[转换你的 Windows Azure 网站](http://blogs.msdn.com/b/waws/archive/2014/06/17/transform-your-microsoft-azure-web-site.aspx)。
...
21. 你现在可以管理 Azure 网站中已迁移的 Web 应用。为此，请登录到 [Azure 门户](https://manage.windowsazure.cn/)。
