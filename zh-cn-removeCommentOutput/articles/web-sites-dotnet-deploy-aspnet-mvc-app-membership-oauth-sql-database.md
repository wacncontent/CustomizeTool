...
3. 当“配置 Windows Azure Web 应用设置”对话框出现时，请确保已登录 Azure：如果还没有登录，现在请登录；如果登录已过期，请重新输入凭据。
...
5. 在“Azure Websites 计划”下拉列表中，选择“创建新的 Azure Websites 计划”并输入名称，如下图中所示的“StandardWeb”。

	如果需要，你也可以选择已有的 Azure Websites 计划。有关 Azure Websites 计划的信息，请参阅 [Azure Websites 计划深入概述](/documentation/articles/azure-web-sites-web-hosting-plans-in-depth-overview)。
...
4. 单击**“确定”**。
	...
	Visual Studio 将创建 ContactManager Web 项目、创建资源组和指定的 Azure Websites 计划，并在 Azure 网站中创建具有指定名称的 Web 应用。
