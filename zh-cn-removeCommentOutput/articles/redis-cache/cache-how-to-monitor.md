...
若要查看缓存度量值，请[浏览到](https://msdn.microsoft.com/zh-cn/library/azure/cbe6d113-7bdc-4664-a59d-ff0df6f4e214#CacheSettings) [Azure 门户](https://manage.windowsazure.cn/)中的缓存实例。Azure Redis 缓存实例的度量值可在“Redis 缓存”边栏选项卡上访问。
