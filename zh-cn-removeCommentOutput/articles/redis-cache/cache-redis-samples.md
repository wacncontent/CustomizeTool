...
[PHP 示例](https://msdn.microsoft.com/zh-cn/library/azure/dn690470.aspx#PHPExample)演示了将 Azure Redis 缓存与 PHP 和 [predis](https://github.com/nrk/predis) 客户端配合使用的入门知识。

[在缓存中处理 .NET 对象](https://msdn.microsoft.com/zh-cn/library/azure/dn690521.aspx#Objects)演示了如何对 .NET 对象进行序列化以便可以将其写入到 Azure Redis 缓存实例以及从中进行读取。
...
[访问 Redis 缓存监视数据](https://github.com/rustd/RedisSamples/tree/master/CustomMonitoring)示例演示了如何在 Azure 门户外访问你的 Azure Redis 缓存的监视数据。
