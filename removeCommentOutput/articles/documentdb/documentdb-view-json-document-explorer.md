...
This article provides an overview of the [Windows Azure DocumentDB](/home/features/documentdb/) Document Explorer, an Azure Preview portal tool that enables you to view, edit, create, and upload JSON documents with DocumentDB.
