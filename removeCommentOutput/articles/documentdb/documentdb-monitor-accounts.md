...
You can monitor your DocumentDB accounts in the [Windows Azure preview portal](https://manage.windowsazure.cn/). For each DocumentDB account, both performance metrics, such as requests and server errors, and usage metrics, such as storage consumption, are available.

## How to: View performance metrics for a DocumentDB account
1.	In the [Azure preview portal](https://manage.windowsazure.cn/), click **Browse**, **DocumentDB Accounts**, and then click the name of the DocumentDB account for which you would like to view performance metrics.
...
1.	In the [Azure preview portal](https://manage.windowsazure.cn/), click **Browse**, **DocumentDB Accounts**, and then click the name of the DocumentDB account for which you would like to see usage metrics.
...
1.	In the [Azure preview portal](https://manage.windowsazure.cn/), click **Browse All**, **DocumentDB Accounts**, and then click the name of the DocumentDB account for which you would like to setup performance metric alerts.
