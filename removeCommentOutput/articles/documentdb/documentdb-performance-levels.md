...
The Azure Preview portal is one option available to you when managing your collections' performance levels. Follow these steps to change a collection's performance level from the Azure Management Portal.

1. Navigate over to the [**Azure Preview portal**](https://manage.windowsazure.cn) from your browser.
