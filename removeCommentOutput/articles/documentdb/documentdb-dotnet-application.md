...
2. In the **Project types** pane, expand **Templates**, **Visual C#**, **Web**, and then select **ASP.NET web site**.
  	...
  	![Screen shot of the New Project dialog box with the ASP.NET web site project type highlighted](./media/documentdb-dotnet-application/image10.png)
...
## <a name="_Toc395637767"></a>Step 3: Add DocumentDB to your web site project

Now that we have most of the ASP.NET MVC plumbing that we need for
this solution, let's get to the real purpose of this tutorial, adding Azure DocumentDB to our web site.
...
### <a name="_Toc395637770"></a>Listing incomplete Items in your web site
...
To add additional functionality to your application, review the APIs available in the [Document DB .NET Library](http://msdn.microsoft.com/zh-cn/library/azure/dn783362.aspx) and feel free to contribute to the DocumentDB .NET Library on [GitHub][]. 
