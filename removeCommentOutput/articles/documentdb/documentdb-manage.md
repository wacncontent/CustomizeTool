...
You can create any number of collections to meet the storage and throughput scale requirements of your applications. Collections can be created through the [Azure Preview portal](https://manage.windowsazure.cn/) or through any one of the [DocumentDB SDKs](https://msdn.microsoft.com/zh-cn/library/azure/dn781482.aspx).   
...
For instructions on changing your consistency level on the Azure Preview portal, see [How to Manage a DocumentDB Account](/documentation/articles/documentdb-manage-account#consistency). Or, for more information on consistency levels, see [Using consistency levels](/documentation/articles/documentdb-consistency-levels).
...
## Next steps
For instructions on monitoring performance levels on the Azure Preview portal, see [Monitor a DocumentDB account](/documentation/articles/documentdb-monitor-accounts).
