...
The following diagram shows the lifecycle of a runbook job for  [PowerShell Workflow runbooks](/documentation/articles/automation-runbook-types#powershell-workflow-runbooks).
...
|Failed| For [ PowerShell Workflow runbooks](/documentation/articles/automation-runbook-types), the runbook failed to compile.  For [PowerShell Script runbooks](/documentation/articles/automation-runbook-types), the runbook failed to start or the job encountered an exception. |
