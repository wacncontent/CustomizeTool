<properties
    pageTitle="Configure geo-replication for Azure SQL Database with Transact-SQL | Windows Azure"
...
1. Using version 13.0.600.65 or later of SQL Server Management Studio.
 	 ...
 	 > [AZURE.IMPORTANT] Download the [latest](https://msdn.microsoft.com/zh-cn/library/mt238290.aspx) version of SQL Server Management Studio. It is recommended that you always use the latest version of Management Studio to remain in sync with updates to the Azure Management Portal.
