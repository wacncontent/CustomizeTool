<properties 
   pageTitle="Get started creating Internet facing load balancer in classic deployment model using the Azure Management Portal | Windows Azure"
...
# Get started creating Internet facing load balancer (classic) in the Azure Management Portal
