...
In the Azure Management Portal, under the group's **Configure** tab, select the **Advanced rule** option and then type in your advanced rule in the provided text box. You can create your advanced rule using the following information.
