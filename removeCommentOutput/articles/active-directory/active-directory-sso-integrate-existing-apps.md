<properties
   pageTitle="Integrating Azure Active Directory SSO with existing apps | Windows Azure"
...
See also *Suppressing user consent* in the [Guiding developers](/documentation/articles/active-directory-applications-guiding-developers-for-lob-applications) article.
