...
This article is one in a series introducing Azure Media Services programming. The previous topic was [How to: Check Job Progress](/documentation/articles/media-services-check-job-progress).
...
The following example shows how to create a simple job to provide PlayReady Protection.
   ...
   1. Retrieve configuration data. You can get an example configuration file from the [Task Preset for Azure Media Encryptor](http://msdn.microsoft.com/zh-cn/library/hh973610.aspx) topic.
...
<ul>
<li><a href="http://msdn.microsoft.com/zh-cn/library/dn189154.aspx">Protecting Assets with Microsoft PlayReady</a></li>
<li><a href="http://www.microsoft.com/PlayReady/">Microsoft PlayReady</a></li>
</ul>

<h2>Next Steps</h2>
Now that you know how to protect asssets with Media services, go to the [How To Manage Assets](/documentation/articles/media-services-manage-assets) topic.
