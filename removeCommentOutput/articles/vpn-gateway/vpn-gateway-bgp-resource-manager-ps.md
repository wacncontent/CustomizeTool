<properties
    pageTitle="How to configure BGP on Azure VPN Gateways using Azure Resource Manager and PowerShell | Azure"
...
Please see [Overview of BGP with Azure VPN Gateways](/documentation/articles/vpn-gateway-bgp-overview/) for more discussion on benefits of BGP and to understand the technical requirements and considerations of using BGP.
