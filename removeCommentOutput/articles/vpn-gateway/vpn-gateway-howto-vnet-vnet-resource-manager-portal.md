<properties
    pageTitle="Connect VNets using the Resource Manager deployment model and the Azure portal  | Azure"
...
When you use the Azure portal to connect virtual networks, the VNets must be in the same subscription. If your virtual networks are in different subscriptions, you can still connect them by using the [PowerShell](/documentation/articles/vpn-gateway-vnet-vnet-rm-ps/) steps.
