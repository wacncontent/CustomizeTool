...
1. In **Server Explorer**, expand **Azure**, expand **App Services**, expand the resource group that your web site is located in, and then expand the node for your web site.
