...
This option enables you to find out if your application is having any issues. In your web siteâs blade, click the **Requests and errors** tile. The **Metric** blade will show you all the metrics you can add.
...
This is often the simplest way to recover from one-time issues. On the [Azure Management Portal](https://manage.windowsazure.cn), on your web siteâs blade, you have the options to stop or restart your app.
