...
The Web Apps Restore feature, available on the **Backups** blade in the [Azure preview portal](http://manage.windowsazure.cn), is available only in Standard and Premium modes. For information about scaling your app using Standard or Premium mode, see [Scale a web app in Azure Websites](/documentation/articles/web-sites-scale). 
