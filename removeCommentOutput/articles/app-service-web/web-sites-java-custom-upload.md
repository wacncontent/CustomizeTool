...
Note that Azure provides a means for creating Java web sites using the Azure Management Portal's configuration UI, and the Azure Marketplace, as documented at [Create a Java web site in Azure Websites](/documentation/articles/web-sites-java-get-started). This tutorial is for scenarios in which you do not want to use the Azure Management Portal configuration UI or the Azure Marketplace.  
