...
Quickly create new web sites from a popular CMS in the gallery or bring your existing web assets to Azure Websites from a variety of languages and frameworks.
...
[Create an ASP.NET MVC app with auth and SQL DB and deploy to Azure Websites]:web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database.md
