...
There are many ways to set up a multiple environment for your project and the examples below are one just one such method the respective applications.
...
Assuming you already have a WordPress web app running on Azure Web, login to [Azure Management Portal Preview](http://portal.azure.cn) and go to your WordPress web app. Apps If not you can create one from the marketplace. To learn more, [click here](/documentation/articles/web-sites-php-web-site-gallery/).
...
For more details on how to upgrade your web app locally, follow the guidelines as mentioned [here](https://our.umbraco.org/documentation/getting-started/set up/upgrading/general).
