...
Once you have initialized your Java web app in [Azure App Service][] as documented at [Create a Java web app in Azure App Service](/documentation/articles/web-sites-java-get-started/), you can upload your application by placing your WAR in the **webapps** folder.
...
Note that you can use source control to upload your application or web pages, including [continuous integration scenarios](/documentation/articles/app-service-continuous-deployment/). FTP is also an option for uploading your application or web pages.
