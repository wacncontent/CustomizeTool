...
> [AZURE.NOTE] Alternatively, if a record is already in use and you need to preemptively bind your apps to it, map **awverify.contoso.com** to **contoso.trafficmanager.cn**.
