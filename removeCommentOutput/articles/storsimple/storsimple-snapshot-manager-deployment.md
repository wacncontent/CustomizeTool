...
3. In the **Device** list box, select the IP address of the Windows Azure StorSimple device or virtual device. In the **Password** text box, type the StorSimple Snapshot Manager password that you created for the device in the Windows Azure Management Portal. Click **OK**.
