...
This tutorial explains how to list, select, and delete a backup set. To learn how to restore your device from backup, go to [Restore your device from a backup set](/documentation/articles/storsimple-restore-from-backup-set). To learn how to clone a volume, go to [Clone a StorSimple volume](/documentation/articles/storsimple-clone-volume).
...
- Learn how to [use the backup catalog to restore your device from a backup set](/documentation/articles/storsimple-restore-from-backup-set).
