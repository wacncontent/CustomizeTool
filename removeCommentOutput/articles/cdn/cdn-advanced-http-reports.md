<properties 
	...
	description="Advanced HTTP reports in Windows Azure CDN. These reports provide detailed information on CDN activity." 
	services="cdn" 
...
# Advanced HTTP reports in Windows Azure CDN

## Overview

This document explains advanced HTTP reporting in Windows Azure CDN. These reports provide detailed information on CDN activity.

> [AZURE.NOTE] Advanced HTTP reports is a feature of the Premium CDN tier.  For a comparison of Standard and Premium CDN features, see [Azure CDN Overview](/documentation/articles/cdn-overview).
