...
You can either follow the steps below, or create a new client and server together by following the [Create a mobile app](/documentation/articles/app-service-mobile-ios-get-started/) tutorial. The tutorial contains a simplified version of these instructions and is best for proof of concept projects.
...
1. Install Git, if you haven't already done so. The steps required to install Git vary between operating systems. See [Installing Git](http://git-scm.com/book/zh/v2/%E8%B5%B7%E6%AD%A5-%E5%AE%89%E8%A3%85-Git) for operating system specific distributions and installation guidance.

2. Follow the steps in [Enable the App Service app repository](/documentation/articles/web-sites-deploy-local-git/#Step3) to enable the Git repository for your backend site, making a note of the deployment username and password.
...
Azure provides many mechanisms for publishing your Azure App Service Mobile Apps Node.js backend to the Azure service.  These include utilizing deployment tools integrated into Visual Studio, command-line tools and continuous deployment options based on source control.  For more information on this topic, refer to the [Azure App Service Deployment Guide].
...
The swagger endpoint will be located at http://_yoursite_.chinacloudsites.cn/swagger.  You can access the Swagger UI via the `/swagger/ui` endpoint.
...
Mobile Apps integrates with Azure Notification Hubs to enable you to send targeted push notifications to millions of devices across all major platforms. By using Notification Hubs, you can send push notifications to iOS, Android and Windows devices. To learn more about all that you can do with Notification Hubs, see [Notification Hubs Overview](/documentation/articles/notification-hubs-push-notification-overview/).
...
<!-- URLs -->
[Android Client QuickStart]: /documentation/articles/app-service-mobile-android-get-started/
[Apache Cordova Client QuickStart]: /documentation/articles/app-service-mobile-cordova-get-started/
[iOS Client QuickStart]: /documentation/articles/app-service-mobile-ios-get-started/
[Xamarin.iOS Client QuickStart]: /documentation/articles/app-service-mobile-xamarin-ios-get-started/
[Xamarin.Android Client QuickStart]: /documentation/articles/app-service-mobile-xamarin-android-get-started/
[Xamarin.Forms Client QuickStart]: /documentation/articles/app-service-mobile-xamarin-forms-get-started/
[Windows Store Client QuickStart]: /documentation/articles/app-service-mobile-windows-store-dotnet-get-started/
[HTML/Javascript Client QuickStart]: /documentation/articles/app-service-html-get-started/
[offline data sync]: /documentation/articles/app-service-mobile-offline-data-sync/
...
[How to configure Facebook Authentication]: /documentation/articles/app-service-mobile-how-to-configure-facebook-authentication/
[How to configure Google Authentication]: /documentation/articles/app-service-mobile-how-to-configure-google-authentication/
...
[How to configure Twitter Authentication]: /documentation/articles/app-service-mobile-how-to-configure-twitter-authentication/
...
[specify the Node Version]: /documentation/articles/nodejs-specify-node-version-azure-apps/
[use Node modules]: /documentation/articles/nodejs-use-node-modules-azure-apps/
