<properties
    pageTitle="Control routing and virtual appliances using the Azure CLI | Azure"
...
This article covers the Resource Manager deployment model. You can also create UDRs in the [classic deployment model](/documentation/articles/virtual-network-create-udr-classic-cli/).
