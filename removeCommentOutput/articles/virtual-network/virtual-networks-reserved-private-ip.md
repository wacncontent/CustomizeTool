...
> [AZURE.NOTE]
> If you want to test the command above in a safe environment follow the guidelines in [Create a Virtual Network](/documentation/articles/virtual-networks-create-vnet-classic-portal/) to create a vnet named *TestVnet* and ensure it uses the *10.0.0.0/8* address space.
> 
> 
