<properties
   pageTitle="Use Azure Machine Learning with SQL Data Warehouse | Windows Azure"
...
2. Database server name: Type the server name. You can use the [Azure Management Portal][] to find this.
...
[Create experiment tutorial]: /documentation/articles/machine-learning-create-experiment/
