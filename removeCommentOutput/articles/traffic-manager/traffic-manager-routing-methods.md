...
The configuration of endpoint priorities is carried out differently in the ARM APIs (and new Azure portal) vs the ASM APIs (and Classic Management Portal):
