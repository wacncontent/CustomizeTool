...
For an example of setting the environment variables in the [Azure Management Portal](portal.azure.com) for an Azure Website, see [Node.js web site with Storage]
