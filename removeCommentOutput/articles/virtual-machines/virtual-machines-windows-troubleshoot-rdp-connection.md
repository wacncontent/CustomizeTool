...
If you need more help at any point in this article, you can contact the Azure experts on [the MSDN Azure and Stack Overflow forums](https://azure.microsoft.com/support/forums/). Alternatively, you can file an Azure support incident. Go to the [Azure support site](https://azure.microsoft.com/support/contact/) and select **Get Support**.
...
- Reset the Remote Desktop service from the [Azure portal](https://portal.azure.cn). Select **Browse** > **Virtual machines (classic)** > *your VM* > **Reset Remote...**.
