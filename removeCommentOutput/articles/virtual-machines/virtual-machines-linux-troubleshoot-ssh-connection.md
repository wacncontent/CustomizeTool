...
- Reset remote access from the [Azure portal](https://portal.azure.cn). On the Azure portal, select **Browse** > **Virtual machines (classic)** > *your Linux virtual machine* > **Reset Remote...**.

- Restart the VM. On the [Azure portal](https://portal.azure.cn), select **Browse** > **Virtual machines (classic)** > *your Linux virtual machine* > **Restart**.
