...
> [AZURE.WARNING]
> Only use this process as a last resort. Always try to reset a password using the [Azure portal or Azure PowerShell](/documentation/articles/virtual-machines-windows-reset-rdp/) first.
> 
> 
