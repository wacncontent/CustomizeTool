<properties 
	pageTitle="How to use Service Bus queues with Python | Windows Azure" 
...
> [AZURE.NOTE] To install Python or the [Python Azure package][], see the [Python Installation Guide](/documentation/articles/python-how-to-install).
...
The values for the SAS key name and value can be found in the [Azure Management Portal][] connection information, or in the Visual Studio **Properties** pane when selecting the Service Bus namespace in Server Explorer (as shown in the previous section).
