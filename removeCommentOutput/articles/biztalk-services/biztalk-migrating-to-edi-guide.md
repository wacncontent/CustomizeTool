...
- *How to integrate a WCF Workflow Service with Service Bus Queues and Topics* by Paolo Salvatori. See [here](https://msdn.microsoft.com/zh-cn/library/azure/hh709041.aspx).
...
- *Windows Workflow Foundation 4 (WF4) documentation on MSDN*. See [here](https://msdn.microsoft.com/zh-cn/library/dd489441(v=vs.100).aspx).
