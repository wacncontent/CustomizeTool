...
> [AZURE.NOTE]
> If you are already familiar with using Linux-based Hadoop servers, but you are new to HDInsight, see [Linux-based HDInsight tips](/documentation/articles/hdinsight-hadoop-linux-information/).
...
1. After you are connected to the HDInsight cluster, use the following **Hadoop** command to start a MapReduce job:
    ...
    > [AZURE.NOTE]
    > For more information about this MapReduce job and the example data, see [Use MapReduce in Hadoop on HDInsight](/documentation/articles/hdinsight-use-mapreduce/).
