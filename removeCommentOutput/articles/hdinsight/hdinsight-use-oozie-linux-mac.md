...
* **An HDInsight cluster**: See [Get Started with HDInsight on Linux](/documentation/articles/hdinsight-hadoop-tutorial-get-started-windows-v1/)
...
## Create the database
Follow the steps in the [Create a SQL Database](/documentation/articles/sql-database-get-started/) document to create a new database. When creating the database, use **oozietest** as the database name. Also make a note of the name used for the database server, as this will be needed in the next section.
...
1. Use the following command to get the full WASB address to default storage. This will be used in the configuration file in a moment:
    ...
    Save the **wasbs://mycontainer@mystorageaccount.blob.core.chinacloudapi.cn** value, as it will be used in the next steps.
...
4. Once the nano editor opens, use the following as the contents of the file:
   ...
   * Replace all instances of **wasbs://mycontainer@mystorageaccount.blob.core.chinacloudapi.cn** with the value you received earlier.
