...
> [AZURE.NOTE]
> The `--type` parameter indicates how the storage account will be replicated. For more information, see [Azure Storage Replication](/documentation/articles/storage-redundancy/). Don't use ZRS as ZRS doesn't support page blob, file, table or queue.
> 
> 
