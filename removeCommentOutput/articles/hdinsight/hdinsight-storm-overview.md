...
> [AZURE.NOTE]
> You can also provision Storm clusters by using the [Azure CLI](/documentation/articles/xplat-cli-install/) or [Azure PowerShell](/documentation/articles/powershell-install-configure/).
> 
> 
