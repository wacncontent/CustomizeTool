...
* A **Linux-based Azure HDInsight cluster**. For information on creating a cluster, see [Get Started with Linux-based HDInsight](/documentation/articles/hdinsight-hadoop-tutorial-get-started-windows-v1/) for steps on creating a cluster.
