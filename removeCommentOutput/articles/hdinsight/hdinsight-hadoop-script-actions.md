...
> [AZURE.NOTE]
> The information in this document is specific to Windows-based HDInsight clusters. For information on using script actions with Windows-based clusters, see [Script action development with HDInsight (Linux)](/documentation/articles/hdinsight-hadoop-script-actions-linux/).
>
>
...
> [AZURE.NOTE]
> The sample scripts work only with HDInsight cluster version 3.1 or above. For more information on HDInsight cluster versions, see [HDInsight cluster versions](/documentation/articles/hdinsight-component-versioning-v1/).
>
>
