<properties
	pageTitle="Troubleshoot Azure Sign-up Issues | Windows Azure"
...
**Note:** You can change your preferred phone number at a later time by updating [your profile information](https://account.windowsazure.cn/Profile).
...
The Azure Terms of Use agreement has a limit of only one available trial activation for any user that never used Azure before. If you have had any other type of Azure subscription, you will not be able to activate a trial.

Suggestions:
- If you already activated an Azure subscription in the past and trial activation fails, please consider purchasing a Pay-As-You-Go subscription. You may also be eligible for a benefit offer. Learn more at the [Windows Azure offer details page](http://azure.microsoft.com/support/legal/offer-details/) instead of Azure Trial plan. Please note that benefit plans require specific prerequisites.
