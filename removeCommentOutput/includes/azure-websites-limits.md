...
<sup>3</sup>Dedicated instances can be of different sizes. See [Azure Pricing](/pricing/details/data-transfer/pricing/details/app-service/) for more details. Additional instances are available by opening a support request.  
