...
1. In the [Azure Management Portal], click **Browse** > **Azure Websitess**, then click your Mobile App backend > **All settings**, then under **Mobile** click **Push** > **Notification Hub**.
