...
We need to be able to detect an expired token, and refresh it. To do this we use a [ServiceFilter](http://azure.github.io/azure-storage-android/com/microsoft/windowsazure/mobileservices/ServiceFilter.html) from the [Android client library](http://azure.github.io/azure-storage-android/).
