...
There are others ways to list the contents of a blob container. See [How to use Blob Storage from .NET](/documentation/articles/storage-dotnet-how-to-use-blobs/#list-blob) for more information.
