...
<sup>3</sup>Dedicated instances can be of different sizes. See [Azure Web App Pricing](/home/features/web-site/#price) for more details. Additional instances are available by opening a support request.  
