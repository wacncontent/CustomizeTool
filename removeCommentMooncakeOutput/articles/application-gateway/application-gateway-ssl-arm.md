<properties 
   pageTitle="Configure an application gateway for SSL offload using Azure Resource Manager | Windows Azure"
...
It creates a virtual network named "appgwvnet" in resource group "appw-rg" for the China North region using the prefix 10.0.0.0/16 with subnet 10.0.0.0/24	
...
It creates a public IP resource "publicIP01" in resource group "appw-rg" for the China North region. 
