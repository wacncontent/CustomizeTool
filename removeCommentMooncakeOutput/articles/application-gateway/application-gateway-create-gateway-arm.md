...
Creates a virtual network named "appgwvnet" in resource group "appw-rg" for the China East region using the prefix 10.0.0.0/16 with subnet 10.0.0.0/24	
...
Creates a public IP resource "publicIP01" in resource group "appw-rg" for the China East region. 
