<properties 
    pageTitle="Tutorial: Azure Active Directory Integration with xMatters OnDemand | Windows Azure" description="Learn how to use xMatters OnDemand with Azure Active Directory to enable single sign-on, automated provisioning, and more!." 
