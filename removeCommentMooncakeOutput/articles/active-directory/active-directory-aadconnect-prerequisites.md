<properties
   pageTitle="Azure AD Connect: Prerequisites and hardware | Windows Azure"
...
- [Add and verify the domain](/documentation/articles/active-directory-add-domain) you plan to use in Azure AD. For example if you plan to use contoso.com for your users then make sure this domain has been verified and you are not only using the contoso.partner.onmschina.cn default domain.
...
- If Active Directory Federation Services is being deployed, the servers where AD FS or web site Proxy will be installed must be Windows Server 2012 R2 or later. [Windows remote management](#windows-remote-management) must be enabled on these servers for remote installation.
...
## Windows Remote Management
 ...
 When using Azure AD Connect to deploy Active Directory Federation Services or the web site Proxy, check the requirements below to ensure connectivity and configuration will succeed:
...
The minimum requirements for computers running AD FS or web site Servers is the following:
