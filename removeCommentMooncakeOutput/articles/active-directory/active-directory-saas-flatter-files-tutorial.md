<properties
	pageTitle="Tutorial: Azure Active Directory integration with Flatter Files | Windows Azure"
...
<br><br>![Configure Single Sign-On](./media/active-directory-saas-flatter-files-tutorial/tutorial_flatter_files_08.png)  <br>
    ...
    b. In the Azure Management Portal, on the Configure single sign-on at Flatter Files dialog, copt the Single Sign-On Service URL, and then paste it into the Identity Provider URL textbox.
...
<br><br>![Cfreate a Flatter Files User](./media/active-directory-saas-flatter-files-tutorial/tutorial_flatter_files_10.png)<br>
    ...
    c. In the **Email Address** textbox, type Britta's email address in the Azure Management Portal.
