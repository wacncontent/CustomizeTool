...
--- | --- | ---
This corporate app <!-- deleted by customization can't --><!-- keep by customization: begin --> can’t <!-- keep by customization: end --> be accessed. You are not authorized to access this application. Authorization failed. Make sure to assign the user with access to this application. | You may not have assigned the user for this application. | Go to the Application tab, and under Users and Groups, assign this user or user group to this application.
This corporate app <!-- deleted by customization can't --><!-- keep by customization: begin --> can’t <!-- keep by customization: end --> be accessed. You are not authorized to access this application. Authorization failed. Make sure that the user has a license for Azure Active Directory Premium or Basic. | Your user may get this error when trying to access the app you published if the user who tried to access the application was not explicitly assigned with a Premium/Basic license by the <!-- deleted by customization subscriber's --><!-- keep by customization: begin --> subscriber’s <!-- keep by customization: end --> administrator. | Go to the <!-- deleted by customization subscriber's --><!-- keep by customization: begin --> subscriber’s <!-- keep by customization: end --> Active Directory **Licenses** tab and make sure that this user or user group is assigned a Premium or Basic license.
...
| Clear error is presented in the registration window. Cannot proceed <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> only to close the window | You entered the wrong username or password. | Try again. |
