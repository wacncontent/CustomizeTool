...
Azure Active Directory provides single-sign on and enhanced application access security to thousands of SaaS applications and on-premises web <!-- deleted by customization sites --><!-- keep by customization: begin --> applications <!-- keep by customization: end -->. For a detailed list of Azure Active Directory application gallery for supported SaaS applications, see Azure Active Directory federation compatibility list: third-party identity providers that can be used to implement single sign-on
