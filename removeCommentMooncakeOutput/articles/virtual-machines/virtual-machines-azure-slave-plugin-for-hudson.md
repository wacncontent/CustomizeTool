...
4. Click **Add new cloud > Azure**.
	...
	>[AZURE.NOTE] In order to user Azure China, you need to click **Advanced...**, and replace "https://management.core.chinacloudapi.cn" by "https://management.core.chinacloudapi.cn".
