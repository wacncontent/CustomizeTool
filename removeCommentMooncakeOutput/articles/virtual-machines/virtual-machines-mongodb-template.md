<properties pageTitle="Create a MongoDB cluster on Ubuntu using a Resource Manager Template" description="Create a MongoDB cluster on Ubuntu using a Resource Manager Template via PowerShell or the Azure CLI" services="virtual-machines" documentationCenter="" authors="karthmut" manager="timlt" editor="tysonn"/>
