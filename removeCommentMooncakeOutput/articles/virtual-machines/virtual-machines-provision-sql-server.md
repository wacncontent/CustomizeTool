...
* [Connect to the Azure Classic Management Portal and provision a virtual machine from the gallery](#Provision)
...
1. Log in to the [Azure Classic Management Portal](http://manage.windowsazure.cn) using your account. If you do not have an Azure account, visit [Azure trial](/pricing/1rmb-trial/).

2. On the Azure Classic Management Portal, at the bottom left of the web page, click **+NEW**, click **COMPUTE**, click **VIRTUAL MACHINE**, and then click **FROM GALLERY**.
