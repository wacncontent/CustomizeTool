<properties
 ...
 description="Learn how to use the Azure portal Preview and the Resource Manager deployment model to create a Microsoft HPC Pack head node in an Azure VM."
...
Use a [Microsoft HPC Pack virtual machine image](https://azure.microsoft.com/marketplace/partners/microsoft/hpcpack2012r2onwindowsserver2012r2/) from the Azure gallery
...
2. To create the HPC Pack head node in the [Azure portal Preview](https://portal.azure.cn), select the HPC Pack 2012 R2 image from the Azure gallery. To do this, click **New** and search the Marketplace for **HPC Pack**. Select the **HPC Pack 2012 R2 on Windows Server 2012 R2** image.
...
4. Use the portal to configure the settings and create the VM. If you're new to Azure, follow the tutorial [Create a Windows virtual machine in the Azure portal Preview](/documentation/articles/virtual-machines-windows-hero-tutorial/). For a proof of concept deployment you can usually accept many default or recommended settings.
