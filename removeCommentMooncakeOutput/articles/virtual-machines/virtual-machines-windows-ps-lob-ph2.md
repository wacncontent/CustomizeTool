...
You must complete this phase before moving on to [Phase 3](/documentation/articles/virtual-machines-windows-ps-lob-ph3/). See [Deploy a High-Availability Line of Business Application in Azure](/documentation/articles/virtual-machines-windows-lob-overview/) for all of the phases.
...
Recall that you defined Tables V, S, ST, and A in [Phase 1: Configure Azure](/documentation/articles/virtual-machines-windows-ps-lob-ph1/).
...
1.	In the left pane of the Azure portal Preview, click **Virtual networks**, and then click the name of your virtual network (Table V - Item 1 - Value column).
...
4.	In the left pane of the Azure portal Preview, click **Virtual machines**.
...
- Use [Phase 3](/documentation/articles/virtual-machines-windows-ps-lob-ph3/) to continue with the configuration of this workload.
