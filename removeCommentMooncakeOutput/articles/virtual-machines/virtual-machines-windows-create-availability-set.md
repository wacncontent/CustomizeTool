...
<properties
	...
	description="Learn how to create an availability set for your virtual machines using Azure portal Preview or PowerShell using the Resource Manager deployment model."
