<properties pageTitle="DataStax on Ubuntu Resource Manager Template" description="Learn to easily deploy a new DataStax cluster on Ubuntu VMs using Azure PowerShell or the Azure CLI and a Resource Manager template" services="virtual-machines" documentationCenter="" authors="karthmut" manager="timlt" editor="tysonn"/>
