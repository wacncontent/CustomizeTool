...
1. Follow the instructions given [here](/documentation/articles/virtual-machines-linux-tutorial-portal-rm) to create an Azure virtual machine of the *Ubuntu Server 14.04 LTS* distribution.
