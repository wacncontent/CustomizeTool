...
<properties
	...
	description="Learn how to create your first Windows virtual machine using the Azure portal Preview."
...
If you don't have an Azure subscription, you can create a [trial account](/pricing/1rmb-trial/) in just a couple of minutes.
