<properties 
	pageTitle="How to Set Up Tomcat7 on a Linux Virtual Machine with Windows Azure" 
	description="Learn how to set up Tomcat7 with Windows Azure using an Azure virtual machine (VM) running Linux." 
...
In the [Azure  Portal](https://manage.windowsazure.cn/), click **New** in the task bar to create an image, choosing the Linux image based on your needs. The following example uses the Ubuntu 14.04 image. 
![][3]
