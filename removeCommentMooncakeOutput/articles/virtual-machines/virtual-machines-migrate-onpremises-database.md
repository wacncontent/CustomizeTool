...
> [AZURE.NOTE] If you have an AlwaysOn deployment on-premises, you can also consider using the [Add Azure Replica Wizard](https://msdn.microsoft.com/zh-cn/library/dn463980.aspx) to create a replica in Azure and then failover as a method of migrating.
...
> [AZURE.NOTE] To migrate an entire application, consider using [Azure Site Recovery](/documentation/articles/services/site-recovery)].
