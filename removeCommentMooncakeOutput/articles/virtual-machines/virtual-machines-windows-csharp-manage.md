...
2. Add variables to the Main method of the Program class to specify the names of the resources that you want to manage, the location of the resources, such as "China North", and your subscription identifier:
