...
This article only applies to Azure virtual machines running Windows. For Azure virtual machines running Linux, see [Troubleshoot SSH connection to an Azure VM](/documentation/articles/virtual-machines-troubleshoot-ssh-connections).
