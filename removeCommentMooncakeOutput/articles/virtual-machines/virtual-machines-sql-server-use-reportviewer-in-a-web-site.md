...
For instructions on publishing an ASP.NET Web application to Azure, see [Get started with Web Apps and ASP.NET](/documentation/articles/web-sites-dotnet-get-started).
