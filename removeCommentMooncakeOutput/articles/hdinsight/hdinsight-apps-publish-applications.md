...
# Publish HDInsight applications into the Azure gallery

An HDInsight application is an application that users can install on a Linux-based HDInsight cluster. These applications can be developed by Microsoft, independent software vendors (ISV) or by yourself. In this article, you will learn how to publish an HDInsight application into the Azure gallery.  For general information about publishing into the Azure gallery, see [publish an offer to the Azure gallery](/documentation/articles/marketplace-publishing-getting-started/).
...
You must also have register your developer account. See [publish an offer to the Azure gallery](/documentation/articles/marketplace-publishing-getting-started/) and [Create a Microsoft Developer account](/documentation/articles/marketplace-publishing-accounts-creation-registration/).

## Define application

There are two steps involved for publishing applications to the Azure gallery.  First you define a **createUiDef.json** file to indicate which clusters your application is compatible with; and then you publish the template from the Azure portal. The following is a sample createUiDef.json file.
