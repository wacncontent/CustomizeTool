...
The fees associated with an HDInsight Premium cluster with R Server are structured in a manner similar to those for the standard HDInsight clusters and will be based on the sizing of the underlying VMs across the name, data, and edge nodes, with the addition of a core-hour uplift for Premium. For more information on HDInsight Premium pricing, including pricing during Public Preview, and the availability of a 30-day trial, see [HDInsight pricing](/home/features/hdinsight/pricing/).
