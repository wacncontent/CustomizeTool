...
Confirming that your service is operational and accessible from a client application is the final step in configuring Azure Search. You can use [Fiddler with Azure Search](/documentation/articles/search-fiddler) to verify service availability.
