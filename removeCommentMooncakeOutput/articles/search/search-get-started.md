...
1. Sign in to [Azure Management Portal](https://manage.windowsazure.cn) using your existing subscription. Notice that this URL takes you to the Portal. Using the Portal is a requirement. 
