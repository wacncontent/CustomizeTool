...
Learn how to build a custom NodeJS search application that uses Azure Search for its search experience. This tutorial uses the [Azure Search Service REST API](https://msdn.microsoft.com/zh-cn/library/dn798935.aspx) to construct the objects and operations used in this exercise.
