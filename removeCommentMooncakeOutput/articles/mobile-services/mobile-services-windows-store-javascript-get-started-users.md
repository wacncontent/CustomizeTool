<properties
	pageTitle="Get started with authentication (JavaScript) | Windows Azure"
...
<ol start="3">
<li><p>In Visual Studio 2012 Express for Windows 8, open the project that you created when you completed the tutorial <a href="/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-get-started/">Get started with Mobile Services</a>.</p></li> 
