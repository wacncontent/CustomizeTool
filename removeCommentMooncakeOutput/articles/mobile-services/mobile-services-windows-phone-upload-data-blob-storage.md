<properties 
	pageTitle="Upload images to Azure Storage from a Windows Phone Silverlight app | Windows Azure" 
...
In this tutorial, you add functionality to the [GetStartedWithData sample app project](/documentation/articles/mobile-services-windows-phone-get-started-data) to take pictures and upload the images to Azure by using an SAS generated by Mobile Services. 
...
+ Complete the tutorial [Add Mobile Services to an existing app](/documentation/articles/mobile-services-windows-phone-get-started-data)  
