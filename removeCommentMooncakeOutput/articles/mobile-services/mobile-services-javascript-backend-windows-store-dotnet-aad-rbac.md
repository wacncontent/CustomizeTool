<properties 
	pageTitle="Role Based Access Control in Mobile Services using JavaScript and the Azure Active Directory (Windows Store) | Windows Azure" 
...
5. Add the following exported `checkGroupMembership` function to *rbac.js* .  
...
6. Save your changes to *rbac.js*.
...
<!-- URLs. -->
[Add authentication to your Mobile Service app]: /documentation/articles/mobile-services-windows-store-dotnet-get-started-users/
...
[Graph API Error Reference]: http://msdn.microsoft.com/zh-cn/library/azure/hh974480.aspx
