...
6. In ViewController.m, add the following code to generate the SAS authorization token that will be provided in the *Authorization* header as mentioned in the [REST API Reference](http://msdn.microsoft.com/zh-cn/library/azure/dn495627.aspx).
