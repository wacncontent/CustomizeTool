...
This document will let you know what to expect when using some of the new roles in the Azure Management Portal.  There are three pre-built roles that are included in this release:
* Owner
* Contributor
* Reader
