...
- encode your stream to multi-bitrate ([adaptive bitrate](http://en.wikipedia.org/wiki/自适性串流)) video stream (this will take care of quality and network conditions) and 
