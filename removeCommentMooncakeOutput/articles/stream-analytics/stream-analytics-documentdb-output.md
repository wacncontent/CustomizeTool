<properties
	pageTitle="JSON output for Stream Analytics | Windows Azure"
...
Stream Analytics can target [Azure DocumentDB](/home/features/documentdb/) for JSON output, enabling data archiving and low-latency queries on unstructured JSON data. Learn how to best implement this integration.
