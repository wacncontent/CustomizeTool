<properties
   pageTitle="Upgrading a Service Fabric cluster | Windows Azure"
...
For details on how to set custom health policies for your cluster refer to  [Cluster Upgrade and Health Parameters](/documentation/articles/service-fabric-cluster-health-parameters).
...
1) upload the new certificate to the keyvault - refer to [Service Fabric Security](/documentation/articles/service-fabric-cluster-security) for instructions - start with step #2 in that document.
...
### Placement Properties
  ...
  >[AZURE.NOTE] For details on the use of placement property refer to [the placement constraints documentation](/documentation/articles/service-fabric-placement-constraint).

### Capacity Metrics

For each of the Node Types, you can add custom capacity metrics that you want to use in your applications to report load. For details on the use of capacity metrics to report load against refer to [the overview of dynamic load reporting](/documentation/articles/service-fabric-resource-balancer-dynamic-load-reporting).
...
- Learn how to [scale your cluster up and down](/documentation/articles/service-fabric-cluster-scale-up-down)
