<properties 
	pageTitle="DocumentDB Java SDK | Windows Azure" 
...
<tr><td>**Get Started**</td><td>[Get started with the Java SDK](/documentation/articles/documentdb-java-application)</td></tr>
