...
In the [Windows Azure Management Portal](https://manage.windowsazure.cn/),
...
![Azure Management Portal screenshot, Keys blade](./media/documentdb-manage-account/keys.png)
