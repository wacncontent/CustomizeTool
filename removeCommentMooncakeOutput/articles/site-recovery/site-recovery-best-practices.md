...
This article describes how to prepare for your Azure Site Recovery deployment. If you have any questions after reading this article post them on the [Azure Recovery Services forum](https://social.msdn.microsoft.com/Forums/zh-cn/home?forum=hypervrecovmgr). 
...
**Azure account** | You'll need a [Windows Azure](http://www.windowsazure.cn/) account and a subscription to the Site Recovery service. | You'll need an [Windows Azure](http://www.windowsazure.cn/) account and a subscription to the Site Recovery service. | NA | If you don't have an account, start with a [1rmb trial](/pricing/1rmb-trial/). Read about [pricing](/home/features/site-recovery#price) for the service.
...
- **Capacity planning**: Read the [capacity planner](http://www.microsoft.com/zh-cn/download/details.aspx?id=39057) if you're replicating Hyper-V VMs.
