<properties 
	pageTitle="Set up protection between an on-premises VMM site and Azure | Windows Azure"
	...
	manager="jwhit" 
	editor="tysonn"/>
<tags ms.service="site-recovery" ms.date="08/05/2015" wacn.date="04/11/2015"/>
...
- Learn more about setting up VMM clouds:
	...
	- After your cloud fabric elements are in place learn about creating private clouds in  [Creating a private cloud in VMM](http://technet.microsoft.com/library/jj860425.aspx) and [Walkthrough: Creating private clouds with System Center 2012 SP1 VMM](http://blogs.technet.com/b/keithmayer/archive/2013/04/18/walkthrough-creating-private-clouds-with-system-center-2012-sp1-virtual-machine-manager-build-your-private-cloud-in-a-month.aspx).
