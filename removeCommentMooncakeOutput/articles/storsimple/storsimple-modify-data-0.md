...
- To configure network interfaces other than DATA 0, you can use the [Configure page in the Azure Management Portal](/documentation/articles/storsimple-modify-device-config). 
