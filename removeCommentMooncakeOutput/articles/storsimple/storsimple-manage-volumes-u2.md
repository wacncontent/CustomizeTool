<properties
   pageTitle="Manage your StorSimple volumes (U2) | Windows Azure"
...
You [created a volume](/documentation/articles/storsimple-deployment-walkthrough-u2#step-6-create-a-volume) during deployment of your StorSimple solution. Adding a volume is a similar procedure.
...
6. Save your changes by clicking the check icon ![check-icon](./media/storsimple-manage-volumes-u2/HCS_CheckIcon.png). The Azure Management Portal will display an updating volume message. It will display a success message when the volume has been successfully updated.
...
7. Click the check icon ![Check icon](./media/storsimple-manage-volumes-u2/HCS_CheckIcon.png) to start the conversion process. The Azure Management Portal will display an updating volume message. It will display a success message when the volume has been successfully updated.
