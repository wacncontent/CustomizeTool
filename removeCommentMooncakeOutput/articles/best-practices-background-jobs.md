...
- Sensitive data processing where the task is handed off to a more secure location for processing. For example, you may not want to process sensitive data within a web role, and instead use a pattern such as [Gatekeeper](http://msdn.microsoft.com/zh-cn/library/dn589793.aspx) to transfer the data to an isolated background role that has access to protected storage.
...
- Use a startup task to install a Windows service that executes one or more background tasks. You must set the **taskType** property to **background** so that the service executes in the background. For more information, see [Run Startup Tasks in Azure](http://msdn.microsoft.com/zh-cn/library/azure/hh180155.aspx).
...
To help you choose when to use Virtual Machines, see [Azure Websites, Cloud Services and Virtual Machines comparison](/documentation/articles/choose-web-site-cloud-service-vm). For information about the options for [Virtual Machines, see Virtual Machine and Cloud Service Sizes for Azure](http://msdn.microsoft.com/zh-cn/library/azure/dn197896.aspx). For more information about the operating systems and pre-built images available for Virtual Machines, see [Azure Virtual Machines Gallery](http://azure.microsoft.com/gallery/virtual-machines/).
...
- [Virtual Machines](/home/features/virtual-machines/) on the Azure website
...
- [Get Started with the Azure WebJobs SDK](/documentation/articles/websites-dotnet-webjobs-sdk-get-started)
- [Azure Queues and Service Bus Queues - Compared and Contrasted](http://msdn.microsoft.com/zh-cn/library/hh767287.aspx)
- [How To Enable Diagnostics in a Cloud Service](http://msdn.microsoft.com/zh-cn/library/dn482131.aspx)
