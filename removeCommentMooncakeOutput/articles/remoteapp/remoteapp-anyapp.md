...
1. In the Azure Management Portal, scroll down in the left hand nav tree until you see RemoteApp. Open that page.
...
3. Now you need to create an Azure [storage account](/documentation/articles/storage-create-storage-account). We named ours "accessstorage," so pick a name that's meaningful to you. (To misquote Highlander, there can be only one "accessstorage.")
