<properties
    pageTitle="What is in the Azure RemoteApp template images? | Windows Azure"
...
>
> Check out the [RemoteApp licensing details](/documentation/articles/remoteapp-licensing) for more information. And [Using Office with Azure RemoteApp](/documentation/articles/remoteapp-o365) for the Office licensing info.
...
Full functionality of Office 365 ProPlus apps is available only for users who have an Office 365 ProPlus plan. For more details on the Office 365 subscription plans see [Office 365 service plans](http://technet.microsoft.com/zh-cn/library/office-365-plan-options.aspx). Still have questions? Check out the [Office 365 + RemoteApp](/documentation/articles/remoteapp-o365) information. Also check out the new article, [How to use your Office 365 subscription with Azure RemoteApp](/documentation/articles/remoteapp-officesubscription).

Note that you need to license Office 365 ProPlus, Visio Pro, and Project Pro separately - they each have their own license.

## Microsoft Office 2013 Professional Plus (trial only)
During the trial period, you can test the service with the Office 2013 image.
