<properties
	pageTitle="Role-based access control in the Windows Azure Management Portal"
...
Every Azure subscription is associated with an Azure Active Directory. Users and services that access resources of the subscription using the Windows Azure Management Portal or Azure Resource Manager API first need to authenticate with that Azure Active Directory.
...
Role assignments can also be managed by using the Windows Azure module for Windows PowerShell. Here is an example of adding Brock's account by using the New-AzureRoleAssignment cmdlet rather than the portal:

	PS C:\> New-AzureRoleAssignment -Mail brockh@contoso.com -RoleDefinitionName Contributor -ResourceGroupName ProdDB

For more information about using Windows PowerShell to add and remove access, see [Managing role-based access control with Windows PowerShell](/documentation/articles/role-based-access-control-powershell). 
...
Changes to role assignments are logged in the [Audit logs](http://azure.microsoft.com/updates/audit-logs-in-azure-preview-portal/), similar to other events.  The log of role assignment changes can be retrieved using [Azure PowerShell](https://msdn.microsoft.com/zh-cn/library/azure/jj156055.aspx) or the [Azure Resource Manager REST API](https://msdn.microsoft.com/zh-cn/library/azure/dn931927.aspx).
...
Claims               :
                       ...
                       _claim_sources : {"src1":{"endpoint":"https://graph.chinacloudapi.cn/72f988bf-86f1-41af-91ab-2d7cd011
...
If you encounter a problem when you use role based access control feature, see [Troubleshooting role-based access control](/documentation/articles/role-based-access-control-troubleshooting) for any known issues that may be related to the problem.
...
+ [Managing role-based access control with Windows PowerShell](/documentation/articles/role-based-access-control-powershell)
+ [Managing role-based access control with Azure CLI](/documentation/articles/role-based-access-control-xplat-cli)
+ [Troubleshooting role-based access control](/documentation/articles/role-based-access-control-troubleshooting)
+ [Azure Active Directory Premium and Basic](/documentation/articles/active-directory-editions)
