...
[AZURE.INCLUDE [azure-arm-classic-important-include](../includes/azure-arm-classic-important-include.md)] This article covers the Resource Manager deployment model. You can also [Learn how to create an Internet facing load balancer using classic deployment](/documentation/articles/load-balancer-get-started-internet-classic-portal)
...
Create a public IP address named *NRPPublicIP* to be used by a front end IP pool with DNS name *loadbalancernrp.chinaeast.chinacloudapp.cn*. The command below uses the static allocation type and idle timeout of 4 minutes.
