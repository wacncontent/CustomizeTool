<properties
	...
	description="Learn how to monitor Web Apps in Azure by using the Classic Management Portal."
...
1. In the [Classic Management Portal](https://manage.windowsazure.cn), from the web app's page, click the **Monitor** tab to display the **Monitor** management page. By default the chart on the **Monitor** page displays the same metrics as the chart on the **Dashboard** page.
...
Diagnostics are enabled on the **Configure** tab for the web app in the [Classic Management Portal](https://manage.windowsazure.cn). There are two types of diagnostics: **application diagnostics** and **site diagnostics**.
...
5.	Enter the URL for a part of your web app that you want to monitor. For example, http://contoso.chinacloudsites.cn/archive.
