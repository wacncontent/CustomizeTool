...
2. In **Server Explorer**, expand **Azure** and expand **Azure Websitess**.
...
1. In **Server Explorer**, expand **Azure**, expand **Azure Websitess**, expand the resource group that your web site is located in, and then expand the node for your web site.
