...
The compute resources are used for your 4 resource pools.  Each Azure Environment has a set of Front Ends and 3 possible Worker Pools.  You don't need to use all 3 Worker Pools and if you want you can just use one or two.  The resource pools, Front Ends and Workers, are not directly accessible to tenants.  You cannot RDP to them, change their provisioning or act as an admin on them but you can set their quantity and size. In an ASE you have 4 size options labeled P1 through P4.  For details around those sizes and their pricing please see here [Azure Pricing](/documentation/services/web-sites).
