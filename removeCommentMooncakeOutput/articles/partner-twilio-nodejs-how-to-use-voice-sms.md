...
Before using Twilio services, you must first [sign up for an account][signup].  Windows Azure customers receive a special discount - [be sure to sign up here][signup]!
