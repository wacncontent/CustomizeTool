...
- AzCopy Command-Line Utility. Download and install the [latest version of AzCopy][] which is installed with the Windows Azure Storage Tools.
...
1. From the Azure Management Portal select **Browse** > **Storage Accounts**.
