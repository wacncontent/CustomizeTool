...
- To learn how to deploy your template, see [Deploy an application with Azure Resource Manager Template](/documentation/articles/azure-portal/resource-group-template-deploy)
