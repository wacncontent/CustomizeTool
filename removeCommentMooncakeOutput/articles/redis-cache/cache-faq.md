...
-	**Memory**: The Basic and Standard tiers offer 250 MB - 53 GB. The Premium tier offers up to 530 GB. For more information see [Azure Redis Cache Pricing](/home/features/redis-cache/#price).
...
-	Retries
	...
	-	Snowballing - sometimes you may run into an issue where you are retrying and this snowballs and never recovers. In this case you should consider using an exponential backoff retry algorithm as described in [Retry general guidance](https://github.com/mspnp/azure-guidance/blob/master/Retry-General.md) published by the WindowsAzure.cn Patterns & Practices group.
-	Timeout values
...
>[AZURE.IMPORTANT] WindowsAzure.cn recommends all new developments use Azure Redis Cache.
