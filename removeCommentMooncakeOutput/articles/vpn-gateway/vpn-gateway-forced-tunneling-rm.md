<properties 
   pageTitle="Configure Forced Tunneling for VPN Gateways using Resource Manager | Windows Azure"
...
- Azure PowerShell cmdlets (1.0 or later). You can download and install this version from the Windows PowerShell section of the [Download page](/downloads/). This documentation was written for PowerShell 1.0 or later. The necessary cmdlets for this configuration are not present in earlier versions. 

- If you aren't familiar with using Azure Resource Manager and PowerShell, please see [this article](/documentation/articles/powershell-azure-resource-manager) for more information.
