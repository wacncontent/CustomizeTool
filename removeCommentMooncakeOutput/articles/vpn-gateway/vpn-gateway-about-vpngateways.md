<properties 
   pageTitle="About VPN Gateways for Virtual Network cross-premises connectivity | Windows Azure"
...
Pricing does differ between gateway SKUs. For information about pricing, see [VPN Gateway Pricing](/home/features/vpn-gateway/#price).
...
Select the VPN device for your configuration. See [About VPN devices](/documentation/articles/vpn-gateway-about-vpn-devices).
