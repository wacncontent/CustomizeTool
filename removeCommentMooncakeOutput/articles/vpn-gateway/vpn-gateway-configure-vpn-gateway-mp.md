...
This article was written for the classic deployment model and the Azure Management Portal (not the Azure Management Portal). At this time, if you want to configure a VPN Gateway for the classic deployment model using a portal, you must use the Azure Management Portal. 
