...
- Backup and Restore may not be available for all editions. See [BizTalk Services: Editions Chart](/documentation/articles/biztalk-editions-feature-chart).
...
1. In the Azure Management Portal, select **New** > **Azure Websitess** > **BizTalk Service** > **Restore**:
