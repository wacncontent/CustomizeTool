...
- The article [SQL Server Business Intelligence in Azure Virtual Machines](https://msdn.microsoft.com/zh-cn/library/azure/jj992719.aspx) on the Microsoft website.
