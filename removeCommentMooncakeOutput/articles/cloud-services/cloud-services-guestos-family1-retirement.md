...
5. Ensure that your application is using SDK 1.3 and above with .NET framework 3.5 or 4.0. 
6. Set the osFamily attribute to "2" in the ServiceConfiguration.cscfg file, and redeploy your cloud service.
