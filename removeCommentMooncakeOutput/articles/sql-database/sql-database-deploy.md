...
A **Windows Azure account**. For a trial, see this [offer](/pricing/1rmb-trial/).
...
1. In Management Studio, right-click the school database that you just created, point to **Tasks**, and click **Deploy Database to Windows Azure SQL Database**.
...
6. In **Server name**, enter the 10-character server name, followed by **.database.chinacloudapi.cn**
...
For a tutorial on creating a new Azure SQL database, see [Getting Started with SQL Database Administration](/documentation/articles/sql-database-get-started). For the basics of connecting to an Azure SQL database from a C# app, see [Connect to and query your SQL Database with C#](/documentation/articles/sql-database-connect-query). For more tutorials on connection from various platforms (such as PHP) see [Azure SQL Database Development: How-to Topics](https://msdn.microsoft.com/zh-cn/library/azure/ee621787.aspx).
