<properties
   pageTitle="Monitoring Azure SQL Database Using Dynamic Management Views | Windows Azure"
   description="Learn how to detect and diagnose common performance problems by using dynamic management views to monitor Windows Azure SQL Database."
