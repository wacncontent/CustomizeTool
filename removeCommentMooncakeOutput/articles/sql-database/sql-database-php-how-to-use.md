...
* Install PHP and configure IIS: [http://php.net/manual/zh/install.windows.iis7.php][manual-config].
* Download and install SQL Server Express: [http://www.microsoft.com/zh-cn/download/details.aspx?id=29062][install-sql-express]
...
[limitations]: http://msdn.microsoft.com/zh-cn/library/azure/ff394102.aspx
