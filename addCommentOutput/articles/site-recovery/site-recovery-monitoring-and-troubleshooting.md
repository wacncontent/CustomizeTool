...
-   [How to preserve the drive letter for protected virtual machines that are failed over or migrated to <!-- deleted by customization Azure](http://support.microsoft.com/kb/3031135) --><!-- keep by customization: begin --> Azure](http://support.microsoft.com/zh-cn/kb/3031135) <!-- keep by customization: end -->
-   [How to manage on-premises to Azure protection network bandwidth <!-- deleted by customization usage](https://support.microsoft.com/kb/3056159) --><!-- keep by customization: begin --> usage](https://support.microsoft.com/zh-cn/kb/3056159) <!-- keep by customization: end -->
-   [ASR: "The cluster resource could not be found" error when you try to enable protection for a virtual  <!-- deleted by customization machine](http://support.microsoft.com/kb/3010979) --><!-- keep by customization: begin --> machine](http://support.microsoft.com/zh-cn/kb/3010979) <!-- keep by customization: end -->
