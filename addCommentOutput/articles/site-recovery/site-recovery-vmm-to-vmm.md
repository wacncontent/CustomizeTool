...
<!-- deleted by customization 1 --><!-- keep by customization: begin --> >4 <!-- keep by customization: end -->. Install the provider by executing the following command
<!-- keep by customization: begin -->
>
<!-- keep by customization: end -->
		C:\ASR> setupdr.exe /i
<!-- deleted by customization 1 --><!-- keep by customization: begin --> >5 <!-- keep by customization: end -->. Register the provider by running the following command
<!-- keep by customization: begin -->
>
<!-- keep by customization: end -->
