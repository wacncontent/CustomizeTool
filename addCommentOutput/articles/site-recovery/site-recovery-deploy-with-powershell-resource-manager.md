...
- You'll need a [Windows <!-- deleted by customization Azure](http://azure.microsoft.com/) account. You'll need a [Windows Azure](http://azure.microsoft.com/) --><!-- keep by customization: begin --> Azure](http://www.windowsazure.cn/) <!-- keep by customization: end --> account. You can start with a [trial](/pricing/1rmb-trial/). In addition, you can read about [Azure Site Recovery Manager pricing](/home/features/site-recovery/#price).
- You'll need Azure PowerShell 1.0. For information about this release and how to install it, see [Azure PowerShell <!-- deleted by customization 1.0.](http://azure.microsoft.com/) --><!-- keep by customization: begin --> 1.0.](/documentation/articles/powershell-install-configure) <!-- keep by customization: end -->
...
1. Open a PowerShell console and run this command to login to your Azure account. The cmdlet brings up a web page that will prompt you for your account credentials.
    	...
    	Login-AzureRmAccount <!-- keep by customization: begin --> -EnvironmentName AzureChinaCloud <!-- keep by customization: end -->
