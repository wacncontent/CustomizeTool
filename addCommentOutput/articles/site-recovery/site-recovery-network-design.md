...
[Deploying VMM in a <!-- deleted by customization cluster](https://technet.microsoft.com/library/gg610675.aspx) --><!-- keep by customization: begin --> cluster](https://technet.microsoft.com/zh-cn/library/gg610675.aspx) <!-- keep by customization: end --> provides high availability and protection against hardware failover. If you're deploying your VMM cluster with Site Recovery note that:
