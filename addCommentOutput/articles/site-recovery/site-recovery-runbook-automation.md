...
<!-- deleted by customization The table --><!-- keep by customization: begin --> Table <!-- keep by customization: end --> below contains name and description for each variable in the context.
<!-- deleted by customization
