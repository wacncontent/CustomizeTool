...
For more information about defining the template, see [Authoring Azure Resource Manager <!-- deleted by customization Templates](./resource-group-authoring-templates.md) --><!-- keep by customization: begin --> Templates](/documentation/articles/resource-group-authoring-templates) <!-- keep by customization: end -->.
...
For more information about tags, see [Using tags to organize your Azure <!-- deleted by customization resources](./resource-group-using-tags.md) --><!-- keep by customization: begin --> resources](/documentation/articles/resource-group-using-tags) <!-- keep by customization: end -->.
...
For information about PowerShell, see [Using Azure PowerShell with Resource <!-- deleted by customization Manager](./powershell-azure-resource-manager.md) --><!-- keep by customization: begin --> Manager](/documentation/articles/powershell-azure-resource-manager) <!-- keep by customization: end --> and [Azure Resource Manager Cmdlets](https://msdn.microsoft.com/zh-cn/library/azure/dn757692.aspx).

For information about Azure CLI, see [Using the Azure CLI for Mac, Linux, and Windows with Azure Resource <!-- deleted by customization Management](./virtual-machines/xplat-cli-azure-resource-manager.md) --><!-- keep by customization: begin --> Management](/documentation/articles/xplat-cli-azure-resource-manager) <!-- keep by customization: end -->.
...
- To learn about creating templates, see [Authoring <!-- deleted by customization templates](./resource-group-authoring-templates.md) --><!-- keep by customization: begin --> templates](/documentation/articles/resource-group-authoring-templates) <!-- keep by customization: end -->
- To deploy the template you created, see [Deploying templates](/documentation/articles/resource-group-template-deploy)
- To understand the functions you can use in a template, see [Template <!-- deleted by customization functions](./resource-group-template-functions.md) --><!-- keep by customization: begin --> functions](/documentation/articles/resource-group-template-functions) <!-- keep by customization: end -->
