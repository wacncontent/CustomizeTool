<properties 
	pageTitle="How to Use Twilio for Voice and SMS (.NET) | Windows Azure" 
...
> [AZURE.NOTE] While TwiML is designed for use by web services, you can view the TwiML in your browser. For example, click [http://twimlets.com/message](/documentation/articles/twimlet_message_url) to see an empty &lt;Response&gt; element; as another example, click [http://twimlets.com/message?Message%5B0%5D=Hello%20World](/documentation/articles/twimlet_message_url_hello_world) to see a &lt;Response&gt; element that contains a &lt;Say&gt; element.
...
[vs_project]:http://msdn.microsoft.com/zh-cn/library/azure/ee405487.aspx
