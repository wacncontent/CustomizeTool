...
For the latest Azure Media Hyperlapse updates, see [Media Services <!-- deleted by customization blogs](/blog/tags/媒体服务) --><!-- keep by customization: begin --> blogs](/blog/tags/Ă˝ĚĺˇţÎń) <!-- keep by customization: end -->.

## Hyperlapse an asset

First you will need to upload your desired input file to Azure Media Services.  To learn more about the concepts involved with uploading and managing content, read the [content management article](/documentation/articles/media-services-manage-content#upload).
...
> [AZURE.NOTE] You should already have a CloudMediaContext in scope with the name "context" for this code to work.  To learn more about this, read the [content management article](/documentation/articles/media-services-manage-content).
