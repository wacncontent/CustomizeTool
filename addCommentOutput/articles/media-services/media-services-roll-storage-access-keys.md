...
When you create a new Azure Media Services account, you are also asked to select an Azure Storage account that is used to store your media content. Note that you can [add more than one storage accounts](/documentation/articles/meda-services-managing-multiple-storage-accounts) to your Media Services account.
