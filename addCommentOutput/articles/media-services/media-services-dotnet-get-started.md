...
1.  Create a Media Services account (using the Azure Management Portal).
...
1. In the [portal](https://manage.windowsazure.cn/), click **Media Services**. Then, click the name of the media service.
...
- **EnvelopeEncryptionProtected** <!-- deleted by customization â --><!-- keep by customization: begin --> - <!-- keep by customization: end --> Use this option if you are uploading HLS encrypted with AES. Note that the files must have been encoded and encrypted by Transform Manager.
