...
- **EnvelopeEncryptionProtected** = **4** <!-- deleted by customization â --><!-- keep by customization: begin --> - <!-- keep by customization: end --> Use this option if you are uploading HLS encrypted with AES. Note that the files must have been encoded and encrypted by Transform Manager.
