...
- encode your stream to multi-bitrate ([adaptive <!-- deleted by customization bitrate](http://zh.wikipedia.org/wiki/自适性串流)) --><!-- keep by customization: begin --> bitrate](http://en.wikipedia.org/wiki/自适性串流)) <!-- keep by customization: end --> video stream (this will take care of quality and network conditions) and
