...
For the latest Azure Media Indexer updates, see [Media Services <!-- deleted by customization blogs](#preset) --><!-- keep by customization: begin --> blogs](/blog/tags/媒体服务) <!-- keep by customization: end -->.
...
For more information, see [Task Preset for Azure Media <!-- deleted by customization Indexer](#) --><!-- keep by customization: begin --> Indexer](https://msdn.microsoft.com/zh-cn/library/azure/dn783454.aspx) <!-- keep by customization: end -->.
