...
>[AZURE.NOTE] This step will require the <!-- deleted by customization channelâs --><!-- keep by customization: begin --> channel's <!-- keep by customization: end --> ingest URL that was mentioned in the previous step.
