...
[How to: Connect to Media Services Programmatically]: <!-- deleted by customization ../media-services-set-up-computer/ --><!-- keep by customization: begin --> /documentation/articles/media-services-set-up-computer <!-- keep by customization: end -->
