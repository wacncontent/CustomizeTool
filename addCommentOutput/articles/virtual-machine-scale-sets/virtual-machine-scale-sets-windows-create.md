...
3. Create the configuration for the scale set:
    ...
    This example shows a scale set being created with 3 virtual machines. See [Virtual Machine Scale Sets Overview](/documentation/articles/virtual-machine-scale-sets-overview/) for more about the capacity of scale sets. This step also includes setting the size (referred to as SkuName) of the virtual machines in the set. Look at [Sizes for virtual machines](/documentation/articles/virtual-machines-windows-sizes/) to find a size that meets your needs.
...
2. Create the variables that define the image to use:  
    ...
    Look at [Navigate and select Azure virtual machine images with Windows PowerShell and the Azure CLI](/documentation/articles/virtual-machines-windows-cli-ps-findimage/) to find the information about other images to use.
