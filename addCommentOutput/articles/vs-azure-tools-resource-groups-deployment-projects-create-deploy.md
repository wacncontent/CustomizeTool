...
In this procedure, you learn how to create an Azure Resource Group project with a **Web <!-- deleted by customization Apps** --><!-- keep by customization: begin --> Site** <!-- keep by customization: end --> template.
...
1. Choose the template that you want to deploy to Azure Resource Manager. For this example, we'll choose the **Web <!-- deleted by customization Apps** --><!-- keep by customization: begin --> Site** <!-- keep by customization: end --> template.
...
1. If you're also deploying a web site with your template, you'll need to create a reference from the new Azure SDK 2.6 <!-- deleted by customization or later --> Resource Group project to your <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end -->.
