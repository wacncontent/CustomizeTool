...
# How to: Migrate and Publish a <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> to an Azure Cloud Service from Visual Studio
...
>[AZURE.NOTE] This topic is about deploying to cloud services, not to web sites.Â For information about deploying to web sites, see <!-- deleted by customization [Deploy a web site in --><!-- keep by customization: begin --> How to Deploy an <!-- keep by customization: end --> Azure <!-- deleted by customization Websites](/documentation/articles/web-sites-deploy) --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end -->.
...
1. To enable your web site for deployment to Azure, open the shortcut menu for a web project in your solution and choose Add Azure Deployment <!-- deleted by customization Project. --><!-- keep by customization: begin --> Project.The following actions occur: <!-- keep by customization: end -->
...
1. To create an instance of SQL Database in the <!-- keep by customization: begin --> management console for <!-- keep by customization: end --> Azure <!-- deleted by customization Management Portal -->, follow the steps in the following article: [Create a SQL Database Server](http://social.technet.microsoft.com/wiki/contents/articles/1884.getting-started-with-windows-azure-sql-database-using-the-windows-azure-management-portal.aspx).
...
### To use an instance of SQL Database by using the <!-- deleted by customization Azure --> Management Portal
...
1. (Optional) After your role instances have started, Visual Studio automatically shows the deployment environment in the **Azure Compute** node in <!-- deleted by customization **Cloud Explorer** or --> **Server Explorer**. From here you can view the status of the individual role instances. <!-- keep by customization: begin --> For more information about the Azure Compute  node in Server Explorer, see [Viewing the State of a Cloud Service using Server Explorer](/documentation/articles/vs-azure-tools-viewing-the-state-of-a-cloud-service-using-server-explorer). <!-- keep by customization: end -->
