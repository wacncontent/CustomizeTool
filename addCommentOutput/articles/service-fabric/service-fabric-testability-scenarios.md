...
- Remove a Primary/Secondary replica or <!-- deleted by customization stateless --><!-- keep by customization: begin --> Stateless <!-- keep by customization: end --> instance
- Restart a Primary Secondary Replica <!-- deleted by customization (if --><!-- keep by customization: begin --> (If <!-- keep by customization: end --> persisted service)
