...
Service Fabric introduces a new kind of service that is stateful: <!-- deleted by customization a --><!-- keep by customization: begin --> A <!-- keep by customization: end --> service that can maintain state reliably within the service itself, co-located with the code that's using it. Your state ismade highly available by Service Fabric without the need to persist state to an external store.
...
Launch Visual Studio 2015 RC as **Administrator**, and create a new **Service Fabric Application** <!-- deleted by customization project --><!-- keep by customization: begin --> Project <!-- keep by customization: end --> named *HelloWorld*:

![Use the New Project dialog to create a new Service Fabric <!-- deleted by customization application](./media/service-fabric-reliable-services-quick-start/hello-stateless-NewProject.png) --><!-- keep by customization: begin --> Application](./media/service-fabric-reliable-services-quick-start/hello-stateless-NewProject.png) <!-- keep by customization: end -->
...
In <!-- keep by customization: begin --> the <!-- keep by customization: end --> this stateless service example, the count is stored in a local variable. But because this is a stateless service, the value that's being stored only exists for the current lifecycle of the service instance that it's in. When the service moves or restarts, the value is lost.
...
![Use the New Project dialog to create a new Service Fabric <!-- deleted by customization stateful service](./media/service-fabric-reliable-services-quick-start/hello-stateful-NewProject.png) --><!-- keep by customization: begin --> Stateful Service](./media/service-fabric-reliable-services-quick-start/hello-stateful-NewProject.png) <!-- keep by customization: end -->
