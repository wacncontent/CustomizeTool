...
* **Azure Service Bus**: An Azure Service Bus is for coordination of the work within the Azure Cloud Service. See [Service Bus <!-- deleted by customization Pricing](/home/features/service-bus/#price) --><!-- keep by customization: begin --> Pricing](/home/features/messaging/#price) <!-- keep by customization: end -->.
