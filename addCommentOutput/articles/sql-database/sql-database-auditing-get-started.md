...
The following section describes the configuration of auditing using the Azure <!-- deleted by customization Management --><!-- keep by customization: begin --> Preview <!-- keep by customization: end --> Portal. You may also [set up auditing for your database using the Classic Azure Management Portal].
...
The description in this section refers to screen captures above. Either [Azure <!-- deleted by customization Management --><!-- keep by customization: begin --> Preview <!-- keep by customization: end --> Portal](https://manage.windowsazure.cn) or [Classic Azure Management Portal](https://manage.windowsazure.cn/) may be used.
