...
- The [Export](/documentation/articles/sql-database-export) functionality in the <!-- deleted by customization [portal](https://manage.windowsazure.cn/) --><!-- keep by customization: begin --> [portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->.
...
1. In the Azure [portal](http://manage.windowsazure.cn/),
-->
