...
- An Azure account and subscription. You can sign up for a <!-- deleted by customization [trial](/pricing/1rmb-trial/) --><!-- keep by customization: begin --> [trial](http://wacn-ppe.chinacloudsites.cn/zh-cn/pricing/1rmb-trial/) <!-- keep by customization: end -->.
