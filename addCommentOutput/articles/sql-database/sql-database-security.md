...
```
CREATE USER ApplicationUser WITH PASSWORD = 'strong_password'; <!-- deleted by customization -- SQL Authentication -->
```
...
* [Stored <!-- deleted by customization procedures](https://msdn.microsoft.com/zh-cn/library/ms190782) --><!-- keep by customization: begin --> procedures](https://msdn.microsoft.com/zh-CN/library/ms190782) <!-- keep by customization: end --> can be used to limit the actions that can be taken on the database.
...
In addition to the above features and functionality that can help your application meet various security compliance requirements, Azure SQL Database also participates in regular audits and has been certified against a number of compliance standards. For more information, see the [Windows Azure Trust <!-- deleted by customization Center](http://azure.microsoft.com/support/trust-center/) --><!-- keep by customization: begin --> Center](/support/trust-center/) <!-- keep by customization: end -->, where you can find the most current list of [SQL Database compliance <!-- deleted by customization certifications](http://azure.microsoft.com/support/trust-center/services/) --><!-- keep by customization: begin --> certifications](/support/trust-center/services/) <!-- keep by customization: end -->.
