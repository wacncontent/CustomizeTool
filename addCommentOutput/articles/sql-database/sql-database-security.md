...
Managing databases and logical servers from the Azure Management Portal or using the Azure Resource Manager API is controlled by your portal user account's role assignments. For more information on this topic, see [Role-based access control in Azure <!-- deleted by customization Management Portal](/documentation/articles/role-based-access-control-configure) --><!-- keep by customization: begin --> Preview portal](/documentation/articles/role-based-access-control-configure) <!-- keep by customization: end -->.
