...
On Windows the <!-- deleted by customization [PortQry.exe](http://www.microsoft.com/download/details.aspx?id=17148) --><!-- keep by customization: begin --> [PortQry.exe](http://www.microsoft.com/zh-cn/download/details.aspx?id=17148) <!-- keep by customization: end --> utility might be helpful. Here is an example execution that queried the port situation on an Azure SQL Database server, and which was run on a laptop computer:
...
- Free [Book Download: Developer's Guide to Microsoft Enterprise Library, 2nd <!-- deleted by customization Edition](http://www.microsoft.com/download/details.aspx?id=41145) --><!-- keep by customization: begin --> Edition](http://www.microsoft.com/zh-cn/download/details.aspx?id=41145) <!-- keep by customization: end -->
