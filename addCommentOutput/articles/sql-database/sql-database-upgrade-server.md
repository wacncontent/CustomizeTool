<properties 
	pageTitle="Upgrade to Azure SQL Database V12 using PowerShell | Windows Azure" 
...
- **Upgrade all Web and Business databases**: See [Upgrade all Web and Business <!-- deleted by customization databases](/documentation/articles/sql-database-v12-upgrade#upgrade-all-web-and-business-databases) --><!-- keep by customization: begin --> databases](/documentation/articles/sql-database-v12-upgrade/#upgrade-all-web-and-business-databases) <!-- keep by customization: end --> section below or use [PowerShell to upgrade databases and server](/documentation/articles/sql-database-upgrade-server-powershell).
...
For more information, see [Azure SQL Database elastic database pool <!-- deleted by customization recommendations](/documentation/articles/sql-database-elastic-pool-portal#elastic-database-pool-pricing-tier-recommendations) --><!-- keep by customization: begin --> recommendations](/documentation/articles/sql-database-elastic-pool-portal/#elastic-database-pool-pricing-tier-recommendations) <!-- keep by customization: end --> and [Azure SQL Database picing tier recommendations](/documentation/articles/sql-database-service-tier-advisor).
...
- [Create an elastic database pool](/documentation/articles/sql-database-elastic-pool-portal) and add some or all of the databases into the pool.
