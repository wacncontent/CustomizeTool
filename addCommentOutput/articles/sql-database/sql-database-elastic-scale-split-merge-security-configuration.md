...
Certificates can be obtained from public Certificate Authorities (CAs) or from the [Windows Certificate <!-- deleted by customization Service](http://msdn.microsoft.com/zh-cn/library/windows/desktop/aa376539.aspx) --><!-- keep by customization: begin --> Service](https://msdn.microsoft.com/zh-CN/library/windows/desktop/aa376539.aspx) <!-- keep by customization: end -->. These are the preferred methods to obtain certificates.
...
* From a Developer Command Prompt for Visual Studios, see [Visual Studio Command <!-- deleted by customization Prompt](http://msdn.microsoft.com/zh-cn/library/ms229859.aspx) --><!-- keep by customization: begin --> Prompt](https://msdn.microsoft.com/zh-CN/library/ms229859.aspx) <!-- keep by customization: end -->
...
2. Select the cloud service <!-- deleted by customization. -->
3. On the top menu, click **Certificates**.
4. On the bottom bar, click **Upload**.
5. Select the certificate file <!-- deleted by customization. -->
6. If it is a .PFX file, enter the password for the private key <!-- deleted by customization. -->
7. Once completed, copy the certificate thumbprint from the new entry in the list <!-- deleted by customization. -->
-->
<!-- keep by customization: begin -->
1. Select Cloud Services
2. Select the cloud service <!-- deleted by customization. -->
