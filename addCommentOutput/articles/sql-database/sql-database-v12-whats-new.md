...
1. Go to the [Azure Management <!-- deleted by customization Portal](http://manage.windowsazure.cn/) --><!-- keep by customization: begin --> Portal](http://manage.windowsazure.cn) <!-- keep by customization: end -->.
2. Click **Browse**.
3. Click **SQL Servers**.
...
<!-- deleted by customization [Supplemental Terms of Use for Windows Azure Previews](http://azure.microsoft.com/support/legal/preview-supplemental-terms/). -->
