...
For [Real-Time Analytics](http://msdn.microsoft.com/zh-cn/library/dn817827.aspx) you combine In-Memory OLTP and Analytics to get:
...
- [Columnstore indexes](http://msdn.microsoft.com/zh-cn/library/dn817827.aspx) that are *on-disk*.
...
> [AZURE.NOTE] These in-Preview features are available only for [*Premium*](/documentation/articles/sql-database-service-tiers) Azure SQL databases, not for databases on the Standard or Basic service tier.
...
You can create the AdventureWorksLT [V12] sample database by a few clicks in the [Azure Management <!-- deleted by customization Portal](http://manage.windowsazure.cn/) --><!-- keep by customization: begin --> Portal](http://manage.windowsazure.cn) <!-- keep by customization: end -->. Then the steps in this section explain how you can enrich your AdventureWorksLT database with:
...
1. In the [Azure Management <!-- deleted by customization Portal](http://manage.windowsazure.cn/) --><!-- keep by customization: begin --> Portal](http://manage.windowsazure.cn) <!-- keep by customization: end -->, create a Premium database on a V12 server. Set the **Source** to the AdventureWorksLT [V12] sample database.
...
Ideally you would plan to run ostress.exe on an Azure VM. You would create an [Azure Virtual <!-- deleted by customization Machine](/documentation/services/virtual-machines/) --><!-- keep by customization: begin --> Machine](/documentation/services/virtual-machines) <!-- keep by customization: end --> in the same Azure geographic region where your AdventureWorksLT database resides. But you can run ostress.exe on your laptop instead.
...
The In-Memory OLTP features in Azure SQL Database became [active for preview on October 28, <!-- deleted by customization 2015](http://azure.microsoft.com/updates/public-preview-in-memory-oltp-and-real-time-operational-analytics-for-azure-sql-database/) --><!-- keep by customization: begin --> 2015](http://azure.microsoft.com/updates/public-preview-in-memory-oltp-and-real-time-operational-analytics-for-azure-sql-database) <!-- keep by customization: end -->.
...
- [Description of the Replay Markup Language (RML) Utilities for SQL <!-- deleted by customization Server](http://support.microsoft.com/kb/944837) --><!-- keep by customization: begin --> Server](http://support.microsoft.com/zh-cn/kb/944837) <!-- keep by customization: end -->
