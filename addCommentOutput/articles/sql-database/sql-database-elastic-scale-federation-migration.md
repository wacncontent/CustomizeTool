...
## <!-- deleted by customization Create --><!-- keep by customization: begin --> <a name="create-shard-map-manager"></a>Create <!-- keep by customization: end --> a Shard Map Manager from a federation root
