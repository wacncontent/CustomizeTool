...
**1) Ruby:** If your machine does not have Ruby please install it. For new ruby users, we recommend you use Ruby 2.1.X installers. These provide a stable language and a extensive list of packages (gems) that are compatible and updated. [Go the Ruby download <!-- deleted by customization page](http://rubyinstaller.org/downloads/) --><!-- keep by customization: begin --> page](http://rubyinstaller.org/downloads) <!-- keep by customization: end --> and download the appropriate 2.1.x installer. For example if you are on a 64 bit machine, download the **Ruby 2.1.6 (x64)** installer.
...
**2) DevKit:** Download DevKit from the [RubyInstaller <!-- deleted by customization page](http://rubyinstaller.org/downloads/) --><!-- keep by customization: begin --> page](http://rubyinstaller.org/downloads) <!-- keep by customization: end -->
