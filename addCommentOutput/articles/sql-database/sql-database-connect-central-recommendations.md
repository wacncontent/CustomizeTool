...
- [Guidelines for Connecting to Azure SQL Database Programmatically](http://msdn.microsoft.com/zh-cn/library/azure/ee336282.aspx) - discussions include the following:
 ...
 - Connection strings
- [Azure SQL Database Resource <!-- deleted by customization Management](https://msdn.microsoft.com/zh-cn/library/azure/dn338083.aspx) --><!-- keep by customization: begin --> Management](https://msdn.microsoft.com/zh-CN/library/azure/dn338083.aspx) <!-- keep by customization: end --> - discussions include the following:
 - Resource governance
...
- [Error messages for SQL Database client <!-- deleted by customization programs](/documentation/articles/sql-database-develop-error-messages#bkmk_connection_errors) --><!-- keep by customization: begin --> programs](/documentation/articles/sql-database-develop-error-messages/#bkmk_connection_errors) <!-- keep by customization: end -->
