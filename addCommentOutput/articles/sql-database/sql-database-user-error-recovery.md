...
You can learn more about these capabilities in this [blog <!-- deleted by customization post](http://azure.microsoft.com/blog/2014/10/01/azure-sql-database-point-in-time-restore/) --><!-- keep by customization: begin --> post](http://azure.microsoft.com/blog/2014/10/01/azure-sql-database-point-in-time-restore) <!-- keep by customization: end -->.
...
> [AZURE.NOTE] Restoring a database creates a new database. It is important to make sure the server you are restoring to has enough DTU capacity for the new database. You can request an increase of this quota by [contacting <!-- deleted by customization support](http://azure.microsoft.com/blog/azure-limits-quotas-increase-requests/) --><!-- keep by customization: begin --> support](http://azure.microsoft.com/blog/azure-limits-quotas-increase-requests) <!-- keep by customization: end -->.
