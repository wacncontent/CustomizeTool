...
- <!-- deleted by customization [http://manage.windowsazure.cn/](http://manage.windowsazure.cn/)<br/>This --><!-- keep by customization: begin --> [http://manage.windowsazure.cn](http://manage.windowsazure.cn/)<br/>This <!-- keep by customization: end --> Azure preview portal is new and is still at preview status. This portal is not quite yet at full General Availability (GA). This portal:
