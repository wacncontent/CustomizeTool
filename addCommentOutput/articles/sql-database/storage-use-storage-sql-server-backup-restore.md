...
* Storage Account: The storage account is the starting point for all storage services. To access an Azure Blob Storage service, first create an Azure Storage account. For more information about Azure Blob storage service, see [How to use the Azure Blob Storage <!-- deleted by customization Service](/documentation/articles/storage-dotnet-how-to-use-blobs/) --><!-- keep by customization: begin --> Service](/documentation/articles/storage-dotnet-how-to-use-blobs) <!-- keep by customization: end -->
