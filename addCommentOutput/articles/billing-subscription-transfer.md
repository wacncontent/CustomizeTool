...
<!-- deleted by customization You --><!-- keep by customization: begin --> If your account is in the US, you <!-- keep by customization: end --> can now do this easily in the Windows Azure Account Center- for Pay-As-You-Go <!-- deleted by customization, MSDN, Action Pack, or BizSpark --> subscriptions.  We've added the ability to transfer your subscription to another user. In other words, you can now change the account admin on any Pay-As-You-Go <!-- deleted by customization, MSDN, Action Pack, or BizSpark --> subscription that you own <!-- deleted by customization, no matter which country you operate in -->.
...
1. You are now the Account Administrator. Review and update the Service Administrator and Co-Administrators. Manage admins in the [Azure <!-- deleted by customization Management Portal](https://manage.windowsazure.cn) --><!-- keep by customization: begin --> management portal](https://manage.windowsazure.cn) <!-- keep by customization: end --> by going to Settings. [Learn more](https://msdn.microsoft.com/zh-cn/library/azure/hh531793.aspx).
2. You can also use role-based access control (RBAC) for your subscription and services. Visit the [Azure <!-- deleted by customization Management Portal](https://manage.windowsazure.cn) --><!-- keep by customization: begin --> preview portal](https://manage.windowsazure.cn) <!-- keep by customization: end --> [Learn more about RBAC](/documentation/articles/role-based-access-control-configure/)
3. Update credentials associated with this subscription's services. These include:
    -Management certificates that grant the user admin rights to subscription resources. For more information, see [Create and <!-- deleted by customization upload --><!-- keep by customization: begin --> Upload <!-- keep by customization: end --> a <!-- deleted by customization management certificate --><!-- keep by customization: begin --> Management Certificate <!-- keep by customization: end --> for Azure](https://msdn.microsoft.com/zh-cn/library/azure/gg551722.aspx)
    -	Access keys for services like Storage. For more information, see [View, copy, and regenerate storage access keys](/documentation/articles/storage-create-storage-account#view-copy-and-regenerate-storage-access-keys)
    -	Remote Access credentials for services like Azure Virtual Machines
