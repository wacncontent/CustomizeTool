...
- An application that will be configured to use the key or password that you create in this tutorial. A sample application is available from the [Microsoft Download <!-- deleted by customization Center](http://www.microsoft.com/download/details.aspx?id=45343) --><!-- keep by customization: begin --> Center](http://www.microsoft.com/zh-cn/download/details.aspx?id=45343) <!-- keep by customization: end -->. For instructions, see the accompanying Readme file.
...
5.	On the **Tell us about your application** page, specify a name for your application, and then select <!-- deleted by customization **WEB APPLICATION --><!-- keep by customization: begin --> **Web Site <!-- keep by customization: end --> AND/OR WEB API** (the default). Click the **Next** icon.
...
For more detailed instructions about how to generate this BYOK package, see [How to generate and transfer HSM-protected keys for Azure Key Vault](/documentation/articles/key-vault-hsm-protected-keys).
-->
...
For a follow-up tutorial that uses Azure Key Vault in a web site, see [Use Azure Key Vault from a <!-- deleted by customization web site](/documentation/articles/key-vault-use-from-web-application) --><!-- keep by customization: begin --> Web Site](/documentation/articles/key-vault-use-from-web-application) <!-- keep by customization: end -->.
