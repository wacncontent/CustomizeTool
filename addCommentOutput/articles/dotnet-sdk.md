...
* [Create PowerShell deployment scripts while creating new <!-- deleted by customization Websites](/documentation/articles/vs-azure-tools-publishing-using-powershell-scripts) --><!-- keep by customization: begin --> Websites](http://msdn.microsoft.com/zh-cn/library/dn642480.aspx) <!-- keep by customization: end -->.
...
* [Create PowerShell scripts while creating new virtual <!-- deleted by customization machines](/documentation/articles/vs-azure-tools-publishing-using-powershell-scripts) --><!-- keep by customization: begin --> machines](http://msdn.microsoft.com/zh-cn/library/dn642480.aspx) <!-- keep by customization: end -->.
