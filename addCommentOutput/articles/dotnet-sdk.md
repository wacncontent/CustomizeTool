...
If you don't have Visual Studio on your computer, the SDK will install [Visual Studio Express for <!-- deleted by customization Web](http://www.visualstudio.com/products/visual-studio-express-vs.aspx) --><!-- keep by customization: begin --> Web](http://www.visualstudio.com/zh-cn/products/visual-studio-express-vs.aspx) <!-- keep by customization: end -->.
...
* [Manage and troubleshoot Azure Websites in Server <!-- deleted by customization Explorer](/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio#sitemanagement) --><!-- keep by customization: begin --> Explorer](/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio/#sitemanagement) <!-- keep by customization: end -->.
* [Run in debug mode remotely for Websites and <!-- deleted by customization WebJobs](/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio#remotedebug) --><!-- keep by customization: begin --> WebJobs](/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio/#remotedebug) <!-- keep by customization: end -->.
...
This installs <!-- deleted by customization [AzCopy](/documentation/articles/storage-use-azcopy/) --><!-- keep by customization: begin --> [AzCopy](/documentation/articles/storage-use-azcopy) <!-- keep by customization: end -->, a command line tool you can use to transfer data into and out of an Azure Storage account.
...
* [Client libraries](http://www.nuget.org/packages?q=windowsazureofficial). 
	...
	**Project templates that include client libraries.** Only [Azure Cloud <!-- deleted by customization Service](/documentation/articles/cloud-services-dotnet-get-started) --><!-- keep by customization: begin --> Service](/documentation/articles/cloud-services-dotnet-get-started/) <!-- keep by customization: end --> and [Azure Mobile <!-- deleted by customization Service](/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard) --><!-- keep by customization: begin --> Service](/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-leaderboard/) <!-- keep by customization: end --> project templates automatically include some client libraries. For other libraries or other templates, install the [client library NuGet packages](http://www.nuget.org/packages?q=windowsazureofficial) that you need.
...
* You've installed the latest [Visual Studio <!-- deleted by customization Update](http://www.visualstudio.com/downloads/download-visual-studio-vs#DownloadFamilies_5) --><!-- keep by customization: begin --> Update](http://www.visualstudio.com/zh-cn/downloads/download-visual-studio-vs#DownloadFamilies_5) <!-- keep by customization: end -->.
...
For older versions see the [Azure SDK for <!-- deleted by customization .NET](/downloads/) --><!-- keep by customization: begin --> .NET](/downloads/?sdk=net) <!-- keep by customization: end --> downloads page.
...
To see which version is current or to download older versions, see the [Azure SDK for .NET Version <!-- deleted by customization History](/downloads/) --><!-- keep by customization: begin --> History](/downloads/?sdk=net) <!-- keep by customization: end --> page.
...
For Azure client library reference documentation, see [Azure .NET <!-- deleted by customization Reference](/documentation/api/) --><!-- keep by customization: begin --> Reference](http://azure.microsoft.com/zh-cn/documentation/api/) <!-- keep by customization: end -->.
