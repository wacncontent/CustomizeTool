...
In the example above we created a resource group called "appgw-RG" and location "China <!-- deleted by customization North" --><!-- keep by customization: begin --> East" <!-- keep by customization: end -->.
...
### Step 2	
	$vnet = New-AzureRmVirtualNetwork -Name appgwvnet -ResourceGroupName appgw-rg -Location "China <!-- deleted by customization North" --><!-- keep by customization: begin --> East" <!-- keep by customization: end --> -AddressPrefix 10.0.0.0/16 -Subnet $subnet

Creates a virtual network named "appgwvnet" in resource group "appw-rg" for the China <!-- deleted by customization North --><!-- keep by customization: begin --> East <!-- keep by customization: end --> region using the prefix 10.0.0.0/16 with subnet 10.0.0.0/24
...
## Create public IP address for front end configuration
	...
	$publicip = New-AzureRmPublicIpAddress -ResourceGroupName appgw-rg -name publicIP01 -location "China <!-- deleted by customization North" --><!-- keep by customization: begin --> East" <!-- keep by customization: end --> -AllocationMethod Dynamic

Creates a public IP resource "publicIP01" in resource group "appw-rg" for the China <!-- deleted by customization North --><!-- keep by customization: begin --> East <!-- keep by customization: end --> region.
...
## Create Application Gateway using New-AzureApplicationGateway
	...
	$appgw = New-AzureRmApplicationGateway -Name appgwtest -ResourceGroupName appw-rg -Location "China <!-- deleted by customization North" --><!-- keep by customization: begin --> East" <!-- keep by customization: end --> -BackendAddressPools $pool -BackendHttpSettingsCollection $poolSetting -FrontendIpConfigurations $fipconfig  -GatewayIpConfigurations $gipconfig -FrontendPorts $fp -HttpListeners $listener -RequestRoutingRules $rule -Sku $sku
