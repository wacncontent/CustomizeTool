...
<td colspan="5"><a HREF="http://go.microsoft.com/fwlink/p/?LinkID=304011"> Azure BizTalk Services Pricing</a> <br/><br/> <a <!-- deleted by customization HREF="/pricing/calculator/?scenario=full"> --><!-- keep by customization: begin --> HREF="http://azure.microsoft.com/pricing/calculator/?scenario=full"> <!-- keep by customization: end --> Azure Pricing Calculator</a></td>
</tr>
<tr>
...
- You control scale on-demand by simply requesting more or less capacity through the Azure <!-- deleted by customization Management Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end -->.
...
The BizTalk Adapter Service is used by an Azure BizTalk Service. The BizTalk Adapter Service uses the BizTalk Adapter Pack to connect to an on-premises Line of Business (LOB) system. A Hybrid Connection provides an easy and convenient way to connect Azure applications, like the <!-- deleted by customization web sites --><!-- keep by customization: begin --> Web Apps <!-- keep by customization: end --> feature in Azure <!-- deleted by customization Websites --><!-- keep by customization: begin --> App Service <!-- keep by customization: end --> and Azure Mobile Services, to an on-premises resource.
...
Use the backup and restore flow for migrating from one tier to another. Only some migration paths are supported. Refer to [BizTalk Services: Backup and <!-- deleted by customization Restore](/documentation/articles/biztalk-backup-restore) --><!-- keep by customization: begin --> Restore](biztalk-backup-restore.md) <!-- keep by customization: end --> for more details about the supported migration paths.
...
To create Azure BizTalk Services in the Azure <!-- deleted by customization Management Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end -->, go to [BizTalk Services: Provisioning using the Azure <!-- deleted by customization Management Portal](/documentation/articles/biztalk-provision-services) --><!-- keep by customization: begin --> portal](biztalk-provision-services.md) <!-- keep by customization: end -->. To start creating applications, go to [Azure BizTalk Services](http://go.microsoft.com/fwlink/p/?LinkID=235197).

## Additional resources
- [BizTalk Services: Provisioning using the Azure <!-- deleted by customization Management Portal](/documentation/articles/biztalk-provision-services)<br/> --><!-- keep by customization: begin --> portal](biztalk-provision-services.md)<br/> <!-- keep by customization: end -->
<!-- deleted by customization
- [BizTalk Services: Provisioning Status Chart](/documentation/articles/biztalk-service-state-chart)<br/>
- [BizTalk Services: Dashboard, Monitor and Scale <!-- deleted by customization tabs](/documentation/articles/biztalk-dashboard-monitor-scale-tabs)<br/> --><!-- keep by customization: begin --> tabs](biztalk-dashboard-monitor-scale-tabs.md)<br/> <!-- keep by customization: end -->
