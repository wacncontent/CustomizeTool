...
Statements in a formula are free-formed expressions. They can include any system-defined variables, user-defined variables, constant values, and supported operations on these variables or constants <!-- deleted by customization. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->
...
### Example 2 <!-- keep by customization: begin -->. <!-- keep by customization: end -->
