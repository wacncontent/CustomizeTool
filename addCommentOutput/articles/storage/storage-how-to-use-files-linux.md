...
The [Azure Management <!-- deleted by customization Portal](portal.azure.com) --><!-- keep by customization: begin --> portal](https://manage.windowsazure.cn/) <!-- keep by customization: end --> provides a user interface for managing Azure File Storage. You can perform the following actions from your web browser:
