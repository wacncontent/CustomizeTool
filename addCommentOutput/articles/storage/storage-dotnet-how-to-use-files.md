...
You can create Azure file shares using <!-- deleted by customization the Azure preview portal, --> the Azure Storage PowerShell cmdlets, the Azure Storage client libraries, or the Azure Storage REST API. Additionally, because file shares are SMB shares, you can access them via standard and familiar file system APIs.
...
- Use the Azure <!-- deleted by customization Storage Client Library --><!-- keep by customization: begin --> storage client library <!-- keep by customization: end --> for .NET to access the file share from an <!-- deleted by customization on-premises --><!-- keep by customization: begin --> on-premise <!-- keep by customization: end --> application. Create a console application and perform these actions with the file share:
...
Replace `storage-account-name` and `storage-account-key` with your storage account name and key in the following example <!-- deleted by customization. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->
...
Now upload a local file to the directory. The following example uploads a file from `C:\temp\Log1.txt`. Edit the file path so that it points to a valid file on your local machine <!-- deleted by customization. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->
...
1. First, create a new Azure virtual machine by following the instructions in [Create a <!-- deleted by customization virtual machine running --><!-- keep by customization: begin --> Virtual Machine Running <!-- keep by customization: end --> Windows Server](/documentation/articles/virtual-machines-windows-tutorial).
2. Next, remote into the virtual machine by following the instructions in [How to <!-- deleted by customization log --><!-- keep by customization: begin --> Log <!-- keep by customization: end --> on to a <!-- deleted by customization virtual machine running --><!-- keep by customization: begin --> Virtual Machine Running <!-- keep by customization: end --> Windows Server](/documentation/articles/virtual-machines-log-on-windows-server).
3. Open a PowerShell window on the virtual machine.

### Persist your storage account credentials for the virtual machine

Before mounting to the file share, first persist your storage account credentials on the virtual machine. This step allows Windows to automatically reconnect to the file share when the virtual machine reboots. To persist your account credentials, run the `cmdkey` command from the PowerShell window on the virtual machine. Replace `<storage-account-name>` with the name of your storage account, and `<storage-account-key>` with your storage account key <!-- deleted by customization. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->
...
To work with File storage programmatically, you can use the storage client libraries for .NET and Java, or the Azure Storage REST API. The example in this section demonstrates how to work with a file share by using the [Azure .NET Storage Client <!-- deleted by customization Library](https://msdn.microsoft.com/zh-cn/library/wa_storage_30_reference_home.aspx&clcid=0x409) --><!-- keep by customization: begin --> Library](https://msdn.microsoft.com/zh-cn/library/wa_storage_30_reference_home.aspx) <!-- keep by customization: end --> from a simple console application running on the desktop.
...
The example here shows how to retrieve your credentials using the `CloudConfigurationManager` class and encapsulate them with the `CloudStorageAccount` class. Add the following code to the `Main()` method in program.cs <!-- deleted by customization. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->
...
Beginning with version 5.x of the Azure <!-- deleted by customization Storage Client Library --><!-- keep by customization: begin --> storage client library <!-- keep by customization: end -->, you can set set the quota (or maximum size) for a file share, in gigabytes. You can also check to see how much data is currently stored on the share.
...
For more information about creating and using shared access signatures, see [Shared Access Signatures: Understanding the SAS <!-- deleted by customization model](/documentation/articles/storage-dotnet-shared-access-signature-part-1) --><!-- keep by customization: begin --> Model](/documentation/articles/storage-dotnet-shared-access-signature-part-1) <!-- keep by customization: end --> and [Create and use a SAS with the Blob <!-- deleted by customization service](/documentation/articles/storage-dotnet-shared-access-signature-part-2) --><!-- keep by customization: begin --> Service](/documentation/articles/storage-dotnet-shared-access-signature-part-2) <!-- keep by customization: end -->.
...
You can enable metrics for File storage from the <!-- deleted by customization Azure --> Management <!-- deleted by customization Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end -->. You can also enable metrics programmatically by calling the Set File Service Properties operation via the REST API, or one of its analogues in the Storage Client Library.
