...
- An Azure account. You can sign up for an Azure account at <!-- deleted by customization <http://www.azure.com> --><!-- keep by customization: begin --> <http://www.windowsazure.cn> <!-- keep by customization: end -->.
