...
This article has provided code samples that show how to handle common scenarios for working with Azure tables. For more information about how to use Azure WebJobs and the WebJobs SDK, see [Azure WebJobs Recommended <!-- deleted by customization Resources](/documentation/articles/websites-webjobs-resources/) --><!-- keep by customization: begin --> Resources](/documentation/articles/websites-webjobs-resources) <!-- keep by customization: end -->.