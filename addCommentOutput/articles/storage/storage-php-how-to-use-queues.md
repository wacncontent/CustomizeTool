...
For accessing a live service:
	...
	<!-- deleted by customization DefaultEndpointsProtocol=[http|https];AccountName=[yourAccount];AccountKey=[yourKey] --><!-- keep by customization: begin --> DefaultEndpointsProtocol=[http|https];AccountName=[yourAccount];AccountKey=[yourKey];EndpointSuffix=core.chinacloudapi.cn <!-- keep by customization: end -->
