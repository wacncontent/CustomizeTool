...
1. Make sure the namespace declarations at the top of the C# file include these <!-- deleted by customization **using** --><!-- keep by customization: begin --> `using` <!-- keep by customization: end --> statements.
...
To add an entity to a table you<!-- keep by customization: begin -->, <!-- keep by customization: end --> create a class that defines the properties of your entity. The following code defines an entity class called **CustomerEntity** that uses the customer's first name as the row key and  last name as the partition key.
-->
<!-- keep by customization: begin -->
##Add an entity to a table

To add an entity to a table <!-- keep by customization: begin -->, <!-- keep by customization: end --> create a class that defines the properties of your entity. The following code defines an entity class called `CustomerEntity` that uses the customer's first name as the row key and the last name as the partition key.
<!-- keep by customization: end -->
...
Table operations involving entities are done using the <!-- deleted by customization **CloudTable** --><!-- keep by customization: begin --> `CloudTable` <!-- keep by customization: end --> object you created earlier in "Access tables in code." The <!-- deleted by customization **TableOperation** --><!-- keep by customization: begin --> `TableOperation` <!-- keep by customization: end --> object represents the operation to be done. The following code example shows how to create a <!-- deleted by customization **CloudTable** --><!-- keep by customization: begin --> `CloudTable` <!-- keep by customization: end --> object and a <!-- deleted by customization **CustomerEntity** --><!-- keep by customization: begin --> `CustomerEntity` <!-- keep by customization: end --> object. To prepare the operation, a <!-- deleted by customization **TableOperation** --><!-- keep by customization: begin --> `TableOperation` <!-- keep by customization: end --> is created to insert the customer entity into the table. Finally, the operation is executed by calling CloudTable.ExecuteAsync.
...
<!-- deleted by customization
## Delete an entity
You can delete an entity after you find it. The following code looks for a customer entity named "Ben Smith" <!-- deleted by customization, --> and if it finds it, it deletes it.
