...
The <!-- deleted by customization Windows --> Azure Storage Data Movement library preview is now available for download via [Nuget](https://www.nuget.org/packages/Microsoft.Azure.Storage.DataMovement). The Data Movement Library is the core library underlying AzCopy. Source code is available on [GitHub](https://github.com/Azure/azure-storage-net-data-movement). For more information, see [Introducing Azure Storage Data Movement Library <!-- deleted by customization Preview](https://azure.microsoft.com/blog/introducing-azure-storage-data-movement-library-preview-2/). --><!-- keep by customization: begin --> Preview] (https://azure.microsoft.com/zh-cn/blog/introducing-azure-storage-data-movement-library-preview-2/) <!-- keep by customization: end -->
...
| <!-- deleted by customization [V3.2.0](http://xdmrelease.blob.core.chinacloudapi.cn/azcopy-3-2-0/MicrosoftAzureStorageTools.msi) --><!-- keep by customization: begin --> [**V3.2.0**](http://xdmrelease.blob.core.chinacloudapi.cn/azcopy-3-2-0/MicrosoftAzureStorageTools.msi) <!-- keep by customization: end -->  | Supports Append Blob and FIPS compliant MD5 Setting | V5.0.0 | 2015-02-21
...
- [DML: Introducing azure storage data movement library preview] <!-- deleted by customization (https://azure.microsoft.com/blog/introducing-azure-storage-data-movement-library-preview-2/) --><!-- keep by customization: begin --> (https://azure.microsoft.com/zh-cn/blog/introducing-azure-storage-data-movement-library-preview-2/) <!-- keep by customization: end -->
