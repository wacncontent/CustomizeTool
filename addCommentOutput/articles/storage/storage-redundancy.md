...
>[AZURE.NOTE]  ZRS is currently available only for block blobs <!-- deleted by customization, and is supported only in versions 2014-02-14 and later -->. Note that once you have created your storage account and selected zone-redundant replication, you cannot convert it to use <!-- keep by customization: begin --> to <!-- keep by customization: end --> any other type of replication, or vice versa.
