...
To dequeue a message, use <!-- deleted by customization **getMessages** --><!-- keep by customization: begin --> **getMessage** <!-- keep by customization: end -->. This makes the <!-- deleted by customization messages --><!-- keep by customization: begin --> message <!-- keep by customization: end --> invisible in the queue, so no other clients can process <!-- deleted by customization them --><!-- keep by customization: begin --> it <!-- keep by customization: end -->. Once your application has processed <!-- deleted by customization a --><!-- keep by customization: begin --> the <!-- keep by customization: end --> message, call **deleteMessage** to delete it from the queue. The following example gets a message, then deletes it:
...
> [AZURE.NOTE]
> Using <!-- deleted by customization **getMessages** --><!-- keep by customization: begin --> <b>getMessages</b> <!-- keep by customization: end --> when there are no messages in the queue will not return an error, however no messages will be returned.
