...
The Storage Service also includes support for additional conditional headers such as **If-Modified-Since**, **If-Unmodified-Since** and **If-None-Match** as well as combinations thereof. For more information see [Specifying Conditional Headers for Blob Service <!-- deleted by customization Operations](http://msdn.microsoft.com/zh-cn/library/azure/dd179371.aspx) --><!-- keep by customization: begin --> Operations](http://msdn.microsoft.com/zh-cn/library/dd179371.aspx) <!-- keep by customization: end --> on MSDN.
