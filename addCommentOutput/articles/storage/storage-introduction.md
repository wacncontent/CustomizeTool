...
You can get started with Azure with a [trial](/pricing/1rmb-trial/). Once you decide to purchase a plan, you can choose from a variety of [purchase options](/pricing/overview/). If you’re an [MSDN <!-- deleted by customization subscriber](http://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/) --><!-- keep by customization: begin --> subscriber](/pricing/member-offers/msdn-benefits-details/) <!-- keep by customization: end -->, you get free monthly credits that you can use with Azure services, including Azure Storage.
...
The [Storage Pricing <!-- deleted by customization Details](/home/features/storage/#price) --><!-- keep by customization: begin --> Details](/home/features/storage) <!-- keep by customization: end --> page provides detailed pricing information for storage capacity, replication, and transactions. The [Data Transfers Pricing <!-- deleted by customization Details](/home/features/data-transfers/#price) --><!-- keep by customization: begin --> Details](/#pricepricing/details/data-transfers/) <!-- keep by customization: end --> provides detailed pricing information for data egress. You can use the [Azure Storage Pricing <!-- deleted by customization Calculator](http://azure.microsoft.com/pricing/calculator/?scenario=data-management) --><!-- keep by customization: begin --> Calculator](/pricing/calculator/?scenario=data-management) <!-- keep by customization: end --> to help estimate your costs.
