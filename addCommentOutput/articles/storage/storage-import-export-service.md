...
- In shipping your packages, you must follow the terms at [Windows Azure Service <!-- deleted by customization Terms](http://azure.microsoft.com/support/legal/services-terms/) --><!-- keep by customization: begin --> Terms](/support/legal/services-terms/) <!-- keep by customization: end -->.
