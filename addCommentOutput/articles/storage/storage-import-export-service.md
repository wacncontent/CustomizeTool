...
- By using the [Azure Management Portal](portal.azure.com).
-->
<!-- keep by customization: begin -->
- By using the Azure Management Portal(https://manage.windowsazure.cn).
<!-- keep by customization: end -->
- By using a REST interface to the service.

This article provides an overview of the Import/Export service and describes how to use the <!-- deleted by customization [Azure Management Portal](portal.azure.com) --><!-- keep by customization: begin --> [Management Portal](https://manage.windowsazure.cn) <!-- keep by customization: end --> to work with the Import/Export service. For information on the REST API, see the [Azure Import/Export Service REST API <!-- deleted by customization Reference](https://msdn.microsoft.com/zh-cn/library/dn529096.aspx) --><!-- keep by customization: begin --> Reference](http://msdn.microsoft.com/zh-cn/library/dn529096.aspx) <!-- keep by customization: end -->.
...
## Create an Import Job in the <!-- deleted by customization Azure --> Management Portal##
...
Before you create an import job, prepare your drives with the Windows Azure Import/Export Tool. For more details about using the Windows Azure Import/Export Tool, see the [Windows Azure Import/Export Tool <!-- deleted by customization Reference](https://msdn.microsoft.com/zh-cn/library/dn529093.aspx) --><!-- keep by customization: begin --> Reference](http://msdn.microsoft.com/zh-cn/library/dn529096.aspx) <!-- keep by customization: end -->. You can download the [Windows Azure Import/Export Tool](http://download.microsoft.com/download/0/C/D/0CD6ABA7-024F-4202-91A0-CE2656DCE413/WAImportExport.zip) as a standalone package.
...
1.	Once you have prepared your drive, navigate to your storage account in the <!-- deleted by customization [Azure Management Portal](portal.azure.com) --><!-- keep by customization: begin --> [Management Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->, and view the Dashboard. Under **Quick Glance**, click **Create an Import Job**.
...
7. To enter your tracking number after you have shipped your package, return to the **Import/Export** page for your storage account in the <!-- deleted by customization [Azure Management Portal](portal.azure.com) --><!-- keep by customization: begin --> [Management Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->, select your job from the list, and choose **Shipping Info**. Navigate through the wizard and enter your tracking number in Step 2.
...
## Create an Export Job in the <!-- deleted by customization Azure --> Management Portal##
...
1. To create an export job, navigate to your storage account in the <!-- deleted by customization [Azure Management Portal](portal.azure.com) --><!-- keep by customization: begin --> [Management Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->, and view the Dashboard. Under **Quick Glance**, click **Create an Export Job**, and proceed through the wizard.
...
6. To enter your tracking number after you have shipped your package, return to the **Import/Export** page for your storage account in the <!-- deleted by customization [Azure Management Portal](portal.azure.com) --><!-- keep by customization: begin --> [Management Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->, select your job from the list, and choose **Shipping Info**. Navigate through the wizard and enter your tracking number in Step 2.
...
## Track Job Status in the <!-- deleted by customization Azure --> Management Portal##

You can track the status of your import or export jobs from the <!-- deleted by customization [Azure Management Portal](portal.azure.com) --><!-- keep by customization: begin --> [Management Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->. Navigate to your storage account in the Management Portal, and click the **Import/Export** tab. A list of your jobs will appear on the page. You can filter the list on job status, job name, job type, or tracking number.
...
- See the [pricing <!-- deleted by customization page](/home/features/storage-import-export/#price) --><!-- keep by customization: begin --> page](/pricing/overview/) <!-- keep by customization: end --> for pricing information.
...
> [AZURE.NOTE] If you have a converter which is not listed above, you can try running the Windows Azure Import/Export Tool using your converter to prepare the drive and see if it works before purchasing a supported converter.
...
**How long can I view the status of completed jobs in the <!-- deleted by customization Azure --> Management Portal?**
...
- In shipping your packages, you must follow the terms at [Windows Azure Service <!-- deleted by customization Terms](/legal/services-terms/) --><!-- keep by customization: begin --> Terms](/support/legal/services-terms/) <!-- keep by customization: end -->.
