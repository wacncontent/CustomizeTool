...
The [Azure <!-- deleted by customization pricing](/home/features/#storage/#price) --><!-- keep by customization: begin --> pricing](/home/feature/storage#price) <!-- keep by customization: end --> page provides detailed pricing information for storage capacity, replication, and transactions. The [Data <!-- deleted by customization transfers pricing details](/home/features/data-transfers/#price) --><!-- keep by customization: begin --> Transfers Pricing Details](/home/features/data-transfers/#price) <!-- keep by customization: end --> page provides detailed pricing information for data egress.
...
<!-- keep by customization: end -->
	...
	>  
	> Your storage account name must be unique within Azure. The <!-- deleted by customization Azure Management Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end --> will indicate if the storage account name you select is already taken.
...
- To learn more about Azure Storage, see the Azure Storage documentation on <!-- deleted by customization [Azure.com](/documentation/services/storage/) --><!-- keep by customization: begin --> [windowsazure.cn](/documentation/services/storage/) <!-- keep by customization: end --><!-- keep by customization: begin --> and on [MSDN](http://msdn.microsoft.com/zh-cn/library/azure/gg433040.aspx) <!-- keep by customization: end -->.
