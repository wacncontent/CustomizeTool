...
-	See [Azure Storage replication](/documentation/articles/storage-redundancy) and the blog post <!-- deleted by customization [Azure --><!-- keep by customization: begin --> [Windows Azure <!-- keep by customization: end --> Storage Redundancy Options and Read Access Geo Redundant Storage](http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/11/introducing-read-access-geo-replicated-storage-ra-grs-for-windows-azure-storage.aspx) for information about storage redundancy options.
...
Both of these technologies can help you avoid unnecessary load (and bottlenecks) on your web site.  
...
For more information, see the article [An Overview of Performance Improvements in .NET <!-- deleted by customization 4.5](http://msdn.microsoft.com/magazine/hh882452.aspx) --><!-- keep by customization: begin --> 4.5](http://msdn.microsoft.com/zh-cn/magazine/hh882452.aspx) <!-- keep by customization: end -->.
...
For more information, see [Copy <!-- deleted by customization Blob](http://msdn.microsoft.com/zh-cn/library/azure/dd894037.aspx) --><!-- keep by customization: begin --> Blob](http://msdn.microsoft.com/zh-cn/library/dd894037.aspx) <!-- keep by customization: end -->.
...
For up to date cost information, see [Storage Pricing <!-- deleted by customization Details](/home/features/storage/#price) --><!-- keep by customization: begin --> Details](/home/features/storage#price) <!-- keep by customization: end -->.
