...
<li>Learn how to simplify the code you write to work with Azure Storage by using the <a <!-- deleted by customization href="/documentation/articles/websites-dotnet-webjobs-sdk">Azure --><!-- keep by customization: begin --> href="/documentation/articles/websites-dotnet-webjobs-sdk/">Azure <!-- keep by customization: end --> WebJobs SDK</a>.</li>
