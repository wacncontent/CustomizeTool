...
In the [Azure  portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , click **New**, click **Web + mobile**, and then click **Web App**, **Mobile App**,  or  **API App**  or **Logic App** .

...
You can move an app to a different app service plan in the [Azure  portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) . You can move apps between plans as long as the plans are in the same resource group and geographical region.
...
Cloning has some limitations that you can read about at [Azure App Service App cloning using Azure  portal](/documentation/articles/app-service-web-app-cloning-portal/)  Portal Preview](/documentation/articles/app-service-web-app-cloning-portal/) .
