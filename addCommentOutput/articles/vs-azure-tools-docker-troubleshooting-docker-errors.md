...
A: See [Hosting <!-- deleted by customization web sites --><!-- keep by customization: begin --> Web Sites <!-- keep by customization: end --> in Docker](/documentation/articles/vs-azure-tools-docker-hosting-web-apps-in-docker) for information on how to do this.
...
A:  See the section **Provide a Custom Docker Host** in the topic, [Hosting <!-- deleted by customization web sites --><!-- keep by customization: begin --> Web Sites <!-- keep by customization: end --> in Docker](/documentation/articles/vs-azure-tools-docker-hosting-web-apps-in-docker).
