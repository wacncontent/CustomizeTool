...
3. Copy the following code into the new **Notifications** class:
	...
	For more information on templates, see [Templates](/documentation/articles/notification-hubs-templates).
