...
* Follow the [Get started tutorial](/documentation/articles/notification-hubs-ios-get-started) for your mobile platform of choice, implementing the back-end portion in PHP.
...
All the details to implement a full REST wrapper can be found on [MSDN](http://msdn.microsoft.com/zh-cn/library/dn530746.aspx). In this section we will describe the PHP implementation of the main steps required to access Notification Hubs REST endpoints:
...
<!-- keep by customization: begin --><!-- <!-- keep by customization: end --> For more information, see also the [PHP Developer Center](/develop/php/). <!-- keep by customization: begin --> --><!-- keep by customization: end -->

[PHP REST wrapper sample]: https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-php
[Get started tutorial]: <!-- deleted by customization /documentation/articles/notification-hubs-ios-get-started/ --><!-- keep by customization: begin --> /documentation/articles/notification-hubs-ios-get-started <!-- keep by customization: end -->
