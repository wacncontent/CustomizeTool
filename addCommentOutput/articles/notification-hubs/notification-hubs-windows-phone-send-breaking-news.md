...
This topic shows you how to use Azure Notification Hubs to broadcast breaking news notifications to a Windows Phone 8.0/8.1 Silverlight app. If you are targeting Windows Store or Windows Phone 8.1 app, please refer to to the [Windows <!-- deleted by customization Universal](/documentation/articles/notification-hubs-windows-store-dotnet-send-breaking-news) --><!-- keep by customization: begin --> Universal](/documentation/articles/notification-hubs-windows-store-dotnet-send-breaking-news/) <!-- keep by customization: end --> version. When complete, you will be able to register for breaking news categories you are interested in, and receive only push notifications for those categories. This scenario is a common pattern for many apps where notifications have to be sent to groups of users that have previously declared interest in them, e.g. RSS reader, apps for music fans, etc.
...
3. Copy the following code into the new **Notifications** class:
    ...
    This class uses the isolated storage to store the categories of news that this device is to receive. It also contains methods to register for these categories using a [template](/documentation/articles/notification-hubs-templates) notification registration.
...
[Use Notification Hubs to broadcast localized breaking news]: <!-- deleted by customization ../breakingnews-localized-wp8.md --><!-- keep by customization: begin --> ./breakingnews-localized-wp8.md <!-- keep by customization: end -->
...
<!-- deleted by customization [Notification Hubs How-To for Windows Phone]: ?? -->
<!-- keep by customization: begin -->
