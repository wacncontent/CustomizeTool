...
If you don't have access to Visual Studio, you can skip to the next section and send notifications from the app itself. You can also send the proper template notification from the [Azure Management Portal] using the debug tab for your notification hub. 
...
[Use Notification Hubs to broadcast localized breaking news]: <!-- deleted by customization notification-hubs-ios-send-localized-breaking-news.md --><!-- keep by customization: begin --> /documentation/articles/notification-hubs-ios-send-localized-breaking-news/ <!-- keep by customization: end -->
...
<!-- deleted by customization [Azure Management Portal]: https://manage.windowsazure.cn -->
