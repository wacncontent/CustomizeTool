...
<!-- deleted by customization ##Compiling --><!-- keep by customization: begin --> ##<a name="compiling"></a>Compiling <!-- keep by customization: end --> the schema by using the Microsoft Avro Library
...
<!-- deleted by customization ###Sample --><!-- keep by customization: begin --> ###<a name="Scenario3"></a>Sample <!-- keep by customization: end --> 3: Serialization using object container files and serialization with reflection
...
<!-- deleted by customization ###Sample --><!-- keep by customization: begin --> ###<a name="Scenario4"></a>Sample <!-- keep by customization: end --> 4: Serialization using object container files and serialization with generic record
...
<!-- deleted by customization ###Sample --><!-- keep by customization: begin --> ###<a name="Scenario5"></a>Sample <!-- keep by customization: end --> 5: Serialization using object container files with a custom compression codec
...
<!-- deleted by customization ###Sample --><!-- keep by customization: begin --> ###<a name="Scenario6"></a>Sample <!-- keep by customization: end --> 6: Using Avro to upload data for the Windows Azure HDInsight service
