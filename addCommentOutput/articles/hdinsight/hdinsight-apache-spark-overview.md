...
| Ease of use                     | Spark in HDInsight clusters includes Zeppelin and Jupyter notebooks pre-configured. You can use these for interactive data processing and visualization. <!-- deleted by customization The URLs for --><!-- keep by customization: begin --> You can launch <!-- keep by customization: end --> these notebooks <!-- deleted by customization are https://CLUSTERNAME.azurehdinsight.cn/zeppelin and https://CLUSTERNAME.azurehdinsight.cn/jupyter. Replace __CLUSTERNAME__ with --><!-- keep by customization: begin --> from <!-- keep by customization: end --> the <!-- deleted by customization name of your HDInsight --><!-- keep by customization: begin --> cluster dashboard to work directly against a Spark <!-- keep by customization: end --> cluster.|
