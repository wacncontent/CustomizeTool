...
To view the logs, see [Access YARN application logs on  Linux-based HDInsight](/documentation/articles/hdinsight-hadoop-access-yarn-app-logs-linux/)  Windows-based HDInsight](/documentation/articles/hdinsight-hadoop-access-yarn-app-logs/) .
