...
1. Determine the host name for the primary headnode:
    ...
    1. Use SSH to connect to the cluster on port 22. For example, `ssh USERNAME@CLUSTERNAME-ssh.azurehdinsight.cn` where __USERNAME__ is your SSH user name and __CLUSTERNAME__ is the name of your cluster.
