...
1. From the [Azure Classic Management Portal](https://manage.windowsazure.cn), select **NEW** > __APP SERVICES__ > **SERVICE BUS** > **EVENT HUB** > **CUSTOM CREATE**.
...
1. From the [Azure Classic Management Portal](https://manage.windowsazure.cn), select **NEW** > **Data Services** > **Storage** > **Quick Create**.
