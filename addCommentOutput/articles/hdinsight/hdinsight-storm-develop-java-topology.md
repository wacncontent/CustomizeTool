...
Trident applications can be created by using Maven projects. You use the same basic steps as presented earlier in this  article—only  article-only  the code is different.
