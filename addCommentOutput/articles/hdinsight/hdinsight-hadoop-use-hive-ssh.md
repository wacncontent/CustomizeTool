...
3. Using the CLI, enter the following statements to create a new table named **log4jLogs** by using the sample data:
        ...
        SELECT t4 AS sev, COUNT(*) AS count FROM log4jLogs WHERE t4 = '[ERROR]' <!-- deleted by customization AND INPUT__FILE__NAME LIKE '%.log' --> GROUP BY t4;
...
4. Use the following statements to create a new 'internal' table named **errorLogs**:
        ...
        INSERT OVERWRITE TABLE errorLogs SELECT t1, t2, t3, t4, t5, t6, t7 FROM log4jLogs WHERE t4 = '[ERROR]' <!-- deleted by customization AND INPUT__FILE__NAME LIKE '%.log' -->;
...
[import-to-excel]: <!-- deleted by customization /documentation/articles/hdinsight-connect-excel-power-query/ --><!-- keep by customization: begin --> /documentation/articles/hdinsight-connect-excel-power-query <!-- keep by customization: end -->
