...
##  <a id="powershell"></a>  Access blobs using Azure PowerShell
...

	...
	# Use  Add-AzureAccount  Import-AzurePublishSettingsFile  if you haven't connected to your Azure subscription

