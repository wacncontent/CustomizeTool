...
Script Actions are scripts that run during cluster provisioning, and can be used to install additional components on the cluster.  For Linux-based clusters, these  These  are  Bash  PowerShell  scripts.
...
*  [R](/documentation/articles/hdinsight-hadoop-r-scripts-linux/)  [R](/documentation/articles/hdinsight-hadoop-r-scripts/) : An open-source language and environment for statistical computing used in machine learning.
...
For information on developing your own Script Actions, see [Script Action development with  HDInsight](/documentation/articles/hdinsight-hadoop-script-actions-linux/)  HDInsight](/documentation/articles/hdinsight-hadoop-script-actions/) .
...
* Integration with other Azure services, including [Web  apps](/documentation/services/app-service/web/)  apps](/documentation/services/web-sites/)  and [SQL Database](/documentation/services/sql-databases/).
...
* Low entry cost. Start a  [trial](https://azure.microsoft.com/free/)  [trial](/pricing/1rmb-trial/) , or consult [HDInsight pricing details](/pricing/details/hdinsight/).
...

* [Get started with Spark in HDInsight](/documentation/articles/hdinsight-apache-spark-jupyter-spark-sql/): A quick-start tutorial for creating a Spark cluster and running interactive Spark SQL queries.

* [Use R Server on HDInsight](/documentation/articles/hdinsight-hadoop-r-server-get-started/): Start using R Server in HDInsight Premium.
...
* [Connect Excel to Hadoop with Power Query](/documentation/articles/hdinsight-connect-excel-power-query/): Learn how to connect Excel to the Azure Storage account that stores the data associated with your HDInsight cluster by using Microsoft Power Query for Excel. Windows workstation required. Works with  Windows- or Linux-based  Windows-based  cluster.

* [Connect Excel to Hadoop with the Microsoft Hive ODBC Driver](/documentation/articles/hdinsight-connect-excel-hive-ODBC-driver/): Learn how to import data from HDInsight with the Microsoft Hive ODBC Driver. Windows workstation required. Works with  Windows- or Linux-based  Windows-based  cluster.

