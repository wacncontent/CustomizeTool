...
2. In the next screen, click **Browse Repositories** from the lower left corner. In the **Browse Repositories** dialog box that opens, search for **HDInsight**, select the  **Azure  **Microsoft Azure  HDInsight Tools for IntelliJ**, and then click **Install**.
