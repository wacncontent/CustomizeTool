...
1. Using the Python examples [streaming.py](#streamingpy) and  [pig_python.py](#jythonpy)  pig_python.py , create local copies of the files on your development machine.
