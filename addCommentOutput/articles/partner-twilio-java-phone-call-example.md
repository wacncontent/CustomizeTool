<properties 
	pageTitle="How to Make a phone call from Twilio (Java) | Windows Azure" 
...
Additionally, familiarity with the information at [Creating a Hello World Application Using the Azure <!-- deleted by customization Toolkit --><!-- keep by customization: begin --> Plugin <!-- keep by customization: end --> for <!-- deleted by customization Eclipse][azure_java_eclipse_hello_world] --><!-- keep by customization: begin --> Eclipse with Java (by Microsoft Open Technologies)][azure_java_eclipse_hello_world] <!-- keep by customization: end -->, or with other techniques for hosting Java applications in Azure if you are not using Eclipse, is highly recommended.
...
## Run the application
Following are the high-level steps to run your application; details for these steps can be found at [Creating a Hello World Application Using the Azure <!-- deleted by customization Toolkit --><!-- keep by customization: begin --> Plugin <!-- keep by customization: end --> for <!-- deleted by customization Eclipse][azure_java_eclipse_hello_world] --><!-- keep by customization: begin --> Eclipse with Java (by Microsoft Open Technologies)][azure_java_eclipse_hello_world] <!-- keep by customization: end -->.
...
* Instead of using a web form, you could use Azure storage blobs or SQL <!-- deleted by customization Database --><!-- keep by customization: begin --> 数据库 <!-- keep by customization: end --> to store phone numbers and call text. For information about using Azure storage blobs in Java, see [How to Use the Blob Storage Service from Java][howto_blob_storage_java]. For information about using SQL <!-- deleted by customization Database --><!-- keep by customization: begin --> 数据库 <!-- keep by customization: end --> in Java, see [Using SQL <!-- deleted by customization Database --><!-- keep by customization: begin --> 数据库 <!-- keep by customization: end --> in Java][howto_sql_azure_java].
...
[azure_java_eclipse_hello_world]: http://msdn.microsoft.com/zh-cn/library/azure/hh690944.aspx
...
<!-- keep by customization: end -->
[howto_sql_azure_java]: http://msdn.microsoft.com/zh-cn/library/azure/hh749029.aspx
[azure_runtime_jsp]: http://msdn.microsoft.com/zh-cn/library/azure/hh690948.aspx
