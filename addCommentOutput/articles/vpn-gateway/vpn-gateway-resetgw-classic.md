...
After two reboots, if you are still experiencing cross-premises connectivity problems, please open a  support  [support   ticket from the Azure Classic Management Portal  ticket](/support/support-ticket-form/?l=zh-cn)  to contact Azure Support.
