...
You may be able to use VNet peering to create your connection, as long as your virtual network configuration meets certain requirements. VNet peering does not use a virtual network gateway. [VNet peering](/documentation/articles/virtual-network-peering-overview/) is currently in Preview.
