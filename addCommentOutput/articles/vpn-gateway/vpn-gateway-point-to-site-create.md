...
This article walks you through creating a VNet with a Point-to-Site connection in the **classic deployment model** using the Classic Management Portal. Currently, you cannot create this configuration end-to-end in the Azure portal for the classic deployment model.
