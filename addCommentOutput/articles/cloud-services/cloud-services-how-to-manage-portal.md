...
<!-- deleted by customization 8 --><!-- keep by customization: begin --> 7 <!-- keep by customization: end -->. Click **OK** to begin updating the service.
...
The Azure <!-- deleted by customization Management --><!-- keep by customization: begin --> Preview <!-- keep by customization: end --> Portal does not link resources together like the current Azure Management Portal does. Instead, you must deploy additional resources to the same resource group being used by the Cloud Service.
