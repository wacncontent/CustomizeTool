...
<!-- deleted by customization 10 --><!-- keep by customization: begin --> 1 <!-- keep by customization: end -->. In the ContosoAdsWeb project, set a reference to the ContosoAdsCommon project. Right-click the ContosoAdsWeb project, and then click **References** - **Add References**. In the **Reference Manager** dialog box, select **Solution – Projects** in the left pane, select **ContosoAdsCommon**, and then click **OK**.
...
For a video introduction to Azure Storage best practices and patterns, see [Windows Azure Storage – What's New, Best Practices and Patterns](http://channel9.msdn.com/Events/Build/2014/3-628).
