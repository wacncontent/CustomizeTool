...
This task covers how to stage an application by using the <!-- deleted by customization **Microsoft --><!-- keep by customization: begin --> **Windows <!-- keep by customization: end -->
Azure PowerShell**.
...
[How to Deploy a Service Upgrade to Production by Swapping VIPs in Azure]: <!-- deleted by customization /documentation/articles/cloud-services-how-to-manage#how-to-swap-deployments-to-promote-a-staged-deployment-to-production --><!-- keep by customization: begin --> /documentation/articles/cloud-services-how-to-manage/#how-to-swap-deployments-to-promote-a-staged-deployment-to-production <!-- keep by customization: end -->
