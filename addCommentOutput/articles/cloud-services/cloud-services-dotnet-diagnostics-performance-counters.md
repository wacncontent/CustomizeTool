...
For more information on monitoring the performance of your application in the [Azure Management <!-- deleted by customization Portal](http://manage.azure.com/) --><!-- keep by customization: begin --> Portal](http://manage.azure.cn/) <!-- keep by customization: end -->, see [How to Monitor Cloud Services](https://www.windowsazure.cn/manage/services/cloud-services/how-to-monitor-a-cloud-service/).

For additional in-depth guidance on creating a logging and tracing strategy and using diagnostics and other techniques to troubleshoot problems and optimize Azure applications, see [Troubleshooting Best Practices for Developing Azure <!-- deleted by customization Applications](https://msdn.microsoft.com/zh-cn/library/azure/hh771389.aspx) --><!-- keep by customization: begin --> Applications](https://msdn.microsoft.com/zh-ch/library/azure/hh771389.aspx) <!-- keep by customization: end -->.
...
1. Open the ServiceConfiguration.Cloud.cscfg file using your favorite text editor and set the connection string for your storage. The *AccountName* and *AccountKey* values are found in the <!-- deleted by customization Azure --> Management Portal in the storage account dashboard, under Manage Keys.
...
Once your application is deployed and running the Diagnostics monitor will begin collecting performance counters and persisting that data to Azure storage. You use tools such as Server Explorer in Visual Studio, [Azure Storage Explorer](http://azurestorageexplorer.codeplex.com/), or [Azure Diagnostics Manager](http://www.cerebrata.com/Products/AzureDiagnosticsManager/Default.aspx) by Cerebrata to view the performance counters data in the WADPerformanceCountersTable table. You can also programatically query the Table service <!-- deleted by customization using [C#](../storage/storage-dotnet-how-to-use-tables.d) --><!-- keep by customization: begin --> using [C#](/documentation/articles/storage/storage-dotnet-how-to-use-tables) <!-- keep by customization: end -->, <!-- deleted by customization [Java](/documentation/articles/storage-java-how-to-use-table-storage) --><!-- keep by customization: begin --> [Java](/documentation/articles/storage/storage-java-how-to-use-table-storage) <!-- keep by customization: end -->, <!-- deleted by customization [Node.js](/documentation/articles/storage-nodejs-how-to-use-table-storage) --><!-- keep by customization: begin --> [Node.js](/documentation/articles/storage/storage-nodejs-how-to-use-table-storage) <!-- keep by customization: end -->, <!-- deleted by customization [Python](/documentation/articles/storage-python-how-to-use-table-storage) --><!-- keep by customization: begin --> [Python](/documentation/articles/storage/storage-python-how-to-use-table-storage) <!-- keep by customization: end -->, <!-- deleted by customization [Ruby](/documentation/articles/storage-ruby-how-to-use-table-storage) --><!-- keep by customization: begin --> [Ruby](/documentation/articles/storage/storage-ruby-how-to-use-table-storage) <!-- keep by customization: end -->, <!-- deleted by customization or [PHP](/documentation/articles/storage-php-how-to-use-table-storage) --><!-- keep by customization: begin --> or [PHP](/documentation/articles/storage/storage-php-how-to-use-table-storage) <!-- keep by customization: end -->.
