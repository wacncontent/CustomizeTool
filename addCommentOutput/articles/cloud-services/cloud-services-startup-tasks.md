...
- Can be a console application or a batch file that starts a [PowerShell <!-- deleted by customization script](/documentation/articles/cloud-services-startup-tasks-common#create-a-powershell-startup-task) --><!-- keep by customization: begin --> script](/documentation/articles/cloud-services-startup-tasks-common/#create-a-powershell-startup-task) <!-- keep by customization: end -->.
