...
3.  Right-click on **Cloud Service** node, choose **Create Cloud <!-- deleted by customization ServiceâŚ** --><!-- keep by customization: begin --> Service** <!-- keep by customization: end -->
