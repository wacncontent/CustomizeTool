...
[How to Delete a Storage Account from an Azure Subscription]: <!-- deleted by customization /documentation/articles/storage-manage-storage-account/ --><!-- keep by customization: begin --> /documentation/articles/storage-manage-storage-account <!-- keep by customization: end -->
