...
- You can scale resources that are linked to your cloud service. For more information about linking resources, see [How to: Link a resource to a cloud <!-- deleted by customization service](/documentation/articles/cloud-services-how-to-manage#how-to-link-a-resource-to-a-cloud-service) --><!-- keep by customization: begin --> service](/documentation/articles/cloud-services-how-to-manage/#how-to-link-a-resource-to-a-cloud-service) <!-- keep by customization: end -->.
