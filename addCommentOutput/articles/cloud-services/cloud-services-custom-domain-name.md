...
> [AZURE.NOTE]
> The procedures in this task apply to Azure Cloud Services. For Websites, see [Configuring a Custom Domain Name for an Azure <!-- deleted by customization Websites](/documentation/articles/web-sites-custom-domain-name) --><!-- keep by customization: begin --> Websites Web Site](/documentation/articles/web-sites-custom-domain-name) <!-- keep by customization: end -->. For storage accounts, see [Configuring a Custom Domain Name for an Azure Storage Account](/documentation/articles/storage-custom-domain-name).
