...
<!-- deleted by customization 5 --><!-- keep by customization: begin --> 7 <!-- keep by customization: end -->.  Test the success of your build step by checking in a change to your
...
<!-- deleted by customization 4 --><!-- keep by customization: begin --> 5 <!-- keep by customization: end -->.  Save the script template provided at the [end of this article][] to
    your scripts folder as
    c:\\scripts\\WindowsAzure\\**PublishCloudService.ps1**.

<!-- deleted by customization 5 --><!-- keep by customization: begin --> 6 <!-- keep by customization: end -->.  Review the parameters section of the script. Add or modify any
    default values. These values can always be overridden by passing in
    explicit parameters.

<!-- deleted by customization 6 --><!-- keep by customization: begin --> 7 <!-- keep by customization: end -->.  Ensure there are valid cloud service and storage accounts created
    ...
    -   To create a new cloud service, you can call this script or use
        ...
        hence it must be unique.
            ...
            New-AzureService -ServiceName "mytestcloudservice" -Location "China <!-- deleted by customization North" --><!-- keep by customization: begin --> East" <!-- keep by customization: end --> -Label "mytestcloudservice"
    ...
    -   To create a new storage account, you can call this script or use
        ...
        cloud service.
            ...
            New-AzureStorageAccount -ServiceName "mytestcloudservice" -Location "China <!-- deleted by customization North" --><!-- keep by customization: begin --> East" <!-- keep by customization: end --> -Label "mytestcloudservice"

<!-- deleted by customization 7 --><!-- keep by customization: begin --> 8 <!-- keep by customization: end -->.  Call the script directly from Azure PowerShell, or wire up this
...
<!-- deleted by customization 3 --><!-- keep by customization: begin --> 4 <!-- keep by customization: end -->.  Return to the **Process** tab, and use **Show Details** to show a list of available
...
<!-- deleted by customization 4 --><!-- keep by customization: begin --> 5 <!-- keep by customization: end -->.  Open the selected Process Template for editing. You can open
    directly in the Workflow designer or in the XML editor to work with
    the XAML.

<!-- deleted by customization 5 --><!-- keep by customization: begin --> 6 <!-- keep by customization: end -->.  Add the following list of new arguments as separate line items in
...
<!-- deleted by customization 6 --><!-- keep by customization: begin --> 7 <!-- keep by customization: end -->.  Add a new sequence at the end of Run On Agent:
...
<!-- deleted by customization 7 --><!-- keep by customization: begin --> 8 <!-- keep by customization: end -->.  Save the build process template workflow and Check In this file.

<!-- deleted by customization 8 --><!-- keep by customization: begin --> 9 <!-- keep by customization: end -->.  Edit the build definition (close it if it is already open), and select
	the **New** button if you do not yet see the new template in the list of Process Templates.

<!-- deleted by customization 9 --><!-- keep by customization: begin --> 10 <!-- keep by customization: end -->.  Set the parameter property values in the Misc section as follows:
...
<!-- deleted by customization 10 --><!-- keep by customization: begin --> 11 <!-- keep by customization: end -->. Save the changes to the Build Definition.

<!-- deleted by customization 11 --><!-- keep by customization: begin --> 12 <!-- keep by customization: end -->. Queue a Build to execute both the package build and publish. If you
