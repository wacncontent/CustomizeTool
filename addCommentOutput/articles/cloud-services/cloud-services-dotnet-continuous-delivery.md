...
2.  Install the latest [Azure Authoring Tools for .NET](/develop/net/).
3.	Install the [Azure Libraries for .NET](http://download.microsoft.com/download/0/F/E/0FE64840-9806-4D3C-9C11-84B743162618/MicrosoftAzureLibsForNet-x64.msi).
...
To enable remote debugging when using continuous delivery, see [Enable remote debugging when using continuous delivery to publish to Azure](/documentation/articles/cloud-services-virtual-machines-dotnet-continuous-delivery-remote-debugging).
  ...
  [Continuous Delivery to Azure by Using Visual Studio Team Services]: <!-- deleted by customization cloud-services-continuous-delivery-use-vso.md --><!-- keep by customization: begin --> /documentation/articles/cloud-services-continuous-delivery-use-vso <!-- keep by customization: end -->
