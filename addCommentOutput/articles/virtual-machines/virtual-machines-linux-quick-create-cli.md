...
The following example shows how to deploy a  CoreOS  Centos  VM and attach your Secure Shell (SSH) key (your arguments might be different).
...
data:          Name                       :examp-westu-1633070839-nic  :examp-china-1633070839-nic 
data:          Location                  :chinanorth
data:            Public IP address       :138.91.247.29
data:            FQDN                     :examp-westu-1633070839-pip.chinanorth.chinacloudapp.cn  :examp-china-1633070839-pip.chinanorth.chinacloudapp.cn 
data:
...
You can also [use the `docker-machine` Azure driver with various commands to quickly create a Linux VM as a docker host](/documentation/articles/virtual-machines-linux-docker-machine/) as well.
