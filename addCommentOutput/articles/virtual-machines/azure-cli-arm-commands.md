...
As with the [Azure Service Management mode](/documentation/articles/virtual-machines-command-line-tools), the <!-- deleted by customization Resource Manager --><!-- keep by customization: begin --> **arm** <!-- keep by customization: end --> mode of the Azure CLI gives you commands that create resources imperatively on the command line. For example, if you type `azure group create <groupname> <location>` you are asking Azure to create a resource group, and with `azure group deployment create <resourcegroup> <deploymentname>` you are instructing Azure to create a deployment of any number of items and place them in a group. Because each type of resource has imperative commands, you can chain them together to create fairly complex deployments.
...
The command allows to list all virtual networks in a resource group.
	...
	wvnet   newvnet   <!-- deleted by customization westus --><!-- keep by customization: begin --> chinanorth <!-- keep by customization: end -->    10.0.0.0/8
...
Creates a load balancer set.
	...
	azure network lb create -g myresourcegroup -n mylb -l <!-- deleted by customization westus --><!-- keep by customization: begin --> chinanorth <!-- keep by customization: end -->
...
Lists Load balancer resources within a resource group.
	...
	data:    Name  Location
	data:    ----  --------
	data:    mylb  <!-- deleted by customization westus --><!-- keep by customization: begin --> chinanorth <!-- keep by customization: end -->
...
Creates a public ip resource. You will create the public ip resource and associate to a domain name.
	...
	azure network public-ip create -g myresourcegroup -n mytestpublicip1 -l <!-- deleted by customization eastus --><!-- keep by customization: begin --> chinaeast <!-- keep by customization: end --> -d azureclitest -a "Dynamic"
	...
	data:    Location:             <!-- deleted by customization eastus --><!-- keep by customization: begin --> chinaeast <!-- keep by customization: end -->
	data:    Provisioning state:   Succeeded
	data:    Allocation method:    Dynamic
	data:    Idle timeout:         4
	data:    Domain name label:    azureclitest
	data:    FQDN:                 <!-- deleted by customization azureclitest.eastus.cloudapp.azure.com --><!-- keep by customization: begin --> azureclitest.chinaeast.chinacloudapp.cn <!-- keep by customization: end -->
...
Lists all public IP resources within a resource group.
	...
	data:    ---------------  --------  ----------  ------------  ------------  -------------------------------------------
	data:    mypubip5         <!-- deleted by customization westus --><!-- keep by customization: begin --> chinanorth <!-- keep by customization: end -->    Dynamic                   4             "domain <!-- deleted by customization name".westus.cloudapp.azure.com --><!-- keep by customization: begin --> name".chinanorth.chinacloudapp.cn <!-- keep by customization: end -->
	data:    myPublicIP       <!-- deleted by customization eastus --><!-- keep by customization: begin --> chinaeast <!-- keep by customization: end -->    Dynamic                   4             "domain <!-- deleted by customization name".eastus.cloudapp.azure.com --><!-- keep by customization: begin --> name".chinaeast.chinacloudapp.cn <!-- keep by customization: end -->
	data:    mytestpublicip   <!-- deleted by customization eastus --><!-- keep by customization: begin --> chinaeast <!-- keep by customization: end -->    Dynamic                   4             "domain <!-- deleted by customization name".eastus.cloudapp.azure.com --><!-- keep by customization: begin --> name".chinaeast.chinacloudapp.cn <!-- keep by customization: end -->
	data:    mytestpublicip1  <!-- deleted by customization eastus --><!-- keep by customization: begin --> chinaeast <!-- keep by customization: end -->   Static (Static IP address) 4             <!-- deleted by customization azureclitest.eastus.cloudapp.azure.com --><!-- keep by customization: begin --> xplatclitest.chinaeast.chinacloudapp.cn <!-- keep by customization: end -->
...
Creates a resource called network interface (NIC) which can be used for load balancers or associate to a Virtual Machine.
	...
	azure network nic create -g myresourcegroup -l <!-- deleted by customization eastus --><!-- keep by customization: begin --> chinaeast <!-- keep by customization: end --> -n testnic1 --subnet-name subnet-1 --subnet-vnet-name myvnet
