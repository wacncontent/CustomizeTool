...
1. **An Azure subscription** - If you don't have one, you can [open an Azure account for <!-- deleted by customization free](/pricing/1rmb-trial/?WT.mc_id=A261C142F) --><!-- keep by customization: begin --> 1 RMB](/pricing/1rmb-trial/?WT.mc_id=A261C142F) <!-- keep by customization: end -->: You get credits you can use to try out paid Azure services, and even after they're used up you can keep the account and use <!-- deleted by customization free --><!-- keep by customization: begin --> 1-RMB <!-- keep by customization: end --> Azure services, such as Websites. Your credit card won't be charged, unless you explicitly change your settings and ask to be charged. You also can [activate MSDN subscriber benefits](/pricing/member-offers/msdn-benefits-details/?WT.mc_id=A261C142F): Your MSDN subscription gives you credits every month that you can use for paid Azure services.

2. **Windows Azure PowerShell** - You have the Windows Azure PowerShell module installed and configured to use your subscription. To download the module, see [Windows Azure Downloads](/downloads/). A tutorial to install and configure the module is available [here](/documentation/articles/powershell-install-configure). You'll use the <!-- deleted by customization [Add-AzureVHD](http://msdn.microsoft.com/zh-cn/library/azure/dn495173.aspx) --><!-- keep by customization: begin --> [Add-AzureVHD](http://msdn.microsoft.com/zn-ch/library/azure/dn495173.aspx) <!-- keep by customization: end --> cmdlet to upload the VHD.
...
> [AZURE.IMPORTANT] The VHDX format is not supported in Windows Azure. You can convert the disk to VHD format using Hyper-V Manager or the [Convert-VHD <!-- deleted by customization cmdlet](http://technet.microsoft.com/zh-cn/library/hh848454.aspx) --><!-- keep by customization: begin --> cmdlet](http://technet.microsoft.com/zn-ch/library/hh848454.aspx) <!-- keep by customization: end -->. For details, see this [blogpost](http://blogs.msdn.com/b/virtual_pc_guy/archive/2012/10/03/using-powershell-to-convert-a-vhd-to-a-vhdx.aspx).

## Step 1: Prep the VHD <!-- keep by customization: begin --> ## <!-- keep by customization: end -->
...
## Step 2: Create or get info from your Azure storage <!-- deleted by customization account --><!-- keep by customization: begin --> account## <!-- keep by customization: end -->
...
> [AZURE.TIP] To get started with Azure PowerShell, see [How to install and configure Windows Azure PowerShell](/documentation/articles/install-configure-powershell). For general information, see [Get Started with Windows Azure <!-- deleted by customization Cmdlets.](https://msdn.microsoft.com/zh-cn/library/azure/jj554332.aspx) --><!-- keep by customization: begin --> Cmdlets](https://msdn.microsoft.com/zn-ch/library/azure/jj554332.aspx) <!-- keep by customization: end --><!-- keep by customization: begin -->. <!-- keep by customization: end -->
...
After creating a virtual machine, try to create a SQL Server virtual machine. For instructions, see [Provisioning a SQL Server virtual machine on Windows <!-- deleted by customization Azure](/documentation/articles/virtual-machines-provision-sql-server) --><!-- keep by customization: begin --> Azure](/documentation/article/virtual-machines-provision-sql-server) <!-- keep by customization: end -->.
