...
Login to your account.
	...
	Login-AzureRMAccount <!-- keep by customization: begin --> $(Get-AzureRmEnvironment -Name AzureChinaCloud) <!-- keep by customization: end -->
...
- Use this as a basis to build the [simulated hybrid cloud test environment](/documentation/articles/virtual-networks-setup-simulated-hybrid-cloud-environment-testing).
