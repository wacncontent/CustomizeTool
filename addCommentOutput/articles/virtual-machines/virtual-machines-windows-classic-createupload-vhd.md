...

[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)]. You can also [capture](/documentation/articles/virtual-machines-windows-capture-image/) and [upload](/documentation/articles/virtual-machines-windows-upload-image/) a virtual machine using the Resource Manager model. 


> [AZURE.IMPORTANT] Azure has two different deployment models for creating and working with resources:  [Resource Manager and classic](/documentation/articles/resource-manager-deployment-model/).  This article covers using the classic deployment model. Azure recommends that most new deployments use the Resource Manager model. You can also [capture](/documentation/articles/virtual-machines-windows-capture-image/) and [upload](/documentation/articles/virtual-machines-windows-upload-image/) a virtual machine using the Resource Manager model. 

