...
<!-- deleted by customization ### --><!-- keep by customization: begin --> ## <!-- keep by customization: end --> Troubleshooting common allocation failures in the Resource Manager deployment model
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: resizing a VM, or adding additional VMs or role instances to an existing cloud service
**Error**
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: restarting stopped (de-allocated) VMs - partial de-allocation
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: restarting stopped (de-allocated) VMs - full de-allocation
**Error**
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: Staging/production deployments (platform-as-a-service only)
**Error**
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: affinity group - VM/service proximity
**Error**
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: affinity-group-based virtual network
**Error**
...
<!-- deleted by customization ### --><!-- keep by customization: begin --> ## <!-- keep by customization: end --> Troubleshooting specific allocation failure scenarios in the Azure Resource Manager deployment model
Here are the common allocation scenarios that cause an allocation request to be pinned. We'll dive into each scenario later in this article.
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> Allocation scenario: resizing a VM, or adding additional VMs to an existing Availability Set
**Error**
