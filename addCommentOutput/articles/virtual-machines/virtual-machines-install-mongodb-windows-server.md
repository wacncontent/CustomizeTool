...
For instructions on initializing the disk, see "How to: Initialize a new data disk in Windows Server" in [How to attach a data disk to a Windows virtual <!-- deleted by customization machine](/documentation/articles/storage-windows-attach-disk) --><!-- keep by customization: begin --> machine](/documentation/articles/storage-windows-attach-disk/) <!-- keep by customization: end -->.
