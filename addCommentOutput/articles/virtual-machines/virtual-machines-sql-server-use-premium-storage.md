...
#### Step 4: Copy Blob between Storage Accounts
    #Get Image VHD <!-- keep by customization: begin --> from Portal <!-- keep by customization: end -->
...
#### Step 22: Add Load Balanced Endpoints and ACLs
    ...
    #STOP!!! CHECK in <!-- deleted by customization the Azure Management Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end --> or Machine Endpoints through powershell that these Endpoints are created!
