...
In this phase of deploying an intranet-only SharePoint 2013 farm with SQL Server AlwaysOn Availability Groups in Azure infrastructure services, you build out the Azure networking and storage infrastructure in Azure Service Management. You must complete this phase before moving on to [Phase 2](/documentation/articles/virtual-machines-windows-ps-sp-intranet-ph2). See [Deploying SharePoint with SQL Server AlwaysOn Availability Groups in Azure](/documentation/articles/virtual-machines-windows-sp-intranet-overview) for all of the phases.
...
- Use [Phase 2](/documentation/articles/virtual-machines-windows-ps-sp-intranet-ph2) to continue with the configuration of this workload.
