...
In the Azure portal  Preview , click **Browse** > **Virtual machines** > _your Windows virtual machine_ > **Settings** > **Audit logs**.
...
* Click **Browse all** > **Virtual machines (classic)** > _your virtual machine_ > **Settings** > **Size**. For detailed steps, see [Resize the virtual machine](https://msdn.microsoft.com/zh-cn/library/dn168976.aspx).
