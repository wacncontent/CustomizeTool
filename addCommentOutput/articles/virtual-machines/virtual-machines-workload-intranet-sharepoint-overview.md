...
3. | First database server | Microsoft SQL Server 2014 Enterprise <!-- deleted by customization - --><!-- keep by customization: begin --> 每 <!-- keep by customization: end --> Windows Server 2012 R2 | A5
4. | Second database server | Microsoft SQL Server 2014 Enterprise <!-- deleted by customization - --><!-- keep by customization: begin --> 每 <!-- keep by customization: end --> Windows Server 2012 R2 | A5
5. | Majority node for the cluster | Windows Server 2012 R2 Datacenter | A1
6. | First SharePoint application server | Microsoft SharePoint Server 2013 Trial <!-- deleted by customization - --><!-- keep by customization: begin --> 每 <!-- keep by customization: end --> Windows Server 2012 R2 | A4
7. | Second SharePoint application server | Microsoft SharePoint Server 2013 Trial <!-- deleted by customization - --><!-- keep by customization: begin --> 每 <!-- keep by customization: end --> Windows Server 2012 R2 | A4
8. | First SharePoint web server | Microsoft SharePoint Server 2013 Trial <!-- deleted by customization - --><!-- keep by customization: begin --> 每 <!-- keep by customization: end --> Windows Server 2012 R2 | A4
9. | Second SharePoint web server | Microsoft SharePoint Server 2013 Trial <!-- deleted by customization - --><!-- keep by customization: begin --> 每 <!-- keep by customization: end --> Windows Server 2012 R2 | A4
...
- [Phase 1: Configure Azure](/documentation/articles/virtual-machines-workload-intranet-sharepoint-phase1). Create a storage account, <!-- deleted by customization availability sets --><!-- keep by customization: begin --> cloud services <!-- keep by customization: end -->, and a cross-premises virtual network.
...
- If you already have an existing Azure hybrid cloud <!-- deleted by customization deployment --><!-- keep by customization: begin --> implementation <!-- keep by customization: end -->, feel free to adapt or skip the instructions in phases 1 and 2 to host the new SharePoint farm on the appropriate subnet.
