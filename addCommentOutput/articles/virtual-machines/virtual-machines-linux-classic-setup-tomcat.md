...
In the [Azure  portal](https://portal.azure.cn/)  portal Preview](https://portal.azure.cn/) , click **New** in the task bar to create an image, choosing the Linux image based on your needs. The following example uses the Ubuntu 14.04 image.
![][3]
