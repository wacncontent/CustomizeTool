...
1. Install the latest Azure PowerShell Cmdlets or Azure CLI from <!-- deleted by customization [here](http://azure.microsoft.com/downloads) --><!-- keep by customization: begin --> [here](/downloads) <!-- keep by customization: end -->.
