...
4. At the top of the page, select **Include Prerelease**. Type *Microsoft.Azure.ResourceManager* in the search box, click **Install** for the Azure Resource Management Libraries, and then follow the instructions to install the package.
