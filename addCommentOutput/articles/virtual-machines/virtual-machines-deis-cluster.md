 ...
 * An active Azure subscription. If you don't have one, you can get a free trail on <!-- deleted by customization [azure.com](https://azure.microsoft.com) --><!-- keep by customization: begin --> [azure.com](http://www.windowsazure.cn/) <!-- keep by customization: end -->.
...
[azure-command-line-tools]: <!-- deleted by customization /documentation/articles/xplat-cli-install --><!-- keep by customization: begin --> /documentation/articles/xplat-cli <!-- keep by customization: end -->
