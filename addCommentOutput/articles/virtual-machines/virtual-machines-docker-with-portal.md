...
> [AZURE.NOTE] This functionality is supported in the preview portal only: <!-- deleted by customization https://manage.windowsazure.cn/ --><!-- keep by customization: begin --> https://manage.windowsazure.cn <!-- keep by customization: end -->
...
<!--Link references-->
[How to use the Docker VM Extension from the Azure Command-line Interface (Azure CLI)]: <!-- deleted by customization /documentation/articles/virtual-machines-docker-with-xplat-cli/ --><!-- keep by customization: begin --> /documentation/articles/virtual-machines-docker-with-xplat-cli <!-- keep by customization: end -->
