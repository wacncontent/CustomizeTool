...
1. In Visual Studio, click **File** > **New** > **Project** > **Web**, and then choose **ASP.NET <!-- deleted by customization web site** --><!-- keep by customization: begin --> Web Site** <!-- keep by customization: end --> (under the **Visual C#** or **Visual Basic** nodes).
