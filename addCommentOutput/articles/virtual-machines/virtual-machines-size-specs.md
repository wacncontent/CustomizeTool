...
|Standard_A8|8|56 GB|2| Temporary = 382 GB Note: For information and considerations about using this size, see [About the A8, A9, A10, and A11 compute intensive instances](/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/). |16|16x500|
|Standard_A9|16|112 GB|4| Temporary = 382 GB Note: For information and considerations about using this size, see [About the A8, A9, A10, and A11 compute intensive instances](/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/). |16|16x500|
|Standard_A10|8|56 GB|2| Temporary = 382 GB Note: For information and considerations about using this size, see [About the A8, A9, A10, and A11 compute intensive instances](/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/). |16|16x500|
|Standard_A11|16|112 GB|4| Temporary = 382 GB Note: For information and considerations about using this size, see [About the A8, A9, A10, and A11 compute intensive instances](/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/). |16|16x500|
