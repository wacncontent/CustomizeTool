...
>[AZURE.NOTE] To see related Azure limits, see [Azure subscription and service limits, quotas, and constraints](/documentation/articles/azure-subscription-service-limits) <!-- deleted by customization. -->
...
<!-- deleted by customization ### --><!-- keep by customization: begin --> ## <!-- keep by customization: end --> Basic tier
...
<!-- deleted by customization ### --><!-- keep by customization: begin --> ## <!-- keep by customization: end --> Standard tier <!-- deleted by customization: A-series -->
...
|A8\same|8|56 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|A9\same|16|112 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|A10\same|8|56 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|A11\same|16|112 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="/documentation/articles/virtual-machines-a8-a9-a10-a11-specs/">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
...
|A6\(same)|4|28 GB|<p>OS = 1023 GB</p><p>Temporary = 285 GB</p>|8|8x500|
|A7\(same)|8|56 GB|<p>OS = 1023 GB</p><p>Temporary = 605 GB</p>|16|16x500|
|A8\(same)|8|56 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="http://www.windowsazure.cn/documentation/articles/virtual-machines-a8-a9-a10-a11-specs">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|A9\(same)|16|112 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="http://www.windowsazure.cn/documentation/articles/virtual-machines-a8-a9-a10-a11-specs">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|A10\(same)|8|56 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="http://www.windowsazure.cn/documentation/articles/virtual-machines-a8-a9-a10-a11-specs">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|A11\(same)|16|112 GB|<p><p>OS = 1023 GB</p><p>Temporary = 382 GB</p><blockquote><p>Note: For information and considerations about using this size, see <a href="http://www.windowsazure.cn/documentation/articles/virtual-machines-a8-a9-a10-a11-specs">About the A8, A9, A10, and A11 <!-- deleted by customization compute intensive instances</a>.</p></blockquote>|16|16x500| --><!-- keep by customization: begin --> Compute Intensive Instances</a>.</p></blockquote>|16|16x500| <!-- keep by customization: end -->
|Standard_D1\(same)|1|3.5 GB|<p>OS = 1023 GB</p><p>Temporary (SSD) =50 GB</p>|2|2x500|
|Standard_D2\(same)|2|7 GB|<p>OS = 1023 GB</p><p>Temporary (SSD) =100 GB</p>|4|4x500|
|Standard_D3\(same)|4|14 GB|<p>OS = 1023 GB</p><p>Temporary (SSD) =200 GB</p>|8|8x500|
|Standard_D4\(same)|8|28 GB|<p>OS = 1023 GB</p><p>Temporary (SSD) =400 GB</p>|16|16x500|
...
|---|---|---|---|---|---|---|
<!-- deleted by customization |Standard_DS1\same|1|3.5|<p>OS --><!-- keep by customization: begin --> |Standard_DS1\(same)|1|3.5|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 7 GB</p>|2|43|<p>3,200</p><p>32 MB per second</p>|
<!-- deleted by customization |Standard_DS2\same|2|7|<p>OS --><!-- keep by customization: begin --> |Standard_DS2\(same)|2|7|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 14 GB</p>|4|86|<p>6,400</p><p>64 MB per second</p>|
<!-- deleted by customization |Standard_DS3\same|4|14|<p>OS --><!-- keep by customization: begin --> |Standard_DS3\(same)|4|14|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 28 GB</p>|8|172|<p>12,800</p><p>128 MB per second</p>|
<!-- deleted by customization |Standard_DS4\same|8|28|<p>OS --><!-- keep by customization: begin --> |Standard_DS4\(same)|8|28|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 56 GB</p>|16|344|<p>25,600</p><p>256 MB per second</p>|
<!-- deleted by customization |Standard_DS11\same|2|14|<p>OS --><!-- keep by customization: begin --> |Standard_DS11\(same)|2|14|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 28 GB</p>|4|72|<p>6,400</p><p>64 MB per second</p>|
<!-- deleted by customization |Standard_DS12\same|4|28|<p>OS --><!-- keep by customization: begin --> |Standard_DS12\(same)|4|28|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 56 GB</p>|8|144|<p>12,800</p><p>128 MB per second</p>|
<!-- deleted by customization |Standard_DS13\same|8|56|<p>OS --><!-- keep by customization: begin --> |Standard_DS13\(same)|8|56|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 112 GB</p>|16|288|<p>25,600</p><p>256 MB per second</p>|
<!-- deleted by customization |Standard_DS14\same|16|112|<p>OS --><!-- keep by customization: begin --> |Standard_DS14\(same)|16|112|<p>OS <!-- keep by customization: end --> = 1023 GB</p><p>Local SSD disk = 224 GB</p>|32|576|<p>50,000</p><p>512 MB per second</p>|
...
|Size – Azure Management Portal\cmdlets &amp; APIs|CPU cores|Memory|Max. disk sizes – virtual machine|Max. data disks (1023 GB each)|Max. IOPS (500 per disk)|
|---|---|---|---|---|---|
<!-- deleted by customization |Standard_G1\same|2|28 --><!-- keep by customization: begin --> |Standard_G1\(same)|2|28 <!-- keep by customization: end --> GB|<p>OS = 1023 GB</p><p>Local SSD disk = 384 GB</p>|4|4 x 500|
<!-- deleted by customization |Standard_G2\same|4|56 --><!-- keep by customization: begin --> |Standard_G2\(same)|4|56 <!-- keep by customization: end --> GB|<p>OS = 1023 GB</p><p>Local SSD disk = 768 GB</p>|8|8 x 500|
<!-- deleted by customization |Standard_G3\same|8|112 --><!-- keep by customization: begin --> |Standard_G3\(same)|8|112 <!-- keep by customization: end --> GB|<p>OS = 1023 GB</p><p>Local SSD disk = 1,536 GB</p>|16|16 x 500|
<!-- deleted by customization |Standard_G4\same|16|224 --><!-- keep by customization: begin --> |Standard_G4\(same)|16|224 <!-- keep by customization: end --> GB|<p>OS = 1023 GB</p><p>Local SSD disk = 3,072 GB</p>|32|32 x 500|
<!-- deleted by customization |Standard_G5\same|32|448 --><!-- keep by customization: begin --> |Standard_G5\(same)|32|448 <!-- keep by customization: end --> GB|<p>OS = 1023 GB</p><p>Local SSD disk = 6,144 GB</p>|64|<p>64 x 500</p>|
