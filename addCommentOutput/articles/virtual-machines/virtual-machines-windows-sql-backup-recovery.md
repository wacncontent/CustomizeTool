...
If you are planning your deployment of SQL Server in an Azure VM, you can find provisioning guidance in the following tutorial:  [Provisioning  [Provision  a SQL Server  Virtual Machine on  virtual machine using  Azure  with Azure Resource Manager](/documentation/articles/virtual-machines-windows-portal-sql-server-provision/)  PowerShell (Classic)](/documentation/articles/virtual-machines-windows-classic-ps-sql-create/) .
