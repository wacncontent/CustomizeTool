...
### <a  name="checkdisk"<</a>Check  name="checkdisk"></a>Check  the consistency of added disks
...
### <a  name="checkdisk"<</a>Repair  name="checkdisk"></a>Repair  added disks on your Linux VM
