...
11. Add the new drive to /etc/fstab:
	...
	Or, on systems based on SUSE Linux you may need to use a slightly different format:
		...
		/dev/disk/by-uuid/33333333-3b3b-3c3c-3d3d-3e3e3e3e3e3e   <!-- deleted by customization /datadrive --><!-- keep by customization: begin --> / <!-- keep by customization: end -->   ext3   defaults   1   2
