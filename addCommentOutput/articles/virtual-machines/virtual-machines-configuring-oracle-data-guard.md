...
This tutorial assumes that you already have theoretical and practical knowledge on Oracle Database High Availability and Disaster Recovery concepts. For information, see the [Oracle web site](http://www.oracle.com/technetwork/database/features/availability/index.html) and also the  [Oracle  Oracle  Data Guard Concepts and Administration  Guide](http://docs.oracle.com/cd/E11882_01/server.112/e17022/create_ps.htm)  Guide .
