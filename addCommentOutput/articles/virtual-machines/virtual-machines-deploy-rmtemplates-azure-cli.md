...
If your version is not 0.9.0 or later, <!-- deleted by customization you --><!-- keep by customization: begin --> you'll <!-- keep by customization: end --> need to either [install the Azure CLI](/documentation/articles/xplat-cli-install) or update <!-- deleted by customization by --> using <!-- keep by customization: begin --> either <!-- keep by customization: end --> one of the native installers or through **npm** by typing `npm update -g azure-cli`.
...
> [AZURE.NOTE] If you don't have one, you'll see an error message indicating that you need a different type of account. To create one from your current Azure account, see [Creating a <!-- deleted by customization work --><!-- keep by customization: begin --> Work <!-- keep by customization: end --> or <!-- deleted by customization school --><!-- keep by customization: begin --> School <!-- keep by customization: end --> identity in Azure Active Directory](/documentation/articles/resource-group-create-work-id-from-personal).
...
You can learn lots more about Azure resource groups and what they can do for you in the [Azure Resource Manager <!-- deleted by customization overview](/documentation/articles/resource-group-overview) --><!-- keep by customization: begin --> overview](/documentation/articles/resource-groups-overview) <!-- keep by customization: end -->. If you're interested in authoring templates, see [Authoring Azure Resource Manager <!-- deleted by customization templates](/documentation/articles/resource-group-authoring-templates) --><!-- keep by customization: begin --> Templates](/documentation/articles/resource-group-authoring-templates) <!-- keep by customization: end -->.
...
<!-- keep by customization: end -->
    ...
    / Creating a new virtual network <!-- deleted by customization "coreo-westu-1430261891570-vnet" --><!-- keep by customization: begin --> "coreo-chinaeast-1430261891570-vnet" <!-- keep by customization: end --> [address prefix: "10.0.0.0/16"] with subnet "coreo-westu-1430261891570-sne+" [address prefix: "10.0.1.0/24"]
<!-- deleted by customization
    + Looking up the virtual network "coreo-westu-1430261891570-vnet"
...
Typically Linux machines are connected to through SSH. For more information, see [How to <!-- deleted by customization use --><!-- keep by customization: begin --> Use <!-- keep by customization: end --> SSH with Linux on Azure](/documentation/articles/virtual-machines-linux-use-ssh-key).
...
For more templates you can use, see [Azure Quickstart <!-- deleted by customization templates](http://azure.microsoft.com/documentation/templates/) --><!-- keep by customization: begin --> Templates](http://azure.microsoft.com/documentation/templates/) <!-- keep by customization: end --> and [Application frameworks using templates](/documentation/articles/virtual-machines-app-frameworks).
