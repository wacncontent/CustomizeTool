...
1.	Log in to the [Azure Management <!-- deleted by customization Portal](https://ms.portal.azure.com/) --><!-- keep by customization: begin --> Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->.
