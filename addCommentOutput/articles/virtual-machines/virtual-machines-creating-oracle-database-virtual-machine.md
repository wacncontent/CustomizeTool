...
5.	Specify a **User Name** for the VM. Note that this user is for remotely logging <!-- deleted by customization in to --><!-- keep by customization: begin --> into <!-- keep by customization: end --> the VM; this is not the Oracle database user name.
...
10. Choose a **Subscription** <!-- deleted by customization. -->

11. Choose a **Location** <!-- deleted by customization. -->
...
5.	Respond to the prompts as needed to connect to the <!-- deleted by customization VM --><!-- keep by customization: begin --> Virtual Machine <!-- keep by customization: end -->. When prompted for the administrator name and password, use the values that you provided when you created the <!-- deleted by customization VM --><!-- keep by customization: begin --> Virtual Machine <!-- keep by customization: end -->.

6.	Create an environment variable named **ORACLE_HOSTNAME** with its value set to the computer name of the <!-- deleted by customization VM --><!-- keep by customization: begin --> Virtual Machine <!-- keep by customization: end -->. You can create an environment variable using the following steps:
...
1.	Still logged in to your <!-- deleted by customization VM --><!-- keep by customization: begin --> Virtual Machine <!-- keep by customization: end -->, start a SQL Plus command prompt <!-- deleted by customization. In Windows, click *Start** --><!-- keep by customization: begin -->: Click **Windows Start** <!-- keep by customization: end -->, then type **SQL Plus**. Click the **SQL Plus** icon.
...
3.	Run the following command at the SQL Plus command prompt <!-- deleted by customization. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->

		<!-- deleted by customization **select --><!-- keep by customization: begin --> select <!-- keep by customization: end --> \* from <!-- deleted by customization GLOBAL\_NAME;** --><!-- keep by customization: begin --> GLOBAL\_NAME; <!-- keep by customization: end -->
...
To allow your database to be reached remotely (for example, from a client computer running Java code), you'll need to start the database listener, open port 1521 in your <!-- deleted by customization virtual machine's --><!-- keep by customization: begin --> Virtual Machine's <!-- keep by customization: end --> firewall, and create a public endpoint for port 1521.
...
3.	At the command prompt, run the following <!-- deleted by customization command. --><!-- keep by customization: begin -->: <!-- keep by customization: end -->
...
6.	Accept the defaults for the profiles for which the rule applies and <!-- deleted by customization then --> click **Next**.

7.	Specify a name for the rule and optionally a description, and then click **Finish**.

### Create a public endpoint for port 1521

1.	Log in to the [Azure Management <!-- deleted by customization Portal](https://manage.windowsazure.cn/) --><!-- keep by customization: begin --> Portal](https://manage.windowsazure.cn) <!-- keep by customization: end -->.

2.	Click **Browse** <!-- deleted by customization. -->
...
5.	Click **Settings** <!-- deleted by customization. -->
-->
<!-- keep by customization: begin -->
3.    Click **Virtual Machines**
...
8.	Specify a name for the endpoint <!-- deleted by customization: -->
