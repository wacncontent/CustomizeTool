...
- **An Azure subscription** - If you don't have one, you can create an account in just a couple of minutes. <!-- deleted by customization If you have an MSDN subscription, see [Azure Benefit for MSDN Subscribers](/pricing/member-offers/msdn-benefits-details/). Otherwise, --> see [create a trial account](/pricing/1rmb-trial/).
