<properties
   pageTitle="SAP NetWeaver on Linux virtual machines (VMs) - DBMS Deployment Guide | Azure"
...
For the disks containing the DB2 storage paths for your sapdata and saptmp directories, you must specify a physical disk sector size of 512 KB. When using Windows Storage Pools, you must create the storage pools  manually via command line interface using the parameter  „-LogicalSectorSizeDefault"  "-LogicalSectorSizeDefault" . For details see <https://technet.microsoft.com/zh-cn/library/hh848689.aspx>.
