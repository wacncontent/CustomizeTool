...
1. Sign in to the [Azure Management <!-- deleted by customization Portal] --><!-- keep by customization: begin --> Portal](https://manage.windowsazure.cn/) <!-- keep by customization: end -->.
