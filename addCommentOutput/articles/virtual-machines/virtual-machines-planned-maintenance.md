...
For more information about SLAs, refer to the "Cloud Services, Virtual Machines and Virtual Network" section of [Service Level <!-- deleted by customization Agreements](http://azure.microsoft.com/support/legal/sla/) --><!-- keep by customization: begin --> Agreements](/support/legal/sla) <!-- keep by customization: end -->.
...
[Understand planned versus unplanned maintenance]: <!-- deleted by customization /documentation/articles/virtual-machines-manage-availability#Understand-planned-versus-unplanned-maintenance --><!-- keep by customization: begin --> /documentation/articles/virtual-machines-manage-availability#Understand-planned-versus-unplanned-maintenance/ <!-- keep by customization: end -->