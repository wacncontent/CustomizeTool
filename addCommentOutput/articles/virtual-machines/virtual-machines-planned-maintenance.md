...
For more information about SLAs, refer to the "Cloud Services, Virtual Machines and Virtual Network" section of [Service Level <!-- deleted by customization Agreements](/support/legal/sla/) --><!-- keep by customization: begin --> Agreements](/support/legal/sla) <!-- keep by customization: end -->.
