...
You can run the template with the Azure <!-- deleted by customization preview portal --><!-- keep by customization: begin --> Preview Portal <!-- keep by customization: end -->, Azure PowerShell, or the Azure CLI.
...
Before you begin, make sure you have the right version of Azure PowerShell installed, you have logged in, and you have switched to the new Resource Manager mode. For the details, click <!-- deleted by customization [here](/documentation/articles/virtual-machines-deploy-rmtemplates-powershell#setting-up-powershell-for-resource-manager-templates) --><!-- keep by customization: begin --> [here](/documentation/articles/virtual-machines-deploy-rmtemplates-powershell/#setting-up-powershell-for-resource-manager-templates) <!-- keep by customization: end -->.
...
Next, run your command block in the Azure PowerShell <!-- deleted by customization command --> prompt.
