<properties
	pageTitle="Deploy Azure Resources Using C# | Azure"
	description="Learn to use C# and Azure Resource Manager to create Azure resources."
...
A [storage account](/documentation/articles/storage-create-storage-account/) is needed to store the virtual hard disk file that is created for the virtual machine.
