...
If you do not already have an Azure account, you can sign up for a trial at <!-- deleted by customization [Free one-month trial](/pricing/1rmb-trial/) --><!-- keep by customization: begin --> [Try Azure](/pricing/1rmb-trial/) <!-- keep by customization: end -->. If you have an MSDN Platforms subscription, see [Azure benefit for MSDN Platform subscribers](https://azure.microsoft.com/offers/ms-azr-0062p/).
