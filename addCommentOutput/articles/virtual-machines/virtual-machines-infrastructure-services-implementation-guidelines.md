...
- Create your virtual machines with the Azure Management Portal, the  Azure Management Portal, the  **New-AzureVM** PowerShell cmdlet,  or  the Azure CLI , or with Resource Manager templates .
