...
 #What  # What  to do in the event that an Azure service disruption impacts Azure virtual machines
...
 Microsoft  Azure.cn  provides a Service Level Agreement (SLA) for its services as a commitment for uptime and connectivity. The SLA for individual Azure services can be found at [Azure Service Level Agreements](/support/legal/sla/).
...
 ##Option  ## Option  2: Restore a VM from a backup
...
 ##Option  ## Option  3: Initiate a failover by using Azure Site Recovery
...
If the instructions are not clear, or if you would like  Microsoft  Azure.cn  to do the operations on your behalf, contact [Customer  Support](https://portal.azure.cn/#blade/Microsoft_Azure_Support/HelpAndSupportBlade)  Support](/support/support-azure/) .
