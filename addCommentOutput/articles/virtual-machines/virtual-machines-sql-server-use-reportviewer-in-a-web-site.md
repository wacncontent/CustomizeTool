...
You can build a Windows Azure Web site with the Visual Studio ReportViewer control that displays a report stored on an Windows Azure Virtual Machine. The ReportViewer control is in a <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> that you build using the ASP.NET <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> template.
