...
To view the monitoring information for a specific device, in the Azure <!-- deleted by customization Management --> Portal, select the StorSimple Manager service, click the **Monitor** tab, and then select from the list of devices. The **Monitor** page contains the following information.
...
- Learn how to [use the StorSimple Manager service device <!-- deleted by customization dashboard](/documentation/articles/storsimple-device-dashboard) --><!-- keep by customization: begin --> dashboard](storsimple-device-dashboard.md) <!-- keep by customization: end -->.
