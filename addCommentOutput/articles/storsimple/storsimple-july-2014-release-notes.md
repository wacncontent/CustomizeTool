<properties 
   pageTitle="StorSimple 8000 Release version release notes | Windows Azure"
   description="Describes the new features, open issues, and available workarounds for the July 2014 Windows Azure StorSimple release."
   services="storsimple"
...
# StorSimple <!-- deleted by customization 8000 Series Release Version --> release notes - July 2014

## Overview

The follow release notes identify the critical open issues for the <!-- deleted by customization StorSimple 8000 Series --> July 2014 <!-- deleted by customization general availability --><!-- keep by customization: begin --> General Availability <!-- keep by customization: end --> (GA) release of Windows Azure StorSimple. This release corresponds to software version 6.3.9600.17215.

Unless otherwise specified, these release notes apply to all models of the StorSimple device. The release notes are continuously updated; as critical issues requiring a workaround are discovered, they are added. Before you deploy your Windows Azure StorSimple solution, consider the following information.  
