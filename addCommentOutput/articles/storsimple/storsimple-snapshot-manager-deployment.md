...
StorSimple Snapshot Manager can be installed on computers that are running the Windows <!-- deleted by customization ServerÂŽ --><!-- keep by customization: begin --> Server® <!-- keep by customization: end --> 2008 R2 SP1, Windows Server 2012, or Windows Server 2012 R2 operating system.
...
Before you install or upgrade the StorSimple Snapshot Manager snap-in for the Microsoft Management Console (MMC), make sure that the <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple device and host server are configured correctly.

## Configure prerequisites

The following steps provide a high-level overview of configuration tasks that you must complete before you install the StorSimple Snapshot Manager. For complete <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple configuration and setup information, including system requirements and step-by-step instructions, see [Deploy your on-premises StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-deployment-walkthrough) --><!-- keep by customization: begin --> device](storsimple-deployment-walkthrough.md) <!-- keep by customization: end -->.

>[AZURE.IMPORTANT] Before you begin, review the [Deployment configuration <!-- deleted by customization checklist](/documentation/articles/storsimple-deployment-walkthrough#deployment-configuration-checklist) --><!-- keep by customization: begin --> checklist](storsimple-deployment-walkthrough.md#deployment-configuration-checklist) <!-- keep by customization: end --> and
...
3. Make sure that you meet all the <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple configuration requirements. For details, go to [Deployment <!-- deleted by customization prerequisites](/documentation/articles/storsimple-deployment-walkthrough#deployment-prerequisites) --><!-- keep by customization: begin --> prerequisites](storsimple-deployment-walkthrough.md#deployment-prerequisites) <!-- keep by customization: end -->.

4. Connect the device to the host and perform the initial configuration. For details, go to [Deployment <!-- deleted by customization steps](/documentation/articles/storsimple-deployment-walkthrough#deployment-steps) --><!-- keep by customization: begin --> steps](storsimple-deployment-walkthrough.md#deployment-steps) <!-- keep by customization: end -->.
...
>[AZURE.IMPORTANT]
>
>- For a StorSimple virtual device, the host must be a <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure Virtual Machine.
>
...
3. In the **Device** list box, select the IP address of the <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple device or virtual device. In the **Password** text box, type the StorSimple Snapshot Manager password that you created for the device in the <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure Management Portal. Click **OK**.
...
- To learn more about StorSimple Snapshot Manager, go to [What is StorSimple Snapshot <!-- deleted by customization Manager?](/documentation/articles/storsimple-what-is-snapshot-manager) --><!-- keep by customization: begin --> Manager?](storsimple-what-is-snapshot-manager.md) <!-- keep by customization: end -->.

- To learn more about the StorSimple Snapshot Manager user interface, go to [StorSimple Snapshot Manager user <!-- deleted by customization interface](/documentation/articles/storsimple-use-snapshot-manager) --><!-- keep by customization: begin --> interface](storsimple-use-snapshot-manager.md) <!-- keep by customization: end -->.

- To learn more about using StorSimple Snapshot Manager, go to [Use StorSimple Snapshot Manager to administer your StorSimple <!-- deleted by customization solution](/documentation/articles/storsimple-snapshot-manager-admin) --><!-- keep by customization: begin --> solution](storsimple-snapshot-manager-admin.md) <!-- keep by customization: end -->.