...
Welcome to Windows Azure StorSimple. This article describes important system requirements and best practices for your StorSimple device and for the storage clients accessing the device. We recommend that you review the information carefully before you deploy your Azure StorSimple system, and then refer back to it as necessary during deployment and subsequent operation.
...
| Supported operating systems | Version required | <!-- deleted by customization Additional requirements/notes --><!-- keep by customization: begin --> Details/notes <!-- keep by customization: end --> |
| --------------------------- | ---------------- | ------------- |
<!-- deleted by customization
...
- Isolate the iSCSI and cloud traffic by having dedicated network interfaces on your device for iSCSI and cloud access. For more information, see how to [modify network interfaces](/documentation/articles/storsimple-modify-device-config#modify-network-interfaces) on your StorSimple device.
...
The hardware platform that is included with the StorSimple solution has <!-- keep by customization: begin --> enterprise-grade <!-- keep by customization: end --> availability and reliability features that provide a foundation for a highly available, fault-tolerant storage infrastructure in your datacenter. However, there are requirements and best practices that you should comply with to help ensure the availability of your Azure StorSimple solution. Before you deploy Azure StorSimple, carefully review the following requirements and best practices for the StorSimple device and connected host computers.
<!-- deleted by customization

For more information about monitoring and maintaining the hardware components of your StorSimple device, go to [Use the StorSimple Manager service to monitor hardware components and status](/documentation/articles/storsimple-monitor-hardware-status) and [StorSimple hardware component replacement](/documentation/articles/storsimple-hardware-component-replacement).
-->
...
<!-- deleted by customization - Do not remove both PCMs concurrently. The PCM module includes the backup battery module. Removing both of the PCMs will result in a shutdown without battery protection, and the device state will not be saved. For more information about the battery, go to [Maintain the backup battery module](/documentation/articles/storsimple-battery-replacement#maintain-the-backup-battery-module). -->
<!-- keep by customization: begin -->
...
- If a controller module fails or needs replacement, make sure that the other controller module is in an active state before replacing the failed controller module. <!-- deleted by customization To verify that a controller is active, go to [Identify the active controller on your device](/documentation/articles/storsimple-controller-replacement#identify-the-active-controller-on-your-device). -->
...
<!-- deleted by customization
A failure of 2 or more disks of certain type (HDD, SSD) or consecutive failure within a short time frame may result in system malfunction and potential data loss. If this occurs, [contact Microsoft Support](/documentation/articles/storsimple-contact-microsoft-support) for assistance.
-->
...
- If an EBOD enclosure controller module <!-- keep by customization: begin --> or an HDD <!-- keep by customization: end --> fails, request a replacement immediately.

- If an EBOD enclosure controller module fails, make sure that the other controller module is active before you replace the failed module. <!-- deleted by customization To verify that a controller is active, go to [Identify the active controller on your device](/documentation/articles/storsimple-controller-replacement#identify-the-active-controller-on-your-device). -->
...
### High availability <!-- deleted by customization recommendations --><!-- keep by customization: begin --> requirements <!-- keep by customization: end --> for your host computers

Carefully review these <!-- keep by customization: begin --> requirements and <!-- keep by customization: end --> best practices to ensure the high availability of hosts connected to your StorSimple device.
...
<!-- deleted by customization
- [Learn about StorSimple system limits](/documentation/articles/storsimple-limits).
- [Learn how to deploy your StorSimple solution](/documentation/articles/storsimple-deployment-walkthrough).
-->
<!-- keep by customization: begin -->
...
<!--Reference links-->
<!-- deleted by customization
[1]: https://technet.microsoft.com/zh-cn/library/cc731844(v=WS.10).aspx
-->
<!-- keep by customization: begin -->
