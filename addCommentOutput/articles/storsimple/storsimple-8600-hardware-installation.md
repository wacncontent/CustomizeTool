...
## Overview
Your <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple 8600 is a dual enclosure device and consists of a primary and an EBOD enclosure. This tutorial explains how to unpack, rack-mount, and cable the StorSimple 8600 device hardware before you configure the StorSimple software.
...
1. Inspect the box and the packaging foam for crushes, cuts, water damage, or any other obvious damage. If the box or packaging is severely damaged, do not open the box. Please [contact Microsoft <!-- deleted by customization Support](/documentation/articles/storsimple-contact-microsoft-support) --><!-- keep by customization: begin --> Support](storsimple-contact-microsoft-support.md) <!-- keep by customization: end --> to help you assess whether the device is in good working order.
...
3. After unpacking the two boxes, make sure that you have:
  ...
  - Getting started documentation
    ...
    If you did not receive any of the items listed above, [contact Microsoft <!-- deleted by customization Support](/documentation/articles/storsimple-contact-microsoft-support) --><!-- keep by customization: begin --> Support](storsimple-contact-microsoft-support.md) <!-- keep by customization: end -->.
...
2. Perform this step only if inner rails are not installed on your device. Typically, the inner rails are installed at the factory. If rails are not installed, then install the left-rail and right-rail slides to the sides of the enclosure chassis. They attach using six metric screws on each side. To help with orientation, the rail slides are marked **LH <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> Front** and **RH <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> Front**, and the end that is affixed towards the rear of the enclosure has a tapered end.
...
- [Supported hardware for 10 GbE network interfaces on your StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-supported-hardware-for-10-gbe-network-interfaces) --><!-- keep by customization: begin --> device](storsimple-supported-hardware-for-10-gbe-network-interfaces.md) <!-- keep by customization: end -->
...
- When possible, connect network interfaces from each controller to two different switches to ensure availability against a switch failure. The figure illustrates the two 10 GbE network interfaces, DATA 2 and DATA 3, from each controller connected to two different switches. For more information, refer to the **Network interfaces** under the [High availability requirements for your StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-system-requirements#high-availability-requirements-for-storsimple.md) --><!-- keep by customization: begin --> device](storsimple-system-requirements/#high-availability-requirements-for-storsimple.md) <!-- keep by customization: end -->.

>[AZURE.NOTE] If using SFP+ transceivers with your 10 GbE network interfaces, use the provided QSFP-SFP+ adapters. More information on [Supported hardware for 10 GbE network interfaces on your StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-supported-hardware-for-10-gbe-network-interfaces) --><!-- keep by customization: begin --> device](storsimple-supported-hardware-for-10-gbe-network-interfaces.md) <!-- keep by customization: end -->
...
You are now ready to [deploy and configure your on-premises StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-deployment-walkthrough) --><!-- keep by customization: begin --> device](storsimple-deployment-walkthrough.md) <!-- keep by customization: end -->
