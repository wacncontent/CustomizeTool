<properties 
   pageTitle="What are the StorSimple components? | Windows Azure" 
...
The following sections describe the Windows Azure StorSimple components, and explain how the solution arranges data, allocates storage, and facilitates storage management and data protection. 
<!-- keep by customization: end -->

> [AZURE.NOTE] The StorSimple deployment information published on the Windows Azure website applies to the StorSimple 8000 series devices only. For information about the 7000 series device, go to: [StorSimple Help](http://onlinehelp.storsimple.com/).

## StorSimple device

The Windows Azure StorSimple device is an on-premises hybrid storage array that provides primary storage and iSCSI access to data stored <!-- deleted by customization on it --><!-- keep by customization: begin --> elsewhere <!-- keep by customization: end -->. It manages communication with cloud storage, and helps to ensure the security and confidentiality of all data that is stored on the Windows Azure StorSimple solution.
...
In addition to the dedicated StorSimple device and virtual device, Windows Azure StorSimple uses the following software technologies to provide quick access to data and reduce storage consumption:
...
Windows PowerShell for StorSimple provides a command-line interface that you can use to create and manage the Windows Azure StorSimple service and set up and monitor StorSimple devices. It is a Windows <!-- deleted by customization PowerShell-based --><!-- keep by customization: begin --> PowerShellâbased <!-- keep by customization: end -->, command-line interface that includes dedicated cmdlets for managing your StorSimple device. Windows PowerShell for StorSimple has features that allow you to:
...
<!-- deleted by customization
For more information, see [Use StorSimple Manager service to administer your StorSimple device](/documentation/articles/storsimple-manager-service-administration).
-->
<!-- keep by customization: begin -->
For more information, see [StorSimple Manager service](https://msdn.microsoft.com/zh-CN/library/azure/dn772396.aspx).
<!-- keep by customization: end -->

## StorSimple Snapshot Manager

StorSimple Snapshot Manager is a Microsoft Management Console (MMC) snap-in that you can use to create consistent, point-in-time backup copies of local and cloud data. The snap-in runs on a Windows <!-- deleted by customization Server-based --><!-- keep by customization: begin --> Serverâbased <!-- keep by customization: end --> host. You can use StorSimple Snapshot Manager to:
