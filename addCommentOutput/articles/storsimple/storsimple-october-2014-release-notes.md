...
The following release notes identify the critical open issues for <!-- deleted by customization StorSimple 8000 Series Update 0.1 released in --><!-- keep by customization: begin --> the <!-- keep by customization: end --> October 2014 <!-- keep by customization: begin --> release of Windows Azure StorSimple <!-- keep by customization: end -->. They also contain a list of the StorSimple software and firmware updates included in this release. This is the first release after the <!-- keep by customization: begin --> General Availability (GA) release of Windows Azure <!-- keep by customization: end --> StorSimple <!-- deleted by customization 8000 Series Release version was made generally available in July 2014 --> and corresponds to software version 6.3.9600.17312.

We recommend that you scan for and apply any available updates immediately after you install the device. You can also turn on automatic updates to download and install high-priority updates from Microsoft as soon as they are released. For more information, see how to <!-- deleted by customization [Update your StorSimple device](/documentation/articles/storsimple-update-device) --><!-- keep by customization: begin --> install [Updates](https://msdn.microsoft.com/zh-cn/library/azure/1a2cd7de-706b-4d3c-8efb-02e322d3ae73#BKMK_Updates) <!-- keep by customization: end -->.
...
- Ensure that ports 80 and 443 are available on your StorSimple device for outbound communication. For more information, see the [Networking requirements for <!-- deleted by customization your --> StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-system-requirements#networking-requirements-for-your-storsimple-device) --><!-- keep by customization: begin --> device](https://msdn.microsoft.com/zh-cn/library/azure/dn772371.aspx) <!-- keep by customization: end -->.
...
- You can now use the StorSimple Manager service UI to manage your device controllers. The management actions include restart, shutdown, or turn on a controller. For more information, go to [Manage <!-- deleted by customization StorSimple --> device <!-- deleted by customization controllers](/documentation/articles/storsimple-manage-device-controller) --><!-- keep by customization: begin --> controllers](https://msdn.microsoft.com/zh-cn/library/azure/3216e992-f6ae-41c9-9ca4-f671342e1ab3#ManageControllers) <!-- keep by customization: end -->.
- You can schedule WAN bandwidth allocation according to day-of-the-week and time-of-day combinations. This allows you to make better use of WAN bandwidth during off-peak hours. Different bandwidth templates are permitted for different volume containers. For more information, go to <!-- deleted by customization [Manage your StorSimple bandwidth templates](/documentation/articles/storsimple-manage-bandwidth-templates) --><!-- keep by customization: begin --> [Bandwidth templates](https://msdn.microsoft.com/zh-cn/library/azure/1747f56e-858a-4cfe-a020-949d7db23b8b#bt) <!-- keep by customization: end -->.
- You can configure email notifications to proactively notify the administrator(s) and others of existing or possibly upcoming issues. For more information, go to [Configure alert <!-- deleted by customization settings](/documentation/articles/storsimple-manage-alerts#configure-alert-settings) --><!-- keep by customization: begin --> settings](https://msdn.microsoft.com/zh-cn/library/azure/02f1412f-e196-4a88-8eda-2113247ea47c#sec_11) <!-- keep by customization: end -->.
...
| 2 | Factory reset | Do not factory reset a StorSimple device that is updated from GA to October 2014 release. | This operation will only work if a patch is installed. Contact Microsoft Support to get this required patch. | Yes | <!-- deleted by customization No --> |
...
| 5 | Incorrect controller ID | When a controller replacement is performed, controller 0 may show up as controller 1. During controller replacement, when the image is loaded from the peer node, the controller ID can show up initially as the peer <!-- deleted by customization controllerâs --><!-- keep by customization: begin --> controller's <!-- keep by customization: end --> ID. In rare instances, this behavior may also be seen after a system <!-- deleted by customization reboot. |No --><!-- keep by customization: begin --> reboot.	No <!-- keep by customization: end --> user action is required. This situation will resolve itself after the controller replacement is complete. | Yes | No |
...
| 7 | Storage accounts | Using the Storage service to delete the storage account is an unsupported scenario. This will lead to a situation in which user data cannot be retrieved. | <!-- deleted by customization | --> Yes | Yes |
...
| 10 | Web proxy | If your web proxy configuration has HTTPS as the specified protocol, then your device-to-service communication will be affected and the device will go offline. Support packages will also be generated in the process, consuming significant resources on your device. | Make sure that the web proxy URL has HTTP as the specified protocol. More information on how to [Configure web proxy for your <!-- deleted by customization device](/documentation/articles/storsimple-configure-web-proxy) --><!-- keep by customization: begin --> device](https://msdn.microsoft.com/zh-cn/library/azure/dn764937.aspx) <!-- keep by customization: end -->. | Yes | No |
