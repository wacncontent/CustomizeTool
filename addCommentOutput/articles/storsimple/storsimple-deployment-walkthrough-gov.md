...
Welcome to <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple device deployment. These deployment tutorials apply to the StorSimple 8000 Series running Update 1 software in the Azure Government Portal. This series of tutorials describes how to configure your StorSimple device, and includes a configuration checklist, configuration prerequisites, and detailed configuration steps.
...
> - For MPIO and iSCSI installation and configuration instructions on a Linux host, go to [Configure MPIO for your StorSimple Linux <!-- deleted by customization host](/documentation/articles/storsimple-configure-mpio-linux) --><!-- keep by customization: begin --> host](storsimple-configure-mpio-linux.md) <!-- keep by customization: end -->
...
For MPIO installation instructions for a StorSimple device connected to a Linux host, go to [Configure MPIO for your Linux <!-- deleted by customization host](/documentation/articles/storsimple-configure-mpio-linux) --><!-- keep by customization: begin --> host](storsimple-configure-mpio-linux.md) <!-- keep by customization: end -->.
