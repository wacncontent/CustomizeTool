<properties 
   pageTitle="Configure MPIO for your StorSimple device | Windows Azure"
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> To install MPIO on the host
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> To configure MPIO for StorSimple volumes
...
<!-- deleted by customization #### --><!-- keep by customization: begin --> ### <!-- keep by customization: end --> To mount volumes on the host
...
4. Repeat steps 2-3 for a second network interface (for example, DATA 1) on your device. Keep in mind that these interfaces should be enabled for iSCSI. To learn more about this, <!-- deleted by customization see [Modify --><!-- keep by customization: begin --> go to [Configure <!-- keep by customization: end --> network <!-- deleted by customization interfaces](/documentation/articles/storsimple-modify-device-config#modify-network-interfaces) --><!-- keep by customization: begin --> interfaces](https://msdn.microsoft.com/zh-cn/library/02f1412f-e196-4a88-8eda-2113247ea47c#sec05) <!-- keep by customization: end -->.
...
Learn more about [using the StorSimple Manager service to modify your StorSimple device configuration](/documentation/articles/storsimple-modify-device-config).
