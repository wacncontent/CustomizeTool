...
Welcome to <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure StorSimple device deployment. These deployment tutorials apply to StorSimple 8000 Series Update 1.0. This series of tutorials describes how to configure your StorSimple device, and includes a configuration checklist, configuration prerequisites, and detailed configuration steps.

The information in these tutorials assumes that you have reviewed the safety precautions, and unpacked, racked, and cabled your StorSimple device. If you still need to perform those tasks, start with reviewing the [safety <!-- deleted by customization precautions](/documentation/articles/storsimple-safety) --><!-- keep by customization: begin --> precautions](storsimple-safety.md) <!-- keep by customization: end -->. Depending on your device model, you can then unpack, rack mount, and cable by following the instructions in:

- [Unpack, rack mount, and cable your <!-- deleted by customization 8100](/documentation/articles/storsimple-8100-hardware-installation) --><!-- keep by customization: begin --> 8100](storsimple-8100-hardware-installation.md) <!-- keep by customization: end -->
- [Unpack, rack mount, and cable your <!-- deleted by customization 8600](/documentation/articles/storsimple-8600-hardware-installation) --><!-- keep by customization: begin --> 8600](storsimple-8600-hardware-installation.md) <!-- keep by customization: end -->
...
> [AZURE.NOTE] The StorSimple deployment information published on the <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure website applies to StorSimple 8000 series devices only. For complete information about the 7000 series devices, go to: [http://onlinehelp.storsimple.com/](http://onlinehelp.storsimple.com). For 7000 series deployment information, see the [StorSimple System Quick Start Guide](http://onlinehelp.storsimple.com/111_Appliance/).
...
|                                        | Service Registration Key                          | This key is generated from the Azure <!-- deleted by customization Management Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end -->.    |        |
...
|                                        | Network interface: Data 0 controller fixed IPs          | These <!-- deleted by customization IPâs --><!-- keep by customization: begin --> IP’s <!-- keep by customization: end --> should be routable to the Internet.</br>Controller 0 fixed IP address:</br>Controller 1 fixed IP address:|
|   |   |  |  |
...
- You have your <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure storage account with access credentials.

- Your <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure subscription is enabled for the StorSimple Manager service. Your subscription should be purchased through the [Enterprise <!-- deleted by customization Agreement](/pricing/enterprise-agreement/) --><!-- keep by customization: begin --> Agreement](http://azure.microsoft.com/pricing/enterprise-agreement/) <!-- keep by customization: end -->.
...
- The ports in your datacenter firewall are opened to allow for iSCSI and cloud traffic as described in [Networking requirements for your StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-system-requirements#networking-requirements-for-your-storsimple-device) --><!-- keep by customization: begin --> device](storsimple-system-requirements.md#networking-requirements-for-your-storsimple-device) <!-- keep by customization: end -->.
...
> - For MPIO and iSCSI installation and configuration instructions on Windows Server host, go to [Configure MPIO for your StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-configure-mpio-windows-server) --><!-- keep by customization: begin --> device](storsimple-configure-mpio-windows-server.md) <!-- keep by customization: end -->. These will also include the steps to mount, initialize and format StorSimple volumes.

> - For MPIO and iSCSI installation and configuration instructions on a Linux host, go to [Configure MPIO for your StorSimple Linux <!-- deleted by customization host](/documentation/articles/storsimple-configure-mpio-on-linux) --><!-- keep by customization: begin --> host](storsimple-configure-mpio-on-linux.md) <!-- keep by customization: end -->
...
This is an optional step that you need to perform only if you did not enable the automatic creation of a storage account with your service. A <!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure storage account is required to create a StorSimple volume container.

If you need to create an Azure storage account in a different region, see [About Azure Storage <!-- deleted by customization Accounts](/documentation/articles/storage-create-storage-account) --><!-- keep by customization: begin --> Accounts](../storage/storage-create-storage-account.md) <!-- keep by customization: end --> for step-by-step instructions.
...
[AZURE.INCLUDE [Use PuTTY to connect to the device serial <!-- deleted by customization console](../includes/storsimple-use-putty.md)] --><!-- keep by customization: begin --> console](../../includes/storsimple-use-putty.md)] <!-- keep by customization: end -->
...
Perform the following steps to get the iSCSI Qualified Name (IQN) of a Windows host that is running Windows <!-- deleted by customization ServerÂŽ --><!-- keep by customization: begin --> Server® <!-- keep by customization: end --> 2012.
...
Multipath I/O (MPIO) is an optional feature and is not installed on Windows Server by default. It should be installed as a feature through Server Manager. For MPIO installation instructions, go to [Configure MPIO for your StorSimple <!-- deleted by customization device](/documentation/articles/storsimple-configure-mpio-windows-server) --><!-- keep by customization: begin --> device](storsimple-configure-mpio-windows-server.md) <!-- keep by customization: end -->.

For MPIO installation instructions for a StorSimple device connected to a Linux host, go to [Configure MPIO for your Linux <!-- deleted by customization host](/documentation/articles/storsimple-configure-mpio-on-linux) --><!-- keep by customization: begin --> host](storsimple-configure-mpio-on-linux.md) <!-- keep by customization: end -->.
...
Use the [StorSimple Manager service](/documentation/articles/storsimple-manager-service-administration) to manage your StorSimple device.
-->
<!-- keep by customization: begin -->
