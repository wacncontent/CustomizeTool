...
- If you click **Local Snapshot** or **Cloud Snapshot**, the **Results** pane shows the following information about each backup snapshot (depending on your **View** settings): 
    ...
    - **Name** <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> the time the snapshot was taken.

    - **Type** <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> whether this is a local snapshot or a cloud snapshot.
...
- If you expand **Local Snapshot** or **Cloud Snapshot**, and then click an individual snapshot name, the **Results** pane shows the following information about the snapshot that you selected:
    ...
    - **Name** <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> the volume identified by drive letter.

    - **Local Name** <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> the local name of the drive (if available).

    - **Device** <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> the name of the device on which the volume resides.

    - **Available** <!-- deleted by customization - --><!-- keep by customization: begin --> – <!-- keep by customization: end --> whether the snapshot is currently available. **True** indicates that the snapshot is available and can be restored; **False** indicates that the snapshot is no longer available.
...
5. When the cloning process is finished, you must initialize the cloned volume. Start Server Manager, and then start Disk Management. For detailed instructions, see [Mount <!-- deleted by customization volumes](/documentation/articles/storsimple-snapshot-manager-manage-volumes#mount-volumes) --><!-- keep by customization: begin --> volumes](storsimple-snapshot-manager-manage-volumes.md#mount-volumes) <!-- keep by customization: end -->. After it is initialized, the volume will be listed under the **Volumes** node in the **Scope** pane. If you do not see the volume listed, refresh the list of volumes (right-click the **Volumes** node, and then click **Refresh**).
...
5. When the cloning process is finished, you must initialize the cloned volume. Start Server Manager, and then start Disk Management. For detailed instructions, see [Mount <!-- deleted by customization volumes](/documentation/articles/storsimple-snapshot-manager-manage-volumes#mount-volumes) --><!-- keep by customization: begin --> volumes](storsimple-snapshot-manager-manage-volumes.md#mount-volumes) <!-- keep by customization: end -->. After it is initialized, the volume will be listed under the **Volumes** node in the **Scope** pane.
...
- Learn more about [StorSimple Snapshot Manager tasks and <!-- deleted by customization workflows](/documentation/articles/storsimple-snapshot-manager-admin#storsimple-snapshot-manager-tasks-and-workflows) --><!-- keep by customization: begin --> workflows](storsimple-snapshot-manager-admin.md#storsimple-snapshot-manager-tasks-and-workflows) <!-- keep by customization: end -->.
