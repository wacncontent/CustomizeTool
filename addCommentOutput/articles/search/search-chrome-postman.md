...
You must have an Azure Search service. As with any custom application that uses Azure Search, you will need the URL to your service, plus an admin `api-key` so that you can create the index. For instructions on how to get the values for your search service, see [Create a service in the <!-- deleted by customization portal](/documentation/articles/search-create-service-portal) --><!-- keep by customization: begin --> portal](search-create-service-portal.md) <!-- keep by customization: end -->.
...
2. Append to the URL: `?api-version=2015-02-28`. You could also specify a different API version. See [Azure Search service <!-- deleted by customization versioning](https://msdn.microsoft.com/zh-cn/library/azure/dn864560.aspx) --><!-- keep by customization: begin --> versioning](https://msdn.microsoft.com/library/azure/dn864560.aspx) <!-- keep by customization: end --> for details.
...
1. Change the URL to: `https://[SEARCH <!-- deleted by customization SERVICE].search.chinacloudapi.cn/indexes/trails?api-version=2015-02-28` --><!-- keep by customization: begin --> SERVICE].search.windows.net/indexes/trails?api-version=2015-02-28` <!-- keep by customization: end --> using your search service name.
...
1. Change the URL to: `https://[SEARCH <!-- deleted by customization SERVICE].chinacloudapi.cn/indexes/trails/docs/index?api-version=2015-02-28` --><!-- keep by customization: begin --> SERVICE].windows.net/indexes/trails/docs/index?api-version=2015-02-28` <!-- keep by customization: end --> using your search service name. Notice that the URL includes a path to the index you just created.
...
1. Enter the following in the URL: `https://[SEARCH <!-- deleted by customization SERVICE].search.chinacloudapi.cn/indexes/trails/docs?api-version=2015-02-28&search=trail` --><!-- keep by customization: begin --> SERVICE].search.windows.net/indexes/trails/docs?api-version=2015-02-28&search=trail` <!-- keep by customization: end --> using your search service name. Notice that the URL includes the `search` query parameter and a search term of *trail*.
...
Documentation for the REST API can be found on <!-- deleted by customization [MSDN](https://msdn.microsoft.com/zh-cn/library/azure/dn798935.aspx) --><!-- keep by customization: begin --> [MSDN](https://msdn.microsoft.com/library/azure/dn798935.aspx) <!-- keep by customization: end -->.

You can also visit the [Video and tutorial <!-- deleted by customization list](/documentation/articles/search-video-demo-tutorial-list) --><!-- keep by customization: begin --> list](search-video-demo-tutorial-list.md) <!-- keep by customization: end --> for more examples.
