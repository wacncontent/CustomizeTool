...
You will need an Azure subscription and an Azure Search service to complete the tutorial. See [Create a Search service in the <!-- deleted by customization portal](/documentation/articles/search-create-service-portal) --><!-- keep by customization: begin --> portal](search-create-service-portal.md) <!-- keep by customization: end --> for help with setting up the service.
...
**Schema.json** defines the index, including the scoring profiles that are emphasized in this demo. Notice that the schema defines all of the fields used in the index, including non-searchable fields, such as `margin`, that you can use in a scoring profile. Scoring profile syntax is documented in [Add a scoring profile to an Azure Search <!-- deleted by customization index](http://msdn.microsoft.com/zh-cn/library/azure/dn798928.aspx) --><!-- keep by customization: begin --> index](http://msdn.microsoft.com/library/azure/dn798928.aspx) <!-- keep by customization: end -->.
...
Learn more about scoring profiles. See [Add a scoring profile to an Azure Search <!-- deleted by customization index](http://msdn.microsoft.com/zh-cn/library/azure/dn798928.aspx) --><!-- keep by customization: begin --> index](http://msdn.microsoft.com/library/azure/dn798928.aspx) <!-- keep by customization: end --> for details.

Learn more about search syntax and query parameters. See [Search Documents (Azure Search REST <!-- deleted by customization API)](http://msdn.microsoft.com/zh-cn/library/azure/dn798927.aspx) --><!-- keep by customization: begin --> API)](http://msdn.microsoft.com/library/azure/dn798927.aspx) <!-- keep by customization: end --> for details.
