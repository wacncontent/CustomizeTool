...
[Create an ASP.NET MVC app with auth and SQL DB and deploy to Azure Web <!-- deleted by customization App]:web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database.md --><!-- keep by customization: begin --> App]: /documentation/articles/web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database <!-- keep by customization: end -->
