...
-	[Azure AD](/documentation/articles/web-sites-dotnet-lob-application-azure-ad) - You can implement authentication and authorization for your web app with Azure AD. Using Azure AD as the identity provider has the following characteristics:
	...
	-	Sends a general-purpose set of claim types for all relying party applications. For the list of claim types, see [Supported Token and Claim <!-- deleted by customization Types](http://msdn.microsoft.com/zh-cn/library/azure/dn195587.aspx) --><!-- keep by customization: begin --> Types](/documentation/articles/active-directory-token-and-claims/) <!-- keep by customization: end -->. Claims are not customizable.
