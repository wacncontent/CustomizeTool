...
- **Azure subscription** - For a free subscription, see [Azure <!-- deleted by customization Trial](/pricing/1rmb-trial/) --><!-- keep by customization: begin --> Trial](/zh-cn/pricing/1rmb-trial/) <!-- keep by customization: end -->.

- **Visual Studio 2013** - To download a trial version of Visual Studio 2013, see [Visual Studio <!-- deleted by customization Downloads](http://www.visualstudio.com/downloads/download-visual-studio-vs) --><!-- keep by customization: begin --> Downloads](http://www.visualstudio.com/zh-cn/downloads/download-visual-studio-vs) <!-- keep by customization: end -->. Install this before continuing.

- **Microsoft .NET Framework 3.5 Service Pack 1** - If your operating system is Windows 8.1, Windows Server 2012 R2, Windows 8, Windows Server 2012, Windows 7, or Windows Server 2008 R2, you can enable this in Control Panel > Programs and Features > Turn Windows features on or off. Otherwise, you can download it from the [Microsoft Download <!-- deleted by customization Center](http://www.microsoft.com/download/en/details.aspx?displaylang=en&id=22) --><!-- keep by customization: begin --> Center](http://www.microsoft.com/zh-cn/download/details.aspx?displaylang=en&id=22) <!-- keep by customization: end -->.
...
5671 and 9352|**Recommended**<!-- keep by customization: begin --> <td><strong>Recommended</strong> <!-- keep by customization: end --> but Optional for data connectivity. Note this mode usually yields higher throughput. If outbound connectivity to these ports is unavailable, TCP port 443 is used.<!-- keep by customization: begin --> used.</td> <!-- keep by customization: end -->
-->
<!-- keep by customization: begin -->
> <table border="1">
    <tr>
	...
	<tr>
        <td>5671 and 9352</td>
<!-- keep by customization: begin --> <td><strong>Recommended</strong> <!-- keep by customization: end --> but Optional for data connectivity. Note this mode usually yields higher throughput. If outbound connectivity to these ports is unavailable, TCP port 443 is <!-- keep by customization: begin --> used.</td> <!-- keep by customization: end -->
	</tr>
</table>
...
1. Back in the portal, scroll down your web app's blade and click <!-- deleted by customization **Network Feature status** > **Configure your hybrid connection endpoints** --><!-- keep by customization: begin --> **Hybrid connections** <!-- keep by customization: end -->.
<!-- deleted by customization
...
<!-- deleted by customization ### Run --><!-- keep by customization: begin --> ###Run <!-- keep by customization: end --> the project locally and register a new user ###
...
Now, you'll publish your application to your <!-- keep by customization: begin --> website on <!-- keep by customization: end --> Azure <!-- deleted by customization Websites web app --> and then test it to see how the hybrid connection you configured earlier is being used to connect your <!-- deleted by customization web app --><!-- keep by customization: begin --> website application <!-- keep by customization: end --> to the database on your local machine.
