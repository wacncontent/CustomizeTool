...
> [AZURE.NOTE] These steps can also be performed by using the [Azure  Portal](https://portal.azure.cn/)  Management Portal](https://manage.windowsazure.cn/) . See [Build and deploy a Node.js web app in Azure].
>
