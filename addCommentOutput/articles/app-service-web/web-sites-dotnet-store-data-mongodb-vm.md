...
1. In the **New ASP.NET Project** dialog box, select **MVC**, and then click **OK**. <!-- keep by customization: begin --> Make sure **Host in the cloud** is unchecked, and click **OK**. <!-- keep by customization: end -->
