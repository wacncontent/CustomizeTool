...
## Set up the styles ##
To change the title at the top of the page, open the <!-- deleted by customization *Views\Shared\_Layout.cshtml* --><!-- keep by customization: begin --> *Views\Shared_Layout.cshtml* <!-- keep by customization: end --> file in **Solution Explorer** and replace "Application name" in the navbar header with "My Task List Application" so that it looks like this:
