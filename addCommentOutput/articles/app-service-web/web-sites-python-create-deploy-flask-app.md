...
- Git
- [Python Tools for Visual <!-- deleted by customization Studio][](/documentation/articles/PTVS) --><!-- keep by customization: begin --> Studio][] <!-- keep by customization: end --> - Note: this is optional
