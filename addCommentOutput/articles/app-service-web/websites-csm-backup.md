...
## Getting Started
To send REST requests, you will need to know your app's **name**, **resource group** <!-- keep by customization: begin --> (by default it's "Default-Web-ChinaEast" or "Default-Web-ChinaNorth" depending on the location of you web site) <!-- keep by customization: end -->, and **subscription id**. This information can be found by clicking <!-- deleted by customization on your app --><!-- keep by customization: begin --> the **Dashboard** of you web site <!-- keep by customization: end --> in <!-- deleted by customization the **App Services** blade of --> the [Azure Management Portal](https://manage.windowsazure.cn). For the examples in this article, we will be configuring the website `backuprestoreapiexamples.chinacloudsites.cn`. It is stored in the <!-- deleted by customization Default-Web-WestUS --><!-- keep by customization: begin --> Default-Web-ChinaEast <!-- keep by customization: end --> resource group and is running on a subscription with the ID 00001111-2222-3333-4444-555566667777.
...
Here is what the URL looks like using our example website. <!-- deleted by customization `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-WestUS/providers/Microsoft.Web/sites/backuprestoreapiexamples/backup/` --><!-- keep by customization: begin --> `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-ChinaEast/providers/Microsoft.Web/sites/backuprestoreapiexamples/backup/` <!-- keep by customization: end -->
...
Here is what the URL looks like for our example website. <!-- deleted by customization `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-WestUS/providers/Microsoft.Web/sites/backuprestoreapiexamples/config/backup` --><!-- keep by customization: begin --> `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-ChinaEast/providers/Microsoft.Web/sites/backuprestoreapiexamples/config/backup` <!-- keep by customization: end -->
...
The URL for our example site is <!-- deleted by customization `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-WestUS/providers/Microsoft.Web/sites/backuprestoreapiexamples/config/backup/list` --><!-- keep by customization: begin --> `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-ChinaEast/providers/Microsoft.Web/sites/backuprestoreapiexamples/config/backup/list` <!-- keep by customization: end -->.
...
Here is what the URL looks like for our example website. <!-- deleted by customization `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-WestUS/providers/Microsoft.Web/sites/backuprestoreapiexamples/backups/1` --><!-- keep by customization: begin --> `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-ChinaEast/providers/Microsoft.Web/sites/backuprestoreapiexamples/backups/1` <!-- keep by customization: end -->
...
Here is what the URL looks like for our example website. <!-- deleted by customization `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-WestUS/providers/Microsoft.Web/sites/backuprestoreapiexamples/backups/1/restore` --><!-- keep by customization: begin --> `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-ChinaEast/providers/Microsoft.Web/sites/backuprestoreapiexamples/backups/1/restore` <!-- keep by customization: end -->
...
Azure <!-- keep by customization: begin --> Web App <!-- keep by customization: end --> will attempt to delete your backup from Azure Storage using the SAS URL that was provided when the backup was created. If this SAS URL is no longer valid, the backup cannot be deleted through the REST API. However, you can update the SAS URL associated with a backup by sending a **POST** request to the URL `https://manage.windowsazure.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/backups/{id}/list`.

Here is what the URL looks like for our example website. <!-- deleted by customization `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-WestUS/providers/Microsoft.Web/sites/backuprestoreapiexamples/backups/1/list` --><!-- keep by customization: begin --> `https://manage.windowsazure.cn/subscriptions/00001111-2222-3333-4444-555566667777/resourceGroups/Default-Web-ChinaEast/providers/Microsoft.Web/sites/backuprestoreapiexamples/backups/1/list` <!-- keep by customization: end -->
