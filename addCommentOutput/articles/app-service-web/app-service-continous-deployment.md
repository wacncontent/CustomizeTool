...
2. In your app's blade in the [Azure  Portal]  Portal Preview] , click **Settings > Deployment Source**. Click **Choose Source**, then click **GitHub**, for example.
...
1. In your app's blade in the [Azure  Portal]  Portal Preview] , click **Settings > Deployment Source**. Then click **Disconnect** in the **Deployments** blade.
