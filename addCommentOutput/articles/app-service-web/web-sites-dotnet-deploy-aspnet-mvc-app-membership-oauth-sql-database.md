...
1. In the **New ASP.NET Project** dialog box, select the **MVC** template. Verify **Authentication** is set to **Individual User Accounts**, **Host in the cloud** is checked, and <!-- deleted by customization **App Services** --><!-- keep by customization: begin --> **Azure Websitess** <!-- keep by customization: end --> is selected.
