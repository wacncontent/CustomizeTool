...
In the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , you can configure continuous deployment from GitHub, Bitbucket, and Visual Studio Team Services.
...
In the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , you can configure local Git deployment.
