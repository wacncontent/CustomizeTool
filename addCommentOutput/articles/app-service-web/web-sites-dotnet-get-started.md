...
5. In the **Azure** section of the **New ASP.NET Project** dialog box, make sure that **Host in the cloud** is  NOT  selected  and that **App Service** is selected in the drop-down list .
...
* Monitor and manage your web app in the [Azure  portal](https://portal.azure.cn/)  Portal Preview](https://portal.azure.cn/) .
...
* Delete the resource group that contains your web app and any related Azure resources when you're done with them.
	...
	For information about how to work with resource groups in the Azure  portal  Portal   Preview , see [Deploy resources with Resource Manager templates and Azure  portal](/documentation/articles/resource-group-template-deploy-portal/)  Portal Preview](/documentation/articles/resource-group-template-deploy-portal/) .
