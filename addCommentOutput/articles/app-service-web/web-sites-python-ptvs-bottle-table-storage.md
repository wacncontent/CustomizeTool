<properties 
	...
	description="Learn how to use the Python Tools for Visual Studio to create a Bottle application that stores data in Azure Table Storage and deploy the web site to Azure Websites." 
...
In this tutorial, we'll use [Python Tools for Visual Studio] to create a simple polls web site using one of the PTVS sample templates. <!-- deleted by customization This tutorial is also available as a [video](https://www.youtube.com/watch?v=GJXDGaEPy94). -->
...
We'll learn how to create an Azure Storage account, how to configure the web site to use Azure Table Storage, and how to publish the web site to [Azure Websites](/documentation/services/web-sites/)s.
...
2. Click the **New** icon on the <!-- deleted by customization top --><!-- keep by customization: begin --> bottom <!-- keep by customization: end --> left of the <!-- deleted by customization Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end -->, then click **DATA SERVICE** > <!-- deleted by customization **Storage Account** --><!-- keep by customization: begin --> **Storage** <!-- keep by customization: end -->. <!-- deleted by customization  Click the **Create** button, then give --><!-- keep by customization: begin --> Give <!-- keep by customization: end --> the storage account a unique name and create a new [resource group](/documentation/articles/resource-group-overview) for it.
...
The Azure .NET SDK provides an easy way to deploy your web site to Azure Websites.
...
1.  Fill in the following fields and click **Create**.
	...
	-	Leave **Database server** set to **No database**
  	...
  	<!-- ![Create web site on Windows Azure Dialog](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonCreateWebSite.png) -->

1.  Accept all other defaults and click **Publish**.

1.  Your web browser will open automatically to the published web site. If you browse to the about page, you'll see that it uses the **In-Memory** repository, not the **Azure Table Storage** repository.
...
1.  In [Azure Management Portal], open the web site's blade by clicking <!-- deleted by customization **Browse** > -->**Web Apps** > your web site name.

1.  In your web site's blade, click **Configure** <!-- deleted by customization, then click **Application Settings** -->.
...
1.  You should see the web site working as expected, using the **Azure Table Storage** repository.
