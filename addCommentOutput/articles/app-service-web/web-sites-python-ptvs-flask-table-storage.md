<properties 
	...
	description="Learn how to use the Python Tools for Visual Studio to create a Flask web site that stores data in Azure Table Storage and deploy it to Azure Websites." 
...
In this tutorial, we'll use [Python Tools for Visual Studio] to create a simple polls web site using one of the PTVS sample templates. This tutorial is also available as a [video](https://www.youtube.com/watch?v=qUtZWtPwbTk).
...
We'll learn how to create an Azure Storage account, how to configure the web site to use Azure Table Storage, and how to publish the web site to [Azure Websites](/documentation/services/web-sites/).
...
2. Click the **New** icon on the <!-- deleted by customization top --><!-- keep by customization: begin --> bottom <!-- keep by customization: end --> left of the <!-- deleted by customization Portal --><!-- keep by customization: begin --> portal <!-- keep by customization: end -->, then click **DATA SERVICE** > <!-- deleted by customization **Storage Account** --><!-- keep by customization: begin --> **Storage** <!-- keep by customization: end -->. <!-- deleted by customization Click on **Create**, then give --><!-- keep by customization: begin --> Give <!-- keep by customization: end --> the storage account a unique name and create a new [resource group](/documentation/articles/resource-group-overview) for it.
...
1.  In [Azure Management <!-- deleted by customization Portal](https://manage.windowsazure.cn) --><!-- keep by customization: begin --> Portal] <!-- keep by customization: end -->, open the web site's blade by clicking <!-- deleted by customization **Browse** > -->**Web Apps** > your web site name.
