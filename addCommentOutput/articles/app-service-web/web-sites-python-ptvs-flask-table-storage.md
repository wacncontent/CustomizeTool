...
1.  In [Azure Management <!-- deleted by customization Portal](https://manage.windowsazure.cn) --><!-- keep by customization: begin --> Portal] <!-- keep by customization: end -->, open the web app's blade by clicking <!-- deleted by customization **Browse** > --> **Web Apps** > your web app name.
