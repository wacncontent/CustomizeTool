...
We'll learn how to create an Azure Storage account, how to configure the web app to use Azure Table Storage, and how to publish the web app to [Azure App Service Web Apps](/documentation/articles/app-service-changes-existing-services/).
...
1.  Log into the [Azure  Portal](https://portal.azure.cn/)  Portal Preview](https://portal.azure.cn/) .

2. Click the **New** icon on the top left of the Portal, then click **Data + Storage** > **Storage Account**. Click on **Create**, then give the storage account a unique name and create a new [resource group](/documentation/articles/resource-group-overview/) for it.  You should choose Classic Deployment model, otherwise you will not be able to manage the storage account in Visual  Studio. 
...
1.  In [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , open the web app's blade by clicking **Browse** > **App Services** > your web app name.
