...
When the *SSL settings* are displayed, you will see the fields. If a domain is not listed here, it will not be available for mapping inside WordPress, regardless of how the domain DNS is setup.
