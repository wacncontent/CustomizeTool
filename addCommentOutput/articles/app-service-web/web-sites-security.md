...
<!-- deleted by customization - --><!-- keep by customization: begin --> <!- <!-- keep by customization: end --> **Application security** - You need to design the app itself securely. This includes how you integrate with Azure Active Directory, how you manage certificates, and how you make sure that you can securely talk to different services.
