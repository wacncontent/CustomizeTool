...
This is often the simplest way to recover from one-time issues. On the [Azure  Portal](https://portal.azure.cn/)  Management Portal](https://manage.windowsazure.cn/) , on your web app's blade, you have the options to stop or restart your app.
