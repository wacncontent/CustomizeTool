<properties
	pageTitle="Connect a web app in Azure App Service to Redis Cache via the Memcache protocol | Azure"
...
In order to configure Memcache shim, you must create three app settings. This can be done using a variety of methods including the [Azure  Portal](/documentation/articles/app-service-web-app-azure-portal/)  Portal Preview][3] , the [Classic Management  Portal][3]  Portal](https://manage.windowsazure.cn/) , the [Azure PowerShell  Cmdlets][5]  Cmdlets][4]  or the [Azure Command-Line Interface][5]. For the purposes of this post, I'm going to use the [Azure  Portal][4]  Portal Preview][3]  to set the app settings. The following values can be retrieved from **Settings** blade of your Redis Cache instance.
