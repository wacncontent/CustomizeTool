...
This is often the simplest way to recover from one-time issues. On the [Azure  Portal](https://portal.azure.cn/)  Classic Management Portal](https://manage.windowsazure.cn/) , on your web  app's blade  app , you have the options to stop or restart your app.
