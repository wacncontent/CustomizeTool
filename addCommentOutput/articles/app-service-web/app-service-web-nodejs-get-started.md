...
-  A  An  Azure account. If you don't have an account, you can [sign up for a trial]  or [activate your Visual Studio subscriber benefits] .
...
2. `CD` to a working directory and generate an express app using the following syntax:
    ...
    `? Would you like to create a new directory for your project?`  **Yes**  **Yes**<br/> 
    `? Enter directory name`  **{appname}**  **{appname}**<br/> 
    `? Select a version to install:`  **MVC**  **MVC**<br/> 
    `? Select a view engine to use:`  **Jade**  **Jade**<br/> 
    `? Select a css preprocessor to use (Sass Requires Ruby):`  **None**  **None**<br/> 
    `? Select a database to use:`  **None**  **None**<br/> 
...
2. Make sure you're still in the root directory of your app, then create the App Service app resource in Azure with a unique app name with the next command; for example: http://{appname}.chinacloudsites.cn
