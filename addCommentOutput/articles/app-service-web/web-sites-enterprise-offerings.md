...


##<a name="highlevel"></a> High Level Solution ##

...
- [Virtual Network Integration](https://azure.microsoft.com/documentation/articles/app-service-vnet-integration-powershell/) - Web Apps integration with Azure Virtual Network allows you to connect your web app to an Azure Virtual Network which in turn can be connected to your on premises infrastructure through a site-to-site VPN.
...
 In Azure China,  App Service Web Apps offers  multiple options  one option  for connecting to on premises resources, such as databases, enabling reuse of existing high value infrastructure. The  options are  option is  as listed below:
...
App Service Web Apps allows web applications to be configured to scale automatically via the Azure  portal  Portal   Preview , depending on two vectors - scheduled times or by CPU usage. Web Apps Auto Scaling provides a cost effective and extremely flexible way to cater for greater changes in usage for all business applications, from web applications like our expense reporting system to marketing websites, which experience a high burst of traffic for a short duration of promotion. For more information and guidance on scaling your web applications using Web Apps, see [How to Scale Websites](/documentation/articles/web-sites-scale/).
...
## Call to Action ##
For more information on the Azure App Service Web Apps service, visit  [http://aka.ms/enterprisewebsites](/home/features/web-site/enterprise/)  [http://aka.ms/enterprisewebsites](/home/features/app-service/web-apps/)  where more information can be sourced, and sign up for a trial today at [http://aka.ms/azuretrial](/pricing/1rmb-trial/) to evaluate the service and discover the benefits for your business.
