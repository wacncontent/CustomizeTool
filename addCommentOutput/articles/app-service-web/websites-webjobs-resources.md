...
The WebJobs dashboard in the Azure  portal  Portal   Preview  provides powerful management capabilities that give you full control over the execution of WebJobs, including the ability to invoke individual functions within WebJobs. The dashboard also displays function runtimes and logging output.
...
* [How to deploy WebJobs using the Azure  Portal](/documentation/articles/web-sites-create-web-jobs/)  Portal Preview](/documentation/articles/web-sites-create-web-jobs/) 
...
* [Create a Scheduled WebJob in the Azure  Portal](/documentation/articles/web-sites-create-web-jobs/#CreateScheduled)  Portal Preview](/documentation/articles/web-sites-create-web-jobs/#CreateScheduled) 
