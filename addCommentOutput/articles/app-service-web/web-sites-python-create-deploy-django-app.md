...
- Select the base interpreter. Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the  **Application Settings** blade of your web  app  in the Azure Management Portal)  configuration page) .
...
Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the  Application Settings blade of your web  app  in the Azure Management Portal)  configuration page) .
