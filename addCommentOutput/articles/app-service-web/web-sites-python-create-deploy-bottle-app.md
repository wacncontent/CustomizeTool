...
- Select the base interpreter. Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the <!-- deleted by customization **Application Settings** blade of your web --> app in the Azure Management Portal).
...
Visual Studio doesn't show the progress of the deployment. <!-- deleted by customization If you'd like to review the output, see the section on [Troubleshooting - Deployment](#troubleshooting-deployment). -->
...
Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the <!-- deleted by customization Application Settings blade for your web --> app in the Azure Management Portal)
...
Make sure to use the same version of Python that is selected for your web app (in runtime.txt or the <!-- deleted by customization Application Settings blade of your web --> app in the Azure Management Portal).
