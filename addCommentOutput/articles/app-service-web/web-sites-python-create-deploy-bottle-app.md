...
The first step in creating your app is to create the web app via the [Azure  Portal](https://portal.azure.cn)  Classic Management Portal](https://manage.windowsazure.cn) .
