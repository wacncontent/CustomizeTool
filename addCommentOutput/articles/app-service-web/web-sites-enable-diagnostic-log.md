...


This article uses the [Azure Portal Preview](https://portal.azure.cn), Azure PowerShell, and the Azure Command-Line Interface (Azure CLI) to work with diagnostic logs.

...
To enable diagnostics in the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , go to the blade for your web app and click **Settings > Diagnostics logs**.
...
* For a guide to the change of the old portal to the new portal see: [Reference for navigating the Azure  portal](/documentation/articles/app-service-web-app-azure-portal/)  Portal Preview](/documentation/articles/app-service-web-app-azure-portal/) 
