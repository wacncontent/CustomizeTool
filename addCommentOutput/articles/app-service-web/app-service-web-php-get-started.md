...
4. The last two tasks (setting the virtual directory and enabling Composer) requires the [Azure  portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , so log in to
...

 check  Check  out more helpful links for PHP in Azure below:
