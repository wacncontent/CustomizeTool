...
To restart the web app, select the web app in the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , and then click **RESTART** button:
...
To access the diagnostic information through FTP, visit the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , select your web app, and then select the **DASHBOARD**. In the **quick links** section, the **FTP DIAGNOSTIC LOGS** and **FTPS DIAGNOSTIC LOGS** links provide access to the logs using the FTP protocol.
