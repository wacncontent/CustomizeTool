...
This article shows how to deploy WebJobs by using the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) . For information about how to deploy by using Visual Studio or a continuous delivery process, see [How to Deploy Azure WebJobs to Web Apps](/documentation/articles/websites-dotnet-deploy-webjobs/).
...
1. In the **Web App** blade of the [Azure  Portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn) , click **All settings > WebJobs** to show the **WebJobs** blade.
