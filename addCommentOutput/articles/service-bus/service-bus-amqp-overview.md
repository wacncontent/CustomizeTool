...
[Using Service Bus from .NET with AMQP]: <!-- deleted by customization service-bus-amqp-dotnet.md --><!-- keep by customization: begin --> /documentation/articles/service-bus-amqp-dotnet <!-- keep by customization: end -->
[Using Service Bus from Java with AMQP]: <!-- deleted by customization service-bus-amqp-java.md --><!-- keep by customization: begin --> /documentation/articles/service-bus-amqp-java <!-- keep by customization: end -->
[Using Service Bus from Python with AMQP]: <!-- deleted by customization service-bus-amqp-python.md --><!-- keep by customization: begin --> /documentation/articles/service-bus-amqp-python <!-- keep by customization: end -->
[Using Service Bus from PHP with AMQP]: <!-- deleted by customization service-bus-amqp-php.md --><!-- keep by customization: begin --> /documentation/articles/service-bus-amqp-php <!-- keep by customization: end -->
[Installing Apache Qpid Proton-C on an Azure Linux VM]: <!-- deleted by customization service-bus-amqp-apache.md --><!-- keep by customization: begin --> /documentation/articles/service-bus-amqp-apache <!-- keep by customization: end -->
