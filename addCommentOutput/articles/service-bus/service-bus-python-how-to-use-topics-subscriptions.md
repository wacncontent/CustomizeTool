...
# How to <!-- deleted by customization use --><!-- keep by customization: begin --> Use <!-- keep by customization: end --> Service Bus topics and subscriptions
...
Topics and subscriptions are persistent, and must be explicitly deleted either through the Azure <!-- deleted by customization Management Portal --><!-- keep by customization: begin --> management portal <!-- keep by customization: end --> or programmatically. The following example shows how to delete the topic named `mytopic`:
