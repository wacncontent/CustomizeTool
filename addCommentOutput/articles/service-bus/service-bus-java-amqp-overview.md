<properties 
	pageTitle="Service Bus AMQP overview with Java | Windows Azure" 
...
For more information about how to obtain and use these libraries with Service Bus, see the [Service Bus AMQP Developer's Guide][]. See the [Next <!-- deleted by customization steps](/documentation/articles/service-bus-java-amqp-overview#next-steps) --><!-- keep by customization: begin --> steps](/documenatation/articles/service-bus-java-amqp-overview/#next-steps) <!-- keep by customization: end --> section for links to further information.
...
*    [Service Bus AMQP Developer's <!-- deleted by customization Guide][] --><!-- keep by customization: begin --> Guide](/documentation/articles/service-bus-amqp-dotnet) <!-- keep by customization: end -->
