<properties 
   pageTitle="Service Bus brokered messaging REST tutorial | Windows Azure"
...
- Uses your service namespace and [Shared Access Signature](/documentation/articles/service-bus-sas-overview) (SAS) key to to gain access to your Service Bus namespace resources.
...
Paste the following code directly after the <!-- deleted by customization `GetSASToken()` --><!-- keep by customization: begin --> `GetToken()` <!-- keep by customization: end --> code you added in the previous step:
