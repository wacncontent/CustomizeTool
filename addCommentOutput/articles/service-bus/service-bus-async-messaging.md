...
Now that you've learned the basics of asynchronous messaging in Service Bus, read more details about [paired namespaces and cost implications].
  ...
  [Best Practices for Insulating Service Bus Applications Against Service Bus Outages and Disasters]: <!-- deleted by customization service-bus-outages-disasters.md --><!-- keep by customization: begin --> /documentation/articles/service-bus-outages-disasters <!-- keep by customization: end -->
  ...
  [paired namespaces and cost implications]: /documentation/articles/service-bus-paired-namespaces