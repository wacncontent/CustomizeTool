...
your application. You must create the namespace through the command-line interface because the [Azure Management Portal][] does not create the namespace with an ACS connection.
...
> [Azure Management Portal][] and navigate to the
...
For instructions, see [Create a Ruby Application on Azure](/develop/ruby/).
