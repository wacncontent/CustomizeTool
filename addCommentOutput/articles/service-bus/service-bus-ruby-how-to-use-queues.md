...
For a comparision between the Azure Service Bus Queues discussed in this article and Azure Queues discussed in the [How to use the Azure Queue <!-- deleted by customization Service](/develop/ruby/how-to-guides/queue-service/) --><!-- keep by customization: begin --> Service](/develop/ruby/) <!-- keep by customization: end --> article, see [Azure Queues and Azure Service Bus Queues - Compared and Contrasted](/documentation/articles/service-bus-azure-and-service-bus-queues-compared-contrasted)
