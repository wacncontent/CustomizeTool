...
To learn about configuring other parts of your Azure project from Visual Studio, see [Configuring an Azure <!-- deleted by customization Project](https://azure.microsoft.com/zh-cn/documentation/articles/vs-azure-tools-configuring-an-azure-project/) --><!-- keep by customization: begin --> Project](/documentation/articles/vs-azure-tools-configuring-an-azure-project/) <!-- keep by customization: end -->
