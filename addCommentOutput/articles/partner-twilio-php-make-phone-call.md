...
* Instead of using a web form, you could use Azure storage blobs or SQL <!-- deleted by customization Database --><!-- keep by customization: begin --> 数据库 <!-- keep by customization: end --> to store phone numbers and call text. For information about using Azure storage blobs in PHP, see [Using Azure Storage with PHP Applications][howto_blob_storage_php]. For information about using SQL <!-- deleted by customization Database --><!-- keep by customization: begin --> 数据库 <!-- keep by customization: end --> in PHP, see [Using SQL <!-- deleted by customization Database --><!-- keep by customization: begin --> 数据库 <!-- keep by customization: end --> with PHP Applications][howto_sql_azure_php].
