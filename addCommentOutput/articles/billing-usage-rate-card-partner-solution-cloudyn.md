...
Upon registration for [Cloudyn for Azure](https://www.cloudyn.com/microsoft-azure/) services, customers can add their OfferDurableID code, which allows Cloudyn to pull their relevant pricing information through the RateCard API.  Information on the different types of offers can be found one the [Windows Azure Offer <!-- deleted by customization Details](http://azure.microsoft.com/en-gb/support/legal/offer-details/) --><!-- keep by customization: begin --> Details](http://www.windowsazure.cn/en-gb/support/legal/offer-details/) <!-- keep by customization: end --> page.
...
## Learn More
+ To learn more about Windows Azure Enterprise Agreement (EA) offers, please visit [Licensing Azure for the Enterprise] <!-- deleted by customization (http://azure.microsoft.com/pricing/enterprise-agreement/) --><!-- keep by customization: begin --> (/pricing/enterprise-agreement/) <!-- keep by customization: end -->
