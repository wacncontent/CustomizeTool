...
There is a preconfigured set of attribute mappings between Azure AD user objects and each SaaS <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> app's <!-- keep by customization: begin --> --><!-- keep by customization: begin --> app’s <!-- keep by customization: end --><!-- keep by customization: end --> user objects. Some apps manage other types of objects, such as Groups or Contacts. <br>
