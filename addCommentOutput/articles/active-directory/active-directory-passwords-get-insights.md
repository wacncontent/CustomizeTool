...
Password<!-- keep by customization: begin --> <p>Password <!-- keep by customization: end --> reset is not enabled for this user. Enable password reset under the configure tab to resolve this|  Failed<!-- keep by customization: begin --> this</p> <!-- keep by customization: end -->
...
This<!-- keep by customization: begin --> <p>This <!-- keep by customization: end --> user is not a member of the password reset users group. Add this user to that group to resolve this.|Failed<!-- keep by customization: begin --> this.</p> <!-- keep by customization: end -->
...
<table>
            ...
            <tr>
              <td>
<!-- keep by customization: begin --> <p>Password <!-- keep by customization: end --> reset is not enabled for this user. Enable password reset under the configure tab to resolve <!-- keep by customization: begin --> this</p> <!-- keep by customization: end -->
              </td>
              <td>
                <p>Failed</p>
              </td>
            ...
            <tr>
              <td>
<!-- keep by customization: begin --> <p>This <!-- keep by customization: end --> user is not a member of the password reset users group. Add this user to that group to resolve <!-- keep by customization: begin --> this.</p> <!-- keep by customization: end -->
              </td>
              <td>
                <p>Failed</p>
              </td>
