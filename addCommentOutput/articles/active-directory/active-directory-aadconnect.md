...
If you have not worked with a synchronization topology before you want to start to understand the basics and the terms used as described in the [technical <!-- deleted by customization concepts](/documentation/articles/active-directory-aadconnectsync-technical-concepts) --><!-- keep by customization: begin --> concepts](/documentation/articles/active-directory-aadconnect-technical-concepts) <!-- keep by customization: end -->. Azure AD Connect is the evolution of MIIS2003, ILM2007, and FIM2010. Even if some things are identical, a lot has changed as well.
...
| Topic |  |
| --------- | --------- |
| Technical concepts | [Azure AD Connect sync: Technical <!-- deleted by customization Concepts](/documentation/articles/active-directory-aadconnectsync-technical-concepts) --><!-- keep by customization: begin --> Concepts](/documentation/articles/active-directory-aadconnect-technical-concepts) <!-- keep by customization: end --> |
