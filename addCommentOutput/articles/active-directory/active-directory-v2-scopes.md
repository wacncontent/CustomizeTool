...
- The Azure Resource Manager API: <!-- deleted by customization `https://manage.windowsazure.cn` --><!-- keep by customization: begin --> `https://management.azure.com` <!-- keep by customization: end -->
