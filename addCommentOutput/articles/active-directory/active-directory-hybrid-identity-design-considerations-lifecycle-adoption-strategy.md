...
Azure Active Directory provides single-sign on and enhanced application access security to thousands of SaaS applications and on-premises web <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> sites <!-- keep by customization: begin --> --><!-- keep by customization: begin --> applications <!-- keep by customization: end --><!-- keep by customization: end -->. For a detailed list of Azure Active Directory application gallery for supported SaaS applications, see Azure Active Directory federation compatibility list: third-party identity providers that can be used to implement single sign-on
