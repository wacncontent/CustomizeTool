...
To create an external user, create a user in the <!-- deleted by customization Azure Management Portal, --><!-- keep by customization: begin --> portal <!-- keep by customization: end --> and for **Type of User**, select **User in another Azure AD directory**.
