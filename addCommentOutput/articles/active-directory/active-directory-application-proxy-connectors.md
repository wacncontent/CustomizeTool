...
> [AZURE.NOTE] Application Proxy is a feature that is available only if you upgraded to the Premium or Basic edition of Azure Active Directory. For more information, see [Azure Active Directory <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> editions](/documentation/articles/active-directory-editions) <!-- keep by customization: begin --> --><!-- keep by customization: begin --> editions](/documentation/articles/active-directory-edition) <!-- keep by customization: end --><!-- keep by customization: end -->.
...
Once the Connector groups are created, move the Connectors to the appropriate <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> group. Under <!-- keep by customization: begin --> --><!-- keep by customization: begin --> group.Under <!-- keep by customization: end --><!-- keep by customization: end --> **Application Proxy**, click **Manage Connectors** and under **Group**, select the group you want for each Connector. Note that it might take the Connectors up to 10 minutes to become active in the new group.
