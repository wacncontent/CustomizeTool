...
Self-service application access is a feature of [Azure Active Directory <!-- deleted by customization Premium](http://azure.microsoft.com/trial/get-started-active-directory/) --><!-- keep by customization: begin --> Premium](/trial/get-started-active-directory/) <!-- keep by customization: end --> that allow directory administrators to:
