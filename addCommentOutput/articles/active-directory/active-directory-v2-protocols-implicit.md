<properties
	...
	description="Building web sites using Azure AD's implementation of the implicit flow for single page apps."
...
- The security characteristics of these apps are significantly different from traditional server based web sites.
