<properties
	pageTitle="Automatic device registration with Azure Active Directory for Windows Domain-Joined Devices| Windows Azure"
...
7. Type the following claim rule in the **Claim rule:** text <!-- deleted by customization box: --><!-- keep by customization: begin --> box**** <!-- keep by customization: end -->
...
-----------------------------------------------------------------------------------------------------
<!-- keep by customization: begin --> 9. <!-- keep by customization: end --> On your federation server, open a Windows PowerShell command window and type:
...
-----------------------------------------------------------------------------
<!-- keep by customization: begin --> 1. <!-- keep by customization: end --> Configure the AD FS Global Primary Authentication Policy to allow Windows Integrated Authentication for the Intranet (this is the default).


Internet Explorer Configuration
------------------------------------------------------------------------------
<!-- keep by customization: begin --> 1. <!-- keep by customization: end --> Configure the following settings on Internet Explorer on your Windows devices for the Local intranet security zone:
...
You can learn more about deploying device registration with AD FS [here](https://technet.microsoft.com/zh-cn/library/dn486831.aspx).
<!-- deleted by customization
