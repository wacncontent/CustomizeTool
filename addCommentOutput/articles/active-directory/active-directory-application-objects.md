...
The following tables list all the properties of an application object and includes important details for developers. These properties apply to web sites, web APIs, and native client applications that are registered with Azure AD.
