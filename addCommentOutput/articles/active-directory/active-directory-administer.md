...
<!-- deleted by customization For --><!-- keep by customization: begin --><!--For <!-- keep by customization: end --> a video about common usage questions for Azure AD, see [Azure Active Directory - Common Sign-up, sign-in and usage <!-- deleted by customization questions](http://channel9.msdn.com/Series/Windows-Azure-Active-Directory/WAADCommonSignupsigninquestions). --><!-- keep by customization: begin --> questions](http://channel9.msdn.com/Series/Windows-Azure-Active-Directory/WAADCommonSignupsigninquestions).--><!-- keep by customization: end -->
