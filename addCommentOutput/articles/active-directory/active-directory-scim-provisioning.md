<properties
	pageTitle="Using SCIM to enable automatic provisioning of users and groups from Azure Active Directory to applications | Windows Azure"
...
* [An Azure subscription with a trial or licensed version of Azure AD <!-- deleted by customization Premium](/home/features/identity/) --><!-- keep by customization: begin --> Premium](/documentation/services/identity/) <!-- keep by customization: end -->
