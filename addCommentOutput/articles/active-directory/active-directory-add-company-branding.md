...
If they visit a service with non-tenant specific URLs (such as <!-- deleted by customization https://mail.office365.com) --><!-- keep by customization: begin --> https://partner.outlook.cn) <!-- keep by customization: end --> they will see a non-branded sign in page. The sign in page will refresh to show your branding once users have entered their user ID or selected a user tile.
