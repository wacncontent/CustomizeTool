...
> [AZURE.NOTE]
> Using Microsoft Intune? You do not need to edit DNS records for the <!-- deleted by customization Microsoft --><!-- keep by customization: begin --> Windows <!-- keep by customization: end --> Intune cloud service.
...
To <!-- deleted by customization verify --><!-- keep by customization: begin --> check <!-- keep by customization: end --> the status of your domain, on the **Domains** page, click the domain, and then, on the **Domain properties** page, click **Troubleshoot domain**.
