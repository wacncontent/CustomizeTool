...
If you've tried the troubleshooting steps below and are still running into problems, you can post a question on the [Azure AD <!-- deleted by customization Forums](https://social.msdn.microsoft.com/forums/azure/home?forum=WindowsAzureAD) --><!-- keep by customization: begin --> Forums](https://social.msdn.microsoft.com/Forums/zh-CN/home?forum=windowsazurezhchs) <!-- keep by customization: end --> or contact support and we'll take a look at your problem as soon as we can.
...
<table>
          ...
          <tr>
            ...
            <td>
              ...
              <p>See <a <!-- deleted by customization href="../active-directory-passwords-customize#password-management-behavior">Customizing --><!-- keep by customization: begin --> href="active-directory-passwords-customize#password-management-behavior">Customizing <!-- keep by customization: end --> User Password Reset Policy</a> for more info about all of the controls that are available to you.</p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              ...
              <p>See <a <!-- deleted by customization href="../active-directory-passwords-getting-started#enable-users-to-reset-or-change-their-ad-passwords">How --><!-- keep by customization: begin --> href="active-directory-passwords-getting-started#enable-users-to-reset-or-change-their-ad-passwords">How <!-- keep by customization: end --> to enable/disable Password Writeback</a> for more information on how to do this.</p>
            </td>
          </tr>
        </tbody></table>
...
<table>
          ...
          <tr>
            ...
            <td>
              <p>Ensure that user has properly formed contact data on file in the directory before proceeding. See <a <!-- deleted by customization href="../active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What --><!-- keep by customization: begin --> href="active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What <!-- keep by customization: end --> data is used by password reset</a> for information on how to configure authentication information in the directory so that users do not see this error.</p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <p>Ensure that user has at least two properly configured contact methods (e.g., both Mobile Phone and Office Phone) before proceeding. See <a <!-- deleted by customization href="../active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What --><!-- keep by customization: begin --> href="active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What <!-- keep by customization: end --> data is used by password reset</a> for information on how to configure authentication information in the directory so that users do not see this error.</p>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              <p>This could be the result of a mal-formed phone number in the directory. Make sure the phone number is in the format “+ccc xxxyyyzzzzXeeee”. To learn more about formatting phone numbers for use with password reset see <a <!-- deleted by customization href="../active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What --><!-- keep by customization: begin --> href="/documentation/articles/active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What <!-- keep by customization: end --> data is used by password reset</a>.</p>
...
<table>
          ...
          <tr>
            ...
            <td>
              <p>This event indicates that the Management Agent service account does not have the appropriate permissions on the account in question to set a new password. Ensure that the MA account in the user’s forest has Reset and Change password permissions on all objects in the forest.  For more information on how do to this, see <a <!-- deleted by customization href="../active-directory-passwords-getting-started#step-4-set-up-the-appropriate-active-directory-permissions">Step --><!-- keep by customization: begin --> href="/documentation/articles/active-directory-passwords-getting-started#step-4-set-up-the-appropriate-active-directory-permissions">Step <!-- keep by customization: end --> 4: Set up the appropriate Active Directory permissions</a>.</p>
            </td>
          </tr>
          <tr>
            <td>
