...
If you are having issues with Password Management, we're here to help. Most problems you may run into can be solved with a few simple troubleshooting steps which you can read about below totroubleshoot your deployment:
...
<table>
          ...
          <tr>
            ...
            <td>
              ...
              <p>See <a <!-- deleted by customization href="/documentation/articles/active-directory-passwords-customize#password-management-behavior">Customizing --><!-- keep by customization: begin --> href="active-directory-passwords-customize#password-management-behavior">Customizing <!-- keep by customization: end --> User Password Reset Policy</a> for more info about all of the controls that are available to you.</p>
            </td>
          </tr>
          <tr>
            <td>
...
<table>
          ...
          <tr>
            ...
            <td>
              <p>Ensure that user has properly formed contact data on file in the directory before proceeding. See <a <!-- deleted by customization href="/documentation/articles/active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What --><!-- keep by customization: begin --> href="active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What <!-- keep by customization: end --> data is used by password reset</a> for information on how to configure authentication information in the directory so that users do not see this error.</p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <p>Ensure that user has at least two properly configured contact methods (e.g., both Mobile Phone and Office Phone) before proceeding. See <a <!-- deleted by customization href="/documentation/articles/active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What --><!-- keep by customization: begin --> href="active-directory-passwords-learn-more#what-data-is-used-by-password-reset">What <!-- keep by customization: end --> data is used by password reset</a> for information on how to configure authentication information in the directory so that users do not see this error.</p>
            </td>
          </tr>
          <tr>
            <td>
