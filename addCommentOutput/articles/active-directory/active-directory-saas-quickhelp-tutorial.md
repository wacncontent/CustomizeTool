...
-->
<!-- keep by customization: begin -->
The scenario outlined in this tutorial consists of <!-- deleted by customization two --><!-- keep by customization: begin --> three <!-- keep by customization: end --> main building blocks:
<!-- keep by customization: end -->
...
4. **[Creating a QuickHelp test <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> user](#creating-a-quickhelp-test-user)** <!-- keep by customization: begin --> --><!-- keep by customization: begin --> user](#creating-a-halogen-software-test-user)** <!-- keep by customization: end --><!-- keep by customization: end --> - to have a counterpart of Britta Simon in QuickHelp that is linked to the Azure AD representation of her.
...
<br><br>![Configure App Settings][8] <br>
     ...
     a. In the **Sign On URL** textbox, type the URL used by your users to sign-on to your QuickHelp site (e.g.:* <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> https://quickhelp.com/bsiazure/*) <!-- keep by customization: begin --> --><!-- keep by customization: begin --> https://quickhelp.com/bsiazure/#/home/assignedContent*) <!-- keep by customization: end --><!-- keep by customization: end -->.
