...
7.	Sign in to the <!-- deleted by customization Azure --> Management Portal as msmith@hotmail.com. The Contoso directory and the Default directory appear in the Active Directory extension.
...
1.	Sign in to the <!-- deleted by customization Azure --> Management Portal by using the Service Administrator account of the Azure subscription (in this example, msmith@hotmail.com).
