...
The Azure Management Portal provides you with the flexibility to set up advanced rules in Azure Active Directory (Azure AD) to enable more complex dynamic memberships for Azure AD groups.
-->
...
In the Azure Management Portal, under the group's **Configure** tab, select the **Advanced rule** <!-- deleted by customization option --><!-- keep by customization: begin --> radio button <!-- keep by customization: end --> and then type in your advanced rule in the provided text box. You can create your advanced rule using the following information.
...
A complete advanced rule looks similar to this: (leftParameter binaryOperator "RightConstant"), where <!-- deleted by customization the opening --><!-- keep by customization: begin --> open <!-- keep by customization: end --> and <!-- deleted by customization closing --><!-- keep by customization: begin --> close <!-- keep by customization: end --> parenthesis are required for the entire binary expression, double quotes are required for the right constant, and the syntax for the left parameter is user.property. An advanced rule can consist of more than one binary expressions separated by the -and, -or, and -not logical operators.
