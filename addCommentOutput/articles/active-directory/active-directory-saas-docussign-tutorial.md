...
<br><br>![Configuring single sign-on ][9]<br>
    ...
    > [AZURE.TIP] If you <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> donât <!-- keep by customization: begin --> --><!-- keep by customization: begin --> don’t <!-- keep by customization: end --><!-- keep by customization: end --> know what your app URL for your tenant is, try contacting Docusign via SSOSetup@Docusign.com to get the SP Initiated SSO URL for your tenant.
...
6. In the menu on the top, expand the <!-- keep by customization: begin --><!-- deleted by customization <!-- keep by customization: end --> userâs <!-- keep by customization: begin --> --><!-- keep by customization: begin --> user’s <!-- keep by customization: end --><!-- keep by customization: end --> menu, click **Preferences**, and then, in the navigation pane on the left, expand **Account Management**, and then click **Features**.
