...
2. Click the Applications tab for your directory. Click on an application that you added from the Application Gallery, then click on the <!-- deleted by customization **Users --><!-- keep by customization: begin --> *Users <!-- keep by customization: end --> and <!-- deleted by customization Groups** --><!-- keep by customization: begin --> Groups* <!-- keep by customization: end --> tab.
