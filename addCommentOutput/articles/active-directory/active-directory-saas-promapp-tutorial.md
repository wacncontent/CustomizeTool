<properties
	pageTitle="Tutorial: Azure Active Directory integration with Promapp | Windows Azure"
...
<br><br>![Azure AD Single Sign-On][14] <br>
    ...
    a. In the Azure Management Portal, on the **Configure single sign-on at Promapp** dialog, copy the **Remote Login URL**, paste it into the **SSO-Login URL** textbox, and then click **Save**.
