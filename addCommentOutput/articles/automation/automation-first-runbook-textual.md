...
- Azure subscription. If you don't have one yet, you can <!-- deleted by customization [activate your MSDN subscriber benefits](http://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/) or <a href="/pricing/1rmb-trial/" target="_blank">[sign --><!-- keep by customization: begin --> [sign <!-- keep by customization: end --> up for a trial](/pricing/1rmb-trial/).
