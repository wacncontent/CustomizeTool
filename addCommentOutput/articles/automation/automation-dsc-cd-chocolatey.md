...
The included example performs these steps for cChoco and xNetworking. See the <!-- deleted by customization [Notes](#notes) --><!-- keep by customization: begin --> Notes <!-- keep by customization: end --> for special handling for cChoco.
...
The version of the cChoco DSC resource at the PowerShell Gallery isn't quite up to date with its source.  cChoco.zip in the GitHub source project is up to date.  Use the manual technique above in Step 3 to install it.
...
- [Onboarding machines for management by Azure Automation <!-- deleted by customization DSC] (automation-dsc-onboarding.md) --><!-- keep by customization: begin --> DSC](/documentation/articles/automation-dsc-onboarding) <!-- keep by customization: end -->
