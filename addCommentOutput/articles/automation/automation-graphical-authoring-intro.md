...
|PowerShell Expression|Specify simple <!-- deleted by customization [PowerShell expression](#powershell-expressions) --><!-- keep by customization: begin --> PowerShell expression <!-- keep by customization: end -->.  The expression will be evaluated before the activity and the result used for the parameter value.  You can use variables to refer to the output of an activity or a runbook input parameter.|
...
<!-- deleted by customization
- [Operators](https://technet.microsoft.com/zh-cn/library/hh847732.aspx)
-->
