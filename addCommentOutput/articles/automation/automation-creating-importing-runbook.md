...
1. In the Azure  Classic  Management  portal  Portal , select **Automation** and then select an Automation Account.
2. Click **Import**.
...
You can use the  [Publish-AzureRmAutomationRunbook](https://msdn.microsoft.com/zh-cn/library/mt603705.aspx)  [Publish-AzureAutomationRunbook](https://msdn.microsoft.com/zh-cn/library/dn690266.aspx)  cmdlet to publish a runbook with Windows PowerShell. The following sample commands show how to publish a sample runbook.
