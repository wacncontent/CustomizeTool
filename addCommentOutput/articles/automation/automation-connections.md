...
Create a new connection with Windows PowerShell using the [New-AzureAutomationConnection](http://msdn.microsoft.com/zh-cn/library/dn921825.aspx) cmdlet. This cmdlet has a parameter named **ConnectionFieldValues** that expects a [hash <!-- deleted by customization table](http://technet.microsoft.com/library/hh847780.aspx) --><!-- keep by customization: begin --> table](http://technet.microsoft.com/zh-cn/library/hh847780.aspx) <!-- keep by customization: end --> defining values for each of the properties defined by the connection type.
