...
Tags allow you to assign distinct words and phrases to help identify a runbook. For example, when you submit a runbook to the [Runbook  Gallery](https://msdn.microsoft.com/zh-cn/library/dn781422.aspx)  Gallery](/documentation/articles/automation-runbook-gallery/) , you specify particular tags to identify which categories the runbook should be listed in. You can specify multiple tags for a runbook by separating them with commas.

### Logging

By default, Verbose and Progress records are not written to job history. You can change the settings for a particular runbook to log these records. For more information on these records, see [Runbook Output and  Messages](https://msdn.microsoft.com/zh-cn/library/dn879148.aspx)  Messages](/documentation/articles/automation-runbook-output-and-messages/) .
