<properties
   pageTitle="Get started configuring an internet facing load balancer using Azure Resource Manager | Windows Azure "
...
The following steps will show how to configure a load balancer <!-- keep by customization: begin --> to be load balanced <!-- keep by customization: end --> between 2 virtual machines.
...
Create a public IP address to be used by frontend IP pool:
	...
	$publicIP = New-AzurePublicIpAddress -Name PublicIp -ResourceGroupName NRP-RG -Location "China North" -AllocationMethod Dynamic -DomainNameLabel lbip 
