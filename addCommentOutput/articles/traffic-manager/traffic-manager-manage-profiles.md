...
6. **Click <!-- deleted by customization “Create” --><!-- keep by customization: begin --> âCreateâ <!-- keep by customization: end --> to create your new profile**. When the profile configuration is completed, you can locate your profile in the Traffic Manager pane in the Azure Management Portal.
