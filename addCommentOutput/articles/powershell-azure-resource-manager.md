...
You can get more details about a provider by specifying that namespace:
    ...
    Microsoft.Sql     Registered        {locations}                                   {China <!-- deleted by customization East 2 --><!-- keep by customization: begin --> North <!-- keep by customization: end -->, China East <!-- deleted by customization, Cent... -->
    Microsoft.Sql     Registered        {locations/capabilities}                      {China <!-- deleted by customization East 2 --><!-- keep by customization: begin --> North <!-- keep by customization: end -->, China East <!-- deleted by customization, Cent... -->
    ...
