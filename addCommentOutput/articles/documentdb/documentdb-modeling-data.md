...
> [AZURE.TIP] Documents in DocumentDB have a maximum size. For more on this refer to [DocumentDB <!-- deleted by customization limits](/documentation/articles/documentdb-limits) --><!-- keep by customization: begin --> limits](documentdb-limits.md) <!-- keep by customization: end -->.
