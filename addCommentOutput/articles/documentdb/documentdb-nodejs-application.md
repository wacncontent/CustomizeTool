...
# <a name="_Toc395783175"></a>Build a Node.js web <!-- deleted by customization site --><!-- keep by customization: begin --> application <!-- keep by customization: end --> using DocumentDB
...
- How do I deploy the web <!-- deleted by customization site --><!-- keep by customization: begin --> application <!-- keep by customization: end --> to Azure Websites?
...
> For more information on DocumentDB Offer Types please refer to [Performance levels in <!-- deleted by customization DocumentDB](/documentation/articles/documentdb-performance-levels) --><!-- keep by customization: begin --> DocumentDB](documentdb-performance-levels.md) <!-- keep by customization: end -->
...
2. Add the following to **config.js**. This defines configuration settings and values needed for our application.
		...
		config.host = process.env.HOST || "[the URI value from the DocumentDB Keys blade on <!-- deleted by customization http://manage.windowsazure.cn]" --><!-- keep by customization: begin --> http://portal.azure.com]" <!-- keep by customization: end -->;
		config.authKey = process.env.AUTH_KEY || "[the PRIMARY KEY value from the DocumentDB Keys blade on <!-- deleted by customization http://manage.windowsazure.cn]" --><!-- keep by customization: begin --> http://portal.azure.com]" <!-- keep by customization: end -->;
		config.databaseId = "ToDoList";
		config.collectionId = "Items";
		
		module.exports = config;

3. In the **config.js** file, update the values of HOST and AUTH_KEY using the values found in the Keys blade of your DocumentDB account on the <!-- deleted by customization [Windows --><!-- keep by customization: begin --> [Microsoft <!-- keep by customization: end --> Azure Preview <!-- deleted by customization portal](http://manage.windowsazure.cn) --><!-- keep by customization: begin --> portal](http://portal.azure.com) <!-- keep by customization: end -->:

4. Save and close the **config.js** file.
 
### Modify app.js

1. In the project directory, open the **app.js** file. This file was created earlier when the Express web <!-- deleted by customization site --><!-- keep by customization: begin --> application <!-- keep by customization: end --> was created.
...
Now <!-- deleted by customization let's --><!-- keep by customization: begin --> let’s <!-- keep by customization: end --> turn our attention to building the user interface so a user can actually interact with our application. The Express application we created uses **Jade** as the view engine. For more information on Jade please refer to [http://jade-lang.com/](http://jade-lang.com/).
...
1. If you haven't already, enable a git repository for your Azure Website. You can find instructions on how to do this <!-- deleted by customization [here](/documentation/articles/web-sites-publish-source-control-git#step4) --><!-- keep by customization: begin --> [here](../web-sites-publish-source-control-git.md#step4) <!-- keep by customization: end -->.
