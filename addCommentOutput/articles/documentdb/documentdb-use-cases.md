<properties 
    pageTitle="Common DocumentDB use cases | Windows Azure" 
...
<!-- deleted by customization Windows --><!-- keep by customization: begin --> Microsoft <!-- keep by customization: end --> Azure offers rich services that can be leveraged for IoT use cases.  Azure IoT services are a set of services including Azure Event Hubs, Azure DocumentDB, Azure Stream Analytics, Azure Notification Hub, Azure Machine Learning, Azure HDInsight, and PowerBI.
...
For more information on Azure offerings for IoT, see [Create the Internet of Your <!-- deleted by customization Things](http://www.microsoft.com/server-cloud/internet-of-things.aspx) --><!-- keep by customization: begin --> Things](http://www.microsoft.com/en-us/server-cloud/internet-of-things.aspx) <!-- keep by customization: end -->.

## Next steps
 
To get started with DocumentDB, you can create an <!-- deleted by customization [account](/pricing/1rmb-trial/) --><!-- keep by customization: begin --> [account](http://azure.microsoft.com/pricing/free-trial/) <!-- keep by customization: end --> and then follow our [learning path](https://azure.microsoft.com/documentation/learning-paths/documentdb/) to learn about DocumentDB and find the information you need.
