<properties 
	pageTitle="DocumentDB and Power BI visualization tutorial | Windows Azure" 
...
- Access to our demo account or data in your Azure DocumentDB account. 
	...
	- Or, to create your own account, see [Create a DocumentDB database account using the Azure preview portal](/documentation/articles/documentdb-create-account/). Then, to get sample volcano data that's similar to what's used in this tutorial (but does not contain the GeoJSON blocks), see the [NOAA site](https://www.ngdc.noaa.gov/nndc/struts/form?t=102557&s=5&d=5) and then import the data using the [DocumentDB data migration tool](/documentation/articles/documentdb-import-data/).
