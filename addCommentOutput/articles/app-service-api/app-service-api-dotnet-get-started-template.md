...
* [Open an Azure  account for free](/pricing/1rmb-trial/?WT.mc_id=A261C142F)  account](/pricing/1rmb-trial/?WT.mc_id=A261C142F) . You get credits that can be used to try out paid Azure services. Even after the credits are used up, you can keep the account and use free Azure services and features.

...
5. In the  **Azure**  **Microsoft Azure**  section of the **New ASP.NET Project** dialog box, make sure that **Host in the cloud** is selected and that **App Service** is selected in the drop-down list.
...
The  [Azure portal](/home/features/management-portal/)  Azure portal  is a web interface that you can use to manage and monitor your Azure services, such as the API app that you just created. In this section of the tutorial, you look at some of what you can do in the portal.
