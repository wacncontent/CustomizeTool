...
1. Create a new API app in the [Azure  portal]  Portal   Preview] , by clicking the **New -> Web + Mobile -> API app** menu item, entering your app details, and then clicking **Create**.
