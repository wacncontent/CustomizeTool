...
You can configure CORS in the Azure  portal  Portal   Preview  or by using [Azure Resource Manager](/documentation/articles/resource-group-overview/) tools.
...
8. In a browser go to the [Azure Portal Preview](https://portal.azure.cn/).

...
1. Go to the [Azure  portal](https://portal.azure.cn/)  Portal Preview](https://portal.azure.cn/) , and then navigate to the **Web App** blade for the web app that you created to host the TodoListAngular (front end) project.
...
8. In a browser, go to the [Azure  portal](https://portal.azure.cn/)  Portal Preview](https://portal.azure.cn/) .
