...
<!-- deleted by customization For --><!-- keep by customization: begin --><!--For <!-- keep by customization: end --> additional information oh how it works see the following video.

[AZURE.VIDEO <!-- deleted by customization multi-factor-authentication-deep-dive-securing-access-on-premises] --><!-- keep by customization: begin --> multi-factor-authentication-deep-dive-securing-access-on-premises]--><!-- keep by customization: end -->
...
If you do not have any of the above, then to begin using Azure Multi-Factor Authentication, you first need an Azure subscription or an [Azure trial subscription](/pricing/1rmb-trial/). 
...
For pricing details see [Azure MFA Pricing.](/home/features/multi-factor-authentication/#price)

Choose the model that works best for your organization.  Then to get started see [Getting Started](/documentation/articles/multi-factor-authentication-get-started)
