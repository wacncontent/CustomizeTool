...
- The article [SQL Server Business Intelligence in Azure Virtual <!-- deleted by customization Machines](./virtual-machines/virtual-machines-sql-server-business-intelligence.md) --><!-- keep by customization: begin --> Machines](https://msdn.microsoft.com/zh-cn/library/azure/jj992719.aspx) <!-- keep by customization: end --> on the Microsoft website.
