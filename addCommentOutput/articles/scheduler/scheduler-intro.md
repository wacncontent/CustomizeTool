...
# What is <!-- deleted by customization Azure --> Scheduler?

Azure Scheduler allows you to declaratively describe actions to run in the cloud. It then schedules and runs those actions automatically. <!-- deleted by customization  --><!-- keep by customization: begin --> Azure <!-- keep by customization: end --> Scheduler does this by using [the Azure Management Portal](/documentation/articles/scheduler-get-started-portal), code, [REST API](https://msdn.microsoft.com/zh-cn/library/dn528946), or <!-- deleted by customization Azure --> PowerShell.
...
Scheduler allows you to create, update, delete, view, and manage jobs and [job <!-- deleted by customization collections](/documentation/articles/scheduler-concepts-terms) --><!-- keep by customization: begin --> collections ](/documentation/articles/scheduler-concepts-terms) <!-- keep by customization: end --> programmatically, by using scripts, and in the portal.
