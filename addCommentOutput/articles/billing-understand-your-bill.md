...
- **Tags**:  This column contains the user specified resource tags. The tags can be used to group billing records. For example, you can use tags to distribute costs by department using the service. Learn more about [using tags to organize Azure <!-- deleted by customization Resources](./resource-group-using-tags.md) --><!-- keep by customization: begin --> Resources](/resource-group-using-tags.md/) <!-- keep by customization: end -->.Services that support emitting tags are:
    - Virtual Machines
    - Storage and
