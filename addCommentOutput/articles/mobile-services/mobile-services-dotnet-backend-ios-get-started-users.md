<properties
	pageTitle="Add Authentication to Existing Azure Mobile Services App (iOS) | .NET Backend | Windows Azure"
...
<!-- URLs. -->
[Service-side authorization of Mobile Services users]: <!-- deleted by customization mobile-services-dotnet-backend-service-side-authorization.md --><!-- keep by customization: begin --> /documentation/articles/mobile-services-dotnet-backend-service-side-authorization <!-- keep by customization: end -->
