...
[How to use a .NET client with Mobile Services]: <!-- deleted by customization /documentation/articles/mobile-services-windows-dotnet-how-to-use-client-library --><!-- keep by customization: begin --> zh-cn/documentation/articles/mobile-services-windows-dotnet-how-to-use-client-library/ <!-- keep by customization: end -->
