...
2. Type the **Name**, **Description**, and **Website** values for your app, then type the URL of your mobile service appended with the path _/login/twitter_ in **Callback URL**.
	...
	>[AZURE.NOTE]For a .NET backend mobile service published to Azure by using Visual Studio, the redirect URL is the URL of your mobile service appended with the path _signin-twitter_ <!-- deleted by customization. In this example, our --><!-- keep by customization: begin --> your <!-- keep by customization: end --> mobile service <!-- deleted by customization would have the Callback URL ```https://todolist.azure-mobile.cn/signin-twitter``` --><!-- keep by customization: begin --> as a .NET service, such as <code>https://todolist.azure-mobile.cn/signin-twitter</code> <!-- keep by customization: end -->.
...
7. Click the **Settings** tab, scroll down and make sure the **Allow this application to be used to sign in with Twitter** <!-- deleted by customization checkbox is checked -->, then click **Update <!-- deleted by customization Settings** --><!-- keep by customization: begin --> this Twitter application's settings** <!-- keep by customization: end -->.
