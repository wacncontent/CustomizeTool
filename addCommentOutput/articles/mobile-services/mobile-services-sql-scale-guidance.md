...
- **Use an in-memory cache**. Another alternative is to store data, which would commonly be accessed during a traffic spike, in an in-memory cache such as [Azure <!-- deleted by customization Cache](/home/features/cache/) --><!-- keep by customization: begin --> Cache](/documentaiton/services/cache/) <!-- keep by customization: end -->. This means incoming requests would be able to fetch the information they need from memory, instead of repeatedly querying the database.
...
1. Navigate to [SQL Server Editions - <!-- deleted by customization Express](http://www.microsoft.com/server-cloud/products/sql-server-editions/sql-server-express.aspx) --><!-- keep by customization: begin --> Express](http://www.microsoft.com/zh-cn/server-cloud/products/sql-server-editions/sql-server-express.aspx) <!-- keep by customization: end -->
...
<!-- EF -->
[Performance Considerations for Entity Framework 5]: <!-- deleted by customization http://msdn.microsoft.com/data/hh949853 --><!-- keep by customization: begin --> http://msdn.microsoft.com/zh-cn/data/hh949853 <!-- keep by customization: end -->
<!-- deleted by customization
