...
<!-- URLs. -->
[Handling conflicts with offline support for Mobile Services]: <!-- deleted by customization /documentation/articles/mobile-services-xamarin-ios-handling-conflicts-offline-data --><!-- keep by customization: begin --> /documentation/articles/mobile-services-xamarin-ios-handling-conflicts-offline-data/ <!-- keep by customization: end -->
