...
This topic shows you how to use Azure Mobile Services to leverage data in a Windows Phone 8 app. In this tutorial, you will download an app that stores data in memory, create a new mobile service, integrate the mobile service with the app, and then login to the <!-- deleted by customization [Azure --><!-- keep by customization: begin --> Azure <!-- keep by customization: end --> Management <!-- deleted by customization Portal] --><!-- keep by customization: begin --> Portal <!-- keep by customization: end --> to view changes to data made when running the app.
