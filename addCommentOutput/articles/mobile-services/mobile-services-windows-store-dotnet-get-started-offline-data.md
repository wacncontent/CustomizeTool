...
<!-- deleted by customization > [AZURE.VIDEO build-offline-apps-with-mobile-services] -->
...
<!-- deleted by customization * An Azure account. If you don't have an account, you can sign up for an Azure trial and get up to 10 free mobile services that you can keep using even after your trial ends. For details, see [Azure Trial](/pricing/1rmb-trial/?WT.mc_id=AE564AB28). -->
<!-- keep by customization: begin -->
