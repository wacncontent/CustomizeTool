...
This opens your default browser and prompts you to sign in to the Azure Management Portal. After signing in, your `.publishsettings` file is downloaded. Note the location of this saved file.
...
[How to install the Azure Command-Line Tools for Mac and Linux]: <!-- deleted by customization /documentation/articles/xplat-cli/#Download --><!-- keep by customization: begin --> /documentation/articles/xplat-cli <!-- keep by customization: end -->
