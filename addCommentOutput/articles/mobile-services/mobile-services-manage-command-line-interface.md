...
[How to install the Azure Command-Line Tools for Mac and Linux]: <!-- deleted by customization http://go.microsoft.com/fwlink/p/?LinkId=275795 --><!-- keep by customization: begin --> /documentation/articles/xplat-cli <!-- keep by customization: end -->
