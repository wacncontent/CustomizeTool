...
1.  Sign-in to the [Azure  portal](https://portal.azure.cn)  portal preview](https://portal.azure.cn) . If you don't already have an existing network security group, [create an NSG](/documentation/articles/virtual-networks-create-nsg-arm-ps/) before you continue.

2.  In the  Portal Preview  portal preview , click **Browse** >> **Network security groups**.
