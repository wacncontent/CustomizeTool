...
Private IP addresses are used for communication within an Azure virtual network (VNet), and your on-premises network when you use <!-- deleted by customization a VPN gateway or --> ExpressRoute circuit to extend your network to Azure.
...
You can assign a public IP to the frontend of an application gateway. <!-- deleted by customization At this moment, you can only assign a dynamic public IP address to a VPN gateway. -->
...
You assign private IP addresses to allow Azure resources to communicate to other resources in your [VNet](/documentation/articles/virtual-networks-overview), or to your on-premises network through <!-- deleted by customization a VPN gateway or --> ExpressRoute circuit. Each VNet you create will use a range of private IP addresses that you specify. Resources in a VNet must use a private IP address that is part of this range.
