...
- You can connect VNets to your on-premises network by using one of the [connectivity  options](/documentation/articles/vpn-gateway-plan-design/)  options](/documentation/articles/vpn-gateway-cross-premises-options/)  available in Azure.
...
Make sure you view all the [limits related to networking services in Azure](/documentation/articles/azure-subscription-service-limits/#networking-limits) before designing your solution. Some limits can be increased by opening a  support ticket  [support ticket](/support/support-ticket-form/?l=zh-cn) .
...
- Learn more about your [cross-premises and VNet connectivity  options](/documentation/articles/vpn-gateway-plan-design/)  options](/documentation/articles/vpn-gateway-cross-premises-options/) .
