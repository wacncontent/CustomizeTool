...
|Deployment  tool|Classic|Resource Manager|  tool|Classic| 
|---|---|---|
|Management  Portal|![No][red]|![No][red]|  Portal|![No][red]| 

...
1. What types of resources do you want to filter traffic to or from  (NICs in the same VM  (VM , VMs or other resources such as cloud services or application service environments connected to the same subnet, or between resources connected to different subnets)?
...
|---|---|---|
|Number of NSGs you can associate to a subnet,  VM, or NIC|1|This  VM|1|This  means you cannot combine NSGs. Ensure all the rules needed for a given set of resources are included in a single NSG.|
