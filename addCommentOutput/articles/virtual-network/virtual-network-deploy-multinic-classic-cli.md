...
1. Change the values of the variables below based on  your existing resource group  what you  deployed above in [Prerequisites](#Prerequisites).
...
1. Create a new cloud service for all backend VMs. Notice the use of the `$backendCSName` variable for the  resource group  cloud service  name, and `$location` for the Azure region.
