...
An Instance Level Public IP (ILPIP) is a public IP address that you can assign directly to your VM or role instance, rather than to the cloud service that your VM or role instance reside in. This <!-- deleted by customization doesnât --><!-- keep by customization: begin --> doesn't <!-- keep by customization: end --> take the place of the VIP (Virtual IP) that is assigned to your cloud service. Rather, <!-- deleted by customization itâs --><!-- keep by customization: begin --> it's <!-- keep by customization: end --> an additional IP address that you can use to connect directly to your VM or role instance.
