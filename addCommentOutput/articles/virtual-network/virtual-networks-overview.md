...
To learn more about IP addresses in Azure, visit [IP addresses in virtual  network](/documentation/articles/virtual-network-ip-addresses-overview-arm)  network](/documentation/articles/virtual-network-ip-addresses-overview-classic) 
