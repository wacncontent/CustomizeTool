...
## Scale a cache
To scale your cache, [browse to the cache](/documentation/articles/cache-configure/#configure-redis-cache-settings) in the [Azure  portal](https://portal.azure.cn)  Portal Preview](https://portal.azure.cn)  and click **Settings**, **Pricing tier**.
...
###  Can  <a name="can-i-scale-to-from-or-within-a-premium-cache"></a>Can  I scale to, from, or within a Premium cache?
...
###  After  <a name="after-scaling-do-i-have-to-change-my-cache-name-or-access-keys"></a>After  scaling, do I have to change my cache name or access keys?
...
###  Will  <a name="will-i-lose-data-from-my-cache-during-scaling"></a>Will  I lose data from my cache during scaling?
...
###  Is  <a name="is-my-custom-databases-setting-affected-during-scaling"></a>Is  my custom databases setting affected during scaling?
...
###  Will  <a name="will-my-cache-be-available-during-scaling"></a>Will  my cache be available during scaling?
...
###  How  <a name="how-can-i-tell-when-scaling-is-complete"></a>How  can I tell when scaling is complete?
