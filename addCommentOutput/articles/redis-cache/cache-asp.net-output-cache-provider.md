...
Check out the [ASP.NET Session State Provider for Azure Redis  Cache](cache-asp.net-session-state-provider.md)  Cache](/documentation/articles/cache-asp.net-session-state-provider) .
