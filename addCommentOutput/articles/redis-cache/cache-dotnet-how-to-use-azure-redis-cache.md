...
<!-- deleted by customization <a --><!-- keep by customization: begin --> ##<a <!-- keep by customization: end --> name="create-cache"></a> <!-- keep by customization: begin --> Create a cache <!-- keep by customization: end -->
<!-- deleted by customization ## Create a cache -->
<!-- deleted by customization
...
<!-- deleted by customization <a --><!-- keep by customization: begin --> ##<a <!-- keep by customization: end --> name="working-with-caches"></a> <!-- keep by customization: begin --> Working with Caches <!-- keep by customization: end -->
<!-- deleted by customization
## Working with Caches
-->
...
To connect to an Azure Redis Cache and be returned an instance of a connected `ConnectionMultiplexer`, call the static `Connect` method and pass in the cache endpoint and key like the following example. Use the key <!-- deleted by customization generated --><!-- keep by customization: begin --> you can get <!-- keep by customization: end --> from the <!-- deleted by customization Azure Management Portal --><!-- keep by customization: begin --> `Get-AzureRmRedisCacheKey` PowerShell command <!-- keep by customization: end --> as the password parameter.
...
<!-- deleted by customization <a --><!-- keep by customization: begin --> ##<a <!-- keep by customization: end --> name="next-steps"></a> <!-- keep by customization: begin --> Next Steps <!-- keep by customization: end -->
<!-- deleted by customization
## Next Steps
-->
