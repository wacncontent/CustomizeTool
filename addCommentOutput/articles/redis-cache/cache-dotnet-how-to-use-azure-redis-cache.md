...
This guide shows you how to get started using **Azure Redis Cache**. Azure Redis Cache is based on the popular open source Redis Cache. It gives you access to a secure, dedicated Redis cache, managed by  Microsoft  Azure.cn . A cache created using Azure Redis Cache is accessible from any application within Azure.
...
To connect to an Azure Redis Cache and be returned an instance of a connected `ConnectionMultiplexer`, call the static `Connect` method and pass in the cache endpoint and key like the following example. Use the key generated from the Azure Portal  Preview  as the password parameter.
...
## <a  name="add-object"></a>  name="add-object" id="add-and-retrieve-objects-from-the-cache"></a>  Add and retrieve objects from the cache
