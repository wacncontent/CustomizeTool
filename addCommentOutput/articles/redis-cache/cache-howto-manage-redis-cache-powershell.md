...

[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-rm-include.md)] [classic model](/documentation/articles/resource-manager-deployment-model/#classic-deployment-characteristics).


> [AZURE.NOTE] Azure has two different deployment models for creating and working with resources:  [Resource Manager and classic](/documentation/articles/resource-manager-deployment-model/).  This article covers using the Resource Manager deployment model, which Azure recommends for most new deployments instead of the [classic model](/documentation/articles/resource-manager-deployment-model/#classic-deployment-characteristics).

...
For more information on the `databases` property, see [Default Azure Redis Cache server configuration](/documentation/articles/cache-configure/#default-redis-server-configuration). For more information on creating a cache using the [New-AzureRmRedisCache](https://msdn.microsoft.com/zh-cn/library/azure/mt634517.aspx) cmdlet, see the previous [To create a Redis Cache](#to-create-a-redis-cache) section.
...
>[AZURE.NOTE]Scaling a cache using PowerShell is subject to the same limits and guidelines as scaling a cache from the Azure  portal  Portal   Preview . You can scale to a different pricing tier with the following restrictions.

>
...
 >-	You  ><p>-	You  can scale from a **Basic** cache to a **Standard** cache but you can't change the size at the same time. If you need a different size, you can do a subsequent scaling operation to the desired size.
 >-	You  ><p>-	You  can't scale from a **Basic** cache directly to a **Premium** cache. You must scale from **Basic** to **Standard** in one scaling operation, and then from **Standard** to **Premium** in a subsequent scaling operation.
 >-	You  ><p>-	You  can't scale from a larger size down to the **C0 (250 MB)** size.
 >  ><p> 
 >For  ><p>For  more information, see [How to Scale Azure Redis Cache](/documentation/articles/cache-how-to-scale/).
...
>[AZURE.IMPORTANT] Import/Export is only available for [premium tier](/documentation/articles/cache-premium-tier-intro/) caches. For more information about Import/Export, see [Import and Export data in Azure Redis Cache](/documentation/articles/cache-how-to-import-export-data/).
...
>[AZURE.IMPORTANT] Reboot is only available for [premium tier](/documentation/articles/cache-premium-tier-intro/) caches. For more information about rebooting your cache, see [Cache administration - reboot](/documentation/articles/cache-administration/#reboot).
...
- [Using Resource groups to manage your Azure resources](/documentation/articles/resource-group-template-deploy-portal/): Learn how to create and manage resource groups in the  Azure portal  Azure Portal   Preview .
