...
- [Redis Azure Cache docs <!-- deleted by customization ](/documentation/services/cache/) --><!-- keep by customization: begin --> ](/documentation/services/redis-cache/) <!-- keep by customization: end -->: This page provides many good links to using the Redis Azure cache.
...
- [How to Use ASP.NET Session State with Azure Websites](/documentation/articles/web-sites-dotnet-session-state-caching): This topic explains how to use the Azure Redis Cache Service for session state.
