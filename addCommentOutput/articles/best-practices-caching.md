...
If you are building a web site that serves data over an HTTP
...
> Both Azure Managed Cache Service and Azure In-Role Cache
  ...
  [What Redis Cache offering and size should I use?](/documentation/articles/cache-faq#what-redis-cache-offering-and-size-should-i-use) on the Microsoft website.
...
For more information visit the [ASP.NET Session State Provider for Azure Redis <!-- deleted by customization Cache](redis-cache/cache-asp.net-session-state-provider.md) --><!-- keep by customization: begin --> Cache](/documentation/articles/cache-asp.net-session-state-provider) <!-- keep by customization: end --> page on the Microsoft website.
...
- The [Azure Redis Cache Documentation](/documentation/services/cache/) page on the Microsoft website.
- The [Azure Redis Cache FAQ](/documentation/articles/cache-faq) page on the Microsoft website.
-->
...
- The [Using Redis as an LRU Cache](http://redis.io/topics/lru-cache) <!-- deleted by customization page --> on the Redis website.
- The [Transactions](http://redis.io/topics/transactions) <!-- deleted by customization page --> on the Redis website.
- The [Redis Security](http://redis.io/topics/security) page on the Redis website.
- The [Lap around Azure Redis Cache](http://azure.microsoft.com/blog/2014/06/04/lap-around-azure-redis-cache-preview/) <!-- deleted by customization page --> on the Azure blog.
<!-- deleted by customization
...
-->
<!-- keep by customization: begin -->
- The [Running Redis on a CentOS Linux VM](http://blogs.msdn.com/b/tconte/archive/2012/06/08/running-redis-on-a-centos-linux-vm-in-windows-azure.aspx) in Azure on the Microsoft website.
...
- The [An Introduction to Redis data types and abstractions](http://redis.io/topics/data-types-intro)  on the Redis website.
<!-- keep by customization: end -->
