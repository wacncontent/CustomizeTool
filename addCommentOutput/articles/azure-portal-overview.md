<properties
	pageTitle="Windows Azure Management Portal overview"
	description="Learn how to use the Windows Azure Management Portal."
	services=""
	documentationCenter=""
	authors="davidwrede"
	manager="dwrede"
...
The Windows Azure Management Portal is a central place where you can provision and manage your Azure resources.  This tutorial will familiarize you with the portal and show you how to use some of these key capabilities:
...
3.	Click 'Create' and <!-- deleted by customization your --><!-- keep by customization: begin --> you're <!-- keep by customization: end --> VM will begin to provision immediately.
...
The Windows Azure Management Portal radically simplifies building and managing your applications in the cloud.  Take a look at the [management blog](http://azure.microsoft.com/blog/topics/management/) to keep up to date as we're constantly [listening to feedback](http://feedback.azure.com/forums/223579-azure-preview-portal) and making improvements.  [ScottGu's blog](http://weblogs.asp.net/scottgu) is another great place to look for all Azure updates.
