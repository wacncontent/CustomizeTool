...
By putting your Data Warehouse in the cloud, you no longer have to deal with low-level hardware issues. <!-- deleted by customization  --> Gone are the days where you need to research what type of processors, how much memory or what type of storage you need to have great performance in your data warehouse. <!-- deleted by customization  --> Instead, SQL Data Warehouse asks you this question: how fast do you want to <!-- deleted by customization process --><!-- keep by customization: begin --> analyze <!-- keep by customization: end --> your data?
