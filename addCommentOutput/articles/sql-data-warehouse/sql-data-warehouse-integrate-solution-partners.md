<properties
   pageTitle="SQL Data Warehouse solution partners | Windows Azure"
...
| ![LogiAnalytics][12] |**LogiAnalytics**<br>Together, Logi Analytics and the Windows Azure SQL Data Warehouse can now enable your organization to collect, analyze, and immediately act on the largest and most diverse data sets in the world to drive a high-performance organization. | [More][logianalytics_more] |
...
| ![Qlik][14] |**Qlik**<br>Qlik provides a platform-based approach to visual analytics on top of Windows Azure SQL Data Warehouse.  Leveraging the enterprise-class features within Microsoft's elastic data warehouse, Qlik empowers the entire organization to make fast decisions with confidence. Qlik brings insights and clarity to where it's needed the most: the point of decision. | [More][qlik_more] |
| ![Redpont Global][15] |**Redpoint Global**<br>RedPoint Interaction and RedPoint Data Management enable marketers to leverage all their data to drive cross-channel customer engagement while performing structured and unstructured data management. By taking advantage of Windows Azure SQL Data Warehouse, RedPoint users can maximize the value of all their structured or unstructured data to deliver the hyper-personalized and contextual interactions needed to engage today's omni-channel customer. Drag-and-drop interface makes designing and executing data management processes easy. | [More][redpoint_global_more] |
...
| ![SnapLogic][17] |**SnapLogic**<br>The SnapLogic integration platform as a service (iPaaS) enables customers to quickly transfer data into and out of Windows Azure SQL Data Warehouse.  SnapLogic offers the ability to integrate over hundreds applications, services and IoT in the cloud, on-premises or in hybrid mode for fast, effective delivery of insights. | [More][snaplogic_more] |
...
| ![Tableau][19] |**Tableau**<br>Tableau's self-service analytics help anyone see and understand their data, across many kinds of data from flat files to databases. Tableau has a native, optimized connector to Windows Azure SQL Data Warehouse that supports both live data and in-memory analytics. | [More][tableau_more] |
