<properties
   pageTitle="Build integrated solutions with SQL Data Warehouse | Windows Azure"
...
In addition to its core functionality, SQL Data Warehouse enables users to leverage many of the other services in Azure alongside it. <!-- deleted by customization  --> Specifically, we have currently taken steps to deeply integrate with the following:
...
See [Integrate with Power BI](/documentation/articles/sql-data-warehouse-integrate-power-bi) or the [Power BI documentation](http://blogs.msdn.com/b/powerbi/archive/2015/06/24/exploring-azure-sql-data-warehouse-with-power-bi.aspx) for more information.
...
See [Integrate with Azure Data Factory](/documentation/articles/sql-data-warehouse-integrate-azure-data-factory) or the [Azure Data Factory documentation](/documentation/services/data-factory/) for more information.
...
See [Integrate with Azure Machine Learning](/documentation/articles/sql-data-warehouse-integrate-azure-machine-learning) or the [Azure Machine Learning documentation](/home/features/machine-learning/) for more information.
...
See [Integrate with Azure Stream Analytics](/documentation/articles/sql-data-warehouse-integrate-azure-stream-analytics) or the [Azure Stream Analytics documentation](/documentation/services/stream-analytics/) for more information.
