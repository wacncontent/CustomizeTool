<properties
   pageTitle="PolyBase in SQL Data Warehouse Tutorial | Windows Azure"
...
The LOCATION option specifies the path to the data from the root of the data source. In this example, the data is located at 'wasbs://mycontainer@test.blob.core.chinacloudapi.cn/path/Demo/'. All the files for the same table need to be under the same logical folder in Azure blob storage.
