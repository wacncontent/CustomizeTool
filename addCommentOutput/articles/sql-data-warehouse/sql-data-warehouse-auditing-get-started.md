...
1. Launch the <a href="https://manage.windowsazure.cn" target="_blank">Azure Preview Portal</a>.
...
The description in this section refers to screen captures above. Either <a <!-- deleted by customization href="https://manage.windowsazure.cn" target="_blank">Azure Preview Portal</a> or <a --> href= "https://manage.windowsazure.cn/" <!-- deleted by customization target="_bank">Classic Azure Management --><!-- keep by customization: begin --> target="_bank">Azure Manager <!-- keep by customization: end --> Portal</a> may be used.
