...
Your fully qualified server name and database name can be found in the Azure Management Portal.  Please note that SQL Data Warehouse only has a presence in the Azure Preview portal at this time.
