...
1. [Download Visual Studio 2015](https://www.visualstudio.com/downloads) from Visual Studio <!-- deleted by customization online --><!-- keep by customization: begin --> Team Services <!-- keep by customization: end -->.
