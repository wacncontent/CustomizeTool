...
<!-- deleted by customization 6 --><!-- keep by customization: begin --> 5 <!-- keep by customization: end -->. From the **Subscription** drop-down list, select the subscription that the storage account will be used with.
<!-- deleted by customization 7 --><!-- keep by customization: begin --> 6 <!-- keep by customization: end -->.  Click **Create Storage Account**. The process of creating the storage account might take several minutes to complete.
<!-- deleted by customization 8 --><!-- keep by customization: begin --> 7 <!-- keep by customization: end -->.  To verify that the storage account was created successfully, verify that the account appears in the items listed for **Storage** with a status of **Online**.
