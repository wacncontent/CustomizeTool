...
For more information, see [About Traffic Manager Load Balancing <!-- deleted by customization Methods](/documentation/articles/traffic-manager-load-balancing-methods) --><!-- keep by customization: begin --> Methods](http://msdn.microsoft.com/zh-cn/library/azure/dn339010.aspx) <!-- keep by customization: end -->.
...
For more information, see [Azure Load <!-- deleted by customization Balancer](/documentation/articles/load-balancer-overview) --><!-- keep by customization: begin --> Balancer](http://msdn.microsoft.com/zh-cn/library/azure/dn655058.aspx) <!-- keep by customization: end -->. For the steps to create a load-balanced set, see [Configure a load-balanced <!-- deleted by customization set](/documentation/articles/load-balancer-overview) --><!-- keep by customization: begin --> set](http://msdn.microsoft.com/zh-cn/library/azure/dn655055.aspx) <!-- keep by customization: end -->.
...
For more information, see [Internal load <!-- deleted by customization balancing](/documentation/articles/load-balancer-internal-overview) --><!-- keep by customization: begin --> balancing](http://msdn.microsoft.com/zh-cn/library/azure/dn690121.aspx) <!-- keep by customization: end -->. For the steps to create a load-balanced set, see [Configure an internal load-balanced <!-- deleted by customization set](/documentation/articles/load-balancer-internal-getstarted) --><!-- keep by customization: begin --> set](http://msdn.microsoft.com/zh-cn/library/azure/dn690125.aspx) <!-- keep by customization: end -->.
