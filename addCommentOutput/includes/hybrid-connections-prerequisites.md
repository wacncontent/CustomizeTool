...
- **An on-premises computer** <br/>You can run the Hybrid Connections Manger on the same on-premises computer as your SQL Server instance, or you can run each on a separate computer. The computer on which the Hybrid Connection Manager runs must meet the following criteria:
	...
	For more information see [Hybrid Connections <!-- deleted by customization Overview](/documentation/articles/integration-hybrid-connection-overview) --><!-- keep by customization: begin --> Overview](/documentation/articles//integration-hybrid-connection-overview) <!-- keep by customization: end -->.