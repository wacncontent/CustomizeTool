...
* For a .NET API app, make sure you are getting as much information in error messages as possible by setting  [customErrors  customErrors  mode to  Off](/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio/#remoteview)  Off .

