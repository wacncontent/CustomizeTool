...
First, you need to have an  [Azure  Azure  Active  Directory](https://azure.microsoft.com/trial/get-started-active-directory/)  Directory  (AAD) in your subscription. Among many benefits, this allows you to grant permission to your key vault for certain users and applications.
