...
Use the [Azure preview <!-- deleted by customization portal](http://manage.windowsazure.cn/) --><!-- keep by customization: begin --> portal](https://manage.windowsazure.cn/) <!-- keep by customization: end --> to obtain the connection string necessary for your client program to interact with Azure SQL Database:
