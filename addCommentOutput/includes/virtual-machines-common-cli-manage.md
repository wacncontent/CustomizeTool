...
-------------- | ----------- | -------------------------
Create the most basic VM | `azure vm create [options] <dns-name> <image> [userName] [password]` | `azure vm quick-create [options] <resource-group> <name> <location> <os-type> <image-urn> <admin-username> <admin-password>`<br/><br/>(Obtain the `image-urn` for popular Marketplace images by running `azure help vm quick-create`. For URNs in the form *publisherName:offer:skus:version*, see  [this article](/documentation/articles/virtual-machines-linux-cli-ps-findimage/)  [Windows](/documentation/articles/virtual-machines-windows-cli-ps-findimage/) or [Linux](/documentation/articles/virtual-machines-linux-cli-ps-findimage/)  for examples.)
...
* For additional examples of the CLI commands, see [Azure CLI commands in Azure Service Management mode](/documentation/articles/virtual-machines-command-line-tools/) and
[Azure CLI commands in Azure Resource Manager mode](/documentation/articles/azure-cli-arm-commands/).
