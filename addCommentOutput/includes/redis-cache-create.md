
To create a cache, first sign in to the [Azure Portal](https://portal.azure.cn), and click **New**, **DATA SERVICE**, **Redis Cache**.
...
-	In **Resource group**, select or create a resource group for your cache. For more information, see [Using Resource groups to manage your Azure resources](../articles/documentation/articles/resource-group-overview). 
