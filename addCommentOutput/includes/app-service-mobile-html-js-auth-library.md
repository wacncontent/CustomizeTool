...
example, to login with  Facebook  Microsoft Account  use the following code.
...
If you are using an identity provider other than  Facebook  Microsoft Account , change the value passed to the login method above to  one of  `aad`. 

