...
If you don't already have an Azure subscription, you can <!-- deleted by customization activate your [MSDN subscriber benefits](http://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/) or --> sign up for a [trial](/pricing/1rmb-trial/).
