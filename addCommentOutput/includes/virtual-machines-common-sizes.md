...
The standard sizes consist of several series: A, D, DS, F,  and  Fs , G, and GS . Considerations for some of these sizes include:
...

*	Dv2-series, D-series,  G-series,  and the  DS/GS  DS  counterparts  are ideal for applications that demand faster CPUs, better local disk performance, or have higher memory demands.  They offer a powerful combination for many enterprise-grade applications.
