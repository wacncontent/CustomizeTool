...
1. Follow the [HDInsight Storm - Get <!-- deleted by customization Started](/documentation/articles/hdinsight-storm-overview) --><!-- keep by customization: begin --> Started](/documentation/articles/hdinsight-storm-getting-started) <!-- keep by customization: end --> procedure to create a new HDInsight cluster, and connect to it via Remote Desktop.
...
[HDInsight sensor analysis tutorial]: /documentation/articles/hdinsight-storm-sensor-data-analysis
<!-- Images -->
