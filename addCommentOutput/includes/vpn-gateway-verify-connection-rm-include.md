...
In the Azure  portal  Portal   Preview , you can view the connection status by navigating to the connection. There are multiple ways to do this. Below is one way to navigate to your connection.

1. In the [Azure  portal](http://portal.azure.cn)  Portal Preview](http://portal.azure.cn) , navigate to **Virtual network gateways**. Click your gateway name.
