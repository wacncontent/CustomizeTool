...
6. Click **OK** on the confirmation dialog. 
	...
	![Status notification via the Azure <!-- keep by customization: begin --> Web App <!-- keep by customization: end --> Activity window](./media/app-service-api-pub-web-create/26-provisioning-success-v3.png)