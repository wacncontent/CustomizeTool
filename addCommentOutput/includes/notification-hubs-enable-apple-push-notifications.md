...
2. Update the following three fields for your new app and then click **Continue**:
	...
	* **Push Notifications**: Check the **Push Notifications** option in the **Azure Websites** section, .
...
2. Type a descriptive name for your app in **App ID Description** name. 
	...
	Check the **Push Notifications** option in the Azure Websites section, and then click **Continue**.
...
3. <!-- deleted by customization In the Developer Center, under App IDs, locate --><!-- keep by customization: begin --> Locate <!-- keep by customization: end --> the app ID that you just created, and click on its row.

   	![](./media/notification-hubs-enable-apple-push-notifications/notification-hubs-ios-appids2.png)

   	Clicking on the app ID will display the app details. Click the **Edit** button <!-- deleted by customization at the bottom -->.
