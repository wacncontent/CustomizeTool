...
related to a <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> deployed to Azure (from J.D.
...
-   **WCF (REST) Service With Live ID / Microsoft Account, Facebook,
    ...
    Microsoft Account.
-   **ASP.NET <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> to REST WCF Service Using Shared SWT Token.** In
...
-   [How To: Host Login Pages in Your ASP.NET <!-- deleted by customization web site](http://msdn.microsoft.com/zh-cn/library/gg185926.aspx) --><!-- keep by customization: begin --> Web Site](http://msdn.microsoft.com/zh-cn/library/gg185926.aspx) <!-- keep by customization: end -->
...
-   [How To: Configure Trust Between ACS and ASP.NET <!-- deleted by customization web sites --><!-- keep by customization: begin --> Web Sites <!-- keep by customization: end -->
...
###ASP.NET <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> to REST WCF Service Using Shared SWT Token
...
-   [How To: Configure Facebook as an Identity Provider](http://msdn.microsoft.com/zh-cn/library/gg185919.aspx)
-   [How To: Configure Yahoo! as an Identity Provider](http://msdn.microsoft.com/zh-cn/library/gg185977.aspx)
-   [ASP.NET <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> To REST WCF Service Delegation Using Shared SWT
...
-   [ACS How To's](http://msdn.microsoft.com/zh-cn/library/azure/gg185939.aspx)
-   [Secure Azure Web Role ASP.NET <!-- deleted by customization web site --><!-- keep by customization: begin --> Web Site <!-- keep by customization: end --> Using Access Control Service v2.0](http://social.technet.microsoft.com/wiki/contents/articles/2590.aspx)
