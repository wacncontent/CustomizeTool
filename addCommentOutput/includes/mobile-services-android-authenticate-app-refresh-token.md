...
We need to be able to detect an expired token, and refresh it. To do this we use a <!-- deleted by customization [ServiceFilter](http://dl.windowsazure.com/androiddocs/com/microsoft/windowsazure/mobileservices/ServiceFilter.html) --><!-- keep by customization: begin --> [ServiceFilter](http://dl.windowsazure.cn/androiddocs/com/microsoft/windowsazure/mobileservices/ServiceFilter.html) <!-- keep by customization: end --> from the [Android client <!-- deleted by customization library](http://dl.windowsazure.com/androiddocs/) --><!-- keep by customization: begin --> library](http://dl.windowsazure.cn/androiddocs/) <!-- keep by customization: end -->.
