...

In this article, you will learn how to use Git to publish directly from your local computer to Web Apps (in Azure, this method of publishing is called **Local Git**). You will also learn how to enable continuous deployment from repository sites like BitBucket  and , CodePlex, Dropbox,  GitHub , or Mercurial . For information about using  VSTS  TFS  for continuous deployment, see [Continuous delivery to Azure using Visual Studio Team Services].
