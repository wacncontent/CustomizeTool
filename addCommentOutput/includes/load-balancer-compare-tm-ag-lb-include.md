...
There are different options to distribute network traffic using Azure.These options work differently from each other, having a different feature set and  support  supports  different scenarios.They can each be used in isolation, or combining them.
