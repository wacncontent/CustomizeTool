The data in your Windows Azure storage account is always replicated to ensure durability and high availability, meeting the [Azure Storage <!-- deleted by customization SLA](http://azure.microsoft.com/support/legal/sla/) --><!-- keep by customization: begin --> SLA](/support/legal/sla/) <!-- keep by customization: end --> even in the face of transient hardware failures.
