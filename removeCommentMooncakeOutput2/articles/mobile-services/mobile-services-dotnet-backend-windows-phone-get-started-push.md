...
>[AZURE.NOTE]This tutorial targets Windows Phone 8.1 Silverlight apps. If you are instead building a Windows Phone 8.1 Store app, see the [Windows Store app](/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-push) version of this tutorial. For information on Windows Phone Silverlight apps and how they compare with Windows Phone Store apps, see [Windows Phone Silverlight 8.1 apps]. 
...
[Windows Phone Silverlight 8.1 apps]: http://msdn.microsoft.com/zh-cn/library/windowsphone/develop/dn642082(v=vs.105).aspx
