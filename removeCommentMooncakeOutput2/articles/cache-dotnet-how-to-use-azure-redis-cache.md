...
Windows Azure Redis Cache, currently in preview, is based on the popular open source Redis Cache. It gives you access to a secure, dedicated Redis cache, managed by Microsoft. A cache created using Azure Redis Cache is accessible from any application within Windows Azure.
...
To create a cache, first sign in to the [Windows Azure Management Portal][], and click **New**, **DATA SERVICE**, **Redis Cache**.
