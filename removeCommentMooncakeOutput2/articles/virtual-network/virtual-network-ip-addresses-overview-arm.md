...
## Next steps
* [Deploy a VM with a static public IP using the Azure portal preview](/documentation/articles/virtual-network-deploy-static-pip-arm-portal/)
...
* [Deploy a VM with a static private IP address using the Azure portal preview](/documentation/articles/virtual-networks-static-private-ip-arm-pportal/)
