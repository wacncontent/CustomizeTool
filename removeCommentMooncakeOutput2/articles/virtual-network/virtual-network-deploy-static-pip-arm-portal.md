<properties
    pageTitle="Create a VM with a static public IP using the Azure portal preview | Azure"
    description="Learn how to create a VM with a static public IP address through Azure Resource Manager using the Azure portal preview."
...
# Create a VM with a static public IP using the Azure portal preview
> [AZURE.SELECTOR]
