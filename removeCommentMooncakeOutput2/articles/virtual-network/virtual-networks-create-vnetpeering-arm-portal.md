...
<properties
    pageTitle="Create VNet Peering using the Azure portal preview | Azure"
...
To create a VNet peering based on the scenario above by using the Azure portal preview, follow the steps below.
...
5. Then login to Azure portal preview with UserB who is the privilege user for SubscriptionB. Follow above steps to add UserA as Network Contributor.
