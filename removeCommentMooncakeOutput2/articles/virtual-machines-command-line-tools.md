...
Launching browser to <a href="http://go.microsoft.com/fwlink/?LinkID=301774">https://manage.windowsazure.cn/publishsettings</a>
...
This command imports a publishsettings file or certificate so that it can be used by the tool going forward.
	...
	info:   Found subscription: Trial
	info:   Found subscription: Pay-As-You-Go
	info:   Setting default subscription to: Trial
...
In this example, 55bc2b193643443bb879a78bda516fc8__Windows-Server-2012-R2-201502.01-zh.cn-127GB.vhd is an image provided by the platform. For more information about operating system images, see vm image list.
...
Commands in this section are used to manage scheduled jobs that belong to a mobile service. For more information, see [Schedule jobs](https://msdn.microsoft.com/zh-cn/library/azure/jj860528.aspx).
...
Commands in this section are used to scale a mobile service. For more information, see [Scaling a mobile service](https://msdn.microsoft.com/zh-cn/library/azure/jj193178.aspx).
