<properties
    pageTitle="Create self-signed certificates for Point-to-Site virtual network cross-premises connections by using makecert | Azure"
...
* For **Resource Manager** deployment model steps, see [Configure a Point-to-Site connection to a VNet using PowerShell](/documentation/articles/vpn-gateway-howto-point-to-site-rm-ps/). 
* For **classic** deployment model steps, see [Configure a Point-to-Site VPN connection to a VNet using the Classic Management Portal](/documentation/articles/vpn-gateway-point-to-site-create/).
