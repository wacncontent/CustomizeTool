...
- [Many](/documentation/articles/virtual-machines-linux-classic-cli-use-docker/) [different](/documentation/articles/virtual-machines-linux-classic-portal-use-docker/) [ways](/documentation/articles/virtual-machines-linux-classic-docker-quickstart/) to [create Docker hosts](https://github.com/Azure/azure-quickstart-templates/tree/master/docker-simple-on-ubuntu) for containers to suit your situation
- [Azure Resource  Manager](../articles/documentation/articles/resource-group-overview/)  Manager](/documentation/articles/resource-group-overview/)  and [resource group templates](/documentation/articles/resource-group-authoring-templates/) to simplify deploying and updating complex distributed applications
...
They're great for many things, but they encourage&mdash;as do [Azure Cloud  Services](/home/features/cloud-services/) and [Azure Service Fabric](/documentation/articles/service-fabric-overview/)&mdash;the  Services](/home/features/cloud-services/)&mdash;the  creation of single-service, [microservice]-oriented distributed applications, in which application design is based on more small, composable parts rather than on larger, more strongly coupled components.
...
- [Getting Started Quickly with Docker in the Azure  Marketplace](/documentation/articles/virtual-machines-linux-classic-docker-quickstart/)  gallery](/documentation/articles/virtual-machines-linux-classic-docker-quickstart/) 
