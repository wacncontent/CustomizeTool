...
>[AZURE.IMPORTANT]Azure has two different deployment models for creating and working with resources: Resource Manager and Classic. This article covers using the Resource Manager model.  Microsoft  Azure  recommends that most new deployments use the Resource Manager model.
