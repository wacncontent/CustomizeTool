...
- Resize the VM to a different VM size.<br>
	Click **Browse all** > **Virtual machines (classic)** > your virtual machine > **Settings** > **Size**. For detailed steps, see [Resize the virtual  machine](https://msdn.microsoft.com/library/dn168976.aspx)  machine](https://msdn.microsoft.com/zh-cn/library/dn168976.aspx) .
