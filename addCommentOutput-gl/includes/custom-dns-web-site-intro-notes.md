This article is for  Azure Web  App  Service (Web Apps, API Apps, Mobile Apps, Logic Apps) ; for Cloud Services, see <a href="/develop/net/common-tasks/custom-dns/">Configuring a Custom Domain Name in Azure</a>.
