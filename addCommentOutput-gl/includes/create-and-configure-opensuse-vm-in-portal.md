...
5. On the first **Virtual machine configuration** page:
	...
	- Decide which type of **Authentication** to use. For general password guidelines, see [Strong  passwords](http://msdn.microsoft.com/library/ms161962.aspx)  passwords](http://msdn.microsoft.com/zh-cn/library/ms161962.aspx) .
...
- From a computer running Windows, use PuTTY. If you don't have it installed, download it from the [PuTTY Download Page][PuTTYDownload].
	...
	Type the host name, such as  "testlinuxvm.cloudapp.net"  "testlinuxvm.chinacloudapp.cn" , and type "22" for the **Port**.
