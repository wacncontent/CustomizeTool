1. In the Azure  [Management Portal](http://manage.windowsazure.com)  [Classic Management Portal](http://manage.windowsazure.cn) , click **Virtual Machines** and then select the virtual machine you just created (**testlinuxvm**).
