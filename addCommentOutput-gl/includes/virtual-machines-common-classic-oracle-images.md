...
To create virtual machines based on Oracle images, sign in to the [Azure  portal](https://portal.azure.com/)  portal](https://portal.azure.cn/) , click **Marketplace**, click **Compute**, and then type **Oracle** into the Search box. Select an image and follow the instructions to set up the image on  Microsoft  Azure. Note that Oracle images by Microsoft on the [Azure  portal](https://portal.azure.com/)  portal](https://portal.azure.cn/)  run on Windows, and Oracle images by Oracle run on Oracle Linux.
