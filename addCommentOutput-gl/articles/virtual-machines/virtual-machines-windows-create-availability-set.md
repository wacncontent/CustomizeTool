...
This example creates an availability set in the **RMResGroup** resource group in the  **West US**  **China North**  location. This needs to be done before you create the first VM that will be in the set.
