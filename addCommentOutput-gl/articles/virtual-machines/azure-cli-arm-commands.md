...
Example: Create a Storm on Linux cluster
	...
	azure hdinsight cluster create -g myarmgroup -l  westus  chinanorth  -y Linux --clusterType Storm --version 3.2 --defaultStorageAccountName mystorageaccount --defaultStorageAccountKey <defaultStorageAccountKey> --defaultStorageContainer mycontainer --userName admin --password <clusterPassword> --sshUserName sshuser --sshPassword <sshPassword> --workerNodeCount 1 myNewCluster01
...
Example: Create a cluster with a script action
	...
	azure hdinsight cluster create -g myarmgroup -l  westus  chinanorth  -y Linux --clusterType Hadoop --version 3.2 --defaultStorageAccountName mystorageaccount --defaultStorageAccountKey <defaultStorageAccountKey> --defaultStorageContainer mycontainer --userName admin --password <clusterPassword> --sshUserName sshuser --sshPassword <sshPassword> --workerNodeCount 1 -configurationPath "C:\myFiles\configFile.config" myNewCluster01
...
Allows to create a new virtual network. In the following example we create a virtual network named newvnet for resource group myresourcegroup in the  West US  China North  region.
...
The command allows to list all virtual networks in a resource group.
	...
	wvnet   newvnet    westus  chinanorth     10.0.0.0/8
...
Creates a load balancer set.
	...
	azure network lb create -g myresourcegroup -n mylb -l  westus  chinanorth 
...
Creates a public ip resource. You will create the public ip resource and associate to a domain name.
	...
	azure network public-ip create -g myresourcegroup -n mytestpublicip1 -l  eastus  chinaeast  -d azureclitest -a "Dynamic"
	...
	data:    FQDN:                  azureclitest.eastus.cloudapp.azure.com  azureclitest.chinaeast.chinacloudapp.cn 
...
Lists all public IP resources within a resource group.
	...
	data:    ---------------  --------  ----------  ------------  ------------  -------------------------------------------
	data:    mypubip5          westus  chinanorth     Dynamic                   4             "domain  name".westus.cloudapp.azure.com  name".chinanorth.chinacloudapp.cn 
	data:    myPublicIP        eastus  chinaeast     Dynamic                   4             "domain  name".eastus.cloudapp.azure.com  name".chinaeast.chinacloudapp.cn 
	data:    mytestpublicip    eastus  chinaeast     Dynamic                   4             "domain  name".eastus.cloudapp.azure.com  name".chinaeast.chinacloudapp.cn 
	data:    mytestpublicip1   eastus  chinaeast    Static (Static IP address) 4              azureclitest.eastus.cloudapp.azure.com  azureclitest.chinaeast.chinacloudapp.cn 
...
Creates a resource called network interface (NIC) which can be used for load balancers or associate to a Virtual Machine.
	...
	azure network nic create -g myresourcegroup -l  eastus  chinaeast  -n testnic1 --subnet-name subnet-1 --subnet-vnet-name myvnet
...
**Create a VM with default resources**
    ...
    vm quick-create [options] <resource-group> <name> <location> <os-type> <image-urn> <admin-username>  <admin-password  <admin-password> 
