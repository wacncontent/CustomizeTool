...
> [AZURE.NOTE] You must already have an  Microsoft  Azure VM running Linux. To create and set up a Linux VM, see the [Azure Linux VM tutorial](/documentation/articles/virtual-machines-linux-classic-createportal/).
...
In a Windows machine, start the remote desktop client, input your Linux VM DNS name, or go to `Dashboard` of your VM in Azure  classic  Classic   portal  Management Portal  and click `Connect` to connect your Linux VM, you will see below login window:
