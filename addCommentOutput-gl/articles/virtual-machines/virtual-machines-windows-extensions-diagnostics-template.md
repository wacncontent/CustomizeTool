...
> [AZURE.IMPORTANT] These metrics drive the monitoring charts and alerts in the Azure portal  Preview .  The **Metrics** node with the *resourceID* and **MetricAggregation** must be included in the diagnostics configuration for your VM if you want to see the VM monitoring data in the Azure portal  Preview .
