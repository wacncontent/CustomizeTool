...
- [Features Supported by the Editions of SQL Server  2016](https://msdn.microsoft.com/library/cc645993.aspx)  2016](https://msdn.microsoft.com/zh-cn/library/cc645993.aspx) 
...

<sup>1</sup> For additional information on SharePoint and Azure virtual machines, see [Microsoft Azure Architectures for SharePoint 2013](https://technet.microsoft.com/en-us/library/dn635309.aspx) and [SharePoint Deployment on Microsoft Azure Virtual Machines](https://www.microsoft.com/download/details.aspx?id=34598).
...
- The minimum recommended size for a virtual machine is **A3** when using SQL Server Enterprise Edition. The **A4** virtual machine size is recommended for SQL Server BI deployments of Analysis Services and Reporting Services.
	...
	For information on the current VM sizes, see [Virtual Machine Sizes for Azure](/documentation/articles/virtual-machines-linux-sizes/).
...
- A best practice for disk management is to store data, log, and backup files on drives other than **C**: and **D**:. For example, create data disks **E**: and **F**:.
	...
	For more information on creating and attaching disks, see [How to Attach a Data Disk to a Virtual Machine](/documentation/articles/virtual-machines-windows-classic-attach-disk/).
...
The virtual machine gallery image for SQL Server includes Reporting Services Native mode installed, however the report server is not configured. The steps in this section configure the Reporting Services report server. For more detailed information on configuring Reporting Services Native mode, see [Install Reporting Services Native Mode Report Server  (SSRS)](https://msdn.microsoft.com/library/ms143711.aspx)  (SSRS)](https://msdn.microsoft.com/zh-cn/library/ms143711.aspx) .

>[AZURE.NOTE] For similar content that uses Windows PowerShell scripts to configure the report server, see [Use PowerShell to Create an Azure VM With a Native Mode Report Server](/documentation/articles/virtual-machines-windows-classic-ps-sql-report/).
...
For information on report server permissions, see [Granting Permissions on a Native Mode Report  Server](https://msdn.microsoft.com/library/ms156014.aspx)  Server](https://msdn.microsoft.com/zh-cn/library/ms156014.aspx) .
...
- **Report Builder**: The virtual machine includes the click-once version of Microsoft SQL Server Report Builder for SQL 2014 and 2012. To start Report builder the first time on the virtual machine with SQL 2016:
	...
	For more information, see [Start Report  Builder](https://msdn.microsoft.com/library/ms159221.aspx)  Builder](https://msdn.microsoft.com/zh-cn/library/ms159221.aspx) .
...
- Create a .VHD hard drive that contains reports and then upload and attach the drive.
	...
	1. Upload the VHD file to Azure using the Add-AzureVHD cmdlet [Create and upload a Windows Server VHD to Azure](/documentation/articles/virtual-machines-windows-classic-createupload-vhd/).
...
1. Use SQL Server Management Studio to create a static Analysis Services named instance port by updating 'Port' value in tabular AS instance general properties. For more information, see the "Use a fixed port for a default or named instance" in [Configure the Windows Firewall to Allow Analysis Services  Access](https://msdn.microsoft.com/library/ms174937.aspx#bkmk_fixed)  Access](https://msdn.microsoft.com/zh-cn/library/ms174937.aspx#bkmk_fixed) .
...
- Create Endpoints:[How to Set Up Endpoints to a Virtual Machine](/documentation/articles/virtual-machines-windows-classic-setup-endpoints/).

- SQL Server: See the "Complete Configuration steps to connect to the virtual machine Using SQL Server Management Studio" section of [Provisioning a SQL Server Virtual Machine on Azure](/documentation/articles/virtual-machines-windows-portal-sql-server-provision/).
...
- [Provisioning a SQL Server Virtual Machine on Azure](/documentation/articles/virtual-machines-windows-portal-sql-server-provision/)
...
- [Determine the Server Mode of an Analysis Services  Instance](https://msdn.microsoft.com/library/gg471594.aspx)  Instance](https://msdn.microsoft.com/zh-cn/library/gg471594.aspx) 


- [Multidimensional Modeling (Adventure Works Tutorial)](https://technet.microsoft.com/en-us/library/ms170208.aspx)


...
- [Using Power BI in a Hybrid  Environment](https://msdn.microsoft.com/library/dn798994.aspx)  Environment](https://msdn.microsoft.com/zh-cn/library/dn798994.aspx) 
