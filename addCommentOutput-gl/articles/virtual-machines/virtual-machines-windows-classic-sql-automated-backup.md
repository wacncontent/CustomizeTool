...
Automated Backup configures Managed Backup on Azure VMs. So it is important to [review the documentation for Managed  Backup](https://msdn.microsoft.com/library/dn449496.aspx)  Backup](https://msdn.microsoft.com/zh-cn/library/dn449496.aspx)  to understand the behavior and implications.
