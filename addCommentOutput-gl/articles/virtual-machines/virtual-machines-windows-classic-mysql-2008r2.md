...
1.	In the Azure  classic  Classic   portal  Management Portal , click **Virtual Machines**, click the name of your MySQL virtual machine, and then click **Endpoints**.
...
1.	In the Azure  classic  Classic   portal  Management Portal , click **Virtual Machines**, click the name of your MySQL server virtual machine, and then click **Dashboard**.
...
3.	From a local computer running MySQL or the MySQL client, run the following command to log in as a MySQL user.
	...
	For example, for the MySQL user name dbadmin3 and the  testmysql.cloudapp.net  testmysql.chinacloudapp.cn  DNS name for the virtual machine, use the following command.
