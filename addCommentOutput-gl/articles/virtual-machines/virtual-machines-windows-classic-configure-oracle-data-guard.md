...
- You've set the Virtual Machine names as "Machine1" for the primary VM and "Machine2" for the standby VM at the Azure  classic  Classic   portal  Management Portal .
