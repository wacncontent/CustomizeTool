...
When prompted to create an ID, type the name of an initial Office 365 account, your fictitious company name, and then a password. Record the resulting email address (such as  user123@contoso123.onmicrosoft.com)  user123@contoso123.partner.onmschina.cn)  and the password in a secure location. You will need this information to complete the Azure AD Connect configuration in Phase 3.
...
6.	Run Internet Explorer and go to  **http://portal.microsoftonline.com**  **http://portal.partner.microsoftonline.cn** .
7.	Log on with Lynda Meyer's Office 365 credentials. Her user name will be lyndam@<*Your Fictional  Name*>.onmicrosoft.com  Name*>.partner.onmschina.cn . The password is the Lynda Meyer Active Directory user account password.
...

- Deploy this workload [in production](http://technet.microsoft.com/en-us/library/dn635310.aspx).


