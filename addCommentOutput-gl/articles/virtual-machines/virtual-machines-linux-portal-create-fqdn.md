...
You can now connect remotely to the VM using this DNS name such as with `ssh  adminuser@testdnslabel.centralus.cloudapp.azure.com`  adminuser@testdnslabel.centralus.chinacloudapp.cn` .
