...
VM images deployed from the Azure  Marketplace  gallery  have a VM Linux Agent integrated with the OS which allows the VM to interact with various Azure services. Assuming you have deployed a standard image from the Azure  Marketplace  gallery , you would need to do the following to correctly configure your Linux swap file settings:
