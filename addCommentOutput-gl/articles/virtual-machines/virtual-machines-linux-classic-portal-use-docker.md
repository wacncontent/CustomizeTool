...
> [AZURE.NOTE] This functionality is supported in the preview portal only:  https://portal.azure.com/  https://portal.azure.cn/ 
...
Locate and copy the name of your VM's domain, and at the command line of your client computer, type `docker --tls -H  tcp://`*dockerextension*`.cloudapp.net:2376  tcp://`*dockerextension*`.chinacloudapp.cn:2376  info` (where *dockerextension* is replaced by the subdomain for your VM).
