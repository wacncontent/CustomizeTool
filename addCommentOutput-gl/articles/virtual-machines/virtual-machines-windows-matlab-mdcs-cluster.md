...
* **Azure subscription** - If you don't have a subscription, you can create a  [free account](https://azure.microsoft.com/free/)  [trial account](/pricing/1rmb-trial/)  in just a couple of minutes. For larger clusters, consider a pay-as-you-go subscription or other purchase options.
