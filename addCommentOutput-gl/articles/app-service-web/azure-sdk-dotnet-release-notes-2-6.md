...
- Server Explorer changed to reflect new  App Service  Azure  node, with Web, Mobile, and API apps grouped by Resource Group.
...
- API Apps tooling and  App Service  Azure  nodes in Server Explorer are available in Visual Studio 2013 only.
