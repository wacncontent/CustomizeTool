...
[Azure  App Service](/documentation/services/web-sites/)  Web App](/documentation/services/web-sites) . In this article, you'll quickly add some
...
The three activities in this tutorial are only a few examples of the many useful features you get when you put your web app in  App Service  Azure . Many of the features are
...
information on what you get with **Free** tier, see  [App Service  [Azure  limits](/documentation/articles/azure-subscription-service-limits/#app-service-limits).
...
 App Service  Azure  provides a turn-key solution for some of the common authentication needs so you don't need to provide the authentication logic yourself.

...

[Scale pricing tier in Azure App Service](/documentation/articles/app-service-scale/) and 


...
For more information on scaling up your app, see [Scale pricing tier in Azure  App Service](/documentation/articles/app-service-scale/)  Web App](/documentation/articles/app-service-scale/) . For more information on
...
> [AZURE.NOTE] Alert rules is an Azure feature. For more information, see [Receive alert notifications](/documentation/articles/insights-receive-alert-notifications/). 
...
 *.azurewebsites.net  *.chinacloudsites.cn  domain. Or use a domain that you already have.
