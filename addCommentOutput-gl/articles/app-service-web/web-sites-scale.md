...

For increased performance and throughput for your web apps on Microsoft Azure, you can use the [Azure Portal](http://portal.azure.com) to scale your [App Service](/documentation/services/web-sites/) plan from **Free** mode to **Shared**, **Basic**, **Standard**, or **Premium** mode. 
...
- For detailed information about all of the remaining features in the App Service plans, including pricing and features of interest to all users (including developers), see  [App Service  [Azure  Pricing Details](/home/features/web-site/pricing/).

...
- To get started with Azure, see  [Microsoft Azure Free  [Azure  Trial](/pricing/1rmb-trial/).
...


	[Data Transfers Pricing Details](/home/features/data-transfers/pricing/)
...

	...
	[App Service Pricing Details - SSL Connections](/home/features/web-site/pricing/)
