...
[Azure  App Service](/documentation/services/web-sites/)  Web App](/documentation/services/web-sites/) , and then guides you to appropriate resources with instructions specific to your preferred option.
...
Azure  Web  App  Service  maintains the application framework for you (ASP.NET, PHP, Node.js, etc). Some frameworks are enabled by default
...
Since you don't have to worry about the web server or application framework, deploying your app to  Azure Web  App  Service  is
...

for WebJobs).  Azure Web  App  Service  supports the following deployment options:
...
a file upload process. No additional services are provided by  Azure Web  App  Service , such as version control, file structure management, etc.
...

- [Web Deploy](http://www.iis.net/learn/publish/using-web-deploy/introduction-to-web-deploy): Deploy code to  App Service  Azure  directly from your favorite Microsoft tools
...
connection strings, etc.  For  Web Deploy  differs from Kudu in that ,  application binaries are built before they are deployed to Azure.
Similar to FTP, no additional services are provided by  Azure Web  App  Service .
...
 >[AZURE.NOTE] These deployment processes don't actually [provision the Azure resources](/documentation/articles/resource-group-portal/) that your app may need. However, most of the linked how-to articles show you how to provision the app AND deploy 

...
- Having to know how to deploy files to the correct directories in  Azure Web  App  Service .
...
If your development team uses an on-premises local source code management (SCM) service based on Git, you can configure this as a deployment source to  Azure Web  App  Service .
...
In the [Azure  Portal](https://portal.azure.com)  Classic Management Portal](https://manage.windowsazure.cn/) , you can configure local Git deployment.
...
deploy to  App Service  Azure  if they have FTP or Git integration (see [Overview of deployment processes](#overview)).
...
You can perform MSBuild or FTP deployment functions from [Windows  PowerShell](http://msdn.microsoft.com/library/dd835506.aspx)  PowerShell](http://msdn.microsoft.com/zh-cn/library/dd835506.aspx) . If you do that, you can also use a collection of Windows PowerShell cmdlets that make the Azure REST management API easy to call.
...
* [Azure Command line tools](/downloads/#cmd-line-tools). Portal page in  Azure.com  Azure.cn  for command line tool information.
...
* [Web Deployment  Tool](http://technet.microsoft.com/en-us/library/dd568996)  Tool](http://technet.microsoft.com/zh-cn/library/dd568996) . Official documentation on the Microsoft TechNet site. Dated but still a good place to start.
...
Having a backup and restore plan in place is an important part of any deployment workflow. For information about the  App Service  Azure  backup and restore feature, see [Web Apps Backups](/documentation/articles/web-sites-backup/).

