...
This tutorial shows you how to create an ASP.NET 5 web app using [Visual Studio Code (VS Code)](http://code.visualstudio.com//Docs/whyvscode) and deploy it to [Azure  App Service](/documentation/services/web-sites/)  Web App](/documentation/services/web-sites) .


> [AZURE.NOTE] Although this article refers to web apps, it also applies to API apps and mobile apps. 


ASP.NET 5 is a significant redesign of ASP.NET. ASP.NET 5 is a new open-source and cross-platform framework for building modern cloud-based web apps using .NET. For more information, see [Introduction to ASP.NET 5](http://docs.asp.net/en/latest/conceptual-overview/aspnet.html). For information about Azure  App Service  web apps, see [Web Apps  Overview](/home/features/web-site/)  Overview](/home/features/web-site) .
