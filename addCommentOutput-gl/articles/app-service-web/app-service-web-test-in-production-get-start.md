...
In addition to automatic traffic routing,  App Service  Azure  is able to route requests to a specific slot. This is useful when you want your users to be able to opt-into or opt-out of your beta app. To do this, you use the `x-ms-routing-name` query parameter.
...
-   [Set up staging environments for web apps in  Azure App Service](/documentation/articles/web-sites-staged-publishing/)  Azure](/documentation/articles/web-sites-staged-publishing/) 
