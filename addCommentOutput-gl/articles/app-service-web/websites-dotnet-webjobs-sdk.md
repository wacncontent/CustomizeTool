...
* **Dashboard**. Part of the WebJobs SDK is included in Azure  Web  App  Service  and provides rich monitoring and diagnostics for programs that use the NuGet packages. You don't have to write code to use these monitoring and diagnostics features.
