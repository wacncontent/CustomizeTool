...
>[AZURE.NOTE] See a web app in action. [Try  App Service](https://tryappservice.azure.com/)  Azure Web App](https://tryappservice.azure.com/)  immediately and create a short-lived starter app--no credit
...
4. The last two tasks (setting the virtual directory and enabling Composer) requires the [Azure  portal](https://portal.azure.com)  portal](https://portal.azure.cn) , so log in to

