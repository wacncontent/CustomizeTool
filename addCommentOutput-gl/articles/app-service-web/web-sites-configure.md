...

[Configure a custom domain name in Azure  App Service]  Web App] : /documentation/articles/web-sites-custom-domain-name/
[Deploy to Staging Environments for Web Apps in  Azure App Service]  Azure] : /documentation/articles/web-sites-staged-publishing/
[Enable HTTPS for an app in Azure  App Service]  Web App] : /documentation/articles/web-sites-configure-ssl-certificate/
...

[Using Git to deploy Web Apps in  Azure App Service]  Azure] : /documentation/articles/web-sites-publish-source-control/
