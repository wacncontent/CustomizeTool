...
This tutorial shows how to create a simple [Node.js](http://nodejs.org) application and deploy it to a [web  app](/home/features/web-site/)  app](/home/features/web-site)  in [Azure  App Service](/documentation/services/web-sites/)  Web App](/documentation/services/web-sites)  by using [Git](http://git-scm.com). The instructions in this tutorial can be followed on any operating system that is capable of running Node.js.

You'll learn:

* How to create a web app in Azure  App Service  by using the Azure  Classic Management  Portal.
...
5. To view your app, click the **Browse** button on the **Web App** part in the Azure  portal  Classic Management Portal .

...
You've deployed a Node.js application to a web app in Azure  App Service . To learn more about how  App Service  Azure  web apps run Node.js applications, see [Azure  App Service  Web Apps: Node.js](http://blogs.msdn.com/b/silverlining/archive/2012/06/14/windows-azure-websites-node-js.aspx) and [Specifying a Node.js version in an Azure application](/documentation/articles/nodejs-specify-node-version-azure-apps/).
...
If you encounter problems with your application after it has been deployed to Azure, see [How to debug a Node.js application in Azure  App Service](/documentation/articles/web-sites-nodejs-debug/)  Web App](/documentation/articles/web-sites-nodejs-debug/)  for information on diagnosing the problem.
