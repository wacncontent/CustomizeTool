...


In Azure Web App, you can connect your app to an Azure virtual network (VNet) in your subscription. This feature is called VNet Integration.

This article is about how to enable integration by using PowerShell. 

...
To upload the certificate manually, use the [Azure  portal][azureportal]  Portal Preview][azureportal]  and **Browse Virtual Network (classic)** > **VPN connections** > **Point-to-site** > **Manage certificates**. From here, upload your certificate.


Or in Azure Classic Management Portal, click **Networks** > **You Vnet** > **Certificates** > **Upload**.

...
### Resource Manager VNet  Azure Web  App  Service  integration script ###
...

	...
	Account     :  ccompy@microsoft.com  xxxxxxx@xxxxxxx.partner.onmschina.cn 

