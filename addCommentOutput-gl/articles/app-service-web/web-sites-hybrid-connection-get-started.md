...
You can connect an Azure  Web  App  Service app  to any on-premises resource that uses a static TCP port, such as SQL Server, MySQL, HTTP Web APIs, and most custom Web Services. This article shows you how to create a hybrid connection between  App Service  Azure  and an on-premises SQL Server database.

> [AZURE.NOTE] The Web Apps portion of the Hybrid Connections feature is available only in the [Azure  Portal](https://portal.azure.com)  Portal](https://portal.azure.cn) . To create a connection in BizTalk Services, see [Hybrid Connections](/documentation/articles/integration-hybrid-connection-overview/).
> 
> This content also applies to Mobile Apps in Azure  Web  App  Service .

## Prerequisites
- An Azure subscription. For a free subscription, see [Azure  Free  Trial](/pricing/1rmb-trial/).
...
1. In the upper left corner of the [Azure  Portal](https://portal.azure.com)  Portal](https://portal.azure.cn) , click **New** > **Web + Mobile** > **Web App**.
...
1. Back in the [Azure  portal](https://portal.azure.com)  portal](https://portal.azure.cn)  in the web app backend code for your Mobile App, click **All settings**, then **Application settings**.
