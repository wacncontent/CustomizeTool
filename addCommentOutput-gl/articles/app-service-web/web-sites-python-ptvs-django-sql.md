...
We'll learn how to use a SQL database hosted on Azure, how to configure the web app to use a SQL database, and how to publish the web app to [Azure  App Service  Web Apps](/documentation/services/web-sites/).
