...
You can easily migrate your existing websites that run on Internet Information Service (IIS) 6 or later to  [App Service  [Azure  Web Apps](/documentation/services/web-sites/).
...
[Web Apps Migration Assistant](https://www.movemetothecloud.net/) can analyze your IIS server installation, identify which sites can be migrated to  Azure Web  App  Service , highlight any elements that cannot be migrated or are unsupported on the platform, and then migrate your websites and associated databases to Azure.
...
14.	On the next screen you can make changes to the default migration settings, such as:
	...
	>[AZURE.NOTE] the **Enable Azure Active Directory** checkbox in custom settings integrates the Azure web app with [Azure Active Directory](/documentation/articles/active-directory-whatis/) (the **Default Directory**). For more information on syncing Azure Active Directory with your on-premise Active Directory, see [Directory  integration](http://msdn.microsoft.com/library/jj573653)  integration](http://msdn.microsoft.com/zh-cn/library/jj573653) .
...
21. You can now manage the migrated web apps in Azure  App Service . To do this, log into the [Azure  Portal](https://portal.azure.com)  Portal](https://portal.azure.cn) .
