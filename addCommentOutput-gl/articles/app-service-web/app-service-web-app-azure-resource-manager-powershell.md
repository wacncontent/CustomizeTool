...
To learn about the full list of parameters and options for the Web App Azure Resource Manager PowerShell cmdlets, see the [full Cmdlet Reference of Web App Azure Resource Manager-based PowerShell  Cmdlets](https://msdn.microsoft.com/library/mt619237.aspx)  Cmdlets](https://msdn.microsoft.com/zh-cn/library/mt619237.aspx) 
...
To change the settings and configurations for an existing web app, use the **Set-AzureRmWebApp** cmdlet. For a full list of parameters, check the [Cmdlet reference  link](https://msdn.microsoft.com/library/mt652487.aspx)  link](https://msdn.microsoft.com/zh-cn/library/mt652487.aspx) 
...

- To learn about managing  App Service  Azure  SSL certificates using PowerShell, see [SSL Certificates binding using PowerShell.](/documentation/articles/app-service-web-app-powershell-ssl-binding/)
- To learn about the full list of Azure Resource Manager-based PowerShell cmdlets for Azure Web Apps, see [Azure Cmdlet Reference of Web Apps Azure Resource Manager PowerShell  Cmdlets.](https://msdn.microsoft.com/library/mt619237.aspx)  Cmdlets.](https://msdn.microsoft.com/zh-cn/library/mt619237.aspx) 
