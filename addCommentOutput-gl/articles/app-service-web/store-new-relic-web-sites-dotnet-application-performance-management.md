...
monitoring to your web app in [Azure  App Service](/documentation/services/web-sites/)  Web App](/documentation/services/web-sites/) . We'll cover the fast and simple
...
For pricing information see the [New Relic page in the Azure  Marketplace](/marketplace/partners/newrelic/newrelic)  gallery](/marketplace/partners/newrelic/newrelic) .
...
Sign up for New Relic using the Azure  Marketplace  gallery 
--

New Relic integrates seamlessly with Azure Web Roles, Worker roles and Azure  Web  App  Service .

To sign up for New Relic directly from the Azure  Marketplace  gallery , follow these four easy steps.

## Step 1. Create a New Relic account

1. Log in to the [Azure  Portal](https://portal.azure.com/)  Portal](https://portal.azure.cn/)  and click **New** in the corner.
...
1. Open your web app's blade in the [Azure  Portal](https://portal.azure.com/)  Portal](https://portal.azure.cn/) .
...
6. Select the account that you created in the previous step, then click **OK**. 
	...
	Once the save operation has completed, click  **All Settings**  **Configure**  in the web app's blade, then click **Application settings**. You should see the **NEWRELIC\_LICENSEKEY** setting added to the **App settings** section of the blade to support New Relic:
...
2. Open your web app's blade in the [Azure  Portal](https://portal.azure.com/)  Portal](https://portal.azure.cn/) .
