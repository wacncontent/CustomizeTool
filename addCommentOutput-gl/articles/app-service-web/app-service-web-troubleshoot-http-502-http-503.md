...
This article helps you troubleshoot HTTP 502/503 errors in your web app hosted in [Azure  App Service](/documentation/services/web-sites/)  Web App](/documentation/services/web-sites/) .
...
This is often the simplest way to recover from one-time issues. On the [Azure  Portal](https://portal.azure.com/)  Management Portal](https://manage.windowsazure.cn/) , on your web app's blade, you have the options to stop or restart your app.
