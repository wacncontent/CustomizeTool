...
3. If needed, change the parameter values, then follow the steps in the Azure  portal  preview  portal  to deploy the resource group.
...
2. After a few minutes, the execution will end and you will see the rest of the output as shown below.
		...
		info:    Looking up the VM "DB1"
		info:    Looking up the storage account wtestvnetstorageprm
		info:    New data disk location:  https://wtestvnetstorageprm.blob.core.windows.net/vhds/datadisk1-1.vhd  https://wtestvnetstorageprm.blob.core.chinacloudapi.cn/vhds/datadisk1-1.vhd 
		info:    Updating VM "DB1"
		info:    vm disk attach-new command OK
		info:    Executing command vm disk attach-new
		info:    Looking up the VM "DB1"
		info:    Looking up the storage account wtestvnetstorageprm
		info:    New data disk location:  https://wtestvnetstorageprm.blob.core.windows.net/vhds/datadisk1-2.vhd  https://wtestvnetstorageprm.blob.core.chinacloudapi.cn/vhds/datadisk1-2.vhd 
		info:    Updating VM "DB1"
		info:    vm disk attach-new command OK
		info:    Executing command network nic create
		...
		info:    Looking up the VM "DB2"
		info:    Looking up the storage account wtestvnetstorageprm
		info:    New data disk location:  https://wtestvnetstorageprm.blob.core.windows.net/vhds/datadisk2-1.vhd  https://wtestvnetstorageprm.blob.core.chinacloudapi.cn/vhds/datadisk2-1.vhd 
		info:    Updating VM "DB2"
		info:    vm disk attach-new command OK
		info:    Executing command vm disk attach-new
		info:    Looking up the VM "DB2"
		info:    Looking up the storage account wtestvnetstorageprm
		info:    New data disk location:  https://wtestvnetstorageprm.blob.core.windows.net/vhds/datadisk2-2.vhd  https://wtestvnetstorageprm.blob.core.chinacloudapi.cn/vhds/datadisk2-2.vhd 
		info:    Updating VM "DB2"
		info:    vm disk attach-new command OK
