...
4. Create a route table named **UDR-FrontEnd** in the  **westus**  **chinanorth**  region that contains the route created above.

		$routeTable = New-AzureRmRouteTable -ResourceGroupName TestRG -Location  westus  chinanorth  `
