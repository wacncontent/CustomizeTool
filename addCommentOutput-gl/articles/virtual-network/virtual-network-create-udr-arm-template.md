...
3. Run the `New-AzureRmResourceGroupDeployment` cmdlet to deploy the template.
	...
	Expected output:
		...
		Resources         : 
		                    Name                Type                                     Location
		                    ==================  =======================================  ========
		                    ASFW                Microsoft.Compute/availabilitySets        westus  chinanorth 
		                    ASSQL               Microsoft.Compute/availabilitySets        westus  chinanorth 
		                    ASWEB               Microsoft.Compute/availabilitySets        westus  chinanorth 
		                    FW1                 Microsoft.Compute/virtualMachines         westus  chinanorth 
		                    SQL1                Microsoft.Compute/virtualMachines         westus  chinanorth 
		                    SQL2                Microsoft.Compute/virtualMachines         westus  chinanorth 
		                    WEB1                Microsoft.Compute/virtualMachines         westus  chinanorth 
		                    WEB2                Microsoft.Compute/virtualMachines         westus  chinanorth 
		                    NICFW1              Microsoft.Network/networkInterfaces       westus  chinanorth 
		                    NICSQL1             Microsoft.Network/networkInterfaces       westus  chinanorth 
		                    NICSQL2             Microsoft.Network/networkInterfaces       westus  chinanorth 
		                    NICWEB1             Microsoft.Network/networkInterfaces       westus  chinanorth 
		                    NICWEB2             Microsoft.Network/networkInterfaces       westus  chinanorth 
		                    NSG-BackEnd         Microsoft.Network/networkSecurityGroups   westus  chinanorth 
		                    NSG-FrontEnd        Microsoft.Network/networkSecurityGroups   westus  chinanorth 
		                    PIPFW1              Microsoft.Network/publicIPAddresses       westus  chinanorth 
		                    PIPSQL1             Microsoft.Network/publicIPAddresses       westus  chinanorth 
		                    PIPSQL2             Microsoft.Network/publicIPAddresses       westus  chinanorth 
		                    PIPWEB1             Microsoft.Network/publicIPAddresses       westus  chinanorth 
		                    PIPWEB2             Microsoft.Network/publicIPAddresses       westus  chinanorth 
		                    UDR-BackEnd         Microsoft.Network/routeTables             westus  chinanorth 
		                    UDR-FrontEnd        Microsoft.Network/routeTables             westus  chinanorth 
		                    TestVNet            Microsoft.Network/virtualNetworks         westus  chinanorth 
		                    testvnetstorageprm  Microsoft.Storage/storageAccounts         westus  chinanorth 
		                    testvnetstoragestd  Microsoft.Storage/storageAccounts         westus  chinanorth 
...
4. Run the **azure group create** cmdlet to deploy the new VNet by using the template and parameter files you downloaded and modified above. The list shown after the output explains the parameters used.
		...
		azure group create -n TestRG -l  westus  chinanorth  --template-uri 'https://raw.githubusercontent.com/telmosampaio/azure-templates/master/IaaS-NSG-UDR/azuredeploy.json' -e 'c:\udr\azuredeploy.parameters.json'
