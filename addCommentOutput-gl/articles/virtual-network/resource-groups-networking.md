...
Both the request and response conform to a JSON payload format. For more details, see [Azure Resource Management  APIs](https://msdn.microsoft.com/library/azure/dn948464.aspx)  APIs](https://msdn.microsoft.com/zh-cn/library/azure/dn948464.aspx) .
...
4. Click **Edit parameters** and select a location, such as  *West US*  *China North* , for the vnet and subnets.
...
[Compute Resource Provider](/documentation/articles/virtual-machines-windows-compare-deployment-models/)
