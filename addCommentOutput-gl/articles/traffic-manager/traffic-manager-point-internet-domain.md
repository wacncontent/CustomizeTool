...
For example, to point the company domain name www.contoso.com to the Traffic Manager domain name  contoso.trafficmanager.net  contoso.trafficmanager.cn , you would update your DNS resource record to be the following:
