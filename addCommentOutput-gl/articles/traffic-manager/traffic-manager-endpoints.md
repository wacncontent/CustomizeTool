...
1. On the Traffic Manager pane in the Azure  classic  Classic   portal  Management Portal , locate the Traffic Manager profile that contains the endpoint settings that you want to modify, and then click the arrow to the right of the profile name. This will open the settings page for the profile.
...
>[AZURE.NOTE] You cannot delete external locations or Traffic Manager profiles as endpoints using the Azure  classic  Classic   portal  Management Portal . You must use Windows PowerShell. For more information, see  [Remove-AzureTrafficManagerEndpoint](https://msdn.microsoft.com/library/dn690251.aspx)  [Remove-AzureTrafficManagerEndpoint](https://msdn.microsoft.com/zh-cn/library/dn690251.aspx) .
