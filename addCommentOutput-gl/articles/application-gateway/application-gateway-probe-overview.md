...
For example: You configure your application gateway to use back-end servers A, B, and C to receive HTTP network traffic on port 80. The default health monitoring tests the three servers every 30 seconds for a healthy HTTP response. A healthy HTTP response has a [status  code](https://msdn.microsoft.com/library/aa287675.aspx)  code](https://msdn.microsoft.com/zh-cn/library/aa287675.aspx)  between 200 and 399.
