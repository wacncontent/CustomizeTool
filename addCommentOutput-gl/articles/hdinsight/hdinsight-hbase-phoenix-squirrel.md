...
2. Run the following command to get the DNS suffix:
	...
	Write down **Connection-specific DNS Suffix**. For example,  *myhbasecluster.f5.internal.cloudapp.net*  *myhbasecluster.f5.internal.chinacloudapp.cn* . When you connect to an HBase cluster, you will need to connect to one of the Zookeepers using FQDN. Each HDInsight cluster has 3 Zookeepers. They are *zookeeper0*, *zookeeper1*, and *zookeeper2*. The FQDN will be something like  *zookeeper2.myhbasecluster.f5.internal.cloudapp.net*  *zookeeper2.myhbasecluster.f5.internal.chinacloudapp.cn* .
...
- An HBase cluster deployed to an Azure virtual network with a DNS virtual machine.  For instructions, see [Provision HBase clusters on Azure Virtual  Network][hdinsight-hbase-provision-vnet]  Network][hdinsight-hbase-provision-vnet-v1] .
...
3. Click the virtual network you have created (see [Provision HBase clusters on Azure Virtual  Network][hdinsight-hbase-provision-vnet])  Network][hdinsight-hbase-provision-vnet-v1]) .
...
- From the workstation, open a command prompt and ping one of the following names given the HBase cluster's DNS suffix is  myhbase.b7.internal.cloudapp.net  myhbase.b7.internal.chinacloudapp.cn :
