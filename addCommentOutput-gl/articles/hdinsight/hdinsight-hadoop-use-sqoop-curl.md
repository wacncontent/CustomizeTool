...

    ...
    * **-G** - Indicates that this is a GET request.
    ...
    The beginning of the URL,  **https://CLUSTERNAME.azurehdinsight.net/templeton/v1**  **https://CLUSTERNAME.azurehdinsight.cn/templeton/v1** , will be the same for all requests. The path, **/status**, indicates that the request is to return a status of WebHCat (also known as Templeton) for the server.
