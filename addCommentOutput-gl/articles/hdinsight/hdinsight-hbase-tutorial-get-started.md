...

- **A Microsoft Azure subscription**. See [Get Azure free trial](/pricing/1rmb-trial/).
...
3. Enter the following values:
	...
	- **Cluster Operating System** - Select **Windows**.  For creating Linux-based HBase cluster, see  [HBase tutorial: Get started using Apache HBase with Hadoop in HDInsight  (Linux)](/documentation/articles/hdinsight-hbase-tutorial-get-started-linux/)  (Linux)](/documentation/articles/hdinsight-hbase-tutorial-get-started-v1/) .
...
1. Browse to **https://<HDInsight Cluster  Name>.azurehdinsight.net/**  Name>.azurehdinsight.cn/** .
