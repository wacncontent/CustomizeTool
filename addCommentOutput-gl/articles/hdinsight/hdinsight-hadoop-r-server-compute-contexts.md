...
or see the "ScaleR Distributed Computing Guide" available from the [R Server  MSDN](https://msdn.microsoft.com/library/mt674634.aspx  MSDN](https://msdn.microsoft.com/zh-cn/library/mt674634.aspx  "R Server on MSDN") library.
