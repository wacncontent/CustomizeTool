...
The Dashboard can be accessed by browsing to  http://<YourHDInsightClusterName>.azurehdinsight.net/  http://<YourHDInsightClusterName>.azurehdinsight.cn/  or from the Azure Portal.
