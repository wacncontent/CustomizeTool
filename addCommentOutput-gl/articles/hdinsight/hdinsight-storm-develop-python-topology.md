...

    * For __Windows-based__ HDInsight clusters: Connect to the Storm Dashboard by going to  HTTPS://CLUSTERNAME.azurehdinsight.net/  HTTPS://CLUSTERNAME.azurehdinsight.cn/  in your browser. Replace CLUSTERNAME with your HDInsight cluster name and provide the admin name and password when prompted.
...

    ...
    * __Windows-based HDInsight__
        ...
        1. Connect to the Storm Dashboard by going to  HTTPS://CLUSTERNAME.azurehdinsight.net/  HTTPS://CLUSTERNAME.azurehdinsight.cn/  in your browser. Replace CLUSTERNAME with your HDInsight cluster name and provide the admin name and password when prompted.
