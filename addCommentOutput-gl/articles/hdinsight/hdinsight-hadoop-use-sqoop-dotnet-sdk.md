        ...
        namespace SubmitHDInsightJobDotNet
        {
            class Program
            {
                ...
                private static void SubmitSqoopJob()
                {
                    ...
                    var connectionString = "jdbc:sqlserver://" + sqlDatabaseServerName +  ".database.windows.net;user="  ".database.chinacloudapi.cn;user="  + sqlDatabaseLogin + "@" + sqlDatabaseServerName + ";password=" + sqlDatabaseLoginPassword + ";database=" + sqlDatabaseDatabaseName;
