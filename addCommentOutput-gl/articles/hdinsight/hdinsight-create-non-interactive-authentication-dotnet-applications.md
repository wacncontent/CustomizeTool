...
- HDInsight cluster. You can create one using the instructions found in the [getting started  tutorial](/documentation/articles/hdinsight-hadoop-linux-tutorial-get-started/#create-cluster)  tutorial](/documentation/articles/hdinsight-hadoop-tutorial-get-started-windows-v1/#create-cluster) .
...
1.	Sign in to the [Azure classic portal](  https://manage.windowsazure.com/)  https://manage.windowsazure.cn/) .
