...
<tr><td>${nameNode}</td><td>Specifies the URL of the Hadoop name node. Use the default file system address, for example,  <i>wasb://&lt;containerName&gt;@&lt;storageAccountName&gt;.blob.core.windows.net</i>.</td></tr>  <i>wasb://&lt;containerName&gt;@&lt;storageAccountName&gt;.blob.core.chinacloudapi.cn</i>.</td></tr> 
...
4. Create an HDInsight cluster used to run Oozie jobs.
	...
	To examine the cluster, you can use the Azure  portal  Classic Management Portal  or Azure PowerShell.
