...
| ------------ | ---- |  ----------- | --- | ----------- |
| Stargate | 443 | HTTPS | HBase | HBase REST API. See [Get started using  HBase](/documentation/articles/hdinsight-hbase-tutorial-get-started-linux/)  HBase](/documentation/articles/hdinsight-hbase-tutorial-get-started-v1/)  |
...
| Storm | 443 | HTTPS | Storm | Storm web UI. See [Deploy and manage Storm topologies on  HDInsight](/documentation/articles/hdinsight-storm-deploy-monitor-topology-linux/)  HDInsight](/documentation/articles/hdinsight-storm-deploy-monitor-topology/) 
