...
2. Use the following code:
        ...
        namespace SubmitHDInsightJobDotNet
        {
            class Program
            {
                ...
                private const string ExistingClusterUri = ExistingClusterName +  ".azurehdinsight.net"  ".azurehdinsight.cn" ;
...
* [Manage Hadoop clusters in HDInsight by using the Azure  Portal](/documentation/articles/hdinsight-administer-use-management-portal/)  Classic Management Portal](/documentation/articles/hdinsight-administer-use-management-portal-v1/) 

