...
1. Open a web browser and go to  HTTPS://CLUSTERNAME.azurehdinsight.net  HTTPS://CLUSTERNAME.azurehdinsight.cn , where __CLUSTERNAME__ is the name of your HDInsight cluster. When prompted, provide the admin user name (`admin`) and the password that you used for this account when the cluster was created.
...
* __From the [Azure  Portal](https://portal.azure.com)__  Portal](https://portal.azure.cn)__ : In the portal, select the Azure Data Lake Store that you used with HDInsight.
...
1. From the Storm Dashboard  (https://CLUSTERNAME.azurehdinsight.net,)  (https://CLUSTERNAME.azurehdinsight.cn,)  select the __Storm UI__ link at the top of the page.
