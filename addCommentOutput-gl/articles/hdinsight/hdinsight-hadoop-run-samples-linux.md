...
- **A Linux-based HDInsight cluster**: See [Get started using Hadoop with Hive in HDInsight on  Linux](/documentation/articles/hdinsight-hadoop-linux-tutorial-get-started/)  Linux](/documentation/articles/hdinsight-hadoop-tutorial-get-started-windows-v1/) 
