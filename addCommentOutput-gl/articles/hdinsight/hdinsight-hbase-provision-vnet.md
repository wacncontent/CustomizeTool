...
In this section, you will create a Linux-based HBase cluster in HDInsight using [Azure ARM template](/documentation/articles/resource-group-template-deploy/). The Azure ARM template experience is not required for following this tutorial. For other cluster creation methods and understanding the settings, see [Create HDInsight  clusters](/documentation/articles/hdinsight-hadoop-provision-linux-clusters/)  clusters](/documentation/articles/hdinsight-provision-clusters-v1/) . For more information about using ARM template to create Hadoop clusters in HDInsight, see [Create Hadoop clusters in HDInsight using ARM templates](/documentation/articles/hdinsight-hadoop-create-windows-clusters-arm-templates/)
...

				...
				{
					$Url = "https://" + $ClusterFQDN + "/ambari/api/v1/clusters/" + $ClusterFQDN +  "/home/features/YARN/components/RESOURCEMANAGER"  "/services/YARN/components/RESOURCEMANAGER" 
					$Response = $webclient.DownloadString($Url)
					$JsonObject = $Response | ConvertFrom-Json
