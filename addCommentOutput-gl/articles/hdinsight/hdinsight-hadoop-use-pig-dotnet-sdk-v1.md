...
>
>For a version of this document that uses the Azure portal, along with the HDInsight .NET SDK snippets that use Azure Resource Manager (ARM), see [Run Pig jobs using the .NET SDK for Hadoop in HDInsight](/documentation/articles/hdinsight-hadoop-use-pig-dotnet-sdk/)


...
For instructions on how to do this, see [Create a self-signed  certificate](/documentation/articles/hdinsight-administer-use-management-portal/#cert)  certificate](/documentation/articles/hdinsight-administer-use-management-portal-v1/#cert) .
...
1. Visit the [Azure Management  Console](https://manage.windowsazure.com/)  Console](https://manage.windowsazure.cn/) .
