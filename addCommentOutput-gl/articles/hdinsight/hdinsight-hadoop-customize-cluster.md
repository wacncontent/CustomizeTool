...
The information in this article is specific to Windows-based HDInsight clusters. For Linux-based clusters, see [Customize Linux-based HDInsight clusters using Script  Action](/documentation/articles/hdinsight-hadoop-customize-cluster-linux/)  Action](/documentation/articles/hdinsight-hadoop-customize-cluster-v1/) .
...
| **Pre-load Hive libraries** | https://hdiconfigactions.blob.core.windows.net/setupcustomhivelibsv01/setup-customhivelibs-v01.ps1. See [Add Hive libraries on HDInsight clusters](/documentation/articles/hdinsight-hadoop-add-hive-libraries/) |
...
2. Under Optional Configuration, for the **Script Actions** blade, click **add script action** to provide details about the script action, as shown below:
	...
	![Use Script Action to customize a  cluster](./media/hdinsight-hadoop-customize-cluster/HDI.CreateCluster.8.png  cluster](./media/hdinsight-hadoop-customize-cluster-v1/HDI.CreateCluster.8.png  "Use Script Action to customize a cluster")
...

        ...
        {
            var authContext = new  AuthenticationContext("https://login.microsoftonline.com/"  AuthenticationContext("https://login.chinacloudapi.cn/"  + TenantId);

...
- **Built-in components** - These components are pre-installed on HDInsight clusters and provide core functionality of the cluster. For example, YARN ResourceManager, the Hive query language (HiveQL), and the Mahout library belong to this category. A full list of cluster components is available in [What's new in the Hadoop cluster versions provided by  HDInsight?](/documentation/articles/hdinsight-component-versioning/)</a>  HDInsight?](/documentation/articles/hdinsight-component-versioning-v1/)</a> .
