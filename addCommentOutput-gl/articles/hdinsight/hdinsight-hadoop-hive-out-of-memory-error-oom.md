...
The customer consulted [Optimize Hive queries for Hadoop in  HDInsight](/documentation/articles/hdinsight-hadoop-optimize-hive-query/)  HDInsight](/documentation/articles/hdinsight-hadoop-optimize-hive-query-v1/) , and decided to use Tez execution engine. Once the same query was run with the Tez setting enabled the query ran for 15 minutes, and then threw the following error:
