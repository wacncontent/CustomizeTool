...
1. From the [Azure Classic  Portal](https://manage.windowsazure.com)  Management Portal](https://manage.windowsazure.cn) , select **NEW** > __APP SERVICES__ > **SERVICE BUS** > **EVENT HUB** > **CUSTOM CREATE**.
...
1. From the [Azure Classic  Portal](https://manage.windowsazure.com)  Management Portal](https://manage.windowsazure.cn) , select **NEW** > **Data Services** > **Storage** > **Quick Create**.
