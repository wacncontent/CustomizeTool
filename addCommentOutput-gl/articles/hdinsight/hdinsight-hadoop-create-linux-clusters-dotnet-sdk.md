...
6. From Solution Explorer, double-click **Program.cs** to open it, paste the following code, and provide values for the variables:
        ...
        namespace CreateHDInsightCluster
        {
            class Program
            {
                ...
                private const string ExistingStorageName = "<Enter Default Storage Account  Name>.blob.core.windows.net"  Name>.blob.core.chinacloudapi.cn" ;
...
For more inforamtion, see [Customize Linux-based HDInsight clusters using Script  Action](/documentation/articles/hdinsight-hadoop-customize-cluster-linux/)  Action](/documentation/articles/hdinsight-hadoop-customize-cluster-v1/) .
...
- [Run Pig jobs in HDInsight using .NET  SDK](/documentation/articles/hdinsight-hadoop-use-pig-dotnet-sdk/)  SDK](/documentation/articles/hdinsight-hadoop-use-pig-dotnet-sdk-v1/) 
