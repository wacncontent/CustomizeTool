...
* Hadoop on HDInsight cluster - see [Provision an HDInsight  cluster](/documentation/articles/hdinsight-provision-clusters/)  cluster](/documentation/articles/hdinsight-provision-clusters-v1/)  for steps to create a cluster
