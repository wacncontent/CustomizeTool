<properties 
	pageTitle="使用 HBase 分析实时 Twitter 观点 | Windows Azure" 
...
4. 单击**“确定”**。
5. 在“选择模板”中单击“MVC”。 
6. 在“Windows Azure”中单击“管理订阅”。
7. 在“管理 Windows Azure 订阅”中单击“登录”。
8. 输入你的 Azure 凭据。你的 Azure 订阅信息将显示在“帐户”选项卡上。
9. 单击“关闭”以关闭“管理 Windows Azure 订阅”窗口。
10. 在“新建 ASP.NET 项目 - TweetSentimentWeb”中单击“确定”。
11. 在“配置 Windows Azure 站点设置”中，选择与你最靠近的“区域”。你不需要指定数据库服务器。 
12. 单击**“确定”**。
