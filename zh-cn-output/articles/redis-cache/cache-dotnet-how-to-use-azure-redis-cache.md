...
Windows Azure Redis 缓存基于流行的开放源代码 Redis 缓存。它让您访问 Microsoft 管理的安全专用的 Redis 缓存。使用 Azure Redis 缓存创建的缓存可从 Windows Azure 内的任何应用程序进行访问。
...
若要创建缓存，首先请登录到 [Windows Azure 预览门户][]，然后单击“新建”、“数据 + 存储”、“Redis 缓存”。

![新建缓存][NewCacheMenu]

>[AZURE.NOTE]如果你没有 Azure 帐户，只需花费几分钟就能创建一个免费试用帐户。有关详细信息，请参阅 [Azure 免费试用][]。
...
[缓存定价详细信息]: http://www.windowsazure.cn/home/features/cache/#price
[Windows Azure 预览门户]: https://manage.windowsazure.cn
...
[Azure 免费试用]: /pricing/1rmb-trial/?WT.mc_id=redis_cache_hero
