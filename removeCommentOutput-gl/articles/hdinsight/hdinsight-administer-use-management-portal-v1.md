...
- [Provision a cluster by using Quick Create](/documentation/articles/hdinsight-hadoop-linux-tutorial-get-started/)
...
1. Create a self-signed certificate that is used to authenticate the requests. You can use Internet Information Services (IIS) or [makecert]( https://msdn.microsoft.com/library/bfsktky3(v=vs.110).aspx) to create the certificate.
