...
Azure HDInsight provides the big data cloud offerings in two categories: Standard and [Premium](/documentation/articles/hdinsight-component-versioning/#hdinsight-standard-and-hdinsight-premium). HDInsight Premium includes R and other additional components. HDInsight Premium is only supported on HDInsight version 3.4. 
