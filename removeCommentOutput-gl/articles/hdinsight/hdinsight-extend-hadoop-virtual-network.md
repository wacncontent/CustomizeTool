...
* [Provision Hadoop clusters in HDInsight](/documentation/articles/hdinsight-hadoop-provision-linux-clusters/) - Provides information on provisioning Hadoop clusters, including information on using Azure Virtual Network.

* [Use Sqoop with Hadoop in HDInsight](/documentation/articles/hdinsight-use-sqoop-mac-linux/) - Provides information on using Sqoop to transfer data with SQL Server over a virtual network.
