...
Learn how to create HDInsight clusters using .NET SDK. For other cluster creation tools and features click the tab select on the top of this page or see [Cluster creation methods](/documentation/articles/hdinsight-provision-clusters/#cluster-creation-methods).
...
- [Run Pig jobs in HDInsight using .NET SDK](/documentation/articles/hdinsight-hadoop-use-pig-dotnet-sdk/)
