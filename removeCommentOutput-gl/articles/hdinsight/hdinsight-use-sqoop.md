...
- **SQL Server**: If your HDInsight cluster is on the same virtual network in Azure as SQL Server, you can use the steps in this article to import and export data to a SQL Server database.
    ...
    * To create an HDInsight cluster on a virtual network, see [Create Hadoop clusters in HDInsight using custom options](/documentation/articles/hdinsight-provision-clusters/)
...
6. Export a data file to the Azure SQL database.
	...
	> * **Azure HDInsight 3.1**: See [Create Hadoop clusters in HDInsight using custom options](/documentation/articles/hdinsight-provision-clusters/) for information about creating a cluster on a virtual network.
