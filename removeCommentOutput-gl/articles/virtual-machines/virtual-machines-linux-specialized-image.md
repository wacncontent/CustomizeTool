...
1. Copy the VHD files by using the [Azure CLI commands for Storage](/documentation/articles/storage-azure-cli/), as described in the following steps. Alternatively, if you prefer a user interface, you can use the [Microsoft Azure Storage Explorer](http://storageexplorer.com/ ) instead.
</br>
