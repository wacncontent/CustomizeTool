...
- An Azure account and subscription before you start. If you don't have one, sign up for a [free trial](/pricing/1rmb-trial/).
...
Before we can set the operating system properties for the virtual machine, we need to supply the credentials for the local administrator account as a secure string. To accomplish this, we will use the [Get-Credential](https://technet.microsoft.com/en-us/library/hh849815.aspx) cmdlet.
