...
[Azure App Service](/documentation/services/web-sites/). In this article, you'll quickly add some 
...
For more information on scaling up your app, see [Scale pricing tier in Azure App Service](/documentation/articles/app-service-scale/). For more information on
