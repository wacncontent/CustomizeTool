...
This article shows you how to restore an App Service app that you have previously backed up by using the [App Service](/documentation/services/web-sites/) Backup feature. For more information, see [App Service Backups](/documentation/articles/web-sites-backup/). 
