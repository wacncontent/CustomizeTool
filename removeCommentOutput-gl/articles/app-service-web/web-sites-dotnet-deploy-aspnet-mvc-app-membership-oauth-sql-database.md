...
This tutorial shows how to build a secure ASP.NET MVC 5 web app that lets users log in with credentials from Facebook or Google. The app is a simple contact list that uses the ADO.NET Entity Framework for database access. You'll deploy the app to [Azure App Service](/documentation/services/web-sites/). 
...
* How to deploy a web project that uses a database to a [web app](/documentation/services/web-sites/) in Azure App Service.
