...
* [How to deploy WebJobs using the Azure Portal](/documentation/articles/web-sites-create-web-jobs/)
...
* [Create a Scheduled WebJob in the Azure Portal](/documentation/articles/web-sites-create-web-jobs/#CreateScheduled)
