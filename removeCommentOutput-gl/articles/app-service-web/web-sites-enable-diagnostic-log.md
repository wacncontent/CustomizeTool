...
Azure provides built-in diagnostics to assist with debugging an [App Service web app](/documentation/services/web-sites/). In this article you'll learn how to enable diagnostic logging and add instrumentation to your application, as well as how to access the information logged by Azure.
