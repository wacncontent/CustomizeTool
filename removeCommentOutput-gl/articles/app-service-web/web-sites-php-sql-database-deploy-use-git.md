...
This tutorial shows you how to create a PHP web app in [Azure App Service](/documentation/services/web-sites/) that connects to Azure SQL Database and how to deploy it using Git. This tutorial assumes you have [PHP][install-php], [SQL Server Express][install-SQLExpress], the [Microsoft Drivers for SQL Server for PHP](http://www.microsoft.com/download/en/details.aspx?id=20098), and [Git][install-git] installed on your computer. Upon completing this guide, you will have a PHP-SQL web app running in Azure.
...
* How to create an Azure web app and a SQL Database using the [Azure Portal](https://manage.windowsazure.cn/). Because PHP is enabled in App Service Web Apps by default, nothing special is required to run your PHP code.
