...
## Pricing
There is no extra cost for using Virtual Networks in Azure. The compute instances launched within the Vnet will be charged the standard rates as described in [Azure VM Pricing](/home/features/virtual-machines/pricing/). The [VPN Gateways](/home/features/vpn-gateway/pricing/) and [Public IP Addresses] (/home/features/ip-addresses/pricing/) used in the VNet will also be charged standard rates.
