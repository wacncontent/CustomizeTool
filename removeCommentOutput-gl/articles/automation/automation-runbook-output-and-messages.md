...
You can write data to the output stream using [Write-Output](http://technet.microsoft.com/en-us/library/hh849921.aspx) or by putting the object on its own line in the runbook.
