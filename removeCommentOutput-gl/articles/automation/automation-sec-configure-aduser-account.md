...
You should repeat these lines after any [checkpoints](http://technet.microsoft.com/en-us/library/dn469257.aspx#bk_Checkpoints) in your runbook. If the runbook is suspended and then resumes on another worker, then it will need to perform the authentication again.
