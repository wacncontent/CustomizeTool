...
You retrieve a connection in a runbook or DSC configuration with the **Get-AutomationConnection** cmdlet.  This activity retrieves the values of the different fields in the connection and returns them as a [hash table](https://technet.microsoft.com/en-us/library/hh847780.aspx) which can then be used with the appropriate commands in the runbook or DSC configuration.
